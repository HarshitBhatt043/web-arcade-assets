!(function (e) {
          ...
          (o = function (e) {
            ...
            if (
              ...
              (r = function (e, t) {
                ...
                (a = u.cancelTimer),
                (i = u.runOnLoop || u.runOnContext);
            }
            return { setTimer: r, clearTimer: a, asap: i };
  ...
  function (e, t, s) {
    ...
    var p = (function () {
      function e(t, s, n) {
        if (
          ...
          "string" != typeof t || "string" != typeof s)
        )
          throw new Error(
        ...
        (n = n || {}),
          (this._flags = 0),
          this._setFlag(e.STATUS_FLAGS.DATA_URL, 0 === s.indexOf("data:")),
          (this.name = t),
          (this.url = s),
      ...
      return (
        (e.setExtensionLoadType = function (t, s) {
          ...
          if (
            ...
            if (!this.metadata.skipSource)
              if (navigator.isCocoonJS)
                ...
                for (
                  var t = this.metadata.mimeType, s = 0;
                  s < this.url.length;
                  ++s
                )
                ...
                this.data.appendChild(
                  this._createSource(e, this.url, Array.isArray(n) ? n[0] : n)
                );
              }
            this.data.addEventListener("error", this._boundOnError, !1),
              this.data.addEventListener("load", this._boundComplete, !1),
          ...
          if (
            ...
            if (this.xhrType === e.XHR_RESPONSE_TYPE.TEXT)
              ...
              try {
                ...
                return void this.abort(
                  "Error trying to parse loaded xml: " + e
                );
              }
        ...
        (e.prototype._determineCrossOrigin = function (e, t) {
          ...
          (t = t || location),
            c || i || (c = document.createElement("a")),
            i || (c.href = e);
          var s =
              (!(e = (0, o.default)(i ? e : c.href, { strictMode: !0 })).port &&
                "" === t.port) ||
              e.port === t.port,
            n = e.protocol ? e.protocol + ":" : "";
          return e.host === t.hostname && s && n === t.protocol
            ? ""
            : "anonymous";
        }),
    ...
    (t.default = p),
      (p.STATUS_FLAGS = { NONE: 0, DATA_URL: 1, COMPLETE: 2, LOADING: 4 }),
      (p.TYPE = {
        UNKNOWN: 0,
        JSON: 1,
        XML: 2,
      ...
      (p.LOAD_TYPE = { XHR: 1, IMAGE: 2, AUDIO: 3, VIDEO: 4 }),
      (p.XHR_RESPONSE_TYPE = {
        DEFAULT: "text",
        BUFFER: "arraybuffer",
        BLOB: "blob",
    ...
    (t.__esModule = !0),
      ...
      (t.queue = function (e, t) {
        ...
        function a(e, t, s) {
          ...
          if (((r.started = !0), null == e && r.idle()))
            setTimeout(function () {
              return r.drain();
            }, 1);
          else {
            var o = { data: e, callback: "function" == typeof s ? s : n };
            t ? r._tasks.unshift(o) : r._tasks.push(o),
              setTimeout(function () {
                return r.process();
              }, 1);
          }
        ...
        function i(e) {
          return function () {
            (s -= 1),
              ...
              null != arguments[0] && r.error(arguments[0], e.data),
              s <= r.concurrency - r.buffer && r.unsaturated(),
              r.idle() && r.drain(),
              r.process();
          };
        }
    ...
    e.exports = function (e, t) {
      ...
      for (
        var s = {
          ...
          n = s.parser[t.strictMode ? "strict" : "loose"].exec(e),
          o = {},
          r = 14;
        r--;
      ...
      return (
        (o[s.q.name] = {}),
        o[s.key[12]].replace(s.q.parser, function (e, t, n) {
          t && (o[s.q.name][t] = n);
        }),
        o
      );
              ...
              return e._owner !== this
                ...
                : (e._prev && (e._prev._next = e._next),
                  ...
                  e === this._head
                    ...
                    : e === this._tail &&
                      ((this._tail = e._prev), (this._tail._next = null)),
                  (e._owner = null),
                  this);
            },
          },
  ...
  function (e, t, s) {
          ...
          var e =
            ...
            s = {
              ...
              log: function () {
                var s = [];
                o.default
                  ? (s.push("%cWorker%c %c".concat(e)), s.push(i, " "))
                  : s.push("%c".concat(e)),
                  s.push(a(t)),
    ...
    var n,
      o = (n = s(6)) && n.__esModule ? n : { default: n },
      r = [],
      a = function (e) {
  ...
  function (e, t, s) {
    ...
    var n,
      ...
      r,
      a,
      i = (n = s(6)) && n.__esModule ? n : { default: n };
    function u(e, t) {
      for (var s = 0; s < t.length; s++) {
        var n = t[s];
        (n.enumerable = n.enumerable || !1),
    ...
    var c =
            ...
            (s = [
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  for (
                    var s = "",
                      n = 0,
                      o = Math.ceil(t.byteLength / 65535),
                      r = 0;
                    r < o;
                    r++
                  )
                    (s += String.fromCharCode.apply(
                      null,
                      new Uint8Array(t.buffer.slice(n, n + 65535))
                    )),
                      (n += 65535);
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this.getData(e),
                    s = this.getType(e);
                  return (i.default ? self.Blob : Detect.supports.blob)
                    ? a.createObjectURL(new Blob([t], { type: s }))
                ...
                value: function (e) {
                  for (var t = this._config.length; t-- > 0; )
                    if (this._config[t][0] === e) {
                      ...
                      return { name: s[0], begin: s[1], end: s[2], type: s[3] };
                    }
                },
              },
              {
                ...
                value: function (e, t) {
                  return null === this._pack
                    ...
                    ? this._pack.substr(e, t - e)
                    : this._pack.slice(e, t);
                },
              },
              {
                key: "_detectFormat",
      ...
      (o.RAW_FORMAT = "raw"),
      (o.STRING_FORMAT = "string"),
      (o.BYTES_FORMAT = "bytes"),
      (o.URI_FORMAT = "uri"),
      r);
  ...
  function (e, t) {
    e.exports = {
      "/assets/audios/fx/chest.mp3": "/assets/audios/fx/chest.mp3",
      "/assets/audios/fx/door.mp3": "/assets/audios/fx/door.mp3",
      "/assets/audios/fx/error.mp3": "/assets/audios/fx/error.mp3",
      "/assets/audios/fx/explosion.mp3":
        "/assets/audios/fx/explosion.mp3",
      "/assets/audios/fx/fall-stone-0.mp3":
        "/assets/audios/fx/fall-stone-0.mp3",
      "/assets/audios/fx/fall-stone-1.mp3":
        "/assets/audios/fx/fall-stone-1.mp3",
      "/assets/audios/fx/fall-stone-2.mp3":
        "/assets/audios/fx/fall-stone-2.mp3",
      "/assets/audios/fx/fall-stone-3.mp3":
        "/assets/audios/fx/fall-stone-3.mp3",
      "/assets/audios/fx/falling-stone.mp3":
        "/assets/audios/fx/falling-stone.mp3",
      "/assets/audios/fx/fire.mp3": "/assets/audios/fx/fire.mp3",
      "/assets/audios/fx/fragment.mp3":
        "/assets/audios/fx/fragment.mp3",
      "/assets/audios/fx/laser-hit.mp3":
        "/assets/audios/fx/laser-hit.mp3",
      "/assets/audios/fx/laser-loop.mp3":
        "/assets/audios/fx/laser-loop.mp3",
      "/assets/audios/fx/magic-shot.mp3":
        "/assets/audios/fx/magic-shot.mp3",
      "/assets/audios/fx/rock-construct.mp3":
        "/assets/audios/fx/rock-construct.mp3",
      "/assets/audios/fx/thunder.mp3": "/assets/audios/fx/thunder.mp3",
      "/assets/audios/fx/validate-click.mp3":
        "/assets/audios/fx/validate-click.mp3",
      "/assets/audios/fx/walking.mp3": "/assets/audios/fx/walking.mp3",
      "/assets/audios/fx/woosh-2.mp3": "/assets/audios/fx/woosh-2.mp3",
      "/assets/audios/fx/woosh-3.mp3": "/assets/audios/fx/woosh-3.mp3",
      "/assets/audios/fx/woosh.mp3": "/assets/audios/fx/woosh.mp3",
      "/assets/audios/themes/credits-theme.mp3":
        "/assets/audios/themes/credits-theme.mp3",
      "/assets/audios/themes/home-theme.mp3":
        "/assets/audios/themes/home-theme.mp3",
      "/assets/audios/themes/level-1-theme.mp3":
        "/assets/audios/themes/level-1-theme.mp3",
      "/assets/audios/themes/level-2-theme.mp3":
        "/assets/audios/themes/level-2-theme.mp3",
      "/assets/audios/themes/level-3-theme.mp3":
        "/assets/audios/themes/level-3-theme.mp3",
      "/assets/audios/themes/tutorial-theme.mp3":
        "/assets/audios/themes/tutorial-theme.mp3",
      "/assets/audios/ui/active-selection.mp3":
        "/assets/audios/ui/active-selection.mp3",
      "/assets/audios/ui/helper.mp3": "/assets/audios/ui/helper.mp3",
      "/assets/audios/ui/interface-soft-stone.mp3":
        "/assets/audios/ui/interface-soft-stone.mp3",
      "/assets/audios/voices/god/avoid-lightning.mp3":
        "/assets/audios/voices/god/avoid-lightning.mp3",
      "/assets/audios/voices/god/having-fun-rocks.mp3":
        "/assets/audios/voices/god/having-fun-rocks.mp3",
      "/assets/audios/voices/god/hope-youre-glad.mp3":
        "/assets/audios/voices/god/hope-youre-glad.mp3",
      "/assets/audios/voices/god/hurry-up-song.mp3":
        "/assets/audios/voices/god/hurry-up-song.mp3",
      "/assets/audios/voices/god/hurry-up.mp3":
        "/assets/audios/voices/god/hurry-up.mp3",
      "/assets/audios/voices/god/intro.mp3":
        "/assets/audios/voices/god/intro.mp3",
      "/assets/audios/voices/god/laugh.mp3":
        "/assets/audios/voices/god/laugh.mp3",
      "/assets/audios/voices/god/loser.mp3":
        "/assets/audios/voices/god/loser.mp3",
      "/assets/audios/voices/god/power-1.mp3":
        "/assets/audios/voices/god/power-1.mp3",
      "/assets/audios/voices/god/power-2.mp3":
        "/assets/audios/voices/god/power-2.mp3",
      "/assets/audios/voices/god/river.mp3":
        "/assets/audios/voices/god/river.mp3",
      "/assets/audios/voices/god/rock-heavy.mp3":
        "/assets/audios/voices/god/rock-heavy.mp3",
      "/assets/audios/voices/heraclos/electrocution.mp3":
        "/assets/audios/voices/heraclos/electrocution.mp3",
      "/assets/audios/voices/heraclos/grr.mp3":
        "/assets/audios/voices/heraclos/grr.mp3",
      "/assets/audios/voices/heraclos/happened-to-me.mp3":
        "/assets/audios/voices/heraclos/happened-to-me.mp3",
      "/assets/audios/voices/heraclos/hmm.mp3":
        "/assets/audios/voices/heraclos/hmm.mp3",
      "/assets/audios/voices/heraclos/hus-0.mp3":
        "/assets/audios/voices/heraclos/hus-0.mp3",
      "/assets/audios/voices/heraclos/hus-1.mp3":
        "/assets/audios/voices/heraclos/hus-1.mp3",
      "/assets/audios/voices/heraclos/i-hate-this-guy.mp3":
        "/assets/audios/voices/heraclos/i-hate-this-guy.mp3",
      "/assets/audios/voices/heraclos/jump-0.mp3":
        "/assets/audios/voices/heraclos/jump-0.mp3",
      "/assets/audios/voices/heraclos/jump-1.mp3":
        "/assets/audios/voices/heraclos/jump-1.mp3",
      "/assets/audios/voices/heraclos/jump-2.mp3":
        "/assets/audios/voices/heraclos/jump-2.mp3",
      "/assets/audios/voices/heraclos/just-want-to-go-home.mp3":
        "/assets/audios/voices/heraclos/just-want-to-go-home.mp3",
      "/assets/audios/voices/heraclos/scream.mp3":
        "/assets/audios/voices/heraclos/scream.mp3",
      "/assets/audios/voices/heraclos/sigh-2.mp3":
        "/assets/audios/voices/heraclos/sigh-2.mp3",
      "/assets/audios/voices/heraclos/sigh.mp3":
        "/assets/audios/voices/heraclos/sigh.mp3",
      "/assets/audios/voices/heraclos/want-beer.mp3":
        "/assets/audios/voices/heraclos/want-beer.mp3",
      ...
      "/assets/favicons/favicon-96x96.png":
        "/assets/favicons/favicon-96x96.png",
      "/assets/favicons/favicon.ico": "/assets/favicons/favicon.ico",
      ...
      "/assets/favicons/ms-icon-70x70.png":
        "/assets/favicons/ms-icon-70x70.png",
      "/assets/fonts/dino.woff": "/assets/fonts/dino.woff",
      "/assets/fonts/dino.woff2": "/assets/fonts/dino.woff2",
      "/assets/images/fallback/bg.png":
        "/assets/images/fallback/bg.png",
      "/assets/images/fallback/fallback_cover.jpg":
        "/assets/images/fallback/fallback_cover.jpg",
      "/assets/images/joystick.png": "/assets/images/joystick.png",
      "/assets/images/loader/amphora_0.png":
        "/assets/images/loader/amphora_0.png",
      "/assets/images/loader/amphora_1.png":
        "/assets/images/loader/amphora_1.png",
      "/assets/images/loader/amphora_2.png":
        "/assets/images/loader/amphora_2.png",
      "/assets/images/loader/amphora_3.png":
        "/assets/images/loader/amphora_3.png",
      "/assets/images/loader/amphora_4.png":
        "/assets/images/loader/amphora_4.png",
      "/assets/images/loader/amphora_5.png":
        "/assets/images/loader/amphora_5.png",
      "/assets/images/loader/amphora_6.png":
        "/assets/images/loader/amphora_6.png",
      "/assets/images/loader/amphora_7.png":
        "/assets/images/loader/amphora_7.png",
      "/assets/images/loader/amphora_8.png":
        "/assets/images/loader/amphora_8.png",
      "/assets/images/pause/bottom-deco.png":
        "/assets/images/pause/bottom-deco.png",
      "/assets/images/pause/gamepad-layout.png":
        "/assets/images/pause/gamepad-layout.png",
      "/assets/images/pause/keyboard-layout.png":
        "/assets/images/pause/keyboard-layout.png",
      "/assets/images/pause/left-deco.png":
        "/assets/images/pause/left-deco.png",
      "/assets/images/pause/pause-bg.png":
        "/assets/images/pause/pause-bg.png",
      "/assets/images/pause/pause-crystal.png":
        "/assets/images/pause/pause-crystal.png",
      "/assets/images/pause/right-deco.png":
        "/assets/images/pause/right-deco.png",
      "/assets/images/pause/top-deco.png":
        "/assets/images/pause/top-deco.png",
      "/assets/images/pointer.png": "/assets/images/pointer.png",
      "/assets/images/share/facebook.png":
        "/assets/images/share/facebook.png",
      "/assets/images/share/twitter.png":
        "/assets/images/share/twitter.png",
      "/assets/misc/draco/draco_decoder.js":
        "/assets/misc/draco/draco_decoder.js",
      "/assets/misc/draco/draco_decoder.wasm":
        "/assets/misc/draco/draco_decoder.wasm",
      "/assets/misc/draco/draco_wasm_wrapper.js":
        "/assets/misc/draco/draco_wasm_wrapper.js",
      "/assets/packs/common-textures-high-dxt.json":
        "/assets/packs/common-textures-high-dxt.json",
      "/assets/packs/common-textures-high-dxt.pack":
        "/assets/packs/common-textures-high-dxt.pack",
      "/assets/packs/common-textures-high-uncompressed.json":
        "/assets/packs/common-textures-high-uncompressed.json",
      "/assets/packs/common-textures-high-uncompressed.pack":
        "/assets/packs/common-textures-high-uncompressed.pack",
      "/assets/packs/common-textures-low-dxt.json":
        "/assets/packs/common-textures-low-dxt.json",
      "/assets/packs/common-textures-low-dxt.pack":
        "/assets/packs/common-textures-low-dxt.pack",
      "/assets/packs/common-textures-low-uncompressed.json":
        "/assets/packs/common-textures-low-uncompressed.json",
      "/assets/packs/common-textures-low-uncompressed.pack":
        "/assets/packs/common-textures-low-uncompressed.pack",
      "/assets/packs/common-textures-medium-dxt.json":
        "/assets/packs/common-textures-medium-dxt.json",
      "/assets/packs/common-textures-medium-dxt.pack":
        "/assets/packs/common-textures-medium-dxt.pack",
      "/assets/packs/common-textures-medium-uncompressed.json":
        "/assets/packs/common-textures-medium-uncompressed.json",
      "/assets/packs/common-textures-medium-uncompressed.pack":
        "/assets/packs/common-textures-medium-uncompressed.pack",
      "/assets/packs/common.json": "/assets/packs/common.json",
      "/assets/packs/common.pack": "/assets/packs/common.pack",
      "/assets/packs/home-textures-high-dxt.json":
        "/assets/packs/home-textures-high-dxt.json",
      "/assets/packs/home-textures-high-dxt.pack":
        "/assets/packs/home-textures-high-dxt.pack",
      "/assets/packs/home-textures-high-uncompressed.json":
        "/assets/packs/home-textures-high-uncompressed.json",
      "/assets/packs/home-textures-high-uncompressed.pack":
        "/assets/packs/home-textures-high-uncompressed.pack",
      "/assets/packs/home-textures-low-dxt.json":
        "/assets/packs/home-textures-low-dxt.json",
      "/assets/packs/home-textures-low-dxt.pack":
        "/assets/packs/home-textures-low-dxt.pack",
      "/assets/packs/home-textures-low-uncompressed.json":
        "/assets/packs/home-textures-low-uncompressed.json",
      "/assets/packs/home-textures-low-uncompressed.pack":
        "/assets/packs/home-textures-low-uncompressed.pack",
      "/assets/packs/home-textures-medium-dxt.json":
        "/assets/packs/home-textures-medium-dxt.json",
      "/assets/packs/home-textures-medium-dxt.pack":
        "/assets/packs/home-textures-medium-dxt.pack",
      "/assets/packs/home-textures-medium-uncompressed.json":
        "/assets/packs/home-textures-medium-uncompressed.json",
      "/assets/packs/home-textures-medium-uncompressed.pack":
        "/assets/packs/home-textures-medium-uncompressed.pack",
      "/assets/packs/home.json": "/assets/packs/home.json",
      "/assets/packs/home.pack": "/assets/packs/home.pack",
      "/assets/packs/level-1-textures-high-dxt.json":
        "/assets/packs/level-1-textures-high-dxt.json",
      "/assets/packs/level-1-textures-high-dxt.pack":
        "/assets/packs/level-1-textures-high-dxt.pack",
      "/assets/packs/level-1-textures-high-uncompressed.json":
        "/assets/packs/level-1-textures-high-uncompressed.json",
      "/assets/packs/level-1-textures-high-uncompressed.pack":
        "/assets/packs/level-1-textures-high-uncompressed.pack",
      "/assets/packs/level-1-textures-low-dxt.json":
        "/assets/packs/level-1-textures-low-dxt.json",
      "/assets/packs/level-1-textures-low-dxt.pack":
        "/assets/packs/level-1-textures-low-dxt.pack",
      "/assets/packs/level-1-textures-low-uncompressed.json":
        "/assets/packs/level-1-textures-low-uncompressed.json",
      "/assets/packs/level-1-textures-low-uncompressed.pack":
        "/assets/packs/level-1-textures-low-uncompressed.pack",
      "/assets/packs/level-1-textures-medium-dxt.json":
        "/assets/packs/level-1-textures-medium-dxt.json",
      "/assets/packs/level-1-textures-medium-dxt.pack":
        "/assets/packs/level-1-textures-medium-dxt.pack",
      "/assets/packs/level-1-textures-medium-uncompressed.json":
        "/assets/packs/level-1-textures-medium-uncompressed.json",
      "/assets/packs/level-1-textures-medium-uncompressed.pack":
        "/assets/packs/level-1-textures-medium-uncompressed.pack",
      "/assets/packs/level-1.json": "/assets/packs/level-1.json",
      "/assets/packs/level-1.pack": "/assets/packs/level-1.pack",
      "/assets/packs/level-2-textures-high-dxt.json":
        "/assets/packs/level-2-textures-high-dxt.json",
      "/assets/packs/level-2-textures-high-dxt.pack":
        "/assets/packs/level-2-textures-high-dxt.pack",
      "/assets/packs/level-2-textures-high-uncompressed.json":
        "/assets/packs/level-2-textures-high-uncompressed.json",
      "/assets/packs/level-2-textures-high-uncompressed.pack":
        "/assets/packs/level-2-textures-high-uncompressed.pack",
      "/assets/packs/level-2-textures-low-dxt.json":
        "/assets/packs/level-2-textures-low-dxt.json",
      "/assets/packs/level-2-textures-low-dxt.pack":
        "/assets/packs/level-2-textures-low-dxt.pack",
      "/assets/packs/level-2-textures-low-uncompressed.json":
        "/assets/packs/level-2-textures-low-uncompressed.json",
      "/assets/packs/level-2-textures-low-uncompressed.pack":
        "/assets/packs/level-2-textures-low-uncompressed.pack",
      "/assets/packs/level-2-textures-medium-dxt.json":
        "/assets/packs/level-2-textures-medium-dxt.json",
      "/assets/packs/level-2-textures-medium-dxt.pack":
        "/assets/packs/level-2-textures-medium-dxt.pack",
      "/assets/packs/level-2-textures-medium-uncompressed.json":
        "/assets/packs/level-2-textures-medium-uncompressed.json",
      "/assets/packs/level-2-textures-medium-uncompressed.pack":
        "/assets/packs/level-2-textures-medium-uncompressed.pack",
      "/assets/packs/level-2.json": "/assets/packs/level-2.json",
      "/assets/packs/level-2.pack": "/assets/packs/level-2.pack",
      "/assets/packs/level-3-textures-high-dxt.json":
        "/assets/packs/level-3-textures-high-dxt.json",
      "/assets/packs/level-3-textures-high-dxt.pack":
        "/assets/packs/level-3-textures-high-dxt.pack",
      "/assets/packs/level-3-textures-high-uncompressed.json":
        "/assets/packs/level-3-textures-high-uncompressed.json",
      "/assets/packs/level-3-textures-high-uncompressed.pack":
        "/assets/packs/level-3-textures-high-uncompressed.pack",
      "/assets/packs/level-3-textures-low-dxt.json":
        "/assets/packs/level-3-textures-low-dxt.json",
      "/assets/packs/level-3-textures-low-dxt.pack":
        "/assets/packs/level-3-textures-low-dxt.pack",
      "/assets/packs/level-3-textures-low-uncompressed.json":
        "/assets/packs/level-3-textures-low-uncompressed.json",
      "/assets/packs/level-3-textures-low-uncompressed.pack":
        "/assets/packs/level-3-textures-low-uncompressed.pack",
      "/assets/packs/level-3-textures-medium-dxt.json":
        "/assets/packs/level-3-textures-medium-dxt.json",
      "/assets/packs/level-3-textures-medium-dxt.pack":
        "/assets/packs/level-3-textures-medium-dxt.pack",
      "/assets/packs/level-3-textures-medium-uncompressed.json":
        "/assets/packs/level-3-textures-medium-uncompressed.json",
      "/assets/packs/level-3-textures-medium-uncompressed.pack":
        "/assets/packs/level-3-textures-medium-uncompressed.pack",
      "/assets/packs/level-3.json": "/assets/packs/level-3.json",
      "/assets/packs/level-3.pack": "/assets/packs/level-3.pack",
      "/assets/packs/level-textures-high-dxt.json":
        "/assets/packs/level-textures-high-dxt.json",
      "/assets/packs/level-textures-high-dxt.pack":
        "/assets/packs/level-textures-high-dxt.pack",
      "/assets/packs/level-textures-high-uncompressed.json":
        "/assets/packs/level-textures-high-uncompressed.json",
      "/assets/packs/level-textures-high-uncompressed.pack":
        "/assets/packs/level-textures-high-uncompressed.pack",
      "/assets/packs/level-textures-low-dxt.json":
        "/assets/packs/level-textures-low-dxt.json",
      "/assets/packs/level-textures-low-dxt.pack":
        "/assets/packs/level-textures-low-dxt.pack",
      "/assets/packs/level-textures-low-uncompressed.json":
        "/assets/packs/level-textures-low-uncompressed.json",
      "/assets/packs/level-textures-low-uncompressed.pack":
        "/assets/packs/level-textures-low-uncompressed.pack",
      "/assets/packs/level-textures-medium-dxt.json":
        "/assets/packs/level-textures-medium-dxt.json",
      "/assets/packs/level-textures-medium-dxt.pack":
        "/assets/packs/level-textures-medium-dxt.pack",
      "/assets/packs/level-textures-medium-uncompressed.json":
        "/assets/packs/level-textures-medium-uncompressed.json",
      "/assets/packs/level-textures-medium-uncompressed.pack":
        "/assets/packs/level-textures-medium-uncompressed.pack",
      "/assets/packs/level.json": "/assets/packs/level.json",
      "/assets/packs/level.pack": "/assets/packs/level.pack",
      "/assets/packs/tutorial-textures-high-dxt.json":
        "/assets/packs/tutorial-textures-high-dxt.json",
      "/assets/packs/tutorial-textures-high-dxt.pack":
        "/assets/packs/tutorial-textures-high-dxt.pack",
      "/assets/packs/tutorial-textures-high-uncompressed.json":
        "/assets/packs/tutorial-textures-high-uncompressed.json",
      "/assets/packs/tutorial-textures-high-uncompressed.pack":
        "/assets/packs/tutorial-textures-high-uncompressed.pack",
      "/assets/packs/tutorial-textures-low-dxt.json":
        "/assets/packs/tutorial-textures-low-dxt.json",
      "/assets/packs/tutorial-textures-low-dxt.pack":
        "/assets/packs/tutorial-textures-low-dxt.pack",
      "/assets/packs/tutorial-textures-low-uncompressed.json":
        "/assets/packs/tutorial-textures-low-uncompressed.json",
      "/assets/packs/tutorial-textures-low-uncompressed.pack":
        "/assets/packs/tutorial-textures-low-uncompressed.pack",
      "/assets/packs/tutorial-textures-medium-dxt.json":
        "/assets/packs/tutorial-textures-medium-dxt.json",
      "/assets/packs/tutorial-textures-medium-dxt.pack":
        "/assets/packs/tutorial-textures-medium-dxt.pack",
      "/assets/packs/tutorial-textures-medium-uncompressed.json":
        "/assets/packs/tutorial-textures-medium-uncompressed.json",
      "/assets/packs/tutorial-textures-medium-uncompressed.pack":
        "/assets/packs/tutorial-textures-medium-uncompressed.pack",
      "/assets/packs/tutorial.json": "/assets/packs/tutorial.json",
      "/assets/packs/tutorial.pack": "/assets/packs/tutorial.pack",
      "/assets/videos/credits.mp4": "/assets/videos/credits.mp4",
      "/assets/videos/credits.webm": "/assets/videos/credits.webm",
      "/assets/videos/end.mp4": "/assets/videos/end.mp4",
      "/assets/videos/end.webm": "/assets/videos/end.webm",
      "/assets/videos/home.mp4": "/assets/videos/home.mp4",
      "/assets/videos/home.webm": "/assets/videos/home.webm",
      "/assets/videos/intro.mp4": "/assets/videos/intro.mp4",
      "/assets/videos/intro.webm": "/assets/videos/intro.webm",
      "/styles/index.styl": "/main.css",
      "/scripts/index.js": "/main.js",
      "/scripts/vendor/index.js": "/vendor.js",
    ...
    (t.__esModule = !0),
      (t.encodeBinary = function (e) {
        for (var t = "", s = 0; s < e.length; ) {
          for (var o = [0, 0, 0], r = [0, 0, 0, 0], a = 0; a < o.length; ++a)
            s < e.length ? (o[a] = 255 & e.charCodeAt(s++)) : (o[a] = 0);
          switch (
            ((r[0] = o[0] >> 2),
            (r[1] = ((3 & o[0]) << 4) | (o[1] >> 4)),
            (r[2] = ((15 & o[1]) << 2) | (o[2] >> 6)),
      ...
      p = (function () {
        function e() {
          ...
          !(function (e, t) {
            ...
            (this._boundLoadResource = function (e, s) {
              return t._loadResource(e, s);
            }),
            (this._queue = i.queue(this._boundLoadResource, n)),
            this._queue.pause(),
            (this.resources = {}),
            (this.onProgress = new r.default()),
        ...
        return (
          (e.prototype.add = function (e, t, s, o) {
            if (Array.isArray(e)) {
            ...
            if (
              ("object" === (void 0 === e ? "undefined" : n(e)) &&
                ((o = t || e.callback || e.onComplete),
                (s = e),
                (t = e.url),
                (e = e.name || e.key || e.url)),
              "string" != typeof t && ((o = s), (s = t), (t = e)),
              "string" != typeof t)
            )
            ...
            if (
              ...
              (this.resources[e] = new u.default(e, t, s)),
              "function" == typeof o &&
                this.resources[e].onAfterMiddleware.once(o),
              this.loading)
            ) {
              for (
                var a = s.parentResource, i = [], c = 0;
                c < a.children.length;
                ++c
              )
                a.children[c].isComplete || i.push(a.children[c]);
          ...
          (e.prototype.load = function (e) {
            if (
              ("function" == typeof e && this.onComplete.once(e), this.loading)
            )
              return this;
            if (this._queue.idle()) this._onStart(), this._onComplete();
            else {
              for (
                var t = 100 / this._queue._tasks.length, s = 0;
                s < this._queue._tasks.length;
                ++s
              )
                this._queue._tasks[s].data.progressChunk = t;
              this._onStart(), this._queue.resume();
            }
            return this;
          }),
          (e.prototype._prepareUrl = function (e) {
            var t = (0, a.default)(e, { strictMode: !0 }),
              s = void 0;
            if (
              ((s =
              ...
              var n = l.exec(s)[0];
              -1 !== (s = s.substr(0, s.length - n.length)).indexOf("?")
            ...
            (e._dequeue = t),
              i.eachSeries(
                ...
                function () {
                  e.isComplete
                    ? s._onLoad(e)
                    : ((e._onLoadBinding = e.onComplete.once(s._onLoad, s)),
                      e.load());
                },
                !0
              );
  ...
  function (e, t, s) {
    ...
    var n,
      ...
      r = (n = s(13)) && n.__esModule ? n : { default: n },
      a = s(7);
    function i(e) {
      return (i =
        "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              key: "get",
              value: function (e) {
                return this.resources && this.resources[e]
            ...
            },
            {
              ...
              value: function () {
                this.pre(this._extensionMiddleware),
                  this.pre(this._cachebreakMiddleware);
              },
            },
            {
              key: "_checkForErrors",
              value: function (e) {
                for (var t in e) {
                  var s = e[t];
                  if (s.error)
                    return c("Resource '".concat(t, "' error :"), s.error), !0;
                }
                return !1;
              },
            },
            {
              ...
              value: function (e, t) {
                "pack" === e.extension &&
                  (e.xhrType = o.Resource.XHR_RESPONSE_TYPE.BUFFER),
                  t();
              },
            },
            {
              ...
              value: function (e, t) {
                ...
                s
                  ? (e.url = s)
                  : c("Resource '".concat(e.name, "' does not exist :"), e.url),
                  t();
              },
            },
          ]) && u(s.prototype, n),
          ...
          (o = function () {
            return function (e) {
                    ...
                    : "undefined" != typeof self &&
                      (function () {
                        if ("function" == typeof CustomEvent)
                          try {
                            return (
                              new CustomEvent("unhandledRejection") instanceof
                              CustomEvent
                            );
                          } catch (e) {}
                        return !1;
              ...
              function c(e, t, s) {
                for (
                  var n,
                    ...
                    u = new Array(i),
                    c = 0;
                  c < s.length && !a.resolved;
                  ++c
                )
                  void 0 !== (n = s[c]) || c in s ? l(s, o, c, n, a) : --i;
              ...
              (r.resolve = a),
                ...
                (r._handler = h),
                (r.prototype.then = function (e, t, s) {
                  var n = this._handler,
                    o = n.join().state();
                  if (
                    ...
                    return new this.constructor(v, n);
                  var r = this._beget(),
                    a = r._handler;
                ...
                (r.prototype._beget = function () {
                  return (
                    (e = this._handler),
                    new (0, this.constructor)(
                      v,
                      new _(e.receiver, e.join().context)
                    )
                  );
                  var e;
                }),
              ...
              F(v, _),
                ...
                (k.prototype.fold = function (e, t, s, n) {
                  !(function (e, t, s, n, o) {
              ...
              F(v, w),
                (w.prototype._state = -1),
                (w.prototype.fold = function (e, t, s, n) {
                  n.become(this);
                }),
                (w.prototype.when = function (e) {
                  "function" == typeof e.rejected && this._unreport(),
                    M(e.rejected, this, e.receiver, e.resolver);
                }),
                ...
                (w.prototype._unreport = function () {
                  this.handled ||
                    ((this.handled = !0), t.afterQueue(new O(this)));
                }),
                (w.prototype.fail = function (e) {
                  (this.reported = !0),
                    s("unhandledRejection", this),
                    r.onFatalRejection(this, void 0 === e ? this.context : e);
                }),
                (E.prototype.run = function () {
                  this.rejection.handled ||
                    this.rejection.reported ||
                    ((this.rejection.reported = !0),
                    s("unhandledRejection", this.rejection) ||
                      r.onPotentiallyUnhandledRejection(
                        this.rejection,
                        this.context
                      ));
                }),
                (O.prototype.run = function () {
                  this.rejection.reported &&
                    (s("rejectionHandled", this.rejection) ||
                      r.onPotentiallyUnhandledRejectionHandled(this.rejection));
                }),
                (r.createContext =
                  r.enterContext =
                  r.exitContext =
                  r.onPotentiallyUnhandledRejection =
                  r.onPotentiallyUnhandledRejectionHandled =
                  r.onFatalRejection =
                    X);
              var j = new r(v, new v());
              function T(e, t) {
  ...
  function (e, t, s) {
    ...
    !(function (o) {
      ...
      void 0 ===
        (n = function (e) {
          return s(19)({ scheduler: new (s(18))(s(1).asap) });
        }.call(t, s, t, e)) || (e.exports = n);
    })(s(0));
  },
  function (e, t, s) {
    ...
    !(function (o) {
      ...
      void 0 ===
        (n = function () {
          return function (e) {
            return (
              (e.prototype.with = e.prototype.withThis =
                function (e) {
                  var t = this._beget(),
                    s = t._handler;
        ...
        (n = function () {
          return function (s) {
            ...
            function a(e, t, s, o) {
              var r,
                a = e.call(t);
              return ("object" != typeof (r = a) && "function" != typeof r) ||
                null === r
                ? s(o)
                : (function (e, t, s) {
            ...
            return (
              ...
              (s.prototype.catch = s.prototype.otherwise =
                function (t) {
              ...
              (s.prototype.finally = s.prototype.ensure =
                function (e) {
              ...
              (s.prototype.else = s.prototype.orElse =
                function (e) {
          ...
          return function (e) {
            ...
            return (
              (e.any = function (t) {
                ...
                return (
                  0 === i &&
                    r.reject(new RangeError("any(): array must not be empty")),
                  o
                );
                function l(e) {
              ...
              (e.some = function (t, s) {
                ...
                for (
                  ...
                  (void 0 !== (o = t[r]) || r in t) &&
                    e._handler(o).visit(i, d, h, i.notify);
                return a;
                function d(e) {
                  this.resolved ||
                    (u.push(e), 0 == --p && ((c = null), this.resolve(u)));
                }
                function h(e) {
                  this.resolved ||
                    (c.push(e), 0 == --n && ((u = null), this.reject(c)));
                }
              }),
              (e.settle = function (e) {
                return r(e.map(c));
              ...
              (e.filter = function (t, s) {
                ...
                return e._traverse(s, n).then(function (t) {
                  return (function (t, s) {
                    for (
                      var n = s.length, o = new Array(n), r = 0, a = 0;
                      r < n;
                      ++r
                    )
                      s[r] && (o[a++] = e._handler(t[r]).value);
                    return (o.length = a), o;
                  })(n, t);
                });
              }),
              (e.reduce = function (e, t) {
                return arguments.length > 2
                  ? a.call(e, l(t), arguments[2])
                  : a.call(e, l(t));
              }),
              (e.reduceRight = function (e, t) {
                return arguments.length > 2
                  ? i.call(e, l(t), arguments[2])
                  : i.call(e, l(t));
              }),
            ...
            function c(s) {
              var n;
              return (
                s instanceof e && (n = s._handler.join()),
                (n && 0 === n.state()) || !n
                  ? o(s).then(t.fulfilled, t.rejected)
                  : (n._unreport(), t.inspect(n))
              );
            }
            function l(e) {
      ...
      void 0 ===
        (n = function (e) {
          ...
          function v(e) {
            return function () {
              for (
                var t = 0, s = arguments.length, n = new Array(s);
                t < s;
                ++t
              )
                n[t] = arguments[t];
          ...
          function m(e) {
            for (
              var t = 0, s = arguments.length - 1, n = new Array(s);
              t < s;
              ++t
            )
              n[t] = arguments[t + 1];
          ...
          return (
            ...
            (f.reduce = v(d.reduce)),
            (f.reduceRight = v(d.reduceRight)),
            (f.isPromiseLike = function (e) {
            ...
            (f.defer = function () {
              return new (function () {
                ...
                (this.promise = e),
                  ...
                  (this.reject = s),
                  (this.notify = n),
                  (this.resolver = { resolve: t, reject: s, notify: n });
              })();
            }),
            (f.TimeoutError = p),
            f
      ...
      (t.default = function () {
        ...
        if ("function" == typeof t[0])
          throw new SyntaxError(
            "@mixin decorator '" + t[0].name + "' requires at least one mixin"
          );
        return function (e) {
          ...
          var c = function (e) {
            ...
            s[e] = function () {
              for (
                var e = void 0, s = arguments.length, n = Array(s), r = 0;
                r < s;
                r++
              )
                n[r] = arguments[r];
  ...
  function (e, t, s) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function (e, t, s) {
        if (void 0 === s || "function" != typeof s.value)
          throw new SyntaxError(
  ...
  function (e, t, s) {
    ...
    (t.default = { bind: n.default, mixin: o.default }),
      (e.exports = t.default);
  },
  function (e, t, s) {
    "use strict";
    (function (n) {
      ...
      var u,
        ...
        d,
        h,
        f = (0, a.getLogger)("EventWorker", a.INFO, !1),
        v =
          ((u = (o = (function () {
            function e(t) {
              !(function (e, t) {
              ...
              (s = [
                {
                  ...
                  value: function (e, t) {
                    this._binded || this._bind(),
                      this._listeners.push({ eventName: e, cb: t }),
                      f("'".concat(e, "' added"));
                  },
                },
                {
                  ...
                  value: function (e) {
                    ...
                    return (
                      this._binded || this._bind(),
                      this._listeners.push({ eventName: e, cb: t.resolve }),
                      f("'".concat(e, "' added once")),
                      t.promise
                    );
                  },
                },
                  ...
                  value: function (e) {
                    var t =
                      arguments.length > 1 && void 0 !== arguments[1]
                        ? arguments[1]
                        : null;
                    this._ctx.postMessage({ eventName: e, payload: t }),
          ...
          d &&
            void 0 !== h.initializer &&
            ((h.value = h.initializer ? h.initializer.call(d) : void 0),
            (h.initializer = void 0)),
          void 0 === h.initializer &&
            (Object.defineProperty(u, c, h), (h = null)),
          o);
  ...
  function (e, t, s) {
    ...
    var i = new n.default(self),
      ...
      c = function (e, t, s) {
        for (
          var n = [], o = new r.default(t, s), a = 0, u = t.length;
          a < u;
          a++
        ) {
          var c = t[a][0],
          ...
          n.push({ id: p, path: c, type: d, extension: h, data: l });
        }
