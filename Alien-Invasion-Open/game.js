...
var sfx = {
  laser1: new Howl({
    src: ["Audio/laser1.ogg"],
    volume: 0.065,
    rate: 0.65,
  }),
  laser2: new Howl({
    src: ["Audio/laser2.ogg"],
    volume: 0.065,
    rate: 0.65,
  }),
  laser3: new Howl({
    src: ["Audio/laser3.ogg"],
    volume: 0.065,
    rate: 0.65,
  }),
  kill1: new Howl({
...
Button.prototype.checkHover = function () {
  return (
    mouseX > this.x * 1.25 &&
    mouseX < (this.x + this.w) * 1.25 &&
    mouseY > this.y * 1.25 &&
    mouseY < (this.y + this.h) * 1.25
  );
};
      ...
      if (readyToMove && e.alive && !gameOver) {
        ...
        if (e.destroying) {
          if (moveStage < 20) {
            ...
            e.die();
            if (
              buildings[0] + buildings[1] + buildings[2] + buildings[3] ===
              0
            ) {
              endGame();
            }
