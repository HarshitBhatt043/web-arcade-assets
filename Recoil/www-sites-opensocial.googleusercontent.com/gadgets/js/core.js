      ...
      if (j.nodeType == 3 || j.nodeType == 4) {
        ...
        if (j.innerText) {
          ...
          if (j.innerHTML) {
            ...
            if (j.firstChild) {
              var l = [];
              for (var m = j.firstChild; m; m = m.nextSibling) {
                l.push(a(m));
              }
              k = l.join("");
            }
...
(function () {
  gadgets.util.makeClosure = function (d, f, e) {
    var c = [];
    for (var b = 2, a = arguments.length; b < a; ++b) {
      c.push(arguments[b]);
    }
    return function () {
      var g = c.slice();
...
(function () {
  ...
  gadgets.util.createIframeElement = function (g) {
    ...
    try {
      ...
      if (
        f &&
        (!i || (f.tagName == i.tagName && f.namespaceURI == i.namespaceURI))
      ) {
        i = f;
      }
    } catch (h) {}
          ...
          if (typeof c === "object" && g) {
            ...
            for (var h in c) {
              if (c.hasOwnProperty(h)) {
                e[gadgets.util.escapeString(h)] = gadgets.util.escape(
                  c[h],
                  true
                );
              }
  ...
  gadgets.json = (function () {
    ...
    return {
      ...
      stringify: function (d) {
        ...
        var g =
          Array.prototype.toJSON && h([{ x: 1 }]) === '"[{\\"x\\": 1}]"'
            ? f
            : h;
        try {
...
gadgets.io = (function () {
  ...
  function makeXhr() {
    ...
    var wrapperXhr =
      window.shindig &&
      window.shindig["xhrwrapper"] &&
      window.shindig["xhrwrapper"]["createXHR"];
    if (wrapperXhr) {
      return wrapperXhr();
    } else {
  ...
  return {
    ...
    getProxyUrl: function (url, opt_params) {
      ...
      var rewriteMimeParam = params.rewriteMime
        ? "&rewriteMime=" + encodeURIComponent(String(params.rewriteMime))
        : "";
      var ret = config.proxyUrl
        .replace("%url%", encodeURIComponent(url))
        .replace("%host%", document.location.host)
        .replace("%rawurl%", url)
        .replace("%refresh%", encodeURIComponent(String(refresh)))
        .replace("%gadget%", encodeURIComponent(urlParams.url))
        .replace(
          "%container%",
          encodeURIComponent(urlParams.container || urlParams.synd || "default")
        )
  ...
  gadgets.io.makeRequest(
    ...
    function (j) {
      ...
      if (j.data.items && j.data.items.length > 0) {
        ...
        for (var h = 0; h < j.data.Entry.length; ++h) {
      ...
      for (var g = 0; g < j.data.Entry.length; ++g) {
...
(function () {
  function f(b, c, a) {
    ...
    try {
      if ((++window._varz_numerrors, gadgets && !(3 < e))) {
        ...
        var d = gadgets.util.getUrlParameters(),
          g = d.container || d.synd,
          h = d.gadget || d.url,
          l = [
            "/gadgets/evthdlr?t=err&gadget=",
            a(h),
            "&container=",
            a(g),
            "&jsurl=",
        ...
        gadgets.io.makeNonProxiedRequest(l.join(""), null, c);
        e++;
      }
    } catch (m) {}
  }
  ...
  var k = new Date().getTime(),
    e = 0;
  -1 == window.location.href.indexOf("&debug=1") &&
    -1 == window.location.href.indexOf("?debug=1") &&
    (window.onerror = f);
})();
...
(function () {
  var l = null,
    q = (function () {
      ...
      function x(a, e) {
        return "string" == typeof a ? encodeURI(a).replace(e, y) : l;
      }
      function y(a) {
        a = a.charCodeAt(0);
        return (
      ...
      function u(a) {
        if (a === l) return l;
        for (
          var a = a.replace(/(^|\/)\.(?:\/|$)/g, "$1").replace(/\/{2,}/g, "/"),
            e = z,
            m;
          (m = a.replace(e, "$1")) != a;
          a = m
      ...
      function v(a, e) {
        ...
        var s = e.g,
          g = u(s);
        if (b) m.ba(e.T()), (g = g && g.replace(j, ""));
        else if ((b = !!s)) {
          if (47 !== g.charCodeAt(0))
            var g = u(m.g || "").replace(j, ""),
              p = g.lastIndexOf("/") + 1,
              g = u((p ? g.substring(0, p) : "") + u(s)).replace(j, "");
        } else (g = g && g.replace(j, "")), g !== s && m.G(g);
        b ? m.G(g) : (b = e.Z());
        b ? m.M(e.l) : (b = e.X());
        b && m.ea(e.o);
        return m;
      }
      function b(a, e, b, j, s, g, p) {
        this.j = a;
        this.n = e;
        this.k = b;
        this.h = j;
      ...
      b.prototype.toString = function () {
        ...
        l !== this.k &&
          ...
          a.push(this.k),
          l !== this.h && a.push(":", this.h.toString()));
        l !== this.g && a.push(this.g);
        l !== this.l && a.push("?", this.l);
        l !== this.o && a.push("#", this.o);
        return a.join("");
      };
      b.prototype.R = function () {
        return new b(this.j, this.n, this.k, this.h, this.g, this.l, this.o);
      };
      ...
      b.prototype.aa = function (a) {
        if (
          ...
          for (j in a) {
            var s = a[j];
            "string" === typeof s && ((e[++b] = j), (e[++b] = s));
          }
          a = e;
        }
        for (var e = [], b = "", g = 0; g < a.length; )
          (j = a[g++]),
            (s = a[g++]),
            e.push(b, encodeURIComponent(j.toString())),
            (b = "&"),
            s && e.push("=", encodeURIComponent(s.toString()));
        this.l = e.join("");
      };
      ...
      var w =
        ...
        C = /[\#\?]/g;
      b.parse = e;
      b.create = function (a, e, j, p, s, g, u) {
        a = new b(
          x(a, B),
          x(e, B),
          "string" == typeof j ? encodeURIComponent(j) : l,
          0 < p ? p.toString() : l,
          x(s, C),
          l,
          "string" == typeof u ? encodeURIComponent(u) : l
        );
        g &&
          ("string" === typeof g
            ? a.M(g.replace(/[^?&=0-9A-Za-z_\-~.%]/g, y))
            : a.aa(g));
        return a;
      };
      b.$ = v;
      ...
      b.va = {
        pa: function (a) {
          return /\.html$/.test(e(a).S())
            ? "text/html"
            : "application/javascript";
        },
        $: function (a, b) {
          return a ? v(e(a), e(b)).toString() : "" + b;
        },
      };
      return b;
    })();
  "undefined" !== typeof window && (window.URI = q);
  var M = {
    f: {
      NONE: 0,
      URI: 1,
  ...
  M.ELEMENT_DOM_INTERFACES = M.O;
  M.N = { NOT_LOADED: 0, SAME_DOCUMENT: 1, NEW_DOCUMENT: 2 };
  M.ueffects = M.N;
  M.J = {
    "a::href": 2,
    "area::href": 2,
  ...
  M.URIEFFECTS = M.J;
  M.L = { UNSANDBOXED: 2, SANDBOXED: 1, DATA: 0 };
  M.ltypes = M.L;
  M.I = {
    "a::href": 2,
    "area::href": 2,
  ...
  M.LOADERTYPES = M.I;
  "undefined" !== typeof window && (window.html4 = M);
  var Q = (function (e) {
      function x(d) {
        if (D.hasOwnProperty(d)) return D[d];
        var a = d.match(R);
        return a
          ? String.fromCharCode(parseInt(a[1], 10))
          : (a = d.match(S))
          ? String.fromCharCode(parseInt(a[1], 16))
          : E && T.test(d)
          ? ((E.innerHTML = "&" + d + ";"), (a = E.textContent), (D[d] = a))
          : "&" + d + ";";
      }
      function y(d, a) {
        return x(a);
      ...
      function p(d) {
        return d.replace(W, "&amp;$1").replace(F, "&lt;").replace(G, "&gt;");
      }
      function z(d) {
        var a = {
          z: d.z || d.cdata,
        ...
        return function (d, e) {
          ...
          if (X) f = f.split(r);
            ...
            for (var k = [], i = 0, b; (b = r.exec(f)) !== l; )
              k.push(f.substring(i, b.index)),
                k.push(b[0]),
                (i = b.index + b[0].length);
            k.push(f.substring(i));
            f = k;
          }
          w(a, f, 0, { r: !1, C: !1 }, e);
        };
      }
      function j(d, a, c, e, f) {
        return function () {
          w(d, a, c, e, f);
        };
      }
      function w(d, a, c, h, f) {
        try {
          d.H && 0 == c && d.H(f);
          for (var r, k, i, b = a.length; c < b; ) {
            var n = a[c++],
              g = a[c];
            switch (n) {
              case "&":
                Y.test(g)
                  ? (d.d && d.d("&" + g, f, t, j(d, a, c, h, f)), c++)
                  : d.d && d.d("&amp;", f, t, j(d, a, c, h, f));
                break;
              case "</":
                if ((r = /^([-\w:]+)[^\'\"]*/.exec(g)))
                  if (r[0].length === g.length && ">" === a[c + 1])
                    (c += 2),
                      (i = r[1].toLowerCase()),
                      d.t && d.t(i, f, t, j(d, a, c, h, f));
                  else {
                    var m = a,
                      o = c,
                      p = d,
                      ...
                      v = C(m, o);
                    v
                      ? (p.t && p.t(v.name, s, u, j(p, m, o, x, s)),
                        (c = v.next))
                      : (c = m.length);
                  }
                else d.d && d.d("&lt;/", f, t, j(d, a, c, h, f));
                break;
              case "<":
                if ((r = /^([-\w:]+)\s*\/?/.exec(g)))
                  if (r[0].length === g.length && ">" === a[c + 1]) {
                    c += 2;
                    i = r[1].toLowerCase();
                    d.v && d.v(i, [], f, t, j(d, a, c, h, f));
                    var w = e.e[i];
                    w & O && (c = B(a, { name: i, next: c, c: w }, d, f, t, h));
                  } else {
                    var m = a,
                      o = d,
                      p = f,
                      ...
                      A = C(m, c);
                    A
                      ? (o.v && o.v(A.name, A.P, p, s, j(o, m, A.next, u, p)),
                        (c = A.c & O ? B(m, A, o, p, s, u) : A.next))
                      : (c = m.length);
                  }
                else d.d && d.d("&lt;", f, t, j(d, a, c, h, f));
                break;
              case "<!--":
                if (!h.C) {
                  ...
                  if (k < b) {
                    if (d.A) {
                      var y = a.slice(c, k).join("");
                      d.A(
                        y.substr(0, y.length - 2),
                        f,
                        t,
                        j(d, a, k + 1, h, f)
                      );
      ...
      function B(a, b, c, h, f, r) {
        var k = a.length;
        H.hasOwnProperty(b.name) ||
          (H[b.name] = RegExp("^" + b.name + "(?:[\\s\\/]|$)", "i"));
        for (
          var i = H[b.name], g = b.next, n = b.next + 1;
          n < k && !("</" === a[n - 1] && i.test(a[n]));
          n++
        );
        n < k && (n -= 1);
        k = a.slice(g, n).join("");
        if (b.c & e.c.CDATA) c.z && c.z(k, h, f, j(c, a, n, r, h));
        else if (b.c & e.c.RCDATA) c.F && c.F(p(k), h, f, j(c, a, n, r, h));
      ...
      function C(a, b) {
        var c = /^([-\w:]+)/.exec(a[b]),
          h = {};
        h.name = c[1].toLowerCase();
        h.c = e.e[h.name];
        for (
          var f = a[b].substr(c[0].length), r = b + 1, k = a.length;
          r < k && ">" !== a[r];
          r++
        )
          f += a[r];
        if (!(k <= r)) {
          for (var i = []; "" !== f; )
            if ((c = Z.exec(f)))
              if ((c[4] && !c[5]) || (c[6] && !c[7])) {
                for (
                  var c = c[4] || c[6], g = !1, f = [f, a[r++]];
                  r < k;
                  r++
                ) {
                  if (g) {
                    if (">" === a[r]) break;
                  } else 0 <= a[r].indexOf(c) && (g = !0);
                  f.push(a[r]);
                }
                if (k <= r) break;
                f = f.join("");
                ...
                if (c[2]) {
                  ...
                  if (34 === j || 39 === j) n = n.substr(1, n.length - 2);
                  n = u(n.replace($, ""));
                } else n = "";
                i.push(g, n);
                f = f.substr(c[0].length);
              }
      ...
      function a(a) {
        ...
        function c(a) {
          ...
          return a.replace(RegExp("</" + d.m + "(?=[^A-Za-z])>?", "i"), "</>");
        }
        var h, f;
        return z({
          startDoc: function () {
            ...
            if (!f && e.e.hasOwnProperty(c)) {
              ...
              if (!(g & e.c.FOLDABLE)) {
                ...
                if (n) {
                  ...
                  if ("attribs" in n) b = n.attribs;
                  else throw Error("tagPolicy gave no attribs");
                  var j;
                  "tagName" in n
                    ? ((j = n.tagName), (n = e.e[j]))
                    : ((j = c), (n = g));
                  if (g & e.c.OPTIONAL_ENDTAG) {
                    var m = h[h.length - 1];
                    m &&
                      m.D === c &&
                      (m.m !== j || c !== j) &&
                  ...
                  g & e.c.EMPTY || h.push({ D: c, m: j });
                  i.push("<", j);
                  c = 0;
                  for (m = b.length; c < m; c += 2) {
                    var o = b[c],
                      p = b[c + 1];
                    p !== l && void 0 !== p && i.push(" ", o, '="', v(p), '"');
                  }
                  i.push(">");
                  g & e.c.EMPTY && !(n & e.c.EMPTY) && i.push("</", j, ">");
                } else f = !(g & e.c.EMPTY);
              }
            }
          },
          endTag: function (a, d) {
            if (f) f = !1;
            else if (e.e.hasOwnProperty(a)) {
              var c = e.e[a];
              if (!(c & (e.c.EMPTY | e.c.FOLDABLE))) {
                if (c & e.c.OPTIONAL_ENDTAG)
                  for (c = h.length; 0 <= --c; ) {
                    var b = h[c].D;
                    if (b === a) break;
                    if (!(e.e[b] & e.c.OPTIONAL_ENDTAG)) return;
                  }
                else for (c = h.length; 0 <= --c && h[c].D !== a; );
                if (!(0 > c)) {
                  for (b = h.length; --b > c; ) {
                    var g = h[b].m;
                    e.e[g] & e.c.OPTIONAL_ENDTAG || d.push("</", g, ">");
                  }
                  c < h.length && (a = h[c].m);
                  h.length = c;
                  d.push("</", a, ">");
          ...
          pcdata: function (a, d) {
            f || (g() & (e.c.RCDATA | e.c.CDATA) ? d.push(c(a)) : d.push(a));
          },
          rcdata: function (a, d) {
            f || (g() & (e.c.RCDATA | e.c.CDATA) ? d.push(c(a)) : d.push(a));
          },
          cdata: function (a, d) {
            f || (g() & e.c.CDATA ? d.push(c(a)) : d.push(b(a)));
          },
          endDoc: function (a) {
            for (; h.length; h.length--) a.push("</", h[h.length - 1].m, ">");
          },
        });
      }
      function J(a, b, c, e, f) {
        ...
        try {
          ...
          if (g && (!g.K() || aa.test(g.U()))) {
            var k = f(g, b, c, e);
            return k ? k.toString() : l;
          }
        } catch (i) {}
        return l;
      }
      function m(a, b, c, e, f) {
        c || a(b + " removed", { Q: "removed", tagName: b });
        if (e !== f) {
          var g = "changed";
          e && !f ? (g = "removed") : !e && f && (g = "added");
          a(b + "." + c + " " + g, {
            Q: g,
            tagName: b,
            ia: c,
      ...
      function s(a, b, c, h, f) {
        for (var g = 0; g < b.length; g += 2) {
          var k = b[g],
            ...
            o;
          if (
            ((o = a + "::" + k), e.w.hasOwnProperty(o)) ||
            ((o = "*::" + k), e.w.hasOwnProperty(o))
          )
            n = e.w[o];
          if (n !== l)
            switch (n) {
              ...
              case e.f.STYLE:
                ...
                I(i, {
                  declaration: function (a, b) {
                    ...
                    b.length && p.push(d + ": " + b.join(" "));
                  },
                });
                i = 0 < p.length ? p.join(" ; ") : l;
                f && m(f, a, k, j, i);
                break;
              case e.f.ID:
              case e.f.IDREF:
              case e.f.IDREFS:
              case e.f.GLOBAL_NAME:
              case e.f.LOCAL_NAME:
              case e.f.CLASSES:
                i = h ? h(i) : i;
                f && m(f, a, k, j, i);
              ...
              case e.f.URI:
                i = J(
                  ...
                  K(e.J, a, k),
                  K(e.I, a, k),
                  { TYPE: "MARKUP", XML_ATTR: k, XML_TAG: a },
                  c
                );
                f && m(f, a, k, j, i);
                break;
              case e.f.URI_FRAGMENT:
                i && "#" === i.charAt(0)
                  ? ((i = i.substring(1)),
                    (i = h ? h(i) : i),
                    i !== l && void 0 !== i && (i = "#" + i))
      ...
      function g(a, b, c) {
        return function (g, f) {
          if (e.e[g] & e.c.UNSAFE) c && m(c, g, void 0, void 0, void 0);
          else return { attribs: s(g, f, a, b, c) };
        };
      }
      function L(b, e) {
        var c = [];
      ...
      "undefined" !== typeof window &&
        ((I = window.parseCssDeclarations), (P = window.sanitizeCssProperty));
      var D = {
          lt: "<",
          LT: "<",
          gt: ">",
        ...
        Y = /^(#[0-9]+|#[xX][0-9A-Fa-f]+|\w+);/,
        N = /&/g,
        W = /&([^a-z#]|#(?:[^0-9x]|x(?:[^0-9a-f]|$)|$)|$)/gi,
        F = /[<]/g,
        G = />/g,
        V = /\"/g,
        Z =
          /^\s*([-.:\w]+)(?:\s*(=)\s*((")[^"]*("|$)|(')[^']*('|$)|(?=[a-z][-\w]*\s*=)|[^"'\s]*))?/i,
        X = 3 === "a,b".split(/(,)/).length,
        O = e.c.CDATA | e.c.RCDATA,
        t = {},
        H = {},
        aa = /^(?:https?|geo|mailto|sms|tel)$/i,
        o = {};
      o.ka = o.escapeAttrib = v;
      o.la = o.escapePcdata = b;
      o.ma = o.makeHtmlSanitizer = a;
      o.na = o.makeSaxParser = z;
      o.oa = o.makeTagPolicy = g;
      o.qa = o.normalizeRCData = p;
      o.ra = o.sanitize = function (a, b, c, e) {
        return L(a, g(b, c, e));
      };
      o.sa = o.sanitizeAttribs = s;
      o.ta = o.sanitizeWithPolicy = L;
      o.ua = o.unescapeEntities = u;
      return o;
    })(M),
    ba = Q.sanitize;
  "undefined" !== typeof window &&
    ((window.html = Q), (window.html_sanitize = ba));
})();
/* [end] feature=core */
(function () {
