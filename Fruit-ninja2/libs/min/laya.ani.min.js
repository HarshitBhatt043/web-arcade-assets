!(function (t, e, i) {
  ...
  var a = i.static,
    ...
    b = (laya.net.URL, laya.utils.Utils),
    N = (function () {
      function t() {
        (this.nodes = null),
          (this.name = null),
    ...
    A = (function () {
      function t() {}
      return (
        s(t, "laya.ani.AnimationParser01"),
        (t.parse = function (t, e) {
          ...
          for (
            ...
            var x = (t._anis[a] = new N());
            x.nodes = new Array();
            var g = (x.name = _[e.getUint16()]);
            (t._aniMap[g] = a),
              (x.bone3DMap = {}),
              (x.playTime = e.getFloat32());
            var v = (x.nodes.length = e.getUint8());
            for (x.totalKeyframeDatasLength = 0, s = 0; s < v; s++) {
              var M = (x.nodes[s] = new T());
              M.childs = [];
              var D = e.getInt16();
              D >= 0 && ((M.name = _[D]), (x.bone3DMap[M.name] = s)),
                (M.keyFrame = new Array()),
                (M.parentIndex = e.getInt16()),
                -1 == M.parentIndex
                  ? (M.parent = null)
                  : (M.parent = x.nodes[M.parentIndex]),
                (M.lerpType = e.getUint8());
              var I = e.getUint32();
              y.pos = I;
              var b = (M.keyframeWidth = y.getUint16());
              if (
                ((x.totalKeyframeDatasLength += b),
                0 === M.lerpType || 1 === M.lerpType)
              )
                for (
                  M.interpolationMethod = [],
                    M.interpolationMethod.length = b,
                    r = 0;
                  r < b;
                  r++
                )
                  M.interpolationMethod[r] = et.interpolation[y.getUint8()];
              null != M.parent && M.parent.childs.push(M);
              var A = e.getUint16();
              A > 0 &&
                ((M.extenData = i.slice(e.pos, e.pos + A)), (e.pos += A));
              var C = e.getUint16();
              M.keyFrame.length = C;
              var w,
                S = 0;
              for (r = 0, n = C; r < n; r++) {
                if (
                  (((w = M.keyFrame[r] = new Z()).duration = e.getFloat32()),
                  (w.startTime = S),
                  2 === M.lerpType)
                ) {
                  w.interpolationData = [];
                  var F,
                    k = e.getUint8();
                  switch ((F = e.getFloat32())) {
                    case 254:
                      for (w.interpolationData.length = b, u = 0; u < b; u++)
                    ...
                    case 255:
                      ...
                      break;
                    default:
                      for (w.interpolationData.push(F), l = 1; l < k; l++)
                        w.interpolationData.push(e.getFloat32());
                  }
                }
                for (w.data = new Float32Array(b), h = 0; h < b; h++)
                  (w.data[h] = e.getFloat32()),
                    w.data[h] > -1e-8 && w.data[h] < 1e-8 && (w.data[h] = 0);
                S += w.duration;
              }
              (w.startTime = x.playTime),
                (M.playTime = x.playTime),
                t._calculateKeyFrame(M, C, b);
            }
          }
        }),
        t
    ...
    C = (function () {
      function t() {}
      return (
        s(t, "laya.ani.AnimationParser02"),
        ...
        (t.parse = function (e, i) {
          ...
          for (var a = 0, s = t._BLOCK.count; a < s; a++) {
            var r = i.getUint16(),
              ...
              h = t["READ_" + n];
            if (null == h)
              throw new Error("model file err,no this function:" + r + " " + n);
            h.call();
          }
        }),
        (t.READ_ANIMATIONS = function () {
          ...
          for (t._templet._anis.length = o, a = 0; a < o; a++) {
            ...
            for (u.totalKeyframeDatasLength = 0, s = 0; s < d; s++) {
              ...
              var p = e.getUint16();
              p >= 0 && ((_.name = t._strings[p]), (u.bone3DMap[_.name] = s)),
                (_.keyFrame = new Array()),
                (_.parentIndex = e.getInt16()),
                -1 == _.parentIndex
                  ? (_.parent = null)
                  : (_.parent = u.nodes[_.parentIndex]),
                (u.totalKeyframeDatasLength += h),
                (_.interpolationMethod = l),
              ...
              var m = null,
                y = null;
              for (r = 0, n = f; r < n; r++) {
                ((m = _.keyFrame[r] = {}).startTime = e.getFloat32()),
                  y && (y.duration = m.startTime - y.startTime);
              ...
              (m.duration = 0),
                ...
                t._templet._calculateKeyFrame(_, f, h);
            }
          }
        }),
        (t._templet = null),
      ...
      (function () {
        ...
        return (
            ...
            if (((this.rotation = this.transform.skX), t))
              ...
              if (this.inheritRotation && this.inheritScale)
                ...
                this.inheritRotation
                  ? ((a = Math.atan2(i.resultMatrix.b, i.resultMatrix.a)),
                    (s = Math.cos(a)),
                    (r = Math.sin(a)),
                    o.setTo(s, r, -r, s, 0, 0),
                    m.mul(this._tempMatrix, o, m.TEMP),
                    m.TEMP.copyTo(o),
                    (e = this.resultTransform.getMatrix()),
                    m.mul(e, o, this.resultMatrix),
                    this.resultTransform.scX * this.resultTransform.scY < 0 &&
                      this.resultMatrix.rotate(0.5 * Math.PI),
                    (this.resultMatrix.tx = h),
          ...
          (e.updateDraw = function (e, a) {
            (t.ShowBones && !t.ShowBones[this.name]) ||
              (this._sprite
                ? ((this._sprite.x = e + this.resultMatrix.tx),
                  (this._sprite.y = a + this.resultMatrix.ty))
                : ((this._sprite = new M()),
            ...
            var s,
              r = 0;
            for (r = 0, s = this._children.length; r < s; r++)
              this._children[r].updateDraw(e, a);
          }),
          ...
          (e.findBone = function (t) {
            ...
            var e,
              i,
              a = 0;
            for (a = 0, i = this._children.length; a < i; a++)
              if ((e = this._children[a].findBone(t))) return e;
            return null;
          }),
      ...
      return (
            ...
            if (
              ...
              (this.currTexture = this.templet.getTexture(e)),
                this.currTexture &&
                  ...
                  (!x.isConchApp ||
                    (x.isConchApp && M.RUNTIMEVERION > "0.9.15")) &&
            ...
            switch (
                    ...
                    if (h) {
                      ...
                      if (
                        ...
                        a
                          ...
                          : (o = new m()),
                        (!x.isWebGL && this.currDisplayData.uvs) ||
                          (x.isWebGL &&
                            this._diyTexture &&
                            this.currDisplayData.uvs))
                      ) {
              ...
              case 1:
                ...
                if (null == this.currDisplayData.bones) {
                  var d,
                    _ = this.currDisplayData.weights;
                  this.deformData && (_ = this.deformData),
                    this._diyTexture
                      ? (this._curDiyUV || (this._curDiyUV = []),
                        0 == this._curDiyUV.length &&
                          ((this._curDiyUV = Q.getRelativeUV(
                            this.currTexture.uv,
                            this.currDisplayData.uvs,
                            this._curDiyUV
                          )),
                          (this._curDiyUV = Q.getAbsoluteUV(
                            this._diyTexture.uv,
                            this._curDiyUV,
                            this._curDiyUV
                          ))),
                    ...
                    r.init2(n, null, c, this._mVerticleArr, d);
                  var p,
                    f = this.getDisplayMatrix();
                  this._parentMatrix &&
                    f &&
        ...
        (e.skinMesh = function (t, e, i) {
          ...
          if (this.deformData && this.deformData.length > 0) {
            ...
            for (x = 0, g = r.length; x < g; ) {
              for (d = r[x++] + x, u = 0, c = 0; x < d; x++)
                (h = t[r[x]]),
                  (_ = l[f] + this.deformData[v++]),
                  (p = l[f + 1] + this.deformData[v++]),
                  (m = l[f + 2]),
                  (u += (_ * h.a + p * h.c + h.tx) * m),
                  (c += (_ * h.b + p * h.d + h.ty) * m),
                  (f += 3);
              y.push(u, c);
            }
          } else
          ...
          (this._mVerticleArr = y),
            (n = o),
            e.init2(s, null, n, this._mVerticleArr, a);
        }),
    ...
    F = (function () {
      ...
      return (
        ...
        (e._renderDrawTriangle = function (t, e, i, a) {
          ...
          if (t.useUvTransform) {
            var v = t.uvTransform;
            (p = (r[e] * v.a + r[e + 1] * v.c + v.tx) * d),
              (f = (r[i] * v.a + r[i + 1] * v.c + v.tx) * d),
              (m = (r[a] * v.a + r[a + 1] * v.c + v.tx) * d),
              (y = (r[e] * v.b + r[e + 1] * v.d + v.ty) * _),
              (x = (r[i] * v.b + r[i + 1] * v.d + v.ty) * _),
              (g = (r[a] * v.b + r[a + 1] * v.d + v.ty) * _);
          } else
            (p = r[e] * d),
              (f = r[i] * d),
              (m = r[a] * d),
          ...
          if (t.canvasPadding > 0) {
            ...
            (M = w + (F / P) * (P + A)),
              ...
              (k = N - S),
              (D =
                w + ((F = D - w) / (P = Math.sqrt(F * F + k * k))) * (P + A)),
              (N = S + (k / P) * (P + C)),
              (k = T - S),
              (I =
                w + ((F = I - w) / (P = Math.sqrt(F * F + k * k))) * (P + A)),
              (T = S + (k / P) * (P + C));
          }
          ...
          var U = 1 / (p * x + y * m + f * g - x * m - y * f - p * g),
            ...
            Y =
              ...
              y * f * T -
              p * N * g;
          s.transform(L * U, E * U, R * U, K * U, O * U, Y * U),
            s.drawImage(
              o,
              h.uv[0] * d,
              h.uv[1] * _,
    ...
    U = (function () {
      ...
      return (
        (e.binarySearch1 = function (t, e) {
          ...
          if (0 == a) return 1;
          for (var s = a >>> 1; ; ) {
            if ((t[Math.floor(s + 1)] <= e ? (i = s + 1) : (a = s), i == a))
              return i + 1;
            s = (i + a) >>> 1;
          }
          return 0;
        ...
        (e.apply = function (t, e, i) {
          if (
            (void 0 === i && (i = 1), (t += 0.05), !(this.timeList.length <= 0))
          ) {
            var a = 0;
            if (!(t < this.timeList[0])) {
              ...
              if (
                ...
                if (i < 1) for (a = 0; a < s; a++) r[a] += (h[a] - r[a]) * i;
                else for (a = 0; a < s; a++) r[a] = h[a];
                this.deformData = r;
              } else {
      ...
      return (
        ...
        (e._applyIk1 = function (e, i, a, s) {
          var r = e.parentBone,
            ...
            o =
              (h * r.resultMatrix.d - l * r.resultMatrix.c) * n - e.transform.x,
            u =
              (l * r.resultMatrix.a - h * r.resultMatrix.b) * n - e.transform.y,
        ...
        (e._applyIk2 = function (e, a, s, r, n, h) {
          if (0 != h) {
            ...
            N
              ? ((x =
                  v * m + D * (y = a.resultTransform.y) + e.resultMatrix.tx),
                (g = I * m + b * y + e.resultMatrix.ty))
              : ((y = 0),
                (x = v * m + e.resultMatrix.tx),
                (g = I * m + e.resultMatrix.ty)),
              this.isDebug &&
                (this._sp || ((this._sp = new M()), i.stage.addChild(this._sp)),
                this._sp.graphics.clear(),
                this._sp.graphics.drawCircle(s, r, 15, "#ffff00"),
                this._sp.graphics.drawCircle(x, g, 15, "#ff00ff")),
              e.setRotation(
                Math.atan2(g - e.resultMatrix.ty, x - e.resultMatrix.tx)
              );
            var T = e.parentBone;
            (v = T.resultMatrix.a),
              (D = T.resultMatrix.c),
              (I = T.resultMatrix.b);
            var A = 1 / (v * (b = T.resultMatrix.d) - D * I),
              C = s - T.resultMatrix.tx,
              w = r - T.resultMatrix.ty,
              S = (C * b - w * D) * A - l,
              F = (w * v - C * I) * A - o,
              k =
                ((C = x - T.resultMatrix.tx) * b -
                  (w = g - T.resultMatrix.ty) * D) *
                  A -
                l,
              P = (w * v - C * I) * A - o,
              B = Math.sqrt(k * k + P * P),
            ...
            if (N) {
              ...
              var E = (v = u * U) * v,
                ...
                W = -2 * K * B,
                X = K - E;
              if ((b = W * W - 4 * X * (I = K * B * B + E * Y - E * K)) > 0) {
                var z = Math.sqrt(b);
                W < 0 && (z = -z);
                var q = (z = -(W + z) / 2) / X,
                  G = I / z,
              ...
              var Q = 0,
                ...
                et = 0,
                it = 0;
              (b = (C = B + v) * C) > tt && ((J = 0), (tt = b), (et = C)),
                (b = (C = B - v) * C) < Z && ((Q = Math.PI), (Z = b), (j = C));
              var at = Math.acos((-v * B) / (E - K));
              (b =
                (C = v * Math.cos(at) + B) * C + (w = D * Math.sin(at)) * w) <
                Z && ((Q = at), (Z = b), (j = C), ($ = w)),
                b > tt && ((J = at), (tt = b), (et = C), (it = w)),
                Y <= (Z + tt) / 2
                  ? ((L = V - Math.atan2($ * n, j)), (R = Q * n))
                  : ((L = V - Math.atan2(it * n, et)), (R = J * n));
            }
            var st = Math.atan2(y, m) * f,
              rt = e.resultTransform.skX;
            (L = (L - st) * t.radDeg + _ - rt) > 180
              ? (L -= 360)
              : L < -180 && (L += 360),
              (e.resultTransform.x = l),
              (e.resultTransform.y = o),
              (e.resultTransform.skX = e.resultTransform.skY = rt + L * h),
              (rt = a.resultTransform.skX),
              (R = ((R + st) * t.radDeg - 0) * f + p - (rt %= 360)) > 180
                ? (R -= 360)
                : R < -180 && (R += 360),
              (a.resultTransform.x = m),
              (a.resultTransform.y = y),
              (a.resultTransform.skX = a.resultTransform.skY =
                a.resultTransform.skY + R * h),
              e.update();
          }
        }),
        (e._applyIk3 = function (e, a, s, r, n, h) {
          if (0 != h) {
            var l,
              ...
              d,
              _,
              p = a.resultMatrix.a * a.length,
              f = a.resultMatrix.b * a.length,
              m = p * p + f * f,
              y = Math.sqrt(m),
              x = e.resultMatrix.tx,
              g = e.resultMatrix.ty,
              ...
              T = Math.sqrt(N),
              A =
                (I = s - e.resultMatrix.tx) * I +
                (b = r - e.resultMatrix.ty) * b,
              C = Math.sqrt(A);
            if (y + T <= C || C + y <= T || C + T <= y) {
              var w;
              (v = x + ((w = y + T <= C ? 1 : -1) * (s - x) * T) / C),
                (D = g + (w * (r - g) * T) / C);
            } else {
              var S = (N - m + A) / (2 * A),
                F = Math.sqrt(N - S * S * A) / C,
                k = x + I * S,
                P = g + b * S,
                B = -b * F,
                U = I * F;
              n > 0 ? ((v = k - B), (D = P - U)) : ((v = k + B), (D = P + U));
            }
            (l = v),
              (o = D),
              this.isDebug &&
              ...
              (u = Math.atan2(o - e.resultMatrix.ty, l - e.resultMatrix.tx)),
              e.setRotation(u),
              (c = t._tempMatrix).identity(),
              c.rotate(u),
              c.scale(e.resultMatrix.getScaleX(), e.resultMatrix.getScaleY()),
              c.translate(e.resultMatrix.tx, e.resultMatrix.ty),
              c.copyTo(e.resultMatrix),
              e.updateChild(),
              (d = Math.atan2(r - o, s - l)),
              a.setRotation(d),
              (_ = t._tempMatrix).identity(),
              _.rotate(d),
              _.scale(a.resultMatrix.getScaleX(), a.resultMatrix.getScaleY()),
              _.translate(l, o),
              c.copyTo(a.resultMatrix),
              a.updateChild();
          }
        }),
        a(t, [
    ...
    K = (function () {
      function t() {}
      return (
        s(t, "laya.ani.bone.MeshTools"),
        (t.findEdge = function (t, e, i) {
          void 0 === e && (e = 0), void 0 === i && (i = !0);
          var a,
            s = 0,
            r = 0;
          for (a = t.length, r = -1, s = 0; s < a; s += 2)
            (r < 0 || i == t[r + e] < t[s + e]) && (r = s);
          return r;
        }),
        ...
        (t.adptTexture = function (e) {
          ...
          var a,
            ...
            r = (a = e.texture).width,
            n = a.height;
          (s = I.create(a, i[0] * r, i[1] * n, i[2] * r, i[3] * n)),
            (e.texture = s);
        }),
        ...
        (t.solvePoints = function (e, i, a, s, r, n, h, l) {
          ...
          var o,
            u,
            c = 0;
          for (o = e.length, c = 0; c < o; c += 2)
            (u = t.solve2(e[c], e[c + 1], i, a, s, r, n, h)),
              l.push(u[0], u[1]);
          return l;
        }),
        (t.transPoints = function (e, i, a, s, r, n, h, l) {
          ...
          var o,
            u = 0;
          for (o = e.length, u = 0; u < o; u += 2)
            t.transPoint(e[u], e[u + 1], i, a, s, r, n, h, l);
          return l;
        }),
        ...
        (t.solve2 = function (e, i, a, s, r, n, h, l, o, u) {
          ...
          return (
            ...
            (u = u || []),
            0 == r
              ? t.solve2(e, i, a, s, h, l, r, n, !0, u)
              : ((c =
                  ((_ = e - a) -
                    (d = (i - s - (_ * n) / r) / (l - (h * n) / r)) * h) /
                  r),
                o ? u.push(d, c) : u.push(c, d),
                u)
          );
        }),
    ...
    Y = (function () {
      function t(t, e) {
        (this.target = null),
          ...
          (this.bones = []);
        for (var i = this.data.bones, a = 0, s = i.length; a < s; a++)
      ...
      return (
          ...
          if (this.target) {
            ...
            if (o || n)
              for (var f = 0, m = d - 1; f < m; ) {
                ...
                (x = Math.sqrt(g * g + v * v)),
                  o && (u[f] = x),
                  (_[++f] = n ? Math.max(0, x + p) : p);
              }
            else for (f = 1; f < d; f++) _[f] = p;
            var M = this.computeWorldPositions(
              this.target,
              t,
              e,
              d,
            ...
            for (f = 0, A = 3; f < c; f++, A += 3) {
              ((y = this.bones[f]).resultMatrix.tx +=
                (I - y.resultMatrix.tx) * i),
                (y.resultMatrix.ty += (b - y.resultMatrix.ty) * i);
              var C = (g = M[A]) - I,
                w = (v = M[A + 1]) - b;
              if (o && 0 != (x = u[f])) {
              ...
              if (((I = g), (b = v), s)) {
                ...
                (U = l
                  ...
                  ? M[A + 2]
                  : Math.atan2(w, C)),
                  (U -= Math.atan2(P, F) - (N / 180) * Math.PI),
                  T &&
                    ((L = Math.cos(U)),
                    (R = Math.sin(U)),
                    (I += ((x = y.length) * (L * F - R * P) - C) * a),
                    (b += (x * (R * F + L * P) - w) * a)),
                  U > Math.PI
                    ? (U -= 2 * Math.PI)
                  ...
                  (L = Math.cos(U)),
                  (R = Math.sin(U)),
                  (y.resultMatrix.a = L * F - R * P),
                  (y.resultMatrix.c = L * k - R * B),
                  (y.resultMatrix.b = R * F + L * P),
                  (y.resultMatrix.d = R * k + L * B);
              }
            }
          }
        }),
          ...
          if (null != o) {
            ...
            for (m = n, y = 3 * p; m < s; m += 2) {
              for (x = 0, g = 0, f = o[_++], f += _; _ < f; _++, y += 3) {
                ...
                var b = u[y + 2];
                (x += (v * h.a + M * h.c + h.tx) * b),
                  (g += (v * h.b + M * h.d + h.ty) * b);
              }
              (r[m] = x), (r[m + 1] = g);
            }
          } else {
            ...
            var A = T.tx,
              ...
              F = T.c,
              k = T.d;
            for (l && (k *= l.d), _ = a, m = n; m < s; _ += 2, m += 2)
              (v = c[_]),
                (M = c[_ + 1]),
                (r[m] = v * w + M * S + A),
                (r[m + 1] = -(v * F + M * k + C));
        ...
        (e.computeWorldPositions = function (t, e, i, a, s, r, n) {
          ...
          if (
            (p--,
            (u -= 4),
            this.computeWorldVertices2(t, e, 2, u, l, 0),
            this._debugKey)
          )
            for (o = 0; o < l.length; )
              i.drawCircle(l[o++], l[o++], 10, "#ff0000");
          (h = l), (this._curves.length = p);
          var I = this._curves;
          m = 0;
          var b = h[0],
            N = h[1],
            ...
            E = NaN,
            K = 0;
          for (o = 0, K = 2; o < p; o++, K += 6)
            (L =
              2 * (k = 0.1875 * (b - 2 * (T = h[K]) + (C = h[K + 2]))) +
              (B = 0.09375 * (3 * (T - C) - b + (S = h[K + 4])))),
              (R =
                2 * (P = 0.1875 * (N - 2 * (A = h[K + 1]) + (w = h[K + 3]))) +
                (U = 0.09375 * (3 * (A - w) - N + (F = h[K + 5])))),
              (O = 0.75 * (T - b) + k + 0.16666667 * B),
              (E = 0.75 * (A - N) + P + 0.16666667 * U),
              (m += Math.sqrt(O * O + E * E)),
              (O += L),
              (E += R),
              (L += B),
              ...
              (b = S),
              (N = F);
          if ((r && (c *= m), n)) for (o = 0; o < a; o++) d[o] *= m;
          var Y = this._segments,
            V = 0,
            W = 0;
          for (o = 0, y = 0, x = 0, W = 0; o < a; o++, y += 3)
            if ((g = c += v = d[o]) < 0) this.addBeforePosition(g, h, 0, _, y);
            else if (g > m) this.addAfterPosition(g - m, h, u - 4, _, y);
            else {
              for (; ; x++)
                if (!(g > (D = I[x]))) {
                ...
                for (
                  L =
                    2 *
                      (k =
                        0.03 *
                        ((b = h[X]) - 2 * (T = h[X + 2]) + (C = h[X + 4]))) +
                    (B = 0.006 * (3 * (T - C) - b + (S = h[X + 6]))),
                    R =
                      2 *
                        (P =
                          0.03 *
                          ((N = h[X + 1]) -
                            2 * (A = h[X + 3]) +
                            (w = h[X + 5]))) +
                      (U = 0.006 * (3 * (A - w) - N + (F = h[X + 7]))),
                    O = 0.3 * (T - b) + k + 0.16666667 * B,
                    E = 0.3 * (A - N) + P + 0.16666667 * U,
                    V = Math.sqrt(O * O + E * E),
                    Y[0] = V,
                    X = 1;
                  X < 8;
    ...
    q = (function () {
      function t(t, e) {
        ...
        var i,
          a = 0;
        for (a = 0, i = t.boneIndexs.length; a < i; a++)
          this._bones.push(e[t.boneIndexs[a]]);
        (this.rotateMix = t.rotateMix),
          (this.translateMix = t.translateMix),
        ...
        (t.prototype.apply = function () {
          for (
            ...
            if (((t = this._bones[r]), this.rotateMix > 0)) {
              ...
              var d = Math.cos(c),
                _ = Math.sin(c);
              (t.resultMatrix.a = d * h - _ * o),
                (t.resultMatrix.b = d * l - _ * u),
                (t.resultMatrix.c = _ * h + d * o),
            ...
            if (
              ...
              var p = Math.sqrt(
                ...
                m =
                  p > 1e-5
                    ? (p + (f - p + this._data.offsetScaleX) * this.scaleMix) /
                      p
                    : 0;
              (t.resultMatrix.a *= m),
                (t.resultMatrix.c *= m),
                ...
                (m =
                  p > 1e-5
                    ? (p + (f - p + this._data.offsetScaleY) * this.scaleMix) /
                      p
                    : 0),
                (t.resultMatrix.b *= m),
                (t.resultMatrix.d *= m);
            ...
            if (this.shearMix > 0) {
              ...
              (c =
                ...
                (c =
                  y +
                  (c + (this._data.offsetShearY * Math.PI) / 180) *
                    this.shearMix),
                (m = Math.sqrt(l * l + u * u)),
    ...
    Q = (function () {
      ...
      return (
        ...
        (t.getAbsoluteUV = function (t, e, i) {
          ...
          var h,
            l = 0;
          for (h = i.length, l = 0; l < h; l += 2)
            (i[l] = e[l] * s + a), (i[l + 1] = e[l + 1] * n + r);
          return i;
        }),
        t
      );
    ...
    j = (function () {
      function t() {}
      return (
        s(t, "laya.ani.math.BezierLerp"),
        (t.getBezierRate = function (e, i, a, s, r) {
          var n = t._getBezierParamKey(i, a, s, r),
            h = 100 * n + e;
          if (t._bezierResultCache[h]) return t._bezierResultCache[h];
          var l,
            o = t._getBezierPoints(i, a, s, r, n),
            u = 0;
          for (l = o.length, u = 0; u < l; u += 2)
            if (e <= o[u])
              return (t._bezierResultCache[h] = o[u + 1]), o[u + 1];
        ...
        (t._getBezierPoints = function (e, i, a, s, r) {
          return t._bezierPointsCache[r]
            ? t._bezierPointsCache[r]
            : ((n = [0, 0, e, i, a, s, 1, 1]),
              (l = new h().getBezierPoints(n, 100, 3)),
    ...
    $ = (function (t) {
      ...
      var a = e.prototype;
      return (
        i.imps(a, { "laya.resource.IDestroy": !0 }),
        ...
        (a._computeFullKeyframeIndices = function () {
          for (
            var t = (this._fullFrames = []),
              ...
              a = 0,
              s = e.getAnimationCount();
            a < s;
            a++
          ) {
            for (
              var r = [], n = 0, h = e.getAnimation(a).nodes.length;
              n < h;
              n++
            ) {
              for (
                var l = e.getAnimation(a).nodes[n],
                  o = Math.floor(l.playTime / i + 0.01),
                  u = new Uint16Array(o + 1),
                  c = -1,
                  d = 0,
                  _ = l.keyFrame.length;
                d < _;
                ...
                var p = l.keyFrame[d],
                  ...
                  m = f + p.duration + i;
                do {
                  for (var y = Math.floor(f / i + 0.5), x = c + 1; x < y; x++)
                    u[x] = d;
                  (c = y), (u[y] = d), (f += i);
                } while (f <= m);
              }
        ...
        (a._update = function (t) {
          if (
            ...
            if (
              ...
              (0 === this._overallDuration && this._elapsedPlaybackTime >= a)
            )
              return (
                this._setPlayParamsWhenStop(a, e), void this.event("stopped")
              );
            if (((i += this._currentTime), a > 0))
              if (i >= a)
                do {
                  if (((i -= a), this._stopWhenCircleFinish))
                    return (
                      this._setPlayParamsWhenStop(a, e),
                      (this._stopWhenCircleFinish = !1),
    ...
    tt = (function (t) {
      function e() {
        e.__super.call(this), (this.mesh = new k());
      }
      s(e, "laya.ani.bone.canvasmesh.SkinMeshCanvas", F);
      var i = e.prototype;
      return (
        (i.init2 = function (t, e, i, a, s) {
          var r;
          this.transform && (this.transform = null),
            i ? (r = i) : (r = []).push(0, 1, 3, 3, 1, 2),
            (this.mesh.texture = t),
            (this.mesh.indexes = r),
            (this.mesh.vertices = a),
            (this.mesh.uvs = s);
        }),
        (i.render = function (t, i, a) {
          this.mesh.texture &&
            (this.transform
              ? (this.transform.translate(i, a),
    ...
    et = (function (t) {
      ...
      return (
        ...
        (a.getOriginalData = function (t, i, a, s, r) {
          for (
            var n = this._anis[t].nodes, h = 0, l = 0, o = n.length, u = 0;
            l < o;
            l++
          ) {
            var c,
        ...
        (a.getNodesCurrentFrameIndex = function (t, e) {
          ...
          for (var a = 0, s = i.length; a < s; a++) {
            ...
            for (
              ...
              this.unfixedCurrentFrameIndexes[a] < r.keyFrame.length &&
              !(
                r.keyFrame[this.unfixedCurrentFrameIndexes[a]].startTime >
        ...
        (a.getOriginalDataUnfixedRate = function (t, i, a) {
          ...
          t !== this.unfixedLastAniIndex &&
            ...
            (this.unfixedKeyframes = n(s.length)),
            (this.unfixedLastAniIndex = t));
          for (var r = 0, h = 0, l = s.length, o = 0; h < l; h++) {
            var u = s[h];
            for (
              a < this.unfixedCurrentTimes[h] &&
                (this.unfixedCurrentFrameIndexes[h] = 0),
                this.unfixedCurrentTimes[h] = a;
              this.unfixedCurrentFrameIndexes[h] < u.keyFrame.length &&
              !(
                u.keyFrame[this.unfixedCurrentFrameIndexes[h]].startTime >
                this.unfixedCurrentTimes[h]
              );

            )
              (this.unfixedKeyframes[h] =
                u.keyFrame[this.unfixedCurrentFrameIndexes[h]]),
        ...
        (e._BezierInterpolation_6 = function (t, e, i, a, s, r, n, h, l, o, u) {
          return (
            ...
            (i[a] =
              s[e] +
              (l[e] - s[e]) *
                j.getBezierRate(r / h, o[u], o[u + 1], o[u + 2], o[u + 3])),
            5
          );
        }),
    ...
    it =
      ((function (t) {
        ...
        s(e, "laya.ani.bone.canvasmesh.CacheAbleSkinMesh", tt);
        var i = e.prototype;
      ...
      (function (t) {
        ...
        var i = e.prototype;
        return (
          (i.init2 = function (e, i, a, s, r) {
            t.prototype.init2.call(this, e, i, a, s, r),
              (this.cacheOK = !1),
              (this.cacheCmdOK = !1),
          ...
          (i.renderToContext = function (t) {
            if (((this.context = t.ctx || t), this.mesh)) {
              ...
              this.cacheOK ||
                ...
                (this.tempMesh.vertices = K.solveMesh(
                  this.mesh,
          ...
          (i._renderDrawTriangle = function (t, e, i, a) {
            ...
            var M = n[e],
              ...
              P =
                ...
                p * N * g;
            if (
              ((this.transformCmds[0] = C * A),
              (this.transformCmds[1] = F * A),
              (this.transformCmds[2] = w * A),
              (this.transformCmds[3] = k * A),
              (this.transformCmds[4] = S * A),
              (this.transformCmds[5] = P * A),
              (this.drawCmds[0] = o),
              (this.drawCmds[1] = h.uv[0] * d),
              (this.drawCmds[2] = h.uv[1] * _),
              (this.drawCmds[3] = u),
              (this.drawCmds[4] = c),
              (this.drawCmds[5] = h.uv[0] * d),
              (this.drawCmds[6] = h.uv[1] * _),
              (this.drawCmds[7] = u),
              (this.drawCmds[8] = c),
              s.save(),
              this.transform)
    ...
    at = (function (t) {
      ...
      return (
        (a.init = function (t, e) {
          ...
          if (1 == e)
            for (
              this._graphicsCache = [], r = 0, n = t.getAnimationCount();
              r < n;
              r++
            )
          ...
          if (
            ...
            for (this._ikArr = [], r = 0, n = t.ikArr.length; r < n; r++)
              this._ikArr.push(new O(t.ikArr[r], this._boneList));
          if (t.pathArr.length > 0)
            for (
              ...
              (i = t.pathArr[r]),
                (a = new Y(i, this._boneList)),
                (s = this._boneSlotDic[i.name]) &&
                  ((a = new Y(i, this._boneList)).target = s),
                (this._pathDic[i.name] = a);
          if (t.tfArr.length > 0)
            for (this._tfArr = [], r = 0, n = t.tfArr.length; r < n; r++)
              this._tfArr.push(new q(t.tfArr[r], this._boneList));
        ...
        (a._onLoaded = function () {
          var t,
            e = p.getRes(this._aniPath);
          null != e &&
            (null == st.TEMPLET_DICTIONARY && (st.TEMPLET_DICTIONARY = {}),
            (t = st.TEMPLET_DICTIONARY[this._aniPath])
              ? t.isParseFail
                ? this._parseFail()
                : t.isParserComplete
                ? this._parseComplete()
              ...
              : ((t = new st())._setUrl(this._aniPath),
                (st.TEMPLET_DICTIONARY[this._aniPath] = t),
                t.on("complete", this, this._parseComplete),
                t.on("error", this, this._parseFail),
        ...
        (a._parseComplete = function () {
          var t = st.TEMPLET_DICTIONARY[this._aniPath];
        ...
        (a._parseSrcBoneMatrix = function () {
          ...
          if (0 == this._aniMode)
            ...
            for (t = 0, e = s.length; t < e; t++)
              (i = s[t]),
                null == (a = this._bindBoneBoneSlotDic[i.parent]) &&
                  (this._bindBoneBoneSlotDic[i.parent] = a = []),
        ...
        (a._emitMissedEvents = function (t, e, i) {
          void 0 === i && (i = 0);
          var a =
            this._templet.eventAniArr[this._player.currentAnimationClipIndex];
          if (a) {
            var s,
              r,
              n = 0;
            for (r = a.length, n = i; n < r; n++)
              (s = a[n]).time >= this._player.playStart &&
                s.time <= this._player.playEnd &&
                this.event("label", s);
          }
        }),
        (a._update = function (t) {
          if (
            ...
            var e = this.timer.currTimer,
              ...
              a = e - this._lastTime;
            if (
              (t ? this._player._update(a) : (i = -1),
              (this._lastTime = e),
              this._player &&
                ((this._index = this._clipIndex =
                  this._player.currentKeyframeIndex),
                !(
                  this._index < 0 ||
                  (a > 0 &&
                    this._clipIndex == i &&
              ...
              var s,
                r,
                n = this._templet.eventAniArr[this._aniClipIndex];
              if (
                (n &&
                  this._eventIndex < n.length &&
                  ((s = n[this._eventIndex]).time >= this._player.playStart &&
                  s.time <= this._player.playEnd
                    ? this._player.currentPlayTime >= s.time &&
                      (this.event("label", s), this._eventIndex++)
                    : this._eventIndex++),
                0 == this._aniMode)
              ) {
                if (
                  (r = this._templet.getGrahicsDataWithCache(
                    this._aniClipIndex,
                    this._clipIndex
                  ))
                )
                  return void (this.graphics != r && (this.graphics = r));
                var h = 0,
                  l = 0;
                for (
                  l = this._clipIndex;
                ...
                if (
                  (r = this._getGrahicsDataWithCache(
                    this._aniClipIndex,
                    this._clipIndex
                  ))
                )
        ...
        (a._createGraphics = function (t) {
          ...
          if (s && s.length > 0)
            for (
              this._drawOrderIndex = 0, e = s[this._drawOrderIndex];
              a >= e.time &&
              ((this._drawOrder = e.drawOrder),
              this._drawOrderIndex++,
              !(this._drawOrderIndex >= s.length));

            )
              e = s[this._drawOrderIndex];
          0 == this._aniMode || 1 == this._aniMode
            ? (this.graphics = J.create())
          ...
          for (_ = 0, y = c[0]; _ < x; _++)
            (u = this._boneList[_]),
              (l = this._templet.srcBoneMatrixArr[_]),
              (u.resultTransform.scX = l.scX * this._curOriginalData[d++]),
              (u.resultTransform.skX = l.skX + this._curOriginalData[d++]),
              (u.resultTransform.skY = l.skY + this._curOriginalData[d++]),
              (u.resultTransform.scY = l.scY * this._curOriginalData[d++]),
              (u.resultTransform.x = l.x + this._curOriginalData[d++]),
              (u.resultTransform.y = l.y + this._curOriginalData[d++]),
              8 === this._templet.tMatrixDataLen &&
                ((u.resultTransform.skewX =
                  l.skewX + this._curOriginalData[d++]),
                (u.resultTransform.skewY =
                  l.skewY + this._curOriginalData[d++]));
          var g,
            v = {},
            M = {};
          for (y += c[1]; _ < y; _++)
            (v[(g = r[_]).name] = this._curOriginalData[d++]),
              (M[g.name] = this._curOriginalData[d++]),
          ...
          var D,
            ...
            N = {};
          for (y += c[2]; _ < y; _++)
            (b[(g = r[_]).name] = this._curOriginalData[d++]),
              (N[g.name] = this._curOriginalData[d++]),
              this._curOriginalData[d++],
              this._curOriginalData[d++],
              this._curOriginalData[d++],
              this._curOriginalData[d++];
          if (this._pathDic)
            for (y += c[3]; _ < y; _++)
              if (((g = r[_]), (D = this._pathDic[g.name])))
                switch (new o(g.extenData).getByte()) {
                  case 1:
                    D.position = this._curOriginalData[d++];
                    break;
                  case 2:
                    D.spacing = this._curOriginalData[d++];
                    break;
                  case 3:
                    (D.rotateMix = this._curOriginalData[d++]),
                      (D.translateMix = this._curOriginalData[d++]);
                }
          if (
            ...
            for (_ = 0, y = this._ikArr.length; _ < y; _++)
              (I = this._ikArr[_]),
                b.hasOwnProperty(I.name) && (I.bendDirection = b[I.name]),
                N.hasOwnProperty(I.name) && (I.mix = N[I.name]),
                I.apply();
          if (this._pathDic)
            for (var T in this._pathDic)
              (D = this._pathDic[T]).apply(this._boneList, i);
          if (this._tfArr)
          ...
          for (_ = 0, f = this._boneList.length; _ < f; _++)
            if (
              ((u = this._boneList[_]),
              (h = this._bindBoneBoneSlotDic[u.name]),
              u.resultMatrix.copyTo(this._boneMatrixArray[_]),
              h)
            )
              for (p = 0, y = h.length; p < y; p++)
            ...
            if (this._lastAniClipIndex != this._aniClipIndex)
              for (
                this._lastAniClipIndex = this._aniClipIndex,
                  _ = 0,
                  y = this._boneSlotArray.length;
                _ < y;
                _++
              )
                (n = this._boneSlotArray[_]).deformData = null;
            var P,
              B = k[this._aniClipIndex];
            for (P in ((A = B.default),
            this._setDeform(A, F, this._boneSlotArray, a),
            B))
              "default" != P &&
                P != this._skinName &&
                ((A = B[P]), this._setDeform(A, F, this._boneSlotArray, a));
            (A = B[this._skinName]),
              this._setDeform(A, F, this._boneSlotArray, a);
          }
          if (this._drawOrder)
            for (_ = 0, y = this._drawOrder.length; _ < y; _++)
              (C = v[(n = this._boneSlotArray[this._drawOrder[_]]).name]),
                (w = M[n.name]),
                isNaN(w) || (i.save(), i.alpha(w)),
                isNaN(C) ||
                  -2 == C ||
                  (this._templet.attachmentNames
                    ? n.showDisplayByName(this._templet.attachmentNames[C])
                    : n.showDisplayByIndex(C)),
                F[this._drawOrder[_]]
                  ? ((S = F[this._drawOrder[_]]),
                    n.currDisplayData && S[n.currDisplayData.attachmentName]
                      ? (n.deformData = S[n.currDisplayData.attachmentName])
                      : (n.deformData = null))
                  : (n.deformData = null),
                isNaN(w)
                  ? n.draw(i, this._boneMatrixArray, 2 == this._aniMode)
                  : n.draw(i, this._boneMatrixArray, 2 == this._aniMode, w),
                isNaN(w) || i.restore();
          else
            for (_ = 0, y = this._boneSlotArray.length; _ < y; _++)
              (C = v[(n = this._boneSlotArray[_]).name]),
                (w = M[n.name]),
                isNaN(w) || (i.save(), i.alpha(w)),
                isNaN(C) ||
                  -2 == C ||
                ...
                isNaN(w) || i.restore();
          0 == this._aniMode
            ? this._templet.setGrahicsDataWithCache(this._aniClipIndex, t, i)
            : 1 == this._aniMode &&
              this._setGrahicsDataWithCache(this._aniClipIndex, t, i);
        }),
          ...
          if (t) {
            ...
            if (t)
              for (h = 0, l = t.deformSlotDataList.length; h < l; h++)
                for (
                  s = t.deformSlotDataList[h], o = 0;
                  o < s.deformSlotDisplayList.length;
                  o++
                )
                  (n = i[(r = s.deformSlotDisplayList[o]).slotIndex]),
                    r.apply(a, n),
        ...
        (a.play = function (t, e, i, a, s, r) {
          ...
          var n,
            h = -1;
          if (((n = e ? 2147483647 : 0), "string" == typeof t))
          ...
          h > -1 &&
            h < this.getAnimNum() &&
            ((this._aniClipIndex = h),
            (i || this._pause || this._currAniIndex != h) &&
              ((this._currAniIndex = h),
              (this._curOriginalData = new Float32Array(
                this._templet.getTotalkeyframesLength(h)
              )),
              (this._drawOrder = null),
              (this._eventIndex = 0),
              this._player.play(h, this._player.playbackRate, n, a, s),
              r &&
    ...
    st =
        ...
        (a.destroy = function (e) {
          ...
          (a.updates = function () {
            if (!this._parentMovieClip) {
              var t,
                e = 0;
              for (t = this._movieClipList.length, e = 0; e < t; e++)
          ...
          (a._clear = function () {
            if (
              ...
              var t,
                e = 0;
              for (t = this._movieClipList.length, e = 0; e < t; e++)
                this._movieClipList[e] != this &&
                  this._movieClipList[e]._clear();
              this._movieClipList.length = 0;
            }
            var i;
            for (i in (this._atlasPath && p.clearRes(this._atlasPath),
            this._loadedImage))
              this._loadedImage[i] &&
                (p.clearRes(i), (this._loadedImage[i] = !1));
            this.removeChildren(),
              (this.graphics = null),
              (this._parentMovieClip = null);
          }),
            ...
            for (
              ...
              switch (u.getUint16()) {
                ...
                case 4:
                  ...
                  break;
                case 5:
                  o[u.getUint16()][e._ValueList[u.getUint16()]] =
                    u.getFloat32();
                  break;
                case 6:
          ...
          (a.load = function (t, e, a) {
            ...
            void 0 === e && (e = !1),
              (this._url = t),
              e && (this._atlasPath = a || t.split(".swf")[0] + ".json"),
              this.stop(),
              this._clear(),
              (this._movieClipList = [this]),
              (s = [{ url: t, type: "arraybuffer" }]),
              this._atlasPath &&
                s.push({ url: this._atlasPath, type: "atlas" }),
              i.loader.load(s, _.create(this, this._onLoaded));
          }),
          (a._onLoaded = function () {
            var t;
            (t = p.getRes(this._url))
              ? ((this.basePath = this._atlasPath
                  ? p.getAtlas(this._atlasPath).dir
      ...
      (function (t) {
        ...
        var a = e.prototype;
        return (
          (a.loadAni = function (t) {
            (this._skBufferUrl = t),
              i.loader.load(
                t,
                _.create(this, this.onComplete),
                null,
                "arraybuffer"
              );
          }),
          ...
          (a._parseTexturePath = function () {
            if (this._isDestroyed) this.destroy();
              ...
              i.loader.load(
                this._loadList,
                _.create(this, this._textureComplete)
              );
            }
          }),
          ...
          (a._parsePublicExtData = function () {
            var t,
              ...
              s = 0,
              r = 0;
            for (e = 0, r = this.getAnimationCount(); e < r; e++)
              this._graphicsCache.push([]);
            ...
            for (e = 0; e < v; e++) {
              if (
                ...
                (h = this._path + D[2 * e]),
                (M = D[2 * e + 1]),
                null == this._mainTexture && (n = this._textureDic[h]),
                !n)
              )
                return this.event("error", this), void (this.isParseFail = !0);
              (u = l.getFloat32()),
                (c = l.getFloat32()),
                (d = l.getFloat32()),
                (_ = l.getFloat32()),
                ...
                (g = l.getFloat32()),
                (x = isNaN(g) ? _ : g),
                (this.subTextureDic[M] = I.create(n, u, c, d, _, -p, -f, y, x));
            }
            this._mainTexture = n;
            var b,
              N = l.getUint16();
            ...
            for (e = 0; e < O; e++)
              (T = new w()),
                ...
                (T.name = C),
                F && ((A = K[F]) ? A.addChild(T) : (this.mRootBone = T)),
                (K[C] = T),
                this.mBoneArr.push(T);
            this.tMatrixDataLen = l.getUint16();
            var Y,
              q = l.getUint16(),
              Q = Math.floor(q / this.tMatrixDataLen),
              Z = this.srcBoneMatrixArr;
            for (e = 0; e < Q; e++)
              ((Y = new H()).scX = l.getFloat32()),
                (Y.skX = l.getFloat32()),
                (Y.skY = l.getFloat32()),
                (Y.scY = l.getFloat32()),
                (Y.x = l.getFloat32()),
                ...
                8 === this.tMatrixDataLen &&
                  ((Y.skewX = l.getFloat32()), (Y.skewY = l.getFloat32())),
                Z.push(Y),
                ((T = this.mBoneArr[e]).transform = Y);
            var j,
              $ = l.getUint16(),
              J = 0;
            for (e = 0; e < $; e++) {
              for (j = new E(), J = l.getUint16(), i = 0; i < J; i++)
                j.boneNames.push(l.readUTFString()),
                  j.boneIndexs.push(l.getInt16());
              (j.name = l.readUTFString()),
                (j.targetBoneName = l.readUTFString()),
                (j.targetBoneIndex = l.getInt16()),
                (j.bendDirection = l.getFloat32()),
                (j.mix = l.getFloat32()),
                (j.isSpine = t),
                this.ikArr.push(j);
            }
            var tt,
              ...
              it = 0;
            for (e = 0; e < et; e++) {
              for (tt = new G(), it = l.getUint16(), i = 0; i < it; i++)
            ...
            for (e = 0; e < st; e++) {
              ...
              (at.target = l.readUTFString()),
                (at.positionMode = l.readUTFString()),
                (at.spacingMode = l.readUTFString()),
                (at.rotateMode = l.readUTFString()),
                (at.offsetRotation = l.getFloat32()),
                (at.position = l.getFloat32()),
                (at.spacing = l.getFloat32()),
                (at.rotateMix = l.getFloat32()),
                (at.translateMix = l.getFloat32()),
            ...
            for (e = 0; e < ft; e++) {
              ...
              for (var xt = 0; xt < mt; xt++)
                for (
                  (nt = new P()).skinName = l.getUTFString(),
                    yt[nt.skinName] = nt,
                    ut = l.getInt16(),
                    i = 0;
                  i < ut;
                  ...
                  for (
                    ...
                    for (
                      lt = new U(),
                        ht.deformSlotDisplayList.push(lt),
            ...
            var gt,
              ...
              It = 0;
            for (e = 0; e < Mt; e++) {
              for (Dt = l.getInt16(), gt = [], i = 0; i < Dt; i++) {
                for (
                  (vt = new L()).time = l.getFloat32(),
                    It = l.getInt16(),
                    a = 0;
                  a < It;
                  a++
            ...
            var bt,
              ...
              At = 0;
            for (e = 0; e < Tt; e++) {
              for (At = l.getInt16(), bt = [], i = 0; i < At; i++)
                ((Nt = new R()).name = l.getUTFString()),
                  (Nt.intValue = l.getInt32()),
                  (Nt.floatValue = l.getFloat32()),
                  (Nt.stringValue = l.getUTFString()),
                  (Nt.time = l.getFloat32()),
                  bt.push(Nt);
              this.eventAniArr.push(bt);
            }
            var Ct = l.getInt16();
            if (Ct > 0)
              for (this.attachmentNames = [], e = 0; e < Ct; e++)
                this.attachmentNames.push(l.getUTFString());
            var wt,
              St,
              Ft = l.getInt16();
            for (e = 0; e < Ft; e++)
              ((wt = new S()).name = l.readUTFString()),
                (wt.parent = l.readUTFString()),
                (wt.attachmentName = l.readUTFString()),
                (wt.srcDisplayIndex = wt.displayIndex = l.getInt16()),
                (wt.templet = this),
                (this.boneSlotDic[wt.name] = wt),
                null == (St = this.bindBoneBoneSlotDic[wt.parent]) &&
                  (this.bindBoneBoneSlotDic[wt.parent] = St = []),
                St.push(wt),
                this.boneSlotArray.push(wt);
            var kt,
              Pt,
              Bt,
            ...
            for (e = 0; e < Rt; e++) {
              for (
                (kt = new W()).name = Ut[Lt++], Ot = l.getUint8(), i = 0;
                i < Ot;
                i++
              ) {
                for (
                  (Pt = new z()).name = Ut[Lt++],
                    wt = this.boneSlotDic[Pt.name],
                    Et = l.getUint8(),
                    a = 0;
                  a < Et;
                  a++
                  ...
                  if (
                    ...
                    for (Bt.bones = [], s = 0; s < O; s++) {
                      var zt = l.getUint16();
                      Bt.bones.push(zt);
                    }
                  if ((Kt = l.getUint16()) > 0)
                    for (Bt.uvs = [], s = 0; s < Kt; s++)
                      Bt.uvs.push(l.getFloat32());
                  if ((Yt = l.getUint16()) > 0)
                    for (Bt.weights = [], s = 0; s < Yt; s++)
                      Bt.weights.push(l.getFloat32());
                  if ((Vt = l.getUint16()) > 0)
                    for (Bt.triangles = [], s = 0; s < Vt; s++)
                      Bt.triangles.push(l.getUint16());
                  if ((Wt = l.getUint16()) > 0)
                    for (Bt.vertices = [], s = 0; s < Wt; s++)
                      Bt.vertices.push(l.getFloat32());
                  if ((Xt = l.getUint16()) > 0)
                    for (Bt.lengths = [], s = 0; s < Xt; s++)
            ...
            if (h) {
              for (r = 0, n = h.slotArr.length; r < n; r++)
                (s = h.slotArr[r]) &&
                  ...
                  (a.showSlotData(s, i),
                  i &&
                  "undefined" != a.attachmentName &&
                  "null" != a.attachmentName
          ...
          (a.destroy = function () {
            var t;
            for (var i in ((this._isDestroyed = !0), this.subTextureDic))
  ...
  "function" == typeof define &&
    ...
    define("laya.core", ["require", "exports"], function (t, e) {
      "use strict";
      for (var i in (Object.defineProperty(e, "__esModule", { value: !0 }),
      Laya)) {
        var a = Laya[i];
        a && a.__isclass && (e[i] = a);
      }
