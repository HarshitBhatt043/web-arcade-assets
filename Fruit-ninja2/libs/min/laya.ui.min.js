!(function (t, i, e) {
  ...
  e.interface("laya.ui.IItem"),
    e.interface("laya.ui.ISelect"),
    e.interface("laya.ui.IRender"),
    e.interface("laya.ui.IComponent"),
    e.interface("laya.ui.IBox", "IComponent");
  var k = (function () {
      function t() {
        (this.enable = !1),
          (this.top = NaN),
    ...
    L = (function () {
      ...
      return (
        h(t, "laya.ui.UIUtils"),
        (t.fillArray = function (t, i, e) {
          var s = t.concat();
          if (i)
            for (
              var h = i.split(","), n = 0, o = Math.min(s.length, h.length);
              n < o;
              n++
            ) {
              var r = h[n];
              (s[n] = "true" == r || ("false" != r && r)),
                null != e && (s[n] = e(r));
            }
          return s;
        }),
        ...
        (t.gray = function (i, e) {
          void 0 === e && (e = !0),
            e ? t.addFilter(i, t.grayFilter) : t.clearFilter(i, l);
        }),
        ...
        s(t, [
          ...
          function () {
            return (this.grayFilter = new l([
              0.3086, 0.6094, 0.082, 0, 0, 0.3086, 0.6094, 0.082, 0, 0, 0.3086,
    ...
    z = (function (t) {
      ...
      return (
        ...
        (s._setChanged = function () {
          this._isChanged ||
            ((this._isChanged = !0),
            e.timer.callLater(this, this.changeSource));
        }),
        (s.changeSource = function () {
          ...
          if (t && t.bitmap) {
            ...
            if (!h || (n === e && o === s))
              ...
              if (x.isOKCmdList(B.I.get(r)))
                return void (this.cmds = B.I.get(r));
              this.clear();
              var l = h[0],
                a = h[1],
                c = h[2],
              ...
              u &&
                l &&
                this.drawTexture(i.getTexture(t, 0, 0, u, l), 0, 0, u, l),
                a &&
                  l &&
                  this.drawTexture(
                    i.getTexture(t, n - a, 0, a, l),
                    e - a,
                    0,
                    a,
                    l
                ...
                this.drawBitmap(
                  _,
                  i.getTexture(t, u, l, n - u - a, o - l - c),
                  u,
                  l,
                  e - u - a,
                  s - l - c
        ...
        (s.drawBitmap = function (t, i, e, s, h, n) {
          void 0 === h && (h = 0),
            ...
            h < 0.1 ||
              n < 0.1 ||
              (!t || (i.width == h && i.height == n)
                ? this.drawTexture(i, e, s, h, n)
                : this.fillTexture(i, e, s, h, n));
        }),
        (s.clear = function (i) {
        ...
        (i.getTexture = function (t, i, e, s, h) {
          ...
          return (
            (o && o.source) ||
              ((o = S.createFromTexture(t, i, e, s, h)), B.I.set(n, o)),
            o
          );
        }),
        i
      ...
      (function (t) {
        ...
        return (
          ...
          (s.getLayout = function () {
            return (
              this._layout === k.EMPTY && (this._layout = new k()), this._layout
            );
          }),
                ...
                (isNaN(t.centerX)
                  ? isNaN(t.left)
                    ...
                    : ((this.x = Math.round(
                      ...
                      isNaN(t.right) ||
                        (this.width =
                          (i._width - t.left - t.right) /
                          (this.scaleX || 0.01)))
                  : (this.x = Math.round(
                      0.5 * (i.width - this.displayWidth) +
                        t.centerX +
                        this.pivotX * this.scaleX
                    )));
            }
                ...
                (isNaN(t.centerY)
                  ? isNaN(t.top)
                    ...
                    : ((this.y = Math.round(t.top + this.pivotY * this.scaleY)),
                      isNaN(t.bottom) ||
                        (this.height =
                          (i._height - t.top - t.bottom) /
                          (this.scaleY || 0.01)))
                  : (this.y = Math.round(
                      0.5 * (i.height - this.displayHeight) +
                        t.centerY +
                        this.pivotY * this.scaleY
                    )));
            }
            ...
            function (t) {
              ...
              for (var i in this._dataSource)
                this.hasOwnProperty(i) &&
                  ...
                  (this[i] = this._dataSource[i]);
            }
          ),
          n(0, s, "scaleY", t.prototype._$get_scaleY, function (t) {
            e.superGet(C, this, "scaleY") != t &&
              (e.superSet(C, this, "scaleY", t),
              this.callLater(this.changeSize),
          ...
          n(0, s, "scaleX", t.prototype._$get_scaleX, function (t) {
            e.superGet(C, this, "scaleX") != t &&
              (e.superSet(C, this, "scaleX", t),
              this.callLater(this.changeSize),
        ...
        (this.lockLayer = null),
          ...
          (this.closeEffect = function (t, i) {
            w.to(
              ...
              300,
              a.strongOut,
              f.create(this, this.doClose, [t, i])
            );
          }),
          i.__super.call(this),
          (this.maskLayer = new C()),
          ...
          (this.zOrder = 1e3),
          e.stage.addChild(this),
          e.stage.on("resize", this, this._onResize),
          M.closeDialogOnSide &&
      ...
      return (
        ...
        (s.setLockView = function (t) {
          this.lockLayer ||
            ...
            this.lockLayer.size(e.stage.width, e.stage.height)),
        ...
        (s._onResize = function (t) {
          ...
          this.lockLayer && this.lockLayer.size(i, s),
            this.maskLayer.graphics.clear(),
            this.maskLayer.graphics.drawRect(0, 0, i, s, M.popupBgColor),
        ...
        (s._centerDialog = function (t) {
          (t.x = Math.round(((e.stage.width - t.width) >> 1) + t.pivotX)),
            (t.y = Math.round(((e.stage.height - t.height) >> 1) + t.pivotY));
        }),
        ...
        (s.close = function (t, i, e) {
          void 0 === e && (e = !1),
            e && null != t.closeEffect
              ? t.closeEffect.runWith([t, i])
              : this.doClose(t, i),
            this.event("close");
        }),
        (s.doClose = function (t, i) {
          t.removeSelf(),
            ...
            t.closeHandler && t.closeHandler.runWith(i),
            t.onClosed(i);
        }),
        (s.closeAll = function () {
    ...
    N = (function (t) {
      ...
      var o = i.prototype;
      return (
        e.imps(o, { "laya.ui.ISelect": !0 }),
        (o.destroy = function (i) {
          void 0 === i && (i = !0),
            t.prototype.destroy.call(this, i),
            this._bitmap && this._bitmap.destroy(),
            this._text && this._text.destroy(i),
            (this._bitmap = null),
            (this._text = null),
            (this._clickHandler = null),
        ...
        (o.onMouse = function (t) {
          if (!1 !== this.toggle || !this._selected)
            return "click" === t.type
              ...
              : void (!this._selected && (this.state = i.stateMap[t.type]));
        }),
          ...
          if (t) {
            ...
            if ((x.isOkTextureList(h) || (h = null), h)) this._sources = h;
              ...
              if (((this._sources = []), 1 === this._stateNum))
                ...
                for (var n = 0; n < this._stateNum; n++)
                  this._sources.push(S.createFromTexture(t, 0, e * n, i, e));
              B.I.set(s, this._sources);
            }
            this._autoSize
              ? ((this._bitmap.width = this._width || i),
                (this._bitmap.height = this._height || e),
                this._text &&
        ...
        n(0, o, "width", t.prototype._$get_width, function (t) {
          e.superSet(T, this, "width", t),
            this._autoSize &&
              ((this._bitmap.width = t), this._text && (this._text.width = t));
        }),
        n(0, o, "height", t.prototype._$get_height, function (t) {
          e.superSet(T, this, "height", t),
            this._autoSize &&
        ...
        n(0, o, "dataSource", t.prototype._$get_dataSource, function (t) {
          (this._dataSource = t),
            "number" == typeof t || "string" == typeof t
              ? (this.label = t + "")
              : e.superSet(T, this, "dataSource", t);
        }),
        n(
          0,
          o,
      ...
      return (
            ...
            if ((x.isOkTextureList(n) || (n = null), n)) this._sources = n;
              ...
              for (var o = 0; o < this._clipY; o++)
                for (var r = 0; r < this._clipX; r++)
                  this._sources.push(
                    S.createFromTexture(i, e * r, s * o, e, s)
                  );
        ...
        (s.play = function (t, i) {
          void 0 === t && (t = 0),
            ...
            (this._toIndex = i),
            this._index++,
            e.timer.loop(this.interval, this, this._loop),
    ...
    Y = (function (t) {
      ...
      return (
        (s.destroy = function (i) {
          void 0 === i && (i = !0),
            t.prototype.destroy.call(this, i),
            this._colorPanel && this._colorPanel.destroy(i),
            this._colorButton && this._colorButton.destroy(i),
            (this._colorPanel = null),
            (this._colorTiles = null),
            (this._colorBlock = null),
            (this._colorInput = null),
        ...
        (s.createChildren = function () {
          this.addChild((this._colorButton = new N())),
            (this._colorPanel = new H()),
            this._colorPanel.size(230, 166),
            this._colorPanel.addChild((this._colorTiles = new C())),
            this._colorPanel.addChild((this._colorBlock = new C())),
        ...
        (s.changePanel = function () {
          ...
          for (
            var i = [
                0, 3355443, 6710886, 10066329, 13421772, 16777215, 16711680,
        ...
        (s.open = function () {
          var t = this.localToGlobal(new m()),
            i =
              t.x + this._colorPanel.width <= e.stage.width
                ? t.x
                : e.stage.width - this._colorPanel.width,
            s = t.y + this._colorButton.height;
          (s =
            s + this._colorPanel.height <= e.stage.height
              ? s
              : t.y - this._colorPanel.height),
            this._colorPanel.pos(i, s),
            (this._colorPanel.zOrder = 1001),
            e._currentStage.addChild(this._colorPanel),
            e.stage.on("mousedown", this, this.removeColorBox);
        }),
        (s.close = function () {
          e.stage.off("mousedown", this, this.removeColorBox),
        ...
        (s.drawBlock = function (t) {
          ...
          i.clear();
          var e = t || "#ffffff";
          i.drawRect(0, 0, 50, 20, e, this._borderColor),
            t || i.drawLine(0, 0, 50, 20, "#ff0000");
        }),
    ...
    A = (function (t) {
      ...
      return (
        (s.destroy = function (i) {
          void 0 === i && (i = !0),
            t.prototype.destroy.call(this, i),
            this._button && this._button.destroy(i),
            this._list && this._list.destroy(i),
            (this._button = null),
            (this._list = null),
        ...
        (s.createChildren = function () {
          this.addChild((this._button = new N())),
        ...
        (s.onlistItemMouse = function (t, i) {
          ...
          if ("mouseover" === e || "mouseout" === e) {
            ...
            "click" === e && ((this.selectedIndex = i), (this.isOpen = !1));
        }),
        ...
        (s.changeItem = function () {
          ...
          i.length = 0;
          for (var e = 0, s = this._labels.length; e < s; e++)
        ...
        (s.removeList = function (t) {
          e.stage.off("mousedown", this, this.removeList),
            e.stage.off("mousewheel", this, this._onStageMouseWheel),
            (this.isOpen = !1);
        }),
        n(
          0,
          ...
          function (t) {
            if (this._isOpen != t)
              if (
                ...
                (s =
                  s + this._listHeight <= e.stage.height
                    ? s
                    : i.y - this._listHeight),
                  this._list.pos(i.x, s),
                  (this._list.zOrder = 1001),
                  e._currentStage.addChild(this._list),
                  e.stage.once("mousedown", this, this.removeList),
                  e.stage.on("mousewheel", this, this._onStageMouseWheel),
      ...
      return (
        (s.destroy = function (i) {
          void 0 === i && (i = !0),
            ...
            (this.target = null),
            t.prototype.destroy.call(this, i),
            this.upButton && this.upButton.destroy(i),
            this.downButton && this.downButton.destroy(i),
            this.slider && this.slider.destroy(i),
        ...
        (s.createChildren = function () {
          this.addChild((this.slider = new E())),
            this.addChild((this.upButton = new N())),
            this.addChild((this.downButton = new N()));
        }),
        (s.initialize = function () {
        ...
        (s.onButtonMouseDown = function (t) {
          ...
          this.slide(i),
            e.timer.once(I.scrollBarDelayTime, this, this.startLoop, [i]),
        ...
        (s.setScroll = function (t, i, e) {
          this.runCallLater(this.changeSize),
            this.slider.setSlider(t, i, e),
            (this.slider.bar.visible = i > 0),
        ...
        (s.onTargetMouseDown = function (t) {
          (this._clickOnly = !0),
            (this._lastOffset = 0),
            (this._checkElastic = !1),
            this._lastPoint || (this._lastPoint = new m()),
            this._lastPoint.setTo(e.stage.mouseX, e.stage.mouseY),
            e.timer.clear(this, this.tweenMove),
            w.clearTween(this),
            e.stage.once("mouseup", this, this.onStageMouseUp2),
            e.stage.once("mouseout", this, this.onStageMouseUp2),
            ...
            if (
              !(
                Math.abs(
                  this._lastOffset *
                    (this.isVertical
                      ? e.stage._canvasTransform.getScaleY()
                      : e.stage._canvasTransform.getScaleX())
                ) > 1
              )
            )
              return;
        ...
        (s.onStageMouseUp2 = function (t) {
          if (
            (e.stage.off("mouseup", this, this.onStageMouseUp2),
            e.stage.off("mouseout", this, this.onStageMouseUp2),
            e.timer.clear(this, this.loop),
            !(
              this._clickOnly &&
              this._value >= this.min &&
              this._value <= this.max
            ...
            if (((this._target.mouseEnabled = !0), this._isElastic))
              ...
              this._offsets.length < 1 &&
                (this._offsets[0] = this.isVertical
                  ? e.stage.mouseY - this._lastPoint.y
                  : e.stage.mouseX - this._lastPoint.x);
              for (
                var i = 0, s = Math.min(this._offsets.length, 3), h = 0;
                h < s;
                h++
              )
                i += this._offsets[this._offsets.length - 1 - h];
              if (
                ((this._lastOffset = i / s),
                (i = Math.abs(this._lastOffset)) < 2)
              )
        ...
        (s.elasticOver = function () {
          (this._isElastic = !1),
            !this.hide && this.autoHide && w.to(this, { alpha: 0 }, 500),
            this.event("end");
        }),
          ...
          if (
            (t > 0 &&
              (this._lastOffset > 0 && this.value <= this.min
                ? ((this._isElastic = !0),
                  (i = 0.5 * -(this.min - t - this.value)),
                  this._lastOffset > i && (this._lastOffset = i))
                : this._lastOffset < 0 &&
                  this.value >= this.max &&
                  ((this._isElastic = !0),
                  (i = 0.5 * -(this.max + t - this.value)),
                  this._lastOffset < i && (this._lastOffset = i))),
            (this.value -= this._lastOffset),
            Math.abs(this._lastOffset) < 1)
          ) {
            if ((e.timer.clear(this, this.tweenMove), this._isElastic))
            ...
            this._target &&
              ...
              t &&
                (this._mouseWheelEnable &&
                  this._target.on("mousewheel", this, this.onTargetMouseWheel),
    ...
    E = (function (t) {
      ...
      return (
        (o.destroy = function (i) {
          void 0 === i && (i = !0),
            t.prototype.destroy.call(this, i),
            this._bg && this._bg.destroy(i),
            this._bar && this._bar.destroy(i),
            this._progress && this._progress.destroy(i),
            (this._bg = null),
            (this._bar = null),
            (this._progress = null),
            (this.changeHandler = null);
        ...
        (o.createChildren = function () {
          this.addChild((this._bg = new V())),
            this.addChild((this._bar = new N()));
        }),
        (o.initialize = function () {
        ...
        (o.onBarMouseDown = function (t) {
          this._globalSacle || (this._globalSacle = new m()),
            ...
            e.stage.on("mousemove", this, this.mouseMove),
            e.stage.once("mouseup", this, this.mouseUp),
            e.stage.once("mouseout", this, this.mouseUp),
            this.showValueText();
        }),
        ...
        (o.mouseUp = function (t) {
          e.stage.off("mousemove", this, this.mouseMove),
            e.stage.off("mouseup", this, this.mouseUp),
            e.stage.off("mouseout", this, this.mouseUp),
        ...
        (o.mouseMove = function (t) {
          ...
          this.isVertical
            ? ((this._bar.y +=
                (e.stage.mouseY - this._ty) / this._globalSacle.y),
            ...
            : ((this._bar.x +=
                (e.stage.mouseX - this._tx) / this._globalSacle.x),
          ...
          (this._value =
            Math.round(Math.round(this._value / this._tick) * this._tick * s) /
            s),
        ...
        (o.setSlider = function (t, i, e) {
          (this._value = -1),
            (this._min = t),
            (this._max = i > t ? i : t),
            (this.value = e < t ? t : e > i ? i : e);
        }),
        (o.changeValue = function () {
          var t = Math.pow(10, (this._tick + "").length - 1);
          (this._value =
            Math.round(Math.round(this._value / this._tick) * this._tick * t) /
            t),
            (this._value =
        ...
        (o.onBgMouseDown = function (t) {
          ...
          this.isVertical
            ? (this.value =
                (i.y / (this.height - this._bar.height)) *
                  (this._max - this._min) +
                this._min)
            : (this.value =
                (i.x / (this.width - this._bar.width)) *
                  (this._max - this._min) +
                this._min);
        }),
        n(0, o, "measureHeight", function () {
        ...
        n(
          ...
          function (t) {
            if (this._skin != t) {
              ...
              g.getRes(i) &&
                (this._progress ||
                  (this.addChild((this._progress = new V())),
                  (this._progress.sizeGrid = this._bar.sizeGrid),
                  this.setChildIndex(this._progress, 1)),
                (this._progress.skin = i)),
                this.setBarPoint(),
    ...
    V = (function (t) {
      ...
      return (
        ...
        n(
          ...
          function (t) {
            this._bitmap &&
              ((this._bitmap.source = t), this.event("loaded"), this.repaint());
          }
        ),
        n(0, s, "dataSource", t.prototype._$get_dataSource, function (t) {
          (this._dataSource = t),
          ...
          function (t) {
            if (this._skin != t)
              if (((this._skin = t), t)) {
                var i = g.getRes(t);
                i
                  ? ((this.source = i), this.onCompResize())
                  : e.loader.load(
                      this._skin,
                      f.create(this, this.setSource, [this._skin]),
                      null,
                      "image",
                      1,
                      !0,
      ...
      return (
        ...
        (s.changeValue = function () {
          if (this.sizeGrid) {
            ...
            (this._bar.width = i + e + s),
              (this._bar.visible = this._bar.width > i + e);
      ...
      ((function (t) {
        function i() {
          (this._tipBox = null),
            ...
            e.stage.on("showtip", this, this._onStageShowTip),
            e.stage.on("hidetip", this, this._onStageHideTip),
            (this.zOrder = 1100);
        }
        h(i, "laya.ui.TipManager", T);
        var s = i.prototype;
        (s._onStageHideTip = function (t) {
          e.timer.clear(this, this._showTip),
            this.closeAll(),
            this.removeSelf();
        }),
          ...
          (s._showTip = function (t) {
            ...
            e.stage.on("mousemove", this, this._onStageMouseMove),
              e.stage.on("mousedown", this, this._onStageMouseDown),
          ...
          (s._showToStage = function (t, i, s) {
            ...
            var h = t.getBounds();
            (t.x = e.stage.mouseX + i),
              (t.y = e.stage.mouseY + s),
              t.x + h.width > e.stage.width && (t.x -= h.width + i),
              t.y + h.height > e.stage.height && (t.y -= h.height + s);
          }),
          (s.closeAll = function () {
            e.timer.clear(this, this._showTip),
              e.stage.off("mousemove", this, this._onStageMouseMove),
              e.stage.off("mousedown", this, this._onStageMouseDown),
              this.removeChildren();
          }),
          (s.showDislayTip = function (t) {
            this.addChild(t),
              this._showToStage(this),
              e._currentStage.addChild(this);
          }),
      ...
      (function (t) {
        ...
        return (
            ...
            if (
              ...
              for (o = 0; o < r; o++) {
                switch (
                  ((e = new _()),
                  (s = n[o]),
                  e._setUp(this._idMap, s),
                  (this[s.name] = e),
                  e._setControlNode(this),
                  s.action)
                ) {
                  case 1:
                    e.play(0, !1);
          ...
          (i.createComp = function (t, s, h, n) {
            if (!(s = s || i.getCompInstance(t)))
              return console.warn("can not create:" + t.type), null;
            var o = t.child;
            if (o)
              for (
                var l = s instanceof laya.ui.List, a = 0, c = o.length;
                a < c;
                a++
              ) {
                var u = o[a];
                if (
                  !s.hasOwnProperty("itemRender") ||
                  ("render" != u.props.name && "render" !== u.props.renderType)
                )
                  if ("Graphic" == u.type) r.addGraphicsToSprite(u, s);
                    ...
                    "Script" == u.type
                      ? "owner" in d
                        ? (d.owner = s)
                        : "target" in d && (d.target = s)
                      : "mask" == u.props.renderType || "mask" == u.props.name
                      ? (s.mask = d)
                      : d instanceof laya.display.Sprite && s.addChild(d);
                  }
                else s.itemRender = u;
              }
            var f = t.props;
            for (var p in f) {
              var g = f[p];
              i.eventDic[p]
                ? g && h && s.on(p, h, h.onEvent, [g])
                : i.setCompValue(s, p, g, h, n);
            }
            return (
              e.__typeof(s, "laya.ui.IItem") && s.initItems(),
              t.compId && h && h._idMap && (h._idMap[t.compId] = s),
              s
            );
          }),
          (i.setCompValue = function (t, s, h, o, l) {
            if ("string" == typeof h && h.indexOf("${") > -1) {
              if (
                (i._sheet || (i._sheet = r.getClass("laya.data.Table")),
                !i._sheet)
              )
              ...
              if (l) l.push(t, s, h);
                ...
                a.exe(o);
                for (
                  var c, u, _ = h.replace(/\[.*?\]\./g, ".");
                  null != (c = i._parseWatchData.exec(_));
                  ...
                  (p = o._watchMap[d] || (o._watchMap[d] = [])).push(a),
                    i._sheet.I.notifer.on(d, o, o.changeData, [d]);
                }
              }
          ...
          (i.getCompInstance = function (t) {
            var s,
              h = t.props ? t.props.runtime : null;
            return (
              (s = h
                ? i.viewClassMap[h] || i.uiClassMap[h] || e.__classmap[h]
                : i.uiClassMap[t.type]),
              t.props &&
        ...
        n(0, s, "dataSource", t.prototype._$get_dataSource, function (t) {
          (this._dataSource = t),
            "boolean" == typeof t
              ...
              : e.superSet(N, this, "dataSource", t);
        }),
        i
      );
    })(N),
      ...
      return (
        ...
        (e.addChildAt = function (t, i) {
          return (
            t.on("resize", this, this.onResize),
            this._setItemChanged(),
            laya.display.Node.prototype.addChildAt.call(this, t, i)
          );
        }),
          ...
          if (this._sources && this._valueArr) {
            ...
            if ((t = this._sources[0])) {
              ...
              if (this._width)
                switch (this._align) {
                  case "center":
                    e = 0.5 * (this._width - this._wordsW);
                    break;
                  case "right":
    ...
    U = (function (t) {
      ...
      var s = i.prototype;
      return (
        e.imps(s, { "laya.ui.IRender": !0, "laya.ui.IItem": !0 }),
        ...
        (s.onScrollStart = function () {
          this._$P.cacheAs ||
            (this._$P.cacheAs = e.superGet(H, this, "cacheAs")),
            e.superSet(H, this, "cacheAs", "none"),
          ...
          if (((this._cellChanged = !1), this._itemRender)) {
            ...
            this._width > 0 &&
              (this._repeatX2 = this._isVertical
                ? Math.round(this._width / i)
                : Math.ceil(this._width / i)),
              this._height > 0 &&
                (this._repeatY2 = this._isVertical
                  ? Math.ceil(this._height / e)
                  : Math.round(this._height / e));
            var s = this._width ? this._width : i * this.repeatX - this._spaceX,
              h = this._height ? this._height : e * this.repeatY - this._spaceY;
            (this._cellSize = this._isVertical ? e : i),
              (this._cellOffset = this._isVertical
                ? e * Math.max(this._repeatY2, this._repeatY) - h - this._spaceY
                : i * Math.max(this._repeatX2, this._repeatX) -
                  s -
                  this._spaceX),
        ...
        (s._createItems = function (t, i, e) {
          ...
          if (this.cacheContent) {
            ...
            (r.cacheAsBitmap = !0),
              r.pos(
                (this._isVertical ? 0 : t) * n,
                (this._isVertical ? t : 0) * o
              ),
          ...
          for (var u = t; u < e; u++)
            for (var _ = 0; _ < i; _++)
              ((h = l && l.length ? l.pop() : this.createItem()).x =
                (this._isVertical ? _ : u) * n - s.x),
                (h.y = (this._isVertical ? u : _) * o - s.y),
                (h.name = "item" + (u * i + _)),
                s.addChild(h),
                this.addCell(h);
        }),
        ...
        (s.setContentSize = function (t, i) {
          (this._content.width = t),
            (this._content.height = i),
            (this._scrollBar || 0 != this._offset.x || 0 != this._offset.y) &&
              (this._content.scrollRect || (this._content.scrollRect = new y()),
          ...
          e < 0 ||
            ("click" === t.type || "rightclick" === t.type
              ? this.selectEnable && !this._isMoved
                ...
                : this.changeCellState(i, !0, 0)
              : ("mouseover" !== t.type && "mouseout" !== t.type) ||
                this._selectedIndex === e ||
                this.changeCellState(i, "mouseover" === t.type, 0),
        ...
        (s.onScrollBarChange = function (t) {
          ...
          if (this.cacheContent)
            (o = s + 1),
              this._createdLine - h < o &&
                (this._createItems(this._createdLine, e, this._createdLine + o),
            ...
            for (var a = 0; a < o; a++) {
              if (r) {
                ...
                (c = this._cells.pop()), this._cells.unshift(c), (u = l - a);
          ...
          this._isVertical
            ? ((d.y = i - this._offset.y), (d.x = -this._offset.x))
            : ((d.y = -this._offset.y), (d.x = i - this._offset.x)),
        ...
        (s.renderItems = function (t, i) {
          ...
          for (var e = t, s = i || this._cells.length; e < s; e++)
            this.renderItem(this._cells[e], this._startIndex + e);
          this.changeSelectStatus();
        }),
        (s.renderItem = function (t, i) {
          this._array && i >= 0 && i < this._array.length
            ? ((t.visible = !0),
              t._$bindData
                ? ((t._dataSource = this._array[i]),
                  this._bindData(t, this._array[i]))
                : (t.dataSource = this._array[i]),
              this.cacheContent || this.posCell(t, i),
              this.hasListener("render") && this.event("render", [t, i]),
              this.renderHandler && this.renderHandler.runWith([t, i]))
        ...
        n(0, s, "height", t.prototype._$get_height, function (t) {
          t != this._height &&
            (e.superSet(H, this, "height", t), this._setCellChanged());
        }),
        n(
          0,
          s,
        ...
        n(0, s, "width", t.prototype._$get_width, function (t) {
          t != this._width &&
            (e.superSet(H, this, "width", t), this._setCellChanged());
        }),
        n(
          0,
          s,
        ...
        n(
          ...
          function (t) {
            ...
            if (
              ((this.totalPage = Math.ceil(i / (this.repeatX * this.repeatY))),
              (this._selectedIndex =
                this._selectedIndex < i ? this._selectedIndex : i - 1),
              (this.startIndex = this._startIndex),
              this._scrollBar)
            ) {
              ...
              (this._cellOffset > 0 ? this.totalPage + 1 : this.totalPage) > 1
                ? ((this._scrollBar.scrollSize = this._cellSize),
                  (this._scrollBar.thumbPercent = s / h),
                  this._scrollBar.setScroll(
                    0,
                    (h - s) * this._cellSize + this._cellOffset,
        ...
        n(0, s, "dataSource", t.prototype._$get_dataSource, function (t) {
          (this._dataSource = t),
            ("number" == typeof t && Math.floor(t) == t) || "string" == typeof t
              ...
              : t instanceof Array
              ? (this.array = t)
              : e.superSet(H, this, "dataSource", t);
        }),
      ...
      return (
        ...
        (s.removeChildren = function (t, i) {
          return (
            ...
            this._content.removeChildren(t, i),
            this._setScrollChanged(),
            this
          );
        }),
        ...
        (s.changeScroll = function () {
          ...
          e &&
            ((e.x = this._width - e.width),
            (e.y = 0),
            (e.height = this._height - (n ? s.height : 0)),
            (e.scrollSize = Math.max(0.033 * this._height, 1)),
            (e.thumbPercent = r / i),
            e.setScroll(0, i - r, e.value)),
            s &&
              ((s.x = 0),
              (s.y = this._height - s.height),
              (s.width = this._width - (h ? e.width : 0)),
              (s.scrollSize = Math.max(0.033 * this._width, 1)),
              (s.thumbPercent = o / t),
              s.setScroll(0, t - o, s.value));
        }),
        (s.changeSize = function () {
          laya.ui.Component.prototype.changeSize.call(this),
        ...
        (s.setContentSize = function (t, i) {
          ...
          (e.width = t),
            (e.height = i),
            e.scrollRect || (e.scrollRect = new y()),
            e.scrollRect.setTo(0, 0, t, i),
        ...
        (s.scrollTo = function (t, i) {
          void 0 === t && (t = 0),
            void 0 === i && (i = 0),
            this.vScrollBar && (this.vScrollBar.value = i),
      ...
      return (
        ...
        (s.addItem = function (t, i) {
          ...
          if (
            ...
            "horizontal" == this._direction
              ? (e.x = h.x + h.width + this._space)
              : (e.y = h.y + h.height + this._space);
          } else i && ((e.x = 0), (e.y = 0));
          return s;
        }),
          ...
          if (-1 != e) {
            ...
            for (var h = e + 1, n = this._items.length; h < n; h++) {
              ...
              (o.name = "item" + (h - 1)),
                i &&
                  ("horizontal" == this._direction
                    ? (o.x -= s.width + this._space)
                    : (o.y -= s.height + this._space));
            }
        ...
        (s.initItems = function () {
          ...
          for (var t = 0; t < 1e4; t++) {
            ...
            if (null == i) break;
            this._items.push(i),
              (i.selected = t === this._selectedIndex),
              (i.clickHandler = f.create(this, this.itemClick, [t], !1));
          }
        }),
            ...
            for (var t = 0, i = 0, e = this._items.length; i < e; i++) {
              ...
              this._skin && (s.skin = this._skin),
                ...
                this._labelStrokeColor &&
                  (s.labelStrokeColor = this._labelStrokeColor),
                ...
                "horizontal" === this._direction
                  ? ((s.y = 0), (s.x = t), (t += s.width + this._space))
          ...
          function (t) {
            if (this._labels != t) {
              if (
                ...
                for (
                  var i = this._labels.split(","), e = 0, s = i.length;
                  e < s;
                  e++
                ) {
    ...
    Q = (function (t) {
      ...
      return (
        ...
        (s.createChildren = function () {
          this.addChild((this._list = new U())),
          ...
          for (var e in this._source)
            (t = this._source[e]),
              this.getParentOpenStatus(t) &&
                ((t.x = this._spaceLeft * this.getDepth(t)), i.push(t));
          return i;
        }),
        (s.getDepth = function (t, i) {
          return (
            void 0 === i && (i = 0),
            null == t.nodeParent ? i : this.getDepth(t.nodeParent, i + 1)
          );
        }),
        (s.getParentOpenStatus = function (t) {
          ...
          return (
            null == i ||
            (!!i.isOpen &&
              (null == i.nodeParent || this.getParentOpenStatus(i)))
          );
        }),
        (s.renderItem = function (t, i) {
          var e = t.dataSource;
          if (e) {
            ...
            s &&
              (e.hasChild
                ? ((s.visible = !0),
                  (s.index = e.isOpen ? 1 : 0),
                  (s.tag = i),
                  s.off("click", this, this.onArrowClick),
                  s.on("click", this, this.onArrowClick))
                : (s.visible = !1));
            var h = t.getChildByName("folder");
            h &&
              (2 == h.clipY
                ? (h.index = e.isDirectory ? 0 : 1)
                : (h.index = e.isDirectory ? (e.isOpen ? 1 : 0) : 2)),
        ...
        (s.isSameParent = function (t, i) {
          return (
            (null == t.nodeParent && null == i.nodeParent) ||
            (null != t.nodeParent &&
              null != i.nodeParent &&
              t.nodeParent.label == i.nodeParent.label &&
              this.isSameParent(t.nodeParent, i.nodeParent))
          );
        }),
        (s.filter = function (t) {
          if (Boolean(t)) {
        ...
        (s.getFilterSource = function (t, i, e) {
          ...
          for (var h in t)
            !(s = t[h]).isDirectory &&
              String(s.label).toLowerCase().indexOf(e) > -1 &&
              ((s.x = 0), i.push(s)),
              s.child &&
                s.child.length > 0 &&
                this.getFilterSource(s.child, i, e);
        }),
        n(
          0,
          s,
      ...
      return (
        ...
        n(
          ...
          function (t) {
            this._skin != t &&
              ((this._skin = t),
              this._bg || (this.graphics = this._bg = new z()),
              (this._bg.source = g.getRes(this._skin)),
    ...
    ht = (function (t) {
      ...
      return (
        (s.initialize = function () {
          (this.popupEffect = i.manager.popupEffectHandler),
            (this.closeEffect = i.manager.closeEffectHandler),
            this._dealDragArea(),
        ...
        (s._dealDragArea = function () {
          ...
          t &&
            ((this.dragArea = t.x + "," + t.y + "," + t.width + "," + t.height),
            t.removeSelf());
        }),
        ...
        (s._onMouseDown = function (t) {
          ...
          this._dragArea.contains(i.x, i.y)
            ? this.startDrag()
            : this.stopDrag();
        }),
        n(
          ...
          function (t) {
            if (t) {
              ...
              (this._dragArea = new y(i[0], i[1], i[2], i[3])),
        ...
        (s.changeItems = function () {
          ...
          for (var t = [], i = 0, e = 0, s = this.numChildren; e < s; e++) {
            ...
            h &&
              ...
              (i = this._height
                ? this._height
                : Math.max(i, h.height * h.scaleY)));
          }
          this.sortItem(t);
          var n = 0;
          for (e = 0, s = t.length; e < s; e++)
            ((h = t[e]).x = n),
              (n += h.width * h.scaleX + this._space),
              "top" == this._align
                ? (h.y = 0)
                : "middle" == this._align
                ? (h.y = 0.5 * (i - h.height * h.scaleY))
                : "bottom" == this._align && (h.y = i - h.height * h.scaleY);
          this.changeSize();
        }),
        n(0, s, "height", t.prototype._$get_height, function (t) {
          this._height != t &&
            (e.superSet($, this, "height", t),
        ...
        (s.changeItems = function () {
          ...
          for (var t = [], i = 0, e = 0, s = this.numChildren; e < s; e++) {
            ...
            h &&
              ...
              (i = this._width
                ? this._width
                : Math.max(i, h.width * h.scaleX)));
          }
          this.sortItem(t);
          var n = 0;
          for (e = 0, s = t.length; e < s; e++)
            ((h = t[e]).y = n),
              (n += h.height * h.scaleY + this._space),
              "left" == this._align
                ? (h.x = 0)
                : "center" == this._align
                ? (h.x = 0.5 * (i - h.width * h.scaleX))
                : "right" == this._align && (h.x = i - h.width * h.scaleX);
          this.changeSize();
        }),
        n(0, s, "width", t.prototype._$get_width, function (t) {
          this._width != t &&
            (e.superSet($, this, "width", t), this.callLater(this.changeItems));
        }),
        (i.NONE = "none"),
        (i.LEFT = "left"),
        (i.CENTER = "center"),
    ...
    rt = (function (t) {
      ...
      return (
        (i.prototype.createItem = function (t, i) {
          return new J(t, i);
        }),
        i
      );
      ...
      return (
        ...
        (s.changeScroll = function () {
          ...
          (this._tf.width = e),
            ...
            this._vScrollBar &&
              ((this._vScrollBar.x =
                this._width - this._vScrollBar.width - h[2]),
              (this._vScrollBar.y = h[1]),
              (this._vScrollBar.height =
                this._height - (i ? this._hScrollBar.height : 0) - h[1] - h[3]),
              (this._vScrollBar.scrollSize = 1),
              (this._vScrollBar.thumbPercent =
                s / Math.max(this._tf.textHeight, s)),
            ...
            this._hScrollBar &&
              ((this._hScrollBar.x = h[0]),
              (this._hScrollBar.y =
                this._height - this._hScrollBar.height - h[3]),
              (this._hScrollBar.width =
                this._width - (t ? this._vScrollBar.width : 0) - h[0] - h[2]),
              (this._hScrollBar.scrollSize = Math.max(0.033 * e, 1)),
              (this._hScrollBar.thumbPercent =
                e / Math.max(this._tf.textWidth, e)),
              this._hScrollBar.setScroll(0, this.maxScrollX, this.scrollX),
              (this._hScrollBar.visible = i));
        }),
        (s.scrollTo = function (t) {
        ...
        n(
          ...
          function (t) {
            null == this._vScrollBar &&
              (this.addChild((this._vScrollBar = new it())),
        ...
        n(
          ...
          function (t) {
            null == this._hScrollBar &&
              (this.addChild((this._hScrollBar = new j())),
  ...
  "function" == typeof define &&
    define.amd &&
    define("laya.core", ["require", "exports"], function (t, i) {
      "use strict";
