!(function (t, e, i) {
  ...
  var O = (function () {
    ...
    U = (function () {
      ...
      return (
        ...
        (r.addTex = function (t, e, i) {
          ...
          return 0 == r.ret
            ? r
            : (this._fill(r.x, r.y, e, i, t), this._texCount++, r);
        }),
        (r._release = function () {
          null != this._cells &&
        ...
        (r._fill = function (t, e, i, r, s) {
          ...
          for (var h = e; h < r + e; ++h) {
            this._check(this._rowInfo[h].spaceCount >= i),
              (this._rowInfo[h].spaceCount -= i);
            for (var l = 0; l < i; l++) {
              var o = 3 * (t + h * a + l);
              this._check(0 == this._cells[o]),
                (this._cells[o] = s),
                (this._cells[o + 1] = i),
                (this._cells[o + 2] = r);
            }
          ...
          if (t > 0)
            for (h = 0; h < r; ++h) {
              ...
              for (
                l = t - 1;
                l >= 0 && 0 == this._cells[3 * ((e + h) * a + l)];
                --l, ++u
              );
              for (l = u; l > 0; --l)
                (this._cells[3 * ((e + h) * a + t - l) + 1] = l),
                  this._check(l > 0);
            }
          if (e > 0)
            for (l = t; l < t + i; ++l) {
              for (
                u = 0, h = e - 1;
                h >= 0 && 0 == this._cells[3 * (l + h * a)];
                --h, u++
              );
              for (h = u; h > 0; --h)
                (this._cells[3 * (l + (e - h) * a) + 2] = h),
                  this._check(h > 0);
            }
        }),
        (r._check = function (t) {
        ...
        (r._clear = function () {
          ...
          for (var e = 0; e < this._height; e++)
            for (var i = 0; i < this._width; i++) {
              ...
              (this._cells[r] = 0),
                (this._cells[r + 1] = this._width - i),
                (this._cells[r + 2] = this._width - e);
            }
    ...
    k = (function () {
      ...
      var e = t.prototype;
      return (
        (e.setAtlasParam = function (e, i, r, s) {
        ...
        (e.pushData = function (e) {
          var i = e.bitmap,
            ...
            h = 0;
          for (
            a = 0, n = this._atlaserArray.length;
            a < n &&
            ((h = (this._curAtlasIndex + a) % n),
            (s = this._atlaserArray[h]),
            -1 == (r = s.findBitmapIsExist(i)));
            a++
          );
          if (-1 != r) {
          ...
          this._setAtlasParam = !1;
          for (
            var o = Math.ceil((e.bitmap.width + 2) / this._gridSize),
            ...
            for (a = 0; a < f; a++) {
              (h = (this._curAtlasIndex + a) % f),
                this._atlaserArray.length - 1 >= h ||
              ...
              var d = this._atlaserArray[h],
                ...
                g = d.addTex(1, o, u);
              if (g.ret) {
                (m = g.x * this._gridSize + 1),
                  (p = g.y * this._gridSize + 1),
                  (i.lock = !0),
                  d.addToAtlasTexture(i, m, p),
                  d.addToAtlas(e, m, p),
                  (_ = !0),
                  (this._curAtlasIndex = h);
                break;
              }
            }
            if (_) break;
        ...
        (e.garbageCollection = function () {
          if (!0 === this._needGC) {
            for (
              var t = this._atlaserArray.length - this._maxAtlaserCount, e = 0;
              e < t;
              e++
            )
    ...
    G = (function () {
      function t() {}
      return (
        s(t, "laya.webgl.canvas.BlendMode"),
        (t._init_ = function (e) {
          (t.fns = [
            t.BlendNormal,
            t.BlendAdd,
    ...
    W = (function () {
      ...
      return (
        ...
        (e.polygon = function (t, e, i, r, s, a) {
          ...
          return (
            this.geomatrys.push(
              (this._curGeomatry = n = new Lt(t, e, i, r, s, a))
            ),
            r || (n.fill = !1),
            void 0 == a && (n.borderWidth = 0),
            n
          );
        }),
        ...
        (e.drawLine = function (t, e, i, r, s) {
          ...
          return (
            this.closePath
              ? this.geomatrys.push(
                  (this._curGeomatry = a = new Ct(t, e, i, r, s))
                )
              : this.geomatrys.push(
                  (this._curGeomatry = a = new Mt(t, e, i, r, s))
                ),
            (a.fill = !1),
            a
          );
        ...
        (e.update = function () {
          ...
          (this.geoStart = e),
            (this.count = (this.ib._byteLength - t) / mt.BYTES_PIDX);
        }),
        (e.reset = function () {
          this.vb.clear(),
            this.ib.clear(),
      ...
      return (
        ...
        (t.save = function (e, i, r, s) {
          if ((e._saveMark._saveuse & i) !== i) {
            ...
            (n._value = r[(n._valueName = t._namemap[i])]),
              (n._dataObj = r),
              (n._newSubmit = s);
            var h = e._save;
            h[h._length++] = n;
      ...
      return (
        ...
        (t.save = function (e, i) {
          if (131072 != (131072 & e._saveMark._saveuse)) {
            ...
            (s._clipSaveRect = e._clipRect),
              (e._clipRect = s._clipRect.copyFrom(e._clipRect)),
              (s._submitScissor = i);
            var a = e._save;
            a[a._length++] = s;
          }
      ...
      return (
        ...
        (t.save = function (e) {
          ...
          if (2048 != (2048 & i._saveuse)) {
            ...
            var r = t._no,
              s = r._length > 0 ? r[--r._length] : new t();
            (s._savematrix = e._curMat),
              (e._curMat = e._curMat.copyTo(s._matrix));
            var a = e._save;
            a[a._length++] = s;
          }
        }),
      ...
      return (
        ...
        (e._flushToTarget = function (t, e) {
          if (!e._destroy) {
            ...
            if (
              ((vt.worldMatrix = b.EMPTY),
              vt.restoreTempArray(),
              (vt.worldMatrix4 = vt.TEMPMAT4_ARRAY),
              (vt.worldAlpha = 1),
              (vt.worldFilters = null),
              (vt.worldShaderDefines = null),
              (Bt.activeShader = null),
              e.start(),
              f.showCanvasMark ? e.clear(0, 1, 0, 0.3) : e.clear(0, 0, 0, 0),
              t.flush(),
              e.end(),
              (Bt.activeShader = null),
              (vt.worldAlpha = s),
              ...
              (vt.worldMatrix = n),
              (vt.worldFilters = h),
              (vt.worldShaderDefines = l),
              (vt.worldScissorTest = i),
              i)
            ) {
              var o = vt.height - r.y - r.height;
              bt.mainContext.scissor(r.x, o, r.width, r.height),
      ...
      return (
        (e.init = function (e, i, r) {
          if (i) this._vs = i;
            ...
            this._vs.push(0, 0, 0, 0, 1, 1, 1, 1),
              this._vs.push(s, 0, 1, 0, 1, 1, 1, 1),
              this._vs.push(s, a, 1, 1, 1, 1, 1, 1),
        ...
        (e.init2 = function (t, e, i, r, s) {
          this.transform && (this.transform = null),
            ...
            (this.mEleNum = this._ps.length),
            (this.mTexture = t),
            (A.isConchNode || A.isConchApp) &&
              (this._initMyData(), (this.mVBData = new Float32Array(this._vs)));
        }),
        (e._initMyData = function () {
          ...
          if (
            (A.isConchNode || A.isConchApp
              ? ((this._vs.length = r), (s = !0))
              : this._vs.length < r && ((this._vs.length = r), (s = !0)),
            (t._tVSLen = r),
            s)
          )
            for (; e < r; )
        ...
        (e.getData2 = function (e, i, r) {
          ...
          var s;
          (s = t._tempIB).length < this._ps.length &&
            (s.length = this._ps.length);
          for (var a = 0, n = this._ps.length; a < n; a++)
            s[a] = this._ps[a] + r;
        ...
        (e.render = function (t, e, i) {
          if (A.isWebGL && this.mTexture) {
            ...
            vt.mat2MatArray(this._tempMatrix, a),
              ...
              (t._submits[t._submits._length++] = r);
          } else
            A.isConchApp &&
              this.mTexture &&
              (this.transform || (this.transform = b.EMPTY),
    ...
    it = (function () {
      ...
      return (
        ...
        (e.sector = function (t, e, i) {
          ...
          for (var f = 0; f < a + 1; f++)
            t.push(
              r + Math.sin(n * f + this.r0) * h,
              s + Math.cos(n * f + this.r0) * l
            ),
              t.push(u, _, c);
        ...
        (e.createLine2 = function (t, e, i, r, s, a) {
          ...
          (l = w[0]),
            ...
            (m = l - (u = w[2])),
            (d =
              ((d = -(o - (_ = w[3]))) / (S = Math.sqrt(d * d + m * m))) * F),
            (m = (m / S) * F),
            R.push(
              l - d + this.x,
              o - m + this.y,
          ...
          for (var B = 1; B < P - 1; B++)
            (l = w[2 * (B - 1)]),
              ...
              (g = u - c),
              (b =
                (-(d = ((d = -(o - _)) / (S = Math.sqrt(d * d + m * m))) * F) +
                  l) *
                  (-(m = (m / S) * F) + _) -
                (-d + u) * (-m + o)),
              (A =
                (-(p = ((p = -(_ - f)) / (S = Math.sqrt(p * p + g * g))) * F) +
                  c) *
                  (-(g = (g / S) * F) + _) -
                (-p + u) * (-g + f)),
              (E =
        ...
        (e.createLine = function (t, e, i, r) {
          ...
          (c = s[0]),
            ...
            (x = c - (d = s[5])),
            (v =
              ((v = -(f - (m = s[6]))) / (M = Math.sqrt(v * v + x * x))) * P),
            (x = (x / M) * P),
            a.push(c - v, f - x, h, l, o, c + v, f + x, h, l, o);
          for (var D = 1; D < C - 1; D++)
            (c = s[5 * (D - 1)]),
              (f = s[5 * (D - 1) + 1]),
              (d = s[5 * D]),
              ...
              (y = d - p),
              (E =
                (-(v = ((v = -(f - m)) / (M = Math.sqrt(v * v + x * x))) * P) +
                  c) *
                  (-(x = (x / M) * P) + m) -
                (-v + d) * (-x + f)),
              (R =
                (-(b = ((b = -(m - g)) / (M = Math.sqrt(b * b + y * y))) * P) +
                  p) *
                  (-(y = (y / M) * P) + m) -
                (-b + d) * (-y + g)),
              (I =
              ...
              Math.abs(I) < 0.1
                ? ((I += 10.1),
                  a.push(d - v, m - x, h, l, o, d + v, m + x, h, l, o))
                : (((u = (A * R - w * E) / I) - d) * (u - d) +
                    ((_ = (S * E - T * R) / I) - m) +
                    (_ - m),
                  a.push(u, _, h, l, o, d - (u - d), m - (_ - m), h, l, o));
          (c = s[s.length - 10]),
            (f = s[s.length - 9]),
            (x = c - (d = s[s.length - 5])),
            (v =
        ...
        (e.createLoopLine = function (t, e, i, r, s, a) {
          ...
          (v = n[0]),
            ...
            (S = v - (b = n[5])),
            (E =
              ((E = -(x - (y = n[6]))) / (B = Math.sqrt(E * E + S * S))) * V),
            (S = (S / B) * V),
            h.push(v - E, x - S, o, u, _, v + E, x + S, o, u, _);
          for (var U = 1; U < N - 1; U++)
            (v = n[5 * (U - 1)]),
              (x = n[5 * (U - 1) + 1]),
              (b = n[5 * U]),
              ...
              (R = b - T),
              (C =
                (-(E = ((E = -(x - y)) / (B = Math.sqrt(E * E + S * S))) * V) +
                  v) *
                  (-(S = (S / B) * V) + y) -
                (-E + b) * (-S + x)),
              (D =
                (-(w = ((w = -(y - A)) / (B = Math.sqrt(w * w + R * R))) * V) +
                  T) *
                  (-(R = (R / B) * V) + y) -
                (-w + b) * (-R + A)),
              (F =
              ...
              Math.abs(F) < 0.1
                ? ((F += 10.1),
                  h.push(b - E, y - S, o, u, _, b + E, y + S, o, u, _))
                : (((p = (M * D - P * C) / F) - b) * (p - b) +
                    ((g = (L * C - I * D) / F) - y) +
                    (g - y),
                  h.push(p, g, o, u, _, b - (p - b), y - (g - y), o, u, _));
          a && (e = a);
          var k = this.edges + 1;
          for (U = 1; U < k; U++)
            e.push(
    ...
    rt = (function () {
      function t() {}
      return (
        s(t, "laya.webgl.shapes.Earcut"),
        (t.earcut = function (e, i, r) {
          r = r || 2;
          var s = i && i.length,
            a = s ? i[0] * r : e.length,
        ...
        (t.filterPoints = function (e, i) {
          ...
          do {
            if (
              ((r = !1),
              s.steiner ||
                (!t.equals(s, s.next) && 0 !== t.area(s.prev, s, s.next)))
            )
              s = s.next;
            else {
          ...
          if (e) {
            ...
            for (var l, o, u = e; e.prev !== e.next; )
              if (
                ((l = e.prev),
                (o = e.next),
                n ? t.isEarHashed(e, s, a, n) : t.isEar(e))
              )
                i.push(l.i / r),
                  i.push(e.i / r),
                  i.push(o.i / r),
                ...
                h
                  ? 1 === h
                    ? ((e = t.cureLocalIntersections(e, i, r)),
                      t.earcutLinked(e, i, r, s, a, n, 2))
                    : 2 === h && t.splitEarcut(e, i, r, s, a, n)
                  : t.earcutLinked(t.filterPoints(e, null), i, r, s, a, n, 1);
                break;
              }
          }
        }),
        (t.isEar = function (e) {
          ...
          for (var a = e.next.next; a !== e.prev; ) {
            if (
              t.pointInTriangle(i.x, i.y, r.x, r.y, s.x, s.y, a.x, a.y) &&
              t.area(a.prev, a, a.next) >= 0
            )
              return !1;
            a = a.next;
          }
        ...
        (t.isEarHashed = function (e, i, r, s) {
          ...
          for (
            var l = a.x < n.x ? (a.x < h.x ? a.x : h.x) : n.x < h.x ? n.x : h.x,
              o = a.y < n.y ? (a.y < h.y ? a.y : h.y) : n.y < h.y ? n.y : h.y,
              u = a.x > n.x ? (a.x > h.x ? a.x : h.x) : n.x > h.x ? n.x : h.x,
              _ = a.y > n.y ? (a.y > h.y ? a.y : h.y) : n.y > h.y ? n.y : h.y,
              c = t.zOrder(l, o, i, r, s),
              f = t.zOrder(u, _, i, r, s),
              d = e.nextZ;
            d && d.z <= f;
            ...
            if (
              d !== e.prev &&
              d !== e.next &&
              t.pointInTriangle(a.x, a.y, n.x, n.y, h.x, h.y, d.x, d.y) &&
              t.area(d.prev, d, d.next) >= 0
            )
              return !1;
            d = d.nextZ;
          }
            ...
            for (var l = h.next.next; l !== h.prev; ) {
              if (h.i !== l.i && t.isValidDiagonal(h, l)) {
                ...
                return (
                  ...
                  t.earcutLinked(h, i, r, s, a, n),
                  void t.earcutLinked(o, i, r, s, a, n)
                );
              }
              l = l.next;
            }
        ...
        (t.eliminateHoles = function (e, i, r, s) {
          ...
          for (a = 0, n = i.length; a < n; a++)
            (h = i[a] * s),
              (l = a < n - 1 ? i[a + 1] * s : e.length),
              (o = t.linkedList(e, h, l, s, !1)) === o.next && (o.steiner = !0),
              u.push(t.getLeftmost(o));
        ...
        (t.indexCurve = function (e, i, r, s) {
          var a = e;
          do {
            null === a.z && (a.z = t.zOrder(a.x, a.y, i, r, s)),
              (a.prevZ = a.prev),
              (a.nextZ = a.next),
              (a = a.next);
          } while (a !== e);
        ...
        (t.intersects = function (e, i, r, s) {
          return (
            !!(
              (t.equals(e, i) && t.equals(r, s)) ||
              (t.equals(e, s) && t.equals(r, i))
            ) ||
            (t.area(e, i, r) > 0 != t.area(e, i, s) > 0 &&
              t.area(r, s, e) > 0 != t.area(r, s, i) > 0)
          );
        }),
      ...
      (function () {
        ...
        return (
          ...
          (e.renderSubmit = function () {
            ...
            return (
              ...
              G.activeBlendFunction !== this._blendFn &&
                ...
                (G.activeBlendFunction = this._blendFn)),
              C.drawCall++,
              (C.trianglesFaces += this._numEle / 3),
          ...
          (t.createSubmit = function (e, i, r, s, a) {
            ...
            null == r &&
              ((r = n._selfVb || (n._selfVb = Jt.create(-1))).clear(), (s = 0)),
              (n._ib = i),
              (n._vb = r),
              (n._startIdx = s * mt.BYTES_PIDX),
              (n._numEle = 0);
            var h = e._nBlendType;
            (n._blendFn = e._targets ? G.targetFns[h] : G.fns[h]),
              (n.shaderValue = a),
              n.shaderValue.setValue(e._shader2D);
          ...
          (t.createShape = function (e, i, r, s, a, n) {
            ...
            (h._ib = i),
              ...
              (h._startIdx = a),
              (h.shaderValue = n),
              h.shaderValue.setValue(e._shader2D);
            var l = e._nBlendType;
      ...
      return (
        ...
        (e.renderSubmit = function () {
          ...
          return (
            ...
            C.drawCall++,
            (C.trianglesFaces += this._numEle / 3),
            n.drawElements(4, this._numEle, 5123, this.startIndex),
            (vt.worldMatrix4 = r),
            (Bt.activeShader = null),
            1
          );
        ...
        (t.create = function (e, i, r, s, a, n, h, l, o) {
          ...
          switch (((u._blendFn = e._targets ? G.targetFns[_] : G.fns[_]), o)) {
            case 0:
              (u.offset = 0),
                (u.startIndex = (l / (mt.BYTES_PE * i.vertexStride)) * 1.5),
                (u.startIndex *= mt.BYTES_PIDX);
              break;
            case 1:
      ...
      return (
        ...
        (e._scissor = function (t, e, i, r) {
          ...
          if (
            ((t = Math.max(t, o.x)),
            (e = Math.max(e, o.y)),
            (i = Math.min(h, o.right) - t),
            (r = Math.min(l, o.bottom) - e),
            i < 1 || r < 1)
          )
            return !1;
          var u = vt.worldScissorTest;
          return (
            this.screenRect.copyFrom(o),
            (o.x = t),
            (o.y = e),
            (o.width = i),
            (o.height = r),
            ...
            (e = vt.height - e - r),
            bt.mainContext.scissor(t, e, i, r),
            bt.mainContext.enable(3089),
            ...
            u
              ? ((e = vt.height - this.screenRect.y - this.screenRect.height),
                ...
                bt.mainContext.enable(3089))
              : (bt.mainContext.disable(3089), (vt.worldScissorTest = !1)),
            o.copyFrom(this.screenRect),
            !0
          );
        }),
        (e._scissorWithTagart = function (t, e, i, r) {
          ...
          if (
            ((t = Math.max(t, n.x)),
            (e = Math.max(e, n.y)),
            (i = Math.min(s, n.right) - t),
            (r = Math.min(a, n.bottom) - e),
            i < 1 || r < 1)
          )
            return !1;
          var h = vt.worldScissorTest;
          return (
            this.screenRect.copyFrom(n),
            (vt.worldScissorTest = !0),
            (n.x = t),
            (n.y = e),
            (n.width = i),
        ...
        (t.restore = function (e, i, r, s, a) {
          ...
          if (((e._renderKey = 0), t._mask > 0 && t._mask--, 0 == t._mask))
            ...
            if (
              ...
              var l = (e._curSubmit = at.createSubmit(
                e,
                e._ib,
                h,
      ...
      return (
        ...
        (t.create = function (e, i, r, s, a, n) {
          ...
          return (
            ...
            (h._vb = r),
            (h.proName = n),
            (h._startIdx = s * mt.BYTES_PIDX),
            (h._numEle = 0),
            (h.blendType = e._nBlendType),
            (h.shaderValue = a),
            h.shaderValue.setValue(e._shader2D),
            h
          );
      ...
      return (
        ...
        (t._drawSlow = function (e, i, r, s, a, n, h, l, o, u, _, c, f, d, m) {
          var p,
            ...
            A = NaN;
          if (s)
            for (y.length = s.length, x = 0, b = s.length; x < b; x++)
              (A = (g = s[x]).charNum + v.txtID),
                (y[x] = p = t._charsCache[A] || t.getChar(g.char, A, v)),
                p.active();
          else {
            ...
            if (D.CharacterCache) {
              ...
              for (y.length = S, x = 0, b = S; x < b; x++)
                (A = t._charSeg.getCharCode(x) + v.txtID),
                  (y[x] = p =
                    t._charsCache[A] || t.getChar(t._charSeg.getChar(x), A, v)),
                  p.active(),
                  (T += p.cw);
            } else
              (y.length = 0),
                (p = t.getChar(E, -1, v)).active(),
                (T += p.cw),
                (y[0] = p);
          }
          var w = 0;
            ...
            if (s) t._drawSlow(null, e, r, s, a, n, h, l, o, u, _, c, m, p, d);
              ...
              if (null === r.toUpperCase) {
                ...
                return void (T.changed || T.id !== y
                  ...
                  : t._drawFast(T.save, e, a, _, c));
              }
              var A = r + n.toString() + l + o + u + m + p + h,
                E = t._textsCache[A];
              D.CharacterCache
                ? E
                  ? t._drawFast(E, e, a, _, c)
                  : (t._textsCache.__length || (t._textsCache.__length = 0),
                    t._textsCache.__length > f.WebGLTextCacheCount &&
                    ...
                    t._curPoolIndex++,
                    t._drawSlow(E, e, r, s, a, n, h, l, o, u, _, c, m, p, d))
                : t._drawSlow(E, e, r, s, a, n, h, l, o, u, _, c, m, p, d);
            }
          }
        }),
        ...
        (t.__init$ = function () {
          e = (function () {
            ...
            s(t, "");
            return (
              (t.prototype.value = function (e, i, r, s, a, n, h) {
                (this.font = e),
                  (this.fillColor = i),
                  (this.borderColor = r),
                  (this.lineWidth = s),
    ...
    mt = (function () {
      function t() {}
      return (
        s(t, "laya.webgl.utils.CONST3D2D"),
    ...
    pt = (function () {
      ...
      return (
        ...
        (t.fillIBQuadrangle = function (t, e) {
          ...
          for (var i = t.getUint16Array(), r = 0, s = 0; s < e; s++)
            (i[r++] = 4 * s),
              (i[r++] = 4 * s + 2),
              (i[r++] = 4 * s + 1),
              (i[r++] = 4 * s),
        ...
        (t.fillQuadrangleImgVb = function (t, e, i, r, s, a, n, h) {
          ...
          if (1 !== u || 0 !== _ || 0 !== c || 1 !== f) {
            ...
            var d = a.tx + n,
              m = a.ty + h;
            (o[l] = (r[0] + e) * u + (r[1] + i) * c + d),
              (o[l + 1] = (r[0] + e) * _ + (r[1] + i) * f + m),
              (o[l + 4] = (r[2] + e) * u + (r[3] + i) * c + d),
              (o[l + 5] = (r[2] + e) * _ + (r[3] + i) * f + m),
              (o[l + 8] = (r[4] + e) * u + (r[5] + i) * c + d),
              (o[l + 9] = (r[4] + e) * _ + (r[5] + i) * f + m),
              (o[l + 12] = (r[6] + e) * u + (r[7] + i) * c + d),
              (o[l + 13] = (r[6] + e) * _ + (r[7] + i) * f + m);
          } else
            (a.bTransform = !1),
              (e += a.tx + n),
              (i += a.ty + h),
        ...
        (t.fillTranglesVB = function (t, e, i, r, s, a, n) {
          ...
          h -= r.length;
          for (
            var o = r.length, u = s.a, _ = s.b, c = s.c, f = s.d, d = 0;
            d < o;
            d += 4
          )
            if (
              ...
              var m = s.tx + a,
                p = s.ty + n;
              (l[h + d] = (r[d] + e) * u + (r[d + 1] + i) * c + m),
                (l[h + d + 1] = (r[d] + e) * _ + (r[d + 1] + i) * f + p);
            } else
              (s.bTransform = !1),
                (e += s.tx + a),
                (i += s.ty + n),
        ...
        (t.copyPreImgVb = function (t, e, i) {
          ...
          t.byteLength = (r + 16) << 2;
          for (var s = t.getFloat32Array(), a = 0, n = r - 16; a < 4; a++)
            (s[r] = s[n] + e),
              ++n,
              (s[++r] = s[n] + i),
              ++n,
          ...
          if (
            (1 !== C || 0 !== L || 0 !== P || 1 !== D
              ...
              : ((M = 23),
                ...
                (m = (f = i + h.tx + l) + s),
                (p = (d = r + h.ty + o) + a)),
            F && ((g = e.x), (v = e.y), (x = e.width + g), (b = e.height + v)),
            1 !== M)
          ) {
    ...
    gt =
      ((function () {
        function t() {}
        s(t, "laya.webgl.utils.MatirxArray"),
          (t.ArrayMul = function (e, i, r) {
            if (e)
              if (i)
                for (var s = NaN, a = NaN, n = NaN, h = NaN, l = 0; l < 4; l++)
                  (s = e[l]),
                    (a = e[l + 4]),
                    (n = e[l + 8]),
                    (h = e[l + 12]),
                    (r[l] = s * i[0] + a * i[1] + n * i[2] + h * i[3]),
                    (r[l + 4] = s * i[4] + a * i[5] + n * i[6] + h * i[7]),
                    (r[l + 8] = s * i[8] + a * i[9] + n * i[10] + h * i[11]),
                    (r[l + 12] = s * i[12] + a * i[13] + n * i[14] + h * i[15]);
      ...
      (function () {
        ...
        return (
          ...
          (e.createQuadIB = function (t) {
            ...
            for (
              var e = this._ib.getUint16Array(), i = 0, r = 0, s = 0;
              s < t;
              s++
            )
              (e[i++] = r),
    ...
    vt = (function () {
      function t() {}
      return (
        s(t, "laya.webgl.utils.RenderState2D"),
        ...
        (t.mat2MatArray = function (e, i) {
          ...
          return (
            (s[0] = r.a),
            (s[1] = r.b),
            (s[2] = t.EMPTYMAT4_ARRAY[2]),
            (s[3] = t.EMPTYMAT4_ARRAY[3]),
            (s[4] = r.c),
            (s[5] = r.d),
            (s[6] = t.EMPTYMAT4_ARRAY[6]),
            (s[7] = t.EMPTYMAT4_ARRAY[7]),
            (s[8] = t.EMPTYMAT4_ARRAY[8]),
            (s[9] = t.EMPTYMAT4_ARRAY[9]),
            (s[10] = t.EMPTYMAT4_ARRAY[10]),
            (s[11] = t.EMPTYMAT4_ARRAY[11]),
            (s[12] = r.tx),
            (s[13] = r.ty),
            (s[14] = t.EMPTYMAT4_ARRAY[14]),
            (s[15] = t.EMPTYMAT4_ARRAY[15]),
            i
          );
        }),
    ...
    xt = (function () {
      ...
      var a = t.prototype;
      return (
        (a._compileToTree = function (i, r, s, a, n) {
          var h,
            l,
            o,
            u,
              ...
              if (
                ...
                switch (((h.name = u), u)) {
                  ...
                  case "#ifndef":
                    if (
                      ((h.src = o),
                      (h.noCompile = null != o.match(/[!&|()=<>]/)),
                      h.noCompile
                        ? console.log(
                            "function():Boolean{return " +
                              o.substr(d + h.name.length) +
                              "}"
                          )
                        : ((c = o.replace(/^\s*/, "").split(/\s+/)),
                          h.setCondition(c[1], "#ifdef" === u ? 1 : 2),
                          (h.text = "//" + h.text)),
                      h.setParent(i),
                      (i = h),
                      n)
                      ...
                      for (
                        c = o.substr(g).split(t._splitToWordExps3), g = 0;
                        g < c.length;
                        g++
                      )
                        (o = c[g]).length && (n[o] = !0);
                  ...
                  case "#else":
                    (h.src = o),
                      ...
                      (h.noCompile = l.noCompile),
                      h.noCompile ||
                        ((h.condition = l.condition),
                        (h.conditionType = 1 == l.conditionType ? 2 : 1),
                        (h.text =
                          "//" +
                          h.text +
                          " " +
                  ...
                  case "#include":
                    ...
                    if ((d = c[0].indexOf("?")) < 0) {
                      h.setParent(i),
                        (o = x.getWith("with" == c[2] ? c[3] : null)),
                        this._compileToTree(h, o.split("\n"), 0, a, n),
                        (h.text = "");
                      continue;
                    }
                    h.setCondition(c[0].substr(d + 1), 1),
                      (h.text = x.getWith("with" == c[2] ? c[3] : null));
                    break;
                  case "#import":
                    (_ = (c = t.splitToWords(o, null))[1]),
                      a.push({
                        node: h,
                        file: t.includes[_],
                        ofs: h.text.length,
        ...
        (t._parseOne = function (e, i, r, s, a, n) {
          ...
          return (
            n && ("attribute" == a ? e.push(h) : i.push(h)),
            ":" == r[s + 3] && ((h.type = r[s + 4]), (s += 2)),
            (s += 2)
          );
        }),
            ...
            for (o = 0, u = f.length; o < u; o++) {
              ...
              if ("attribute" == d || "uniform" == d)
                ...
                if ("#ifdef" == d) {
                  h[(c = f[++o])] = h[c] || [];
                  for (o++; o < u; o++)
                    if ("attribute" == (d = f[o]) || "uniform" == d)
                      o = t._parseOne(a, n, f, o, d, l[c]);
                    else if ("#else" == d)
                      for (o++; o < u; o++)
                        if ("attribute" == (d = f[o]) || "uniform" == d)
                          o = t._parseOne(a, n, f, o, d, !l[c]);
        ...
        (t.splitToWords = function (t, e) {
          for (var i, r, s = [], a = -1, n = 0, h = t.length; n < h; n++)
            if (((i = t.charAt(n)), " \t=+-*/&%!<>()'\",;".indexOf(i) >= 0)) {
              if (
                (a >= 0 && n - a > 1 && ((r = t.substr(a, n - a)), s.push(r)),
                '"' == i || "'" == i)
              ) {
              ...
              "(" == i &&
                ...
                s.length > 0 &&
                ((r = s[s.length - 1] + ";"),
                "vec4;main;".indexOf(r) < 0 && (e.useFuns += r)),
                (a = -1);
            } else a < 0 && (a = n);
              ...
              (e._toscript = function (t, e, i) {
                ...
                if (
                  ...
                  this.childs.length > 0 &&
                    this.childs.forEach(function (r, s, a) {
                      r._toscript(t, e, i);
                    }),
                  this.includefiles.length > 0 && this.useFuns.length > 0)
                )
                  for (var s, a = 0, n = this.includefiles.length; a < n; a++)
                    this.includefiles[a].curUseID != i &&
                      (s = this.includefiles[a].file.getFunsScript(
                        this.useFuns
                      )).length > 0 &&
                      ((this.includefiles[a].curUseID = i), (e[0] = s + e[0]));
                return e;
              }),
              (t.__id = 1),
              t
            ...
            (i = (function () {
              function e(e) {
                ...
                for (var i = 0, r = 0, s = 0; ; ) {
                  ...
                  "code" == a[1]
                    ? (this.codes[a[2]] = e.substr(r + 1, s - r - 1))
                    : "function" == a[1] &&
                      ((r = e.indexOf("function", i)),
                      (r += "function".length),
                      (this.funs[a[3]] = e.substr(r + 1, s - r - 1)),
                      (this.funnames += a[3] + ";")),
                    (i = s + 1);
                }
              }
      ...
      return (
        ...
        (t._uint16ArraySlice = function (t) {
          var e,
            ...
            s = 0;
          if (0 === i.length)
            for (r = this.length, e = new Uint16Array(r), s = 0; s < r; s++)
              e[s] = this[s];
          else if (2 === i.length) {
            var a = i[0],
              n = i[1];
            if (n > a)
              for (r = n - a, e = new Uint16Array(r), s = a; s < n; s++)
                e[s - a] = this[s];
        ...
        (t.expandContext = function () {
          ...
          (e.fillTrangles = t.fillTrangles),
            Zt.__int__(null),
            (e.setIBVB = function (t, e, i, r, s, a, n, h, l, o) {
              void 0 === l && (l = 0),
                void 0 === o && (o = 0),
                null === i &&
                  ((this._ib = this._ib || $t.QuadrangleIB),
                  (i = this._ib),
                  pt.expandIBQuadrangle(i, r._byteLength / 64 + 8)),
                this._setIBVB(t, e, i, r, s, a, n, h, l, o);
            }),
            (e.fillTrangles = function (t, e, i, r, s) {
              (this._curMat = this._curMat || b.create()),
                ...
                this._ib ||
                  ((this._ib = $t.create()),
                  pt.fillIBQuadrangle(this._ib, n / 4));
              var a = this._vb,
                n = r.length >> 4;
              pt.fillTranglesVB(a, e, i, r, s || this._curMat, 0, 0),
                pt.expandIBQuadrangle(this._ib, a._byteLength / 64 + 8);
              var h = new Et(1, 0);
              h.textureHost = t;
              var l = new jt(
              ...
              (a._vertType = 3),
                this._setIBVB(e, i, this._ib, a, 6 * n, s, l, h, 0, 0);
            });
        }),
        (t.enable = function () {
          if ((u.__init__(), A.isConchApp && !A.isConchWebGL))
            return (
          ...
          if (
            ...
            null == (t.mainContext = R.getWebGLContext(A._mainCanvas)))
          )
            return !1;
          ...
          return (
            ...
            (R.clear = function (t) {
              ...
              var e = A.context.ctx,
                i =
                  0 == e._submits._length || f.preserveDrawingBuffer
                    ? c.create(t)._color
                    : M._wgColor;
            ...
            (R.addToAtlas = function (t, e) {
              void 0 === e && (e = !1);
              var r = t.bitmap;
              A.optimizeTextureMemory(t.url, t)
                ? i.__typeof(r, "laya.webgl.resource.IMergeAtlasBitmap") &&
                  r.allowMerageInAtlas &&
                  r.on("recovered", t, t.addTextureToAtlas)
                : (r.enableMerageInAtlas = !1);
            }),
            ...
            (R.beginFlush = function () {
              for (
                var t = k.instance, e = t.getAtlaserCount(), i = 0;
                i < e;
                i++
              ) {
            ...
            (R.drawToCanvas = function (t, e, i, r, s, a) {
              ...
              n.start(),
                n.clear(0, 0, 0, 0),
                A.context.clear(),
                E.renders[e]._fun(t, A.context, s, vt.height - r + a),
                A.context.flush(),
                n.end();
              ...
              if ((n.recycle(), h.byteLength == i * r * 4)) {
                ...
                return (
                  c.data.set(new Uint8ClampedArray(h.buffer)),
                  (l._imgData = c),
                  _.putImageData(c, 0, 0),
                  o.save(),
                  o.translate(0, r),
                  o.scale(1, -1),
                  o.drawImage(u.canvas.source, 0, 0),
                  o.restore(),
                  l
                );
              }
            ...
            (R.addTextureToAtlas = function (t) {
              t._uvID++,
                k._atlasRestore++,
                t.bitmap.enableMerageInAtlas && k.instance.addToAtlas(t);
            }),
            (R.getTexturePixels = function (t, e, i, r, s) {
              ...
              n.start(),
                n.clear(0, 0, 0, 0),
                a.render(A.context, 0, 0),
                A.context.ctx.flush(),
                n.end();
              for (
                var h = n.getData(0, 0, r, s), l = [], o = 0, u = s - 1;
                u >= 0;
                u--
              )
                for (var _ = 0; _ < r; _++)
            ...
            (m._filterStart = function (t, e, i, r, s) {
              ...
              if (
                ...
                n.clear(0, 0, 0, 0),
                t.addValue("src", n),
                t.addValue("ScissorTest", vt.worldScissorTest),
                vt.worldScissorTest)
              ) {
                var h = new T();
                h.copyFrom(i.ctx._clipRect),
                  t.addValue("clipRect", h),
                  (vt.worldScissorTest = !1),
              ...
              if (s) {
                ...
                if (!g || t._repaint) {
                  (p = t._isHaveGlowFilter()),
                    o.addValue("_isHaveGlowFilter", p),
                    p && ((f = 50), (d = 25)),
                    (l = new T()).copyFrom(t.getSelfBounds()),
                    (l.x += t.x),
                    (l.y += t.y),
                    (l.x -= t.pivotX + 4),
                    (l.y -= t.pivotY + 4);
                  ...
                  if (
                    ...
                    (l.x = u.x),
                    (l.y = u.y),
                    (u.x = l.width * c.a + l.height * c.c),
                    (u.y = l.height * c.d + l.width * c.b),
                    (l.width = u.x),
                    (l.height = u.y),
                  ...
                  var E = t.x - v + d,
                    S = t.y - x + d;
                  s._fun.call(s, t, e, E, S),
                    (A = nt.create([o, t, e, 0, 0], m._filterEnd)),
                    e.addRenderObject(A);
                  for (var w = 0; w < n; w++) {
                    0 != w &&
                      ((A = nt.create([o], m._useSrc)),
                      e.addRenderObject(A),
                      (h = Et.create(1, 0)),
                      b.TEMP.identity(),
                      e.ctx.drawTarget(
        ...
        (t.init = function (e, i, r) {
          ...
          if (
            ((t.compressAstc = s.getExtension("WEBGL_compressed_texture_astc")),
            (t.compressAtc = s.getExtension("WEBGL_compressed_texture_atc")),
            (t.compressEtc = s.getExtension("WEBGL_compressed_texture_etc")),
            (t.compressEtc1 = s.getExtension("WEBGL_compressed_texture_etc1")),
            (t.compressPvrtc = s.getExtension(
              "WEBGL_compressed_texture_pvrtc"
            )),
            (t.compressS3tc = s.getExtension("WEBGL_compressed_texture_s3tc")),
            (t.compressS3tc_srgb = s.getExtension(
              "WEBGL_compressed_texture_s3tc_srgb"
            )),
            (s.deleteTexture1 = s.deleteTexture),
            (s.deleteTexture = function (t) {
              t == yt.curBindTexValue && (yt.curBindTexValue = null),
                s.deleteTexture1(t);
            }),
            t.onStageResize(i, r),
            null == t.mainContext)
          ...
          P.__init__(),
            ...
            Zt.__int__(s),
            G._init_(s),
            A.isConchApp && conch.setOnInvalidGLRes(t.onInvalidGLRes);
        }),
        (t.compressAstc = null),
        (t.compressAtc = null),
        (t.compressEtc = null),
      ...
      return (
        ...
        (t.setBlendFunc = function (e, i, r) {
          (i !== t._sFactor || r !== t._dFactor) &&
            ((t._sFactor = i), (t._dFactor = r), e.blendFunc(i, r));
        }),
    ...
    At = (function (t) {
      function e(t) {
        (this._x = 0),
          ...
          e._contextcount++,
          A.isFlash
            ? ((this._ib = $t.create(35044)), pt.fillIBQuadrangle(this._ib, 16))
            : (this._ib = $t.QuadrangleIB),
          this.clear();
      }
      var n;
      ...
      return (
        ...
        (h.clear = function () {
          this._submits ||
            ((this._other = n.DEFAULT),
            (this._curMat = b.create()),
            (this._vb = Jt.create(-1)),
            (this._submits = []),
            (this._save = [Q.Create(this)]),
            (this._save.length = 10),
            (this._shader2D = new $()),
            (this._triangleMesh = Ft.getAMesh())),
            this._vb.clear(),
          ...
          if (this._width != t || this._height != e)
            if (0 == t || 0 == e) {
              0 != this._vb._byteLength &&
                ...
                this._vb.clear(),
                this._vb.upload());
              for (var i = 0, r = this._submits._length; i < r; i++)
        ...
        (h.translate = function (t, e) {
          (0 === t && 0 === e) ||
            ...
            this._curMat.bTransform &&
              (Z.save(this),
              this._curMat.transformPointN(y.TEMP.setTo(t, e)),
              (t = y.TEMP.x),
              (e = y.TEMP.y)),
            (this._x += t),
            (this._y += e));
        ...
        (h._fillText = function (t, e, i, r, s, a, n, h, l, o) {
          ...
          if (k.enabled)
            ...
            (u.ALPHA === _.ALPHA &&
              d === u.colorAdd &&
              _.colorAdd === u.colorAdd) ||
              ((u.glTexture = null), (u.colorAdd = d)),
              ft.drawText(
                this,
                t,
                e,
        ...
        (h._fillBorderText = function (t, i, r, s, a, n, h, l, o) {
          if (!k.enabled)
            return (
              this._fillText(t, i, r, s, a, null, h, l || 1, o),
              void this._fillText(t, i, r, s, a, n, null, -1, o)
            );
          var u = this._shader2D,
            _ = this._curSubmit.shaderValue;
          u.ALPHA !== _.ALPHA && (u.glTexture = null);
        ...
        (h.fillRect = function (t, e, i, r, s) {
          ...
          if (
            ...
            if (h.fillStyle !== l.fillStyle || h.ALPHA !== l.ALPHA) {
              h.glTexture = null;
              var o = (this._curSubmit = at.createSubmit(
                this,
                this._ib,
                a,
                ((a._byteLength - 64) / 32) * 3,
                Et.create(2, 0)
              ));
              (o.shaderValue.color = h.fillStyle._color._color),
                (o.shaderValue.ALPHA = h.ALPHA),
          ...
          if (t.loaded && t.bitmap && t.source) {
            ...
            if (
              ...
              (p.u_TexRange[0] = g / u),
                ...
                k.enabled &&
                  !this._isMain &&
                  m.addTexture(t, (o._byteLength >> 2) - 16),
                (this._curSubmit = m),
                (m._renderType = 10017),
                (m._numEle += 6);
            }
        ...
        (h.setShader = function (t) {
          Y.save(this, 1048576, this._shader2D, !0),
            (this._shader2D.shader = t);
        }),
        (h.setFilters = function (t) {
          Y.save(this, 2097152, this._shader2D, !0),
        ...
        (h.addTextureVb = function (t, e, i) {
          var r = this._curSubmit._vb || this._vb,
            s = r._byteLength >> 2;
          r.byteLength = (s + 16) << 2;
          for (var a = r.getFloat32Array(), n = 0; n < 16; n += 4)
            (a[s++] = t[n] + e),
              (a[s++] = t[n + 1] + i),
              (a[s++] = t[n + 2]),
              (a[s++] = t[n + 3]);
        ...
        (h.willDrawTexture = function (t, e) {
          ...
          return (
            (o = Dt.create(this, this._ib, l, u, Et.create(1, 0))),
            (this._submits[this._submits._length++] = o),
            (o.shaderValue.textureHost = t),
            (o._renderType = 10016),
            (o._preIsSameTextureShader =
              10016 === this._curSubmit._renderType && a.ALPHA === h.ALPHA),
            (this._curSubmit = o),
            (a.ALPHA = n),
            s
          );
        ...
        (h._drawTextureM = function (t, e, r, s, a, n, h, l, o) {
          ...
          if (c != this._renderKey) {
            ...
            (g = Dt.create(this, this._ib, p, v, Et.create(1, 0))),
              (this._submits[this._submits._length++] = g),
              (g.shaderValue.textureHost = t),
              (g._renderType = 10016),
              (g._preIsSameTextureShader =
                10016 === this._curSubmit._renderType && d.ALPHA === f.ALPHA),
              (this._curSubmit = g),
          ...
          return (
            ...
            (k.enabled &&
              !this._isMain &&
              this._curSubmit.addTexture(t, (u._byteLength >> 2) - 16),
            (this._curSubmit._numEle += 6),
            (this._maxNumEle = Math.max(
              this._maxNumEle,
              this._curSubmit._numEle
        ...
        (h._drawText = function (t, e, i, r, s, a, n, h, l, o) {
          ...
          if (_ != this._renderKey) {
            ...
            ((m = k.enabled
              ? Dt.create(this, this._ib, d, p, Et.create(1, 0))
              : Dt.create(
                  this,
                  this._ib,
                  d,
              ...
              10016 === this._curSubmit._renderType && f.ALPHA === c.ALPHA),
              (this._submits[this._submits._length++] = m),
        ...
        (h.drawTextureWithTransform = function (t, i, r, s, a, n, h, l, o) {
          if (n) {
            var u = this._curMat,
              ...
              c = this._y;
            (0 !== h || 0 !== l) &&
              ((this._x = h * u.a + l * u.c), (this._y = l * u.d + h * u.b)),
              n && u.bTransform
                ? (b.mul(n, u, e._tmpMatrix),
                  (n = e._tmpMatrix)._checkTransform())
                : ((this._x += u.tx), (this._y += u.ty)),
              this._drawTextureM(t, i, r, s, a, 0, 0, n, o),
              (this._x = _),
              (this._y = c);
        ...
        (h.fillQuadrangle = function (t, e, i, r, s) {
          ...
          if (((this._renderKey = 0), t.bitmap)) {
            ...
            (h.glTexture == o && h.ALPHA === l.ALPHA) ||
              ...
              ((a = this._curSubmit =
                at.createSubmit(
                  ...
                  (n._byteLength / 32) * 3,
                  Et.create(1, 0)
                )).shaderValue.glTexture = o),
              (this._submits[this._submits._length++] = a)),
              pt.fillQuadrangleImgVb(
                n,
                e,
                i,
                r,
            ...
            (a.shaderValue.fillStyle &&
              a.shaderValue.fillStyle.equal(t) &&
              h.ALPHA === l.ALPHA) ||
              ((h.glTexture = null),
              (a = this._curSubmit =
                at.createSubmit(
              ...
              (a.shaderValue.fillStyle = z.create(t)),
              (this._submits[this._submits._length++] = a)),
              pt.fillQuadrangleImgVb(
                n,
                e,
        ...
        (h.drawTexture2 = function (t, i, r, s, a, n, h, l) {
          if (0 != n) {
            ...
            if (
              ...
              (this._y = i * o.d + t * o.b),
              a &&
                (o.bTransform || a.bTransform
                  ? (b.mul(a, o, e._tmpMatrix), (a = e._tmpMatrix))
                  : ((this._x += a.tx + o.tx),
                    (this._y += a.ty + o.ty),
                    (a = b.EMPTY))),
              1 !== n || h)
              ...
              var u = this._shader2D.ALPHA,
                _ = this._nBlendType;
              (this._shader2D.ALPHA = n),
                h && (this._nBlendType = G.TOINT(h)),
                this._drawTextureM(
                  l[0],
                  l[1] - r,
                  l[2] - s,
        ...
        (h.drawCanvas = function (t, e, i, r, s) {
          var a = t.context;
          if (((this._renderKey = 0), a._targets))
            (this._submits[this._submits._length++] = Pt.create(a, 0, null)),
              (this._curSubmit = at.RENDERBASE),
              a._targets.drawTo(this, e, i, r, s);
          else {
            var n = (this._submits[this._submits._length++] = Pt.create(
                a,
            ...
            var u = o.tx,
              _ = o.ty;
            (o.tx = o.ty = 0),
              o.transformPoint(y.TEMP.setTo(e, i)),
              o.translate(y.TEMP.x + u, y.TEMP.y + _),
              (this._curSubmit = at.RENDERBASE);
          }
          f.showCanvasMark &&
            (this.save(),
            ...
            this.strokeRect(e - 1, i - 1, r + 2, s + 2, 1),
            this.strokeRect(e, i, r, s, 1),
            this.restore());
        }),
        (h.drawTarget = function (t, e, i, r, s, a, n, h, l, o) {
          ...
          if (
            ...
            var _ = (this._curSubmit = _t.create(
              this,
              this._ib,
              u,
              ((u._byteLength - 64) / 32) * 3,
              h,
              n
            ));
            (_.blendType = -1 == o ? this._nBlendType : o),
              (_.scope = t),
        ...
        (h.drawTriangles = function (t, r, s, a, n, h, l, o, u, _) {
          ...
          var c = this._mixRGBandAlpha(4294967295, o),
            f = (a.length, h.length);
          this._renderKey = -1;
          var d = (this._curSubmit = Dt.create(
            this,
          ...
          return (
            ...
            l
              ? ((e._tmpMatrix.a = l.a),
                ...
                (e._tmpMatrix.c = l.c),
                (e._tmpMatrix.d = l.d),
                (e._tmpMatrix.tx = l.tx + r),
                (e._tmpMatrix.ty = l.ty + s),
              ...
              : ((e._tmpMatrix.a = this._curMat.a),
                ...
                (e._tmpMatrix.tx = this._curMat.tx + r),
                (e._tmpMatrix.ty = this._curMat.ty + s)),
            this._triangleMesh.addData(a, n, h, e._tmpMatrix, c, this),
            (this._curSubmit._numEle += f),
            (this._maxNumEle = Math.max(
              this._maxNumEle,
              this._curSubmit._numEle
            )),
        ...
        (h.transform = function (t, e, i, r, s, a) {
          Z.save(this),
            b.mul(b.TEMP.setTo(t, e, i, r, s, a), this._curMat, this._curMat),
        ...
        (h.clipRect = function (t, e, i, r) {
          if (0 != this._curMat.b || 0 != this._curMat.c) {
            ...
            if (
              ...
              this._shader2D.glTexture = null;
              var h = (this._curSubmit = at.createSubmit(
                this,
                this._ib,
                a,
                ((a._byteLength - 64) / 32) * 3,
            ...
            var o = a.getFloat32Array(),
              u = Math.min(
                Math.min(Math.min(o[n + 0], o[n + 4]), o[n + 8]),
                o[n + 12]
              ),
              _ = Math.max(
                Math.max(Math.max(o[n + 0], o[n + 4]), o[n + 8]),
                o[n + 12]
              ),
              c = Math.min(
                Math.min(Math.min(o[n + 1], o[n + 5]), o[n + 9]),
                o[n + 13]
              ),
              f = Math.max(
                Math.max(Math.max(o[n + 1], o[n + 5]), o[n + 9]),
                o[n + 13]
              );
            K.save(this, l, t, e, i, r, u, c, _ - u, f - c),
              (this._curSubmit = at.RENDERBASE);
          } else {
            (i *= this._curMat.a), (r *= this._curMat.d);
            var d = y.TEMP;
            this._curMat.transformPoint(d.setTo(t, e)),
              i < 0 && ((d.x = d.x + i), (i = -i)),
              r < 0 && ((d.y = d.y + r), (r = -r)),
              (this._renderKey = 0);
            ...
            g < d.x && (p.x = d.x),
              v < d.y && (p.y = d.y),
              (p.width = Math.min(x, g + p.width) - p.x),
              (p.height = Math.min(b, v + p.height) - p.y),
              (this._shader2D.glTexture = null),
              m.clipRect.copyFrom(p),
              (this._curSubmit = at.RENDERBASE);
          }
        }),
        (h.setIBVB = function (t, e, i, r, s, a, n, h, l, o, u) {
          if (
            ...
            if (A.isFlash) {
              var _ = r;
              _._selfIB || (_._selfIB = $t.create(35044)),
                _._selfIB.clear(),
                (i = _._selfIB);
            } else i = this._ib;
        ...
        (h.fillTrangles = function (t, e, i, r, s) {
          ...
          (this._renderKey = 0),
            (h.glTexture == u && h.ALPHA === l.ALPHA) ||
              ...
              (this._submits[this._submits._length++] = a)),
            pt.fillTranglesVB(n, e, i, r, s || this._curMat, this._x, this._y),
            (a._numEle += 6 * o);
        }),
        ...
        (h.flush = function () {
          ...
          if (
            (t > this._ib.bufferLength / 12 &&
              pt.expandIBQuadrangle(this._ib, t),
            !this._isMain &&
              k.enabled &&
              k._atlasRestore > this._atlasResourceChange)
          ) {
        ...
        (h.movePath = function (t, e) {
          var i = t,
            r = e;
          (t = this._curMat.a * i + this._curMat.c * r + this._curMat.tx),
            (e = this._curMat.b * i + this._curMat.d * r + this._curMat.ty),
            (this.mX += t),
            (this.mY += e);
        }),
        ...
        (h.stroke = function () {
          ...
          if (this.lineWidth > 0) {
            ...
            (r.shaderValue.ALPHA = this._shader2D.ALPHA),
              (r.shaderValue.u_pos = i),
              (r.shaderValue.u_mmat2 = vt.TEMPMAT4_ARRAY),
        ...
        (h.line = function (t, e, i, r, s, a) {
          ...
          if (pt.fillLineVb(h, this._clipRect, t, e, i, r, s, a)) {
            ...
            var l = this._shader2D,
              o = n.shaderValue;
            (l.strokeStyle === o.strokeStyle && l.ALPHA === o.ALPHA) ||
              ((l.glTexture = null),
              ((n = this._curSubmit =
                at.createSubmit(
                  this,
              ...
              (n.shaderValue.mainID = 2),
              (n.shaderValue.ALPHA = l.ALPHA),
        ...
        (h.moveTo = function (t, e, i) {
          ...
          if (i) {
            var s = t,
              a = e;
            (t = this._curMat.a * s + this._curMat.c * a),
              (e = this._curMat.b * s + this._curMat.d * a);
          }
          r.addPoint(t, e);
        }),
        ...
        (h.arcTo = function (t, i, r, s, a) {
          if (-1 == this.mId || !this.mHaveKey) {
            ...
            this._curMat.copyTo(e._tmpMatrix),
              ...
              e._tempPoint.setTo(o.getEndPointX(), o.getEndPointY()),
                ...
                if (!(A <= 1e-6)) {
                  ...
                  if (f * b - d * x >= 0) {
                    ...
                    (N = (D = 2 * -R) / e.SEGNUM),
                      (F = Math.sin(N)),
                      (B = Math.cos(N));
                  (h = this._curMat.a * I + this._curMat.c * M),
                    (l = this._curMat.b * I + this._curMat.d * M),
                    (h == this._path.getEndPointX() &&
                  ...
                  for (n = 0; n < e.SEGNUM; n++) {
                    ...
                    (h = U + L),
                      (l = k + P),
                      (t = this._curMat.a * h + this._curMat.c * l),
                      (l = i = this._curMat.b * h + this._curMat.d * l),
                      ((h = t) == this._path.getEndPointX() &&
                        l == this._path.getEndPointY()) ||
                        o.addPoint(h, l),
                      (O = U),
                      (V = k);
        ...
        (h.arc = function (t, e, i, r, s, a, n) {
          if (
            (void 0 === a && (a = !1), void 0 === n && (n = !0), -1 != this.mId)
          ) {
          ...
          (u =
            ...
            (m =
              i < 101
                ...
                : Math.max(10, (o * i) / 40)) /
            2),
            (_ = Math.abs(((4 / 3) * (1 - Math.cos(u))) / Math.sin(u))),
            a && (_ = -_);
          var p = this._getPath(),
            g = NaN,
            v = NaN;
          for (d = 0; d <= m; d++)
            (l = r + o * (d / m)),
              ...
              n &&
                ((g = c),
                (v = f),
                (c = this._curMat.a * g + this._curMat.c * v),
                (f = this._curMat.b * g + this._curMat.d * v)),
              (c == this._path.getEndPointX() &&
                f == this._path.getEndPointY()) ||
                p.addPoint(c, f);
          (c = t + Math.cos(s) * i),
            (f = e + Math.sin(s) * i),
            n &&
        ...
        (h.quadraticCurveTo = function (t, e, i, r) {
          var s = l.I,
            a = i,
            n = r;
          (i = this._curMat.a * a + this._curMat.c * n),
            (r = this._curMat.b * a + this._curMat.d * n),
            (a = t),
            (n = e),
            (t = this._curMat.a * a + this._curMat.c * n),
            (e = this._curMat.b * a + this._curMat.d * n);
          for (
            var h = s.getBezierPoints(
                [
        ...
        (h.rect = function (t, e, i, r) {
          (this._other = this._other.make()),
            this._other.path || (this._other.path = new W()),
            this._other.path.rect(t, e, i, r);
        }),
        (h.strokeRect = function (t, e, i, r, s) {
          var a = 0.5 * s;
          this.line(t - a, e, t + i + a, e, s, this._curMat),
            this.line(t + i, e, t + i, e + r, s, this._curMat),
            this.line(t, e, t, e + r, s, this._curMat),
            this.line(t - a, e + r, t + i + a, e + r, s, this._curMat);
        }),
        (h.clip = function () {}),
        (h.drawPoly = function (t, e, i, r, s, a, n) {
          void 0 === n && (n = !1),
            (this._renderKey = 0),
            (this._shader2D.glTexture = null);
          var h = this._getPath();
          ...
          if (
            ...
            (u.shaderValue.u_pos = _),
            (u.shaderValue.u_mmat2 = vt.EMPTYMAT4_ARRAY),
            ...
            if (this.mHaveLineKey) {
              ...
              N.getInstance().addShape(this.mId, h.drawLine(t, e, i, s, a));
            h.update(),
              ((u = at.createShape(
                this,
                h.ib,
        ...
        a(
          ...
          function (t) {
            this._shader2D.strokeStyle.equal(t) ||
              (Y.save(this, 512, this._shader2D, !1),
        ...
        a(
          ...
          function (t) {
            (t = Math.floor(1e3 * t) / 1e3) != this._shader2D.ALPHA &&
              (Y.save(this, 1, this._shader2D, !0), (this._shader2D.ALPHA = t));
          }
        ),
        a(0, h, "asBitmap", null, function (t) {
          if (t) {
            if (
              (this._targets || (this._targets = new j()),
        ...
        a(
          ...
          function (t) {
            this._shader2D.fillStyle.equal(t) ||
              (Y.save(this, 2, this._shader2D, !1),
        ...
        a(
          ...
          function (t) {
            this._other.textAlign === t ||
              ((this._other = this._other.make()),
              Y.save(this, 32768, this._other, !1),
              (this._other.textAlign = t));
          }
        ),
        a(
        ...
        a(
          ...
          function (t) {
            this._other.textBaseline === t ||
              ((this._other = this._other.make()),
              Y.save(this, 16384, this._other, !1),
              (this._other.textBaseline = t));
          }
        ),
        a(0, h, "font", null, function (t) {
          t != this._other.font.toString() &&
            ((this._other = this._other.make()),
            Y.save(this, 8, this._other, !1),
            this._other.font === dt.EMPTY
              ? (this._other.font = new dt(t))
        ...
        (e._MAXSIZE = 99999999),
        (e._RECTVBSIZE = 16),
        (e.MAXCLIPRECT = new T(0, 0, 99999999, 99999999)),
        (e._COUNT = 0),
        (e._tmpMatrix = new b()),
        (e.SEGNUM = 32),
        (e._contextcount = 0),
    ...
    Et = (function (t) {
      ...
      return (
        ...
        (i._withWorldShaderDefines = function () {
          ...
          if (!a) return e;
          for (var n, h = a.length, l = 0; l < h; l++)
        ...
        (i.upload = function () {
          ...
          var e,
            i = t.worldShaderDefines
              ...
              : Qt.sharders[this.mainID | this.defines._value] ||
        ...
        (e.__init__ = function () {
          (e._POSITION = [2, 5126, !1, 4 * mt.BYTES_PE, 0]),
            (e._TEXCOORD = [2, 5126, !1, 4 * mt.BYTES_PE, 2 * mt.BYTES_PE]),
            e._initone(2, Ut),
            e._initone(4, Gt),
            e._initone(256, kt),
            e._initone(512, Vt),
          ...
          if (l) {
            ...
            if (
              ...
              c.addValue("bounds", u),
                ...
                h._fun.call(h, t, i, r, s),
                i.ctx.restore(),
                (n = ut.create(6)),
                (o = i.ctx.globalCompositeOperation),
                (n.blendMode = "mask"),
                i.addRenderObject(n),
                b.TEMP.identity();
              var f = Et.create(1, 0),
              ...
              (u.width < 32 || u.height < 32) &&
                (((d = e.tempUV)[0] = 0),
                (d[1] = 0),
                (d[2] = u.width >= 32 ? 1 : u.width / 32),
                (d[3] = 0),
                (d[4] = u.width >= 32 ? 1 : u.width / 32),
                (d[5] = u.height >= 32 ? 1 : u.height / 32),
                (d[6] = 0),
                (d[7] = u.height >= 32 ? 1 : u.height / 32),
    ...
    wt = (function (t) {
      ...
      var r = e.prototype;
      return (
        i.imps(r, { "laya.filters.IFilterActionGL": !0 }),
        ...
        (r.apply3d = function (t, e, i, r, s) {
          ...
          var h = b.TEMP;
          h.identity(),
            i.ctx.drawTarget(t, 0, 0, a.width, a.height, h, "src", n);
        }),
        e
      );
    })(),
    Rt = (function (t) {
      function e(t, i, r, s, a) {
        (this._atlasCanvas = null),
          ...
          (this._atlasCanvas.width = r),
          (this._atlasCanvas.height = s),
      ...
      var i = e.prototype;
      return (
        (i.computeUVinAtlasTexture = function (t, e, i, r) {
        ...
        (i.addToAtlas = function (t, e, i) {
          ...
          this._inAtlasTextureKey.push(t),
            this._inAtlasTextureOriUVValue.push(r),
            this._inAtlasTextureBitmapValue.push(s),
            this.computeUVinAtlasTexture(t, r, e, i),
            (t.bitmap = this._atlasCanvas);
        }),
        (i.clear = function () {
          for (var t = 0, e = this._inAtlasTextureKey.length; t < e; t++)
            (this._inAtlasTextureKey[t].bitmap =
              this._inAtlasTextureBitmapValue[t]),
              (this._inAtlasTextureKey[t].uv =
                this._inAtlasTextureOriUVValue[t]),
    ...
    It = (function (t) {
      ...
      return (
        s(e, "laya.webgl.shader.d2.ShaderDefines2D", J),
        (e.__init__ = function () {
          e.reg("TEXTURE2D", 1),
            e.reg("COLOR2D", 2),
            e.reg("PRIMITIVE", 4),
    ...
    Mt =
      ...
      (function (t) {
        function e(t, i, r, s, a) {
          (this._points = []),
            this.rebuild(r),
            e.__super.call(this, t, i, 0, 0, 0, a, s, a, 0);
        }
        ...
        return (
          (i.rebuild = function (t) {
            ...
            for (
              var i = NaN, r = NaN, s = -1, a = -1, n = t.length / 2, h = 0;
              h < n;
              h++
            )
              (i = t[2 * h]),
                (r = t[2 * h + 1]),
                (Math.abs(s - i) > 0.01 || Math.abs(a - r) > 0.01) &&
                  this._points.push(i, r),
                (s = i),
                (a = r);
          }),
    ...
    Ct = (function (t) {
      function e(t, i, r, s, a) {
        this._points = [];
        for (
          var n = NaN, h = NaN, l = -1, o = -1, u = r.length / 2 - 1, _ = 0;
          _ < u;
          _++
        )
          (n = r[2 * _]),
            (h = r[2 * _ + 1]),
            (Math.abs(l - n) > 0.01 || Math.abs(o - h) > 0.01) &&
              this._points.push(n, h),
            (l = n),
            (o = h);
        (n = r[2 * u]),
          (h = r[2 * u + 1]),
          ...
          if (this.borderWidth > 0) {
            for (
              var r = this.color,
                ...
                o = 0,
                u = [],
                _ = Math.floor(this._points.length / 2),
                c = 0;
              c < _;
              c++
            )
              (l = this._points[2 * c]),
                (o = this._points[2 * c + 1]),
                h.push(this.x + l, this.y + o, s, a, n);
            this.createLoopLine(h, u, this.borderWidth, i + h.length / 5),
    ...
    Lt = (function (t) {
      function e(t, i, r, s, a, n) {
        (this._points = null),
          ...
          (this._mat = b.create()),
          (this._points = r.slice(0, r.length)),
          e.__super.call(this, t, i, 0, 0, this._points.length / 2, s, a, n);
      }
      ...
      return (
        ...
        (i.getData = function (t, e, i) {
          ...
          if (this.mUint16Array && this.mFloat32Array && this._repaint) {
            if (this._start != i) {
              for (
                this._start = i, r = [], n = this.earcutTriangles.length, s = 0;
                s < n;
                s++
              )
            ...
            var h = [],
              ...
              _ = ((o >> 8) & 255) / 255,
              c = (255 & o) / 255;
            for (n = Math.floor(a.length / 2), s = 0; s < n; s++)
              h.push(this.x + a[2 * s], this.y + a[2 * s + 1], u, _, c),
                l.push(this.x + a[2 * s], this.y + a[2 * s + 1]);
            for (
              this.earcutTriangles = rt.earcut(l, null, 2),
                n = this.earcutTriangles.length,
                s = 0;
              s < n;
              s++
            )
              r.push(this.earcutTriangles[s] + i);
            (this.mUint16Array = new Uint16Array(r)),
              (this.mFloat32Array = new Float32Array(h));
          }
    ...
    Pt = (function (t) {
      function e() {
        (this._matrix = new b()),
          (this._matrix4 = mt.defaultMatrix4.concat()),
          e.__super.call(this, 1e4),
          (this.shaderValue = new Et(0, 0));
      }
      ...
      return (
        (i.renderSubmit = function () {
          ...
          return (
            ...
            (h[12] = l.tx),
            (h[13] = l.ty),
            (vt.worldMatrix = l.clone()),
            (vt.worldMatrix4 = h),
            (vt.worldAlpha = vt.worldAlpha * a.alpha),
            a.filters &&
              a.filters.length &&
              ((vt.worldFilters = a.filters),
              (vt.worldShaderDefines = a.defines)),
            this._ctx_src.flush(),
            (vt.worldAlpha = t),
            (vt.worldMatrix4 = e),
      ...
      return (
        ...
        (i.renderSubmit = function () {
          ...
          if (
            ...
            C.drawCall++,
            (C.trianglesFaces += this._numEle / 3),
            this._preIsSameTextureShader && Bt.activeShader && e._shaderSet
              ? Bt.activeShader.uploadTexture2D(this.shaderValue.texture)
              : this.shaderValue.upload(),
            (e._shaderSet = !0),
            ...
            for (
              ...
              var o = this._texs[h];
              (o.bitmap === s && h + 1 !== l) ||
                (n.uploadTexture2D(o.source),
                r.drawElements(
                  4,
                  6 * (h - a + 1),
                  5123,
                  this._startIdx + 6 * a * mt.BYTES_PIDX
                ),
                (s = o.bitmap),
                (a = h));
            }
        ...
        (e.create = function (t, i, r, s, a) {
          ...
          null == r &&
            ...
            (n._numEle = 0);
          var h = t._nBlendType;
          (n._blendFn = t._targets ? G.targetFns[h] : G.fns[h]),
            (n.shaderValue = a),
    ...
    Ft = (function (t) {
      ...
      var i = e.prototype;
      return (
        (i.addData = function (t, i, r, s, a, n) {
          for (
            var h = t.length / 2,
              l = this._vb.needSize(h * e.const_stride) >> 2,
              o = this._vb.getFloat32Array(),
              u = 0,
              _ = 0;
            _ < h;
            _++
    ...
    Bt = (function (t) {
      ...
      return (
        s(e, "laya.webgl.shader.BaseShader", S),
        (e.activeShader = null),
        (e.bindShader = null),
        e
      );
    ...
    Nt = (function (t) {
      function e(t, i, r, s, a, n, h, l, o) {
        (this._type = 0),
          ...
          (this.bitmap.lock = !0),
          e.__super.call(this, this.bitmap, F.INV_UV);
      }
      s(e, "laya.webgl.resource.RenderTarget2D", t);
      var r = e.prototype;
      return (
        i.imps(r, { "laya.resource.IDispose": !0 }),
        (r.getType = function () {
          return this._type;
        }),
          ...
          t.bindFramebuffer(
            ...
            1 == this._type
              ? (t.viewport(0, 0, this._svWidth, this._svHeight),
                (vt.width = this._svWidth),
                (vt.height = this._svHeight),
                (Bt.activeShader = null))
        ...
        (r.getData = function (t, e, i, r) {
          ...
          if (!(36053 === s.checkFramebufferStatus(36160)))
            return s.bindFramebuffer(36160, null), null;
          var a = new Uint8Array(this._w * this._h * 4);
          return (
            s.readPixels(t, e, i, r, this._surfaceFormat, this._surfaceType, a),
        ...
        (r.dispose = function () {}),
        (r._createWebGLRenderTarget = function () {
          (this.bitmap = new Xt(
            this.width,
            this.height,
            this._surfaceFormat,
        ...
        (e.create = function (t, i, r, s, a, n, h, l, o) {
          ...
          return (
            ...
            (u.bitmap &&
              ...
              (u._depthStencilFormat = a),
              A.isConchWebGL &&
                34041 === u._depthStencilFormat &&
                (u._depthStencilFormat = 33189),
              (u._mipMap = n),
              (u._repeat = h),
              (u._minFifter = l),
              (u._magFifter = o),
    ...
    Vt = (function (t) {
      function e(t) {
        ...
        (this.position = [2, 5126, !1, i, 0]),
          (this.texcoord = [2, 5126, !1, i, 2 * mt.BYTES_PE]),
    ...
    Gt = (function (t) {
      function e(t) {
        (this.a_color = null),
          ...
          (this.position = [2, 5126, !1, 5 * mt.BYTES_PE, 0]),
          (this.a_color = [3, 5126, !1, 5 * mt.BYTES_PE, 2 * mt.BYTES_PE]);
      }
    ...
    zt = (function (t) {
      ...
      return (
        ...
        (i.texSubImage2D = function (t, e, i) {
          if (A.isFlash) {
            this._flashCacheImage ||
              ((this._flashCacheImage = v.create("")),
            ...
            yt.bindTexture(s, 3553, this._source),
              A.isConchWebGL
                ? (i !== ConchTextCanvas &&
                    (t - 1 >= 0 &&
                      s.texSubImage2DEx(!0, 3553, 0, t - 1, e, 6408, 5121, i),
                    t + 1 <= this._w &&
                      s.texSubImage2DEx(!0, 3553, 0, t + 1, e, 6408, 5121, i),
                    e - 1 >= 0 &&
                      s.texSubImage2DEx(!0, 3553, 0, t, e - 1, 6408, 5121, i),
                    e + 1 <= this._h &&
                      s.texSubImage2DEx(!0, 3553, 0, t, e + 1, 6408, 5121, i)),
                  s.texSubImage2DEx(!0, 3553, 0, t, e, 6408, 5121, i))
                : (s.pixelStorei(37441, !0),
                  t - 1 >= 0 &&
                    s.texSubImage2D(3553, 0, t - 1, e, 6408, 5121, i),
                  t + 1 <= this._w &&
                    s.texSubImage2D(3553, 0, t + 1, e, 6408, 5121, i),
                  e - 1 >= 0 &&
                    s.texSubImage2D(3553, 0, t, e - 1, 6408, 5121, i),
                  e + 1 <= this._h &&
                    s.texSubImage2D(3553, 0, t, e + 1, 6408, 5121, i),
                  s.texSubImage2D(3553, 0, t, e, 6408, 5121, i),
                  s.pixelStorei(37441, !1)),
              a && n && yt.bindTexture(s, a, n);
          }
        }),
        (i.texSubImage2DPixel = function (t, e, i, r, s) {
          ...
          A.isConchWebGL
            ? a.texSubImage2DEx(!0, 3553, 0, t, e, i, r, 6408, 5121, l)
            : (a.pixelStorei(37441, !0),
              a.texSubImage2D(3553, 0, t, e, i, r, 6408, 5121, l),
              a.pixelStorei(37441, !1)),
            n && h && yt.bindTexture(a, n, h);
        }),
      ...
      return (
        ...
        (i.reloadCanvasData = function () {
          ...
          var i = yt.curBindTexTarget,
            r = yt.curBindTexValue;
          yt.bindTexture(t, 3553, this._source),
            A.isConchWebGL
              ? t.texImage2DEx(
                  e.premulAlpha,
                  3553,
        ...
        (i.texSubImage2D = function (t, e, i) {
          ...
          yt.bindTexture(r, 3553, this._source),
            A.isConchWebGL
              ? r.texSubImage2DEx(!0, 3553, 0, e, i, 6408, 5121, t._source)
              : (r.pixelStorei(37441, !0),
                r.texSubImage2D(3553, 0, e, i, 6408, 5121, t._source),
                r.pixelStorei(37441, !1)),
            s && a && yt.bindTexture(r, s, a);
        }),
    ...
    Yt = (function (t) {
      function e(t, i) {
        ...
        var r,
          s = A.isConchApp;
        s
          ? (((r = ConchTextCanvas)._source = ConchTextCanvas),
            (r._source.canvas = ConchTextCanvas))
          : (r = u.canvas.source),
          (this.canvas = r),
          (this._enableMerageInAtlas = !0),
          (this._ctx = s ? r : this.canvas.getContext("2d", void 0));
        ...
        (this.cw = a.width * this.xs),
          ...
          (this.texture = new F(this));
      }
      s(e, "laya.webgl.resource.WebGLCharImage", o);
      var r = e.prototype;
      return (
        i.imps(r, { "laya.webgl.resource.IMergeAtlasBitmap": !0 }),
        (r.active = function () {
          this.texture.active();
        }),
        (r.recreateResource = function () {
          ...
          if (
            ...
            var i = this.fontSize;
            (1 == this.xs && 1 == this.ys) ||
              (i = parseInt(i * (this.xs > this.ys ? this.xs : this.ys) + ""));
            var r = "normal 100 " + this.font;
            (r = r.replace(e._fontSizeReg, i)),
              this.borderColor && (r += " 1 " + this.borderColor),
              (this._ctx.font = r),
            ...
            if (
              ...
              D.RightToLeft && (this._ctx.textAlign = "end"),
              (this._ctx.textBaseline = "top"),
        ...
        (e._fontSizeReg = new RegExp("\\d+(?=px)", "g")),
        e
      );
    })(),
    Xt = (function (t) {
      ...
      return (
        (i.recreateResource = function () {
          ...
          if (
            (n
              ? (this._mipMap ? -1 !== r || (r = 9987) : -1 !== r || (r = 9729),
                -1 !== s || (s = 9729),
                t.texParameteri(3553, 10241, r),
    ...
    Kt = (function (t) {
      function e(t, i, r, s, a, n, h) {
        (this.offsetX = 0),
          ...
          (this._enableMerageInAtlas = !0),
          k.enabled &&
          this._w < k.atlasLimitWidth &&
          this._h < k.atlasLimitHeight
      ...
      return (
        ...
        (r.createWebGlTexture = function () {
          ...
          l
            ? (this.mipmap ? -1 !== s || (s = 9987) : -1 !== s || (s = 9729),
              ...
              t.texParameteri(3553, 10242, n),
              t.texParameteri(3553, 10243, n),
        ...
        (r.disposeResource = function () {
          (k.enabled && this._allowMerageInAtlas) ||
            !this._source ||
            (bt.mainContext.deleteTexture(this._source),
            (this._source = null),
            (this.memorySize = 0));
      ...
      return (
        ...
        (i._compile = function () {
          if (this._vs && this._ps && !this._params) {
            ...
            if (
              ...
              !A.isConchApp && !i.getProgramParameter(this._program, 35714))
            )
            ...
            for (
              ...
              (r = {
                ...
                glfun: null,
                ivartype: 0,
                attrib: (h = A.isConchApp
                  ? i.getActiveAttribEx(this._vs, this._ps, "", s)
                  : i.getActiveAttrib(this._program, s)),
            ...
            for (
              ...
              var o = null;
              (o = A.isConchApp
                ? i.getActiveUniformEx(this._vs, this._ps, "", s)
                : i.getActiveUniform(this._program, s)),
                (r = {
                  vartype: "uniform",
                  glfun: null,
                  ivartype: 1,
                  ...
                  (r.isArray = !0),
                  (r.location = i.getUniformLocation(this._program, r.name))),
                this._params.push(r);
            }
            for (s = 0, a = this._params.length; s < a; s++)
              if (
                ...
                (r.indexOfParams = s),
                (r.index = 1),
                (r.value = [r.location, null]),
                (r.codename = r.name),
                (r.name = this._nameMap[r.codename]
                  ? this._nameMap[r.codename]
                  : r.codename),
                (this._paramsMap[r.name] = r),
                (r._this = this),
                (r.uploadedValue = []),
                "attribute" !== r.vartype)
              )
                switch (r.type) {
                  ...
                  case 35680:
                    ...
                    break;
                  case 35676:
                    (r.glfun = i.uniformMatrix4fv),
                      (r.fun = this._uniformMatrix4fv);
                    break;
                  case 35670:
        ...
        (i._attribute = function (t, e) {
          var i = bt.mainContext,
            ...
            s = t.location;
          return (
            r[s] || i.enableVertexAttribArray(s),
        ...
        (i._uniform_sampler2D = function (t, i) {
          ...
          return null == s[0]
            ? ((s[0] = this._curActTexIndex),
              r.uniform1i(t.location, this._curActTexIndex),
              r.activeTexture(e._TEXTURES[this._curActTexIndex]),
              yt.bindTexture(r, 3553, i),
              this._curActTexIndex++,
              1)
            : (r.activeTexture(e._TEXTURES[s[0]]),
              yt.bindTexture(r, 3553, i),
              0);
        }),
        ...
        (i.upload = function (t, e) {
          (Bt.activeShader = Bt.bindShader = this),
            this._lastUseFrameCount === C.loopCount || this.activeResource(),
            yt.UseProgram(this._program),
            this._reCompile
              ? ((e = this._params), (this._reCompile = !1))
              : (e = e || this._params);
          bt.mainContext;
          for (var i, r, s = e.length, a = 0, n = 0; n < s; n++)
        ...
        (i.uploadArray = function (t, e, i) {
          (Bt.activeShader = this),
            ...
            yt.UseProgram(this._program);
          this._params;
          for (var r, s, a = 0, n = e - 2; n >= 0; n -= 2)
            (s = this._paramsMap[t[n]]) &&
              null != (r = t[n + 1]) &&
              (i && i[s.name] && i[s.name].bind(),
              (a += s.fun.call(this, s, r)));
          C.shaderCall += a;
        }),
    ...
    Zt = (function (t) {
      ...
      return (
        ...
        (i.appendU16Array = function (t, e) {
          ...
          for (
            var i = new Uint16Array(this._buffer, this._byteLength, e), r = 0;
            r < e;
            r++
          )
            i[r] = t[r];
        ...
        (e.__int__ = function (t) {
          ($t.QuadrangleIB = $t.create(35044)),
            pt.fillIBQuadrangle($t.QuadrangleIB, 16);
        }),
        (e.FLOAT32 = 4),
        (e.SHORT = 2),
        e
      ...
      return (
        ...
        (i._make2dQuick1 = function () {
          if (!this._params2dQuick1) {
            ...
            for (var t, e = this._params, i = 0, r = e.length; i < r; i++)
              (t = e[i]),
                (A.isFlash ||
                  ("size" !== t.name &&
                    "position" !== t.name &&
    ...
    $t = (function (t) {
      function e(t) {
        (this._uint8Array = null),
          ...
          A.isFlash || (this._buffer = new ArrayBuffer(8));
      }
    ...
    te = (function (t) {
      function e(t, i, r, s) {
        if (
          ...
          (this._url = t),
            (this._src = t),
            (this._image = new u.window.Image()),
            i &&
      ...
      return (
        i.imps(r, { "laya.webgl.resource.IMergeAtlasBitmap": !0 }),
        (r._init_ = function (t, e) {}),
        (r._createWebGlTexture = function () {
          if (!this._image) throw "create GLTextur err:no data:" + this._image;
          var t = bt.mainContext,
            e = (this._source = t.createTexture()),
            i = yt.curBindTexTarget,
            r = yt.curBindTexValue;
          if ((yt.bindTexture(t, 3553, e), A.isConchWebGL))
            switch (this._format) {
              case 6408:
                t.texImage2DEx(
                  !0,
