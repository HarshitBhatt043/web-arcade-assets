  ...
  Particles = (function () {
    ...
    */
    ...
    function Particles(opts) {
      ...
      this.material = new THREE.ParticleBasicMaterial({
        ...
        blending:
          (_ref3 = opts.blending) != null ? _ref3 : THREE.AdditiveBlending,
      ...
      this.velocity =
        (_ref10 = opts.velocity) != null ? _ref10 : new THREE.Vector3();
      this.randomness =
        (_ref11 = opts.randomness) != null ? _ref11 : new THREE.Vector3();
      this.force = (_ref12 = opts.force) != null ? _ref12 : new THREE.Vector3();
      this.spawnRadius =
        (_ref13 = opts.spawnRadius) != null ? _ref13 : new THREE.Vector3();
      this.life = (_ref14 = opts.life) != null ? _ref14 : 60;
      this.ageing = 1 / this.life;
      this.friction = (_ref15 = opts.friction) != null ? _ref15 : 1.0;
      this.color = new THREE.Color(
        (_ref16 = opts.color) != null ? _ref16 : 0xffffff
      );
      this.color2 = opts.color2 != null ? new THREE.Color(opts.color2) : null;
      this.position =
        (_ref17 = opts.position) != null ? _ref17 : new THREE.Vector3();
      this.rotation =
        (_ref18 = opts.rotation) != null ? _ref18 : new THREE.Vector3();
    ...
    */
    ...
    Particles.prototype.emit = function (count) {
      ...
      for (
        i = _i = 0;
        0 <= emitable ? _i <= emitable : _i >= emitable;
        i = 0 <= emitable ? ++_i : --_i
      ) {
        p = this.pool.pop();
        p.available = false;
    ...
    */
    ...
    Particles.prototype.update = function (dt) {
      ...
      for (
        i = _i = 0, _ref = this.buffer.length;
        0 <= _ref ? _i <= _ref : _i >= _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
        p = this.buffer[i];
