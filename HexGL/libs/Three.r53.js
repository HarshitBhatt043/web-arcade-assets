            ...
            ? ((H = void 0 !== e.color ? e.color : 16777215),
              ...
              "DirectionalLight" === e.type
                ? ((w = e.direction),
                  ...
                  e.target &&
                    (J.push({ object: K, targetName: e.target }),
                    (K.target = null)))
                : "PointLight" === e.type
                ? ((w = e.position),
                  (z = e.distance),
            ...
            if (void 0 === m.geometryGroups) {
              ...
              for (v = q.faces.length; u < v; u++)
                (A = q.faces[u]),
                  ...
                  (D = void 0 !== B ? B : -1),
                  void 0 === G[D] && (G[D] = { hash: D, counter: 0 }),
  ...
  parseDDS: function (a, b) {
    ...
    for (i = 0; i < d.mipmapCount; i++) {
      var j = (((Math.max(4, f) / 4) * Math.max(4, g)) / 4) * e,
        l = { data: new Uint8Array(a, h, j), width: f, height: g };
      d.mipmaps.push(l);
      h += j;
      f = Math.max(0.5 * f, 1);
      g = Math.max(0.5 * g, 1);
...
THREE.Shape.Utils = {
  removeHoles: function (a, b) {
    ...
    return { shape: c, isolatedPts: o, allpoints: d };
  },
