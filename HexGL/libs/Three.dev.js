...
THREE.Ray = function (a, b, c, d) {
  ...
  this.intersectObject = function (a, b) {
    var c,
      d = [];
    if (b === true)
      for (var o = 0, r = a.children.length; o < r; o++)
        Array.prototype.push.apply(d, this.intersectObject(a.children[o], b));
    if (a instanceof THREE.Particle) {
      t = v(this.origin, this.direction, a.matrixWorld.getPosition());
      if (t > a.scale.x) return [];
      c = { distance: t, point: a.position, face: null, object: a };
      d.push(c);
          ...
          if (!(s < 0) && (a.doubleSided || (a.flipSided ? q > 0 : q < 0))) {
            ...
            if (!(t < this.near) && !(t > this.far))
              if (c instanceof THREE.Face3) {
                ...
                if (O(n, e, f, g)) {
                  c = { distance: t, point: n.clone(), face: c, object: a };
                  d.push(c);
                }
  ...
  this.intersectObjects = function (a, b) {
    for (var c = [], d = 0, e = a.length; d < e; d++)
      Array.prototype.push.apply(c, this.intersectObject(a[d], b));
    c.sort(p);
    return c;
  };
};
...
THREE.Matrix4.prototype = {
  ...
  multiplyVector3Array: function (a) {
    for (var b = THREE.Matrix4.__v1, c = 0, d = a.length; c < d; c = c + 3) {
      b.x = a[c];
      b.y = a[c + 1];
      b.z = a[c + 2];
  ...
  getInverse: function (a) {
    var b = this.elements,
      ...
      c = c[15];
    b[0] =
      j * r * q - l * p * q + l * n * s - i * r * s - j * n * c + i * p * c;
    b[4] =
      g * p * q - f * r * q - g * n * s + e * r * s + f * n * c - e * p * c;
    b[8] =
      f * l * q - g * j * q + g * i * s - e * l * s - f * i * c + e * j * c;
    b[12] =
      g * j * n - f * l * n - g * i * p + e * l * p + f * i * r - e * j * r;
    b[1] =
      l * p * o - j * r * o - l * m * s + h * r * s + j * m * c - h * p * c;
    b[5] =
      f * r * o - g * p * o + g * m * s - d * r * s - f * m * c + d * p * c;
    b[9] =
      g * j * o - f * l * o - g * h * s + d * l * s + f * h * c - d * j * c;
    b[13] =
      f * l * m - g * j * m + g * h * p - d * l * p - f * h * r + d * j * r;
    b[2] =
      i * r * o - l * n * o + l * m * q - h * r * q - i * m * c + h * n * c;
    b[6] =
      g * n * o - e * r * o - g * m * q + d * r * q + e * m * c - d * n * c;
    b[10] =
      e * l * o - g * i * o + g * h * q - d * l * q - e * h * c + d * i * c;
    b[14] =
      g * i * m - e * l * m - g * h * n + d * l * n + e * h * r - d * i * r;
    b[3] =
      j * n * o - i * p * o - j * m * q + h * p * q + i * m * s - h * n * s;
    b[7] =
      e * p * o - f * n * o + f * m * q - d * p * q - e * m * s + d * n * s;
    b[11] =
      f * i * o - e * j * o - f * h * q + d * j * q + e * h * s - d * i * s;
    b[15] =
...
THREE.Projector = function () {
    ...
    var e = function (a) {
      if (a.visible !== false) {
        if (
          ...
          (a.frustumCulled === false || J.contains(a) === true)
        ) {
          ...
          f.z = D.z;
          C.sprites.push(f);
        } else a instanceof THREE.Light && C.lights.push(a);
  ...
  var f,
    ...
    v,
    x = [],
    C = { objects: [], sprites: [], lights: [], elements: [] },
    D = new THREE.Vector3(),
    z = new THREE.Vector4(),
    u = new THREE.Matrix4(),
    G = new THREE.Matrix4(),
  ...
  this.projectVector = function (a, b) {
    ...
    u.multiply(b.projectionMatrix, b.matrixWorldInverse);
    u.multiplyVector3(a);
    return a;
  };
        ...
        for (N = ma.length; ba < N; ba++) {
          ...
          if (W instanceof THREE.Face3) {
            ...
            if (
              ...
              D =
                (ia.positionScreen.x - H.positionScreen.x) *
                  (ca.positionScreen.y - H.positionScreen.y) -
                  (ia.positionScreen.y - H.positionScreen.y) *
                    (ca.positionScreen.x - H.positionScreen.x) <
                0;
            ...
            if (
              ...
              D =
                (S.positionScreen.x - H.positionScreen.x) *
                  (ca.positionScreen.y - H.positionScreen.y) -
                  (S.positionScreen.y - H.positionScreen.y) *
                    (ca.positionScreen.x - H.positionScreen.x) <
                  0 ||
                (ca.positionScreen.x - ia.positionScreen.x) *
                  (S.positionScreen.y - ia.positionScreen.y) -
                  (ca.positionScreen.y - ia.positionScreen.y) *
                    (S.positionScreen.x - ia.positionScreen.x) <
                  0;
              if (R.doubleSided === true || D !== R.flipSided) {
                na = void 0;
                if (r === o.length) {
          ...
          D === false &&
            (R.flipSided === true || R.doubleSided === true) &&
          ...
          for (ca = Ga.length; H < ca; H++) {
            ...
            if (na !== void 0) {
              ia = 0;
              for (S = na.length; ia < S; ia++) m.uvs[H][ia] = na[ia];
            }
          }
          m.material = R.material;
          m.faceMaterial =
            W.materialIndex !== null ? fa[W.materialIndex] : null;
...
THREE.BinaryLoader.prototype.createBinModel = function (a, b, c, d) {
  var e = function (b) {
      ...
      for (
        ...
        X.faces.push(
          new THREE.Face3(
            ...
            h,
            [
              new THREE.Vector3(F[j * 3], F[j * 3 + 1], F[j * 3 + 2]),
      ...
      for (
        ...
        X.faces.push(
          new THREE.Face4(
            ...
            i,
            [
              new THREE.Vector3(F[l * 3], F[l * 3 + 1], F[l * 3 + 2]),
              new THREE.Vector3(r, q, m),
              new THREE.Vector3(s, u, n),
              new THREE.Vector3(t, v, o),
            ],
            null,
            j
          )
    ...
    (function (a, b, c) {
      for (var a = new Uint8Array(a, b, c), d = "", f = 0; f < c; f++)
        d = d + String.fromCharCode(a[b + f]);
      return d;
    })(a, B, 12);
    c = C(a, B + 12);
    C(a, B + 13);
    ...
    (function (a) {
      if (r) {
        ...
        M(r, a, b, b + r * Uint32Array.BYTES_PER_ELEMENT * 3);
      }
    })(E);
...
THREE.GeometryLoader.prototype = {
    ...
    d.addEventListener(
      ...
      function (d) {
        d.target.responseText
          ? (c = b.parse(JSON.parse(d.target.responseText), e))
          : b.dispatchEvent({
              type: "error",
  ...
  parse: function (a, b) {
    ...
    if (a.materials) {
      ...
      for (var f = 0; f < a.materials.length; ++f) {
        ...
        if (g.mapNormal) {
          ...
          if (n.opacity !== void 0) l.uOpacity.value = n.opacity;
    ...
    if (a.skinWeights) {
      f = 0;
      for (g = a.skinWeights.length; f < g; f = f + 2)
        d.skinWeights.push(
    ...
    if (a.skinIndices) {
      f = 0;
      for (g = a.skinIndices.length; f < g; f = f + 2) {
        n = 0;
        d.skinIndices.push(
          new THREE.Vector4(a.skinIndices[f], a.skinIndices[f + 1], n, 0)
        );
      }
    }
    d.bones = a.bones;
...
THREE.SceneLoader.prototype.createScene = function (a, b, c) {
  ...
  if (B.transform) {
    ...
    t && N.scene.rotation.set(t[0], t[1], t[2]);
  ...
  for (r in B.cameras) {
    u = B.cameras[r];
    u.type === "perspective"
      ? (O = new THREE.PerspectiveCamera(u.fov, u.aspect, u.near, u.far))
      : u.type === "ortho" &&
        (O = new THREE.OrthographicCamera(
          u.left,
          u.right,
          u.top,
          u.bottom,
  ...
  for (o in B.fogs) {
    p = B.fogs[o];
    p.type === "linear"
      ? (X = new THREE.Fog(0, p.near, p.far))
      : p.type === "exp2" && (X = new THREE.FogExp2(0, p.density));
    u = p.color;
    X.color.setRGB(u[0], u[1], u[2]);
    N.fogs[o] = X;
  }
  if (N.cameras && B.defaults.camera)
    N.currentCamera = N.cameras[B.defaults.camera];
  ...
  for (q in B.textures) {
    ...
    if (l.url instanceof Array) {
      ...
      o = THREE.ImageUtils.loadTexture(
        d(l.url, B.urlBaseType),
        l.mapping,
        a(1)
      );
      if (THREE[l.minFilter] !== void 0) o.minFilter = THREE[l.minFilter];
  ...
  for (m in B.materials) {
    ...
    for (G in w.parameters)
      if (G === "envMap" || G === "map" || G === "lightMap")
        w.parameters[G] = N.textures[w.parameters[G]];
      else if (G === "shading")
        w.parameters[G] =
          w.parameters[G] == "flat" ? THREE.FlatShading : THREE.SmoothShading;
      else if (G === "blending")
        w.parameters[G] =
          w.parameters[G] in THREE
            ? THREE[w.parameters[G]]
            : THREE.NormalBlending;
      else if (G === "combine")
        w.parameters[G] =
          w.parameters[G] == "MixOperation"
            ? THREE.MixOperation
            : THREE.MultiplyOperation;
      else if (G === "vertexColors")
        if (w.parameters[G] == "face") w.parameters[G] = THREE.FaceColors;
        else if (w.parameters[G]) w.parameters[G] = THREE.VertexColors;
    if (w.parameters.opacity !== void 0 && w.parameters.opacity < 1)
      w.parameters.transparent = true;
    if (w.parameters.normalMap) {
      ...
      if (w.parameters.normalMapFactor)
        a.uNormalScale.value = w.parameters.normalMapFactor;
      if (w.parameters.map) {
        a.tDiffuse.texture = w.parameters.map;
    ...
    if (Da.isEmpty() === false) {
      ...
      s < 1 &&
        o.clearRect(
          Math.floor(Da.getX()),
          Math.floor(Da.getY()),
          Math.floor(Da.getWidth()),
          Math.floor(Da.getHeight())
        );
      if (s > 0) {
  ...
  this.render = function (a, l) {
    ...
    function t(a, d, e, g, h, k, j, m) {
      ...
      if (m instanceof THREE.MeshBasicMaterial)
        ...
        m.wireframe === true
          ? Pb(S, m.wireframeLinewidth, m.wireframeLinecap, m.wireframeLinejoin)
          : Hb(S);
      }
    }
    function v(a, d, e, g, h, k, j, m, o) {
      ...
      c(m.blending);
      if (
        (m.map !== void 0 && m.map !== null) ||
        (m.envMap !== void 0 && m.envMap !== null)
      ) {
        t(a, d, g, 0, 1, 3, j, m, o);
        t(h, e, k, 1, 2, 3, j, m, o);
      } else {
        ...
        if (m instanceof THREE.MeshBasicMaterial) {
          ...
          if (hb === true)
            if (
              ...
              U.g = Math.max(0, Math.min(m.color.g * U.g, 1));
              U.b = Math.max(0, Math.min(m.color.b * U.b, 1));
              fa.r = Math.max(0, Math.min(m.color.r * fa.r, 1));
    ...
    for (ld = h.length; Jc < ld; Jc++) {
      Ma = h[Jc];
      ib = Ma.material;
      ib = ib instanceof THREE.MeshFaceMaterial ? Ma.faceMaterial : ib;
      if (!(ib === void 0 || ib.visible === false)) {
        ...
        if (Ma instanceof THREE.RenderableParticle) {
          ...
          Ua.intersects(Aa) === true && s(u, G, Ma, ib, a);
          ...
          M.positionScreen.y = M.positionScreen.y * r;
...
THREE.WebGLRenderer = function (a) {
    ...
    for (var l = k; l !== b; l = l + m) {
      ...
      if (i.render) {
        ...
        if (h) i = h;
          ...
          if (!i) continue;
          g &&
            E.setBlending(i.blending, i.blendEquation, i.blendSrc, i.blendDst);
        ...
        j instanceof THREE.BufferGeometry
          ? E.renderBufferDirect(d, f, e, i, j, k)
          : E.renderBuffer(d, f, e, i, j, k);
      }
    }
  }
    ...
    for (var h, i, k = 0, j = a.length; k < j; k++) {
      ...
      if (i.visible) {
        if (g) h = g;
          ...
          if (!h) continue;
          e &&
            E.setBlending(h.blending, h.blendEquation, h.blendSrc, h.blendDst);
  ...
  function q(a, b, c, d, f) {
    ...
    if (d.morphTargets && !f.__webglMorphTargetInfluences)
      f.__webglMorphTargetInfluences = new Float32Array(E.maxMorphTargets);
    var e = false,
      g = d.program,
      h = g.uniforms,
      i = d.uniforms;
    ...
    if (e || a !== ca) {
      k.uniformMatrix4fv(h.projectionMatrix, false, a._projectionMatrixArray);
      a !== ca && (ca = a);
    }
    if (e) {
      if (c && d.fog) {
      ...
      for (c = b.length; i < c; i++)
        if ((m = g.uniforms[b[i][1]])) {
          ...
          if (l === "i") k.uniform1i(m, j);
            ...
            if (e._array === void 0) e._array = new Float32Array(16);
            ...
            l = 0;
            for (n = j.length; l < n; l++)
              j[l].flattenToArrayOffset(e._array, l * 16);
            k.uniformMatrix4fv(m, false, e._array);
          } else if (l === "t") {
            k.uniform1i(m, j);
            if ((m = e.texture))
                ...
                if (e.image.length === 6)
                  if (e.needsUpdate) {
                    if (!e.image.__webglTextureCube)
                      e.image.__webglTextureCube = k.createTexture();
                    ...
                    for (m = 0; m < 6; m++)
                      k.texImage2D(
                        k.TEXTURE_CUBE_MAP_POSITIVE_X + m,
                        0,
                        n,
                        n,
                        q,
            ...
            l = 0;
            for (n = e.texture.length; l < n; l++)
              (m = e.texture[l]) && E.setTexture(m, e._array[l]);
          }
        }
      if (
    ...
    if (d.skinning)
      if (dc && f.useVertexTexture) {
        ...
        h.boneGlobalMatrices !== null &&
          k.uniformMatrix4fv(h.boneGlobalMatrices, false, f.boneMatrices);
    ...
    h.objectMatrix !== null &&
      k.uniformMatrix4fv(h.objectMatrix, false, f.matrixWorld.elements);
    return g;
  }
  function s(a, b) {
  ...
  function v(a, b, c) {
    ...
    if (
      ...
      k.texParameterf(
        a,
        Ya.TEXTURE_MAX_ANISOTROPY_EXT,
        Math.min(b.anisotropy, pb)
      );
  ...
  function x(a, b) {
    ...
    if (b.depthBuffer && !b.stencilBuffer) {
      ...
      k.renderbufferStorage(k.RENDERBUFFER, k.DEPTH_STENCIL, b.width, b.height);
      k.framebufferRenderbuffer(
        k.FRAMEBUFFER,
  ...
  function D(a) {
    return a === THREE.RepeatWrapping
      ? k.REPEAT
      : a === THREE.ClampToEdgeWrapping
      ? k.CLAMP_TO_EDGE
      : a === THREE.MirroredRepeatWrapping
      ? k.MIRRORED_REPEAT
      : a === THREE.NearestFilter
      ? k.NEAREST
      : a === THREE.NearestMipMapNearestFilter
      ? k.NEAREST_MIPMAP_NEAREST
      : a === THREE.NearestMipMapLinearFilter
      ? k.NEAREST_MIPMAP_LINEAR
      : a === THREE.LinearFilter
      ? k.LINEAR
      : a === THREE.LinearMipMapNearestFilter
      ? k.LINEAR_MIPMAP_NEAREST
      : a === THREE.LinearMipMapLinearFilter
      ? k.LINEAR_MIPMAP_LINEAR
      : a === THREE.UnsignedByteType
      ? k.UNSIGNED_BYTE
      : a === THREE.UnsignedShort4444Type
      ...
      : a === THREE.ShortType
      ? k.SHORT
      : a === THREE.UnsignedShortType
      ? k.UNSIGNED_SHORT
      : a === THREE.IntType
      ? k.INT
      : a === THREE.UnsignedIntType
      ? k.UNSIGNED_INT
      : a === THREE.FloatType
      ? k.FLOAT
      : a === THREE.AlphaFormat
      ...
      : a === THREE.RGBAFormat
      ? k.RGBA
      : a === THREE.LuminanceFormat
      ? k.LUMINANCE
      : a === THREE.LuminanceAlphaFormat
      ? k.LUMINANCE_ALPHA
      : a === THREE.AddEquation
      ? k.FUNC_ADD
      : a === THREE.SubtractEquation
      ? k.FUNC_SUBTRACT
      : a === THREE.ReverseSubtractEquation
      ? k.FUNC_REVERSE_SUBTRACT
      : a === THREE.ZeroFactor
      ? k.ZERO
      : a === THREE.OneFactor
      ? k.ONE
      : a === THREE.SrcColorFactor
      ? k.SRC_COLOR
      : a === THREE.OneMinusSrcColorFactor
      ? k.ONE_MINUS_SRC_COLOR
      : a === THREE.SrcAlphaFactor
      ? k.SRC_ALPHA
      : a === THREE.OneMinusSrcAlphaFactor
      ? k.ONE_MINUS_SRC_ALPHA
      : a === THREE.DstAlphaFactor
      ? k.DST_ALPHA
      : a === THREE.OneMinusDstAlphaFactor
      ? k.ONE_MINUS_DST_ALPHA
      : a === THREE.DstColorFactor
      ? k.DST_COLOR
      : a === THREE.OneMinusDstColorFactor
      ? k.ONE_MINUS_DST_COLOR
    ...
    if (d.visible !== false) {
      ...
      if (!d.morphTargets && b.position >= 0) {
        ...
        if (f.morphTargetForcedOrder.length) {
          ...
          for (
            ...
            j < d.numSupportedMorphTargets && j < i.length;

          ) {
            k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[i[j]]);
      ...
      if (a) {
        ...
        if (
          ...
          k.vertexAttribPointer(b.skinVertexB, 4, k.FLOAT, false, 0, 0);
  ...
  this.renderImmediateObject = function (a, b, c, d, e) {
    ...
    e.immediateRenderCallback
      ? e.immediateRenderCallback(f, k, Da)
      : e.render(function (a) {
  ...
  this.initWebGLObjects = function (a) {
          ...
          if (j instanceof THREE.Geometry) {
            if (j.geometryGroups === void 0) {
              ...
              for (t = q.faces.length; s < t; s++) {
                ...
                v = u.materialIndex;
                x = v !== void 0 ? v : -1;
                C[x] === void 0 && (C[x] = { hash: x, counter: 0 });
                z = C[x].hash + "_" + C[x].counter;
                q.geometryGroups[z] === void 0 &&
                  (q.geometryGroups[z] = {
                    faces3: [],
                    faces4: [],
                    materialIndex: v,
            ...
            for (i in j.geometryGroups) {
              ...
              if (!l.__webglVertexBuffer) {
                ...
                if (X) {
                  if (U.faceUvs.length > 0 || U.faceVertexUvs.length > 0)
                    F.__uvArray = new Float32Array(O * 2);
                  if (U.faceUvs.length > 1 || U.faceVertexUvs.length > 1)
                    F.__uv2Array = new Float32Array(O * 2);
                }
                if (
                  J.geometry.skinWeights.length &&
                  J.geometry.skinIndices.length
                ) {
                  F.__skinVertexAArray = new Float32Array(O * 4);
                ...
                if (F.numMorphTargets) {
                  ...
                  fa = 0;
                  for (ca = F.numMorphTargets; fa < ca; fa++)
                    F.__morphTargetsArrays.push(new Float32Array(O * 3));
                }
                if (F.numMorphNormals) {
                  F.__morphNormalsArrays = [];
                  fa = 0;
                  for (ca = F.numMorphNormals; fa < ca; fa++)
                    F.__morphNormalsArrays.push(new Float32Array(O * 3));
                }
                F.__webglFaceCount = W * 3;
                F.__webglLineCount = S * 2;
                if (Q.attributes) {
                  if (F.__webglCustomAttributesList === void 0)
                    F.__webglCustomAttributesList = [];
                  var aa = void 0;
                  for (aa in Q.attributes) {
                    ...
                    if (!ma.__webglInitialized || ma.createUniqueBuffers) {
                      ...
                      ma.buffer.belongsToAttribute = aa;
                      na.needsUpdate = true;
                      ma.__original = na;
                    }
    ...
    for (; a.__objectsRemoved.length; ) {
      var db = a.__objectsRemoved[0],
        kb = a;
      db instanceof THREE.Mesh ||
      db instanceof THREE.ParticleSystem ||
      db instanceof THREE.Ribbon ||
      db instanceof THREE.Line
        ? r(kb.__webglObjects, db)
        : db instanceof THREE.Sprite
        ? o(kb.__webglSprites, db)
        : db instanceof THREE.LensFlare
        ? o(kb.__webglFlares, db)
        : (db instanceof THREE.ImmediateRenderObject ||
            db.immediateRenderCallback) &&
      ...
      if (lb instanceof THREE.Mesh)
        if (da instanceof THREE.BufferGeometry) {
          if (
            ...
            da.elementsNeedUpdate ||
            da.uvsNeedUpdate ||
            da.normalsNeedUpdate ||
            da.colorsNeedUpdate ||
            da.tangentsNeedUpdate
          ) {
            var Ib = da,
              pc = k.DYNAMIC_DRAW,
              ec = !da.dynamic,
            ...
            if (Ib.normalsNeedUpdate && Yc !== void 0) {
              ...
              if (ga.__inittedArrays) {
                ...
                if (Fd) {
                  ...
                  for (qd = ac.length; Ja < qd; Ja++) {
                    ...
                    k.bindBuffer(
                      k.ARRAY_BUFFER,
                      ga.__webglMorphTargetsBuffers[Ja]
                    );
                    k.bufferData(k.ARRAY_BUFFER, dd[Ja], Za);
                    if (hc.morphNormals) {
                      k.bindBuffer(
                        k.ARRAY_BUFFER,
                        ga.__webglMorphNormalsBuffers[Ja]
                      );
                ...
                if ($b.length) {
                  ...
                  if (K > 0) {
                    ...
                    k.bufferData(k.ARRAY_BUFFER, xa, Za);
                  }
                }
                if (Ed && cd) {
                  I = 0;
        ...
        if (da.verticesNeedUpdate || da.colorsNeedUpdate || oc) {
          ...
          if (jd) {
            ...
            for (xd = jd.length; Xc < xd; Xc++) {
              ...
              if (
                ra.needsUpdate &&
                (ra.boundTo === void 0 || ra.boundTo === "vertices")
              ) {
                ya = 0;
                wc = ra.value.length;
                if (ra.size === 1)
  ...
  this.initMaterial = function (a, b, c, d) {
    ...
    for (f = b.length; o < f; o++) {
      p = b[o];
      if (!p.onlyShadow) {
        p instanceof THREE.DirectionalLight && g++;
    ...
    a: {
      ...
      d = [
        ...
        E.gammaInput ? "#define GAMMA_INPUT" : "",
        E.gammaOutput ? "#define GAMMA_OUTPUT" : "",
      ...
      k.attachShader(q, e);
      k.linkProgram(q);
      k.getProgramParameter(q, k.LINK_STATUS) ||
        console.error(
          "Could not initialise shader\nVALIDATE_STATUS: " +
            k.getProgramParameter(q, k.VALIDATE_STATUS) +
            ", gl error [" +
            k.getError() +
            "]"
        );
      ...
      q.id = T++;
      aa.push({ program: q, code: l, usedTimes: 1 });
      E.info.memory.programs = aa.length;
      r = q;
    }
    a.program = r;
    ...
    if (a.attributes)
      for (i in a.attributes)
        r[i] !== void 0 && r[i] >= 0 && k.enableVertexAttribArray(r[i]);
    if (a.morphTargets) {
  ...
  merge: function (a, b) {
    ...
    for (r = j.length; p < r; p++) {
      ...
      g instanceof THREE.Face3
        ? (q = new THREE.Face3(g.a + e, g.b + e, g.c + e))
        : g instanceof THREE.Face4 &&
          (q = new THREE.Face4(g.a + e, g.b + e, g.c + e, g.d + e));
...
THREE.BufferGeometry.prototype = {
  ...
  computeTangents: function () {
    ...
    if (
      ...
      for (
        var i = this.attributes.tangent.array, j = [], l = [], h = 0;
        h < g;
        h++
      ) {
...
THREE.TrackballControls = function (a, b) {
  ...
  this.zoomCamera = function () {
    ...
    if (a !== 1 && a > 0) {
      ...
      c.staticMoving
        ? (j = l)
        : (j.y = j.y + (l.y - j.y) * this.dynamicDampingFactor);
    }
  };
  this.panCamera = function () {
    ...
    if (a.lengthSq()) {
      ...
      c.staticMoving
        ? (m = n)
        : m.addSelf(a.sub(n, m).multiplyScalar(c.dynamicDampingFactor));
    }
  };
      ...
      if (c.enabled) {
        ...
        f !== -1 &&
          (f === 0 && !c.noRotate
            ...
            : f === 1 && !c.noZoom
            ? (l = c.getMouseOnScreen(a.clientX, a.clientY))
            : f === 2 &&
              !c.noPan &&
              (n = c.getMouseOnScreen(a.clientX, a.clientY)));
      }
    },
    false
  );
      ...
      if (c.enabled) {
        ...
        if (f === -1) {
          ...
          f === 0 && !c.noRotate
            ...
            : f === 1 && !c.noZoom
            ? (j = l = c.getMouseOnScreen(a.clientX, a.clientY))
            : this.noPan || (m = n = c.getMouseOnScreen(a.clientX, a.clientY));
        }
      }
    },
    false
    ...
    for (h = 0; h < o; h++)
      for (i = 0; i < p; i++) {
        ...
        j.faceVertexUvs[0].push([
          new THREE.UV(i / p, 1 - h / o),
          new THREE.UV(i / p, 1 - (h + 1) / o),
          new THREE.UV((i + 1) / p, 1 - (h + 1) / o),
          new THREE.UV((i + 1) / p, 1 - h / o),
        ]);
      }
  }
  THREE.Geometry.call(this);
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
  ...
  function g(c, d, e, f) {
    ...
    c = f
      ? t.generateBottomUV(J, a, b, c, d, e)
      : t.generateTopUV(J, a, b, c, d, e);
  ...
  if (r) {
    ...
    v =
      b.frames !== void 0
        ? b.frames
        : new THREE.TubeGeometry.FrenetFrames(r, n, false);
    x = new THREE.Vector3();
    C = new THREE.Vector3();
    D = new THREE.Vector3();
  }
...
THREE.ConvexGeometry = function (a) {
  ...
  for (f = 0; f < e.length; f++)
    this.faces.push(new THREE.Face3(e[f][0], e[f][1], e[f][2]));
...
THREE.SubdivisionModifier.prototype.smooth = function (a) {
  ...
  function g(a, b, d) {
    var e = a + ":" + b;
    e in w
      ? c("dup vertexNo", a, "oldFaceNo", b, "value", d, "key", e, w[e])
      : (w[e] = d);
  }
  function h(a, b) {
    O[a] === void 0 && (O[a] = []);
  ...
  b("-- Original Faces + Vertices UVs completed", w, "vs", u.length);
  v = 0;
...
THREE.ShadowMapPlugin = function () {
  ...
  this.update = function (j, l) {
    ...
    for (n = v.length; m < n; m++) {
      ...
      if (!o._projectionMatrixArray)
        o._projectionMatrixArray = new Float32Array(16);
      ...
      for (r = t.length; p < r; p++) {
        ...
        if (
          q.visible &&
          q.castShadow &&
          (!(q instanceof THREE.Mesh) || !q.frustumCulled || f.contains(q))
        ) {
      ...
      for (r = t.length; p < r; p++) {
        ...
        if (s.render) {
          ...
          w = q.customDepthMaterial
            ...
            : q.geometry.morphTargets.length
            ? d
            : q instanceof THREE.SkinnedMesh
            ? e
            : c;
          s instanceof THREE.BufferGeometry
            ? b.renderBufferDirect(o, j.__lights, null, w, s, q)
            : b.renderBuffer(o, j.__lights, null, w, s, q);
        }
      }
  ...
  this.update = function (g, h) {
    ...
    for (j = p.length; i < j; i++) {
      ...
      if (l.render) {
        ...
        l = l.buffer;
        b.setObjectFaces(n);
        m = n.customDepthMaterial
          ? n.customDepthMaterial
          : n.geometry.morphTargets.length
          ? d
          : c;
        l instanceof THREE.BufferGeometry
          ? b.renderBufferDirect(h, g.__lights, null, m, l, n)
          : b.renderBuffer(h, g.__lights, null, m, l, n);
      }
    }
