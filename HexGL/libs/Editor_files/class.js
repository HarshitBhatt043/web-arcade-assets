        ...
        obs.push(
          s.replace(regs.replacer, function (whole, inside) {
            ...
            var ob = getObject(
                inside,
                data,
                typeof remove == "boolean" ? !remove : remove
              ),
              type = typeof ob;
...
(function ($) {
  ...
  var initializing = false,
    ...
    cloneObject = function (object) {
      ...
      if (object instanceof Array) {
        ...
        return clone;
      } // otherwise, it's a normal object, clone it's properties
      else {
        var cloneObj = {};
        for (var prop in object) cloneObj[prop] = cloneObject(object[prop]);
        return cloneObj;
      }
    },
  ...
  extend(clss, {
    ...
    callback: function (funcs) {
      ...
      return function class_cb() {
        ...
        for (; f < length; f++) {
          ...
          if (isString && self._set_called) self.called = func;
    ...
    newInstance: function () {
      ...
      for (var prop in inst.__proto__) inst[prop] = cloneObject(inst[prop]);
    ...
    extend: function (fullName, klass, proto) {
      ...
      for (name in this)
        if (this.hasOwnProperty(name)) Class[name] = cloneObject(this[name]);
      ...
      var args = Class.setup.apply(
        Class,
        concatArgs([_super_class], arguments)
      );
