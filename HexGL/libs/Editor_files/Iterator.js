...
pgli.lang.Iterator = gamecore.Base.extend(
  "Iterator",
  // Static
  {
    MAX_ITERATIONS: 1000,
  ...
  // Instance
  {
    ...
    init: function (name, start, comparator, end) {
      ...
      else this.comparator = static.COMPARATORS["<"];
    ...
    loop: function () {
      return (
        this.iter < pgli.lang.Iterator.MAX_ITERATIONS &&
        this.compMethod(this.step, this.end)
      );
    },
