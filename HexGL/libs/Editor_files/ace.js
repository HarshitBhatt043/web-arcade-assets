(function () {
  function h(a) {
    var c = function (a, b) {
      ...
      f = b;
    a && (b[a] || (b[a] = {}), (f = b[a]));
    if (!f.define || !f.define.packaged)
      (d.original = f.define), (f.define = d), (f.define.packaged = !0);
    if (!f.require || !f.require.packaged)
      (e.original = f.require), (f.require = c), (f.require.packaged = !0);
  }
  var a = "ace",
    b = (function () {
      return this;
  ...
  if (!a && typeof requirejs != "undefined") {
    ...
    (b.define = function (a, b, d) {
      return typeof d != "function"
        ...
        : ace.define(a, b, function (a, c, e) {
            return (
              b[2] == "module" && (e.packaged = !0), d.apply(this, arguments)
            );
          });
    }),
      (b.define.packaged = !0);
  ...
  var d = function (a, b, c) {
      if (typeof a != "string") {
        d.original
          ? d.original.apply(window, arguments)
    ...
    e = function (a, b, c) {
      if (Object.prototype.toString.call(b) === "[object Array]") {
        ...
        if (typeof b == "string") {
          var j = g(a, b);
          return !j && e.original
            ? e.original.apply(window, arguments)
            : (c && c(), j);
        }
    ...
    g = function (a, b) {
      ...
      if (typeof c == "function") {
        var g = {},
          h = { id: b, uri: "", exports: g, packaged: !0 },
          i = function (a, c) {
            return e(b, a, c);
          },
          j = c(i, g, h);
        ...
        (b.edit = function (b) {
          if (typeof b == "string") {
            ...
            (b = document.getElementById(b)) ||
              console.log("can't match div #" + c);
          }
          if (b.env && b.env.editor instanceof f) return b.env.editor;
          var k = new g(d.getInnerText(b));
          k.setUndoManager(new h()), (b.innerHTML = "");
          var l = new f(new i(b, a("./theme/textmate")));
          new j(l), l.setSession(k);
          var m = {};
          return (
            (m.document = k),
            (m.editor = l),
    ...
    function (a, b, c) {
      ...
      (b.createElement = function (a, b) {
        return document.createElementNS
          ? document.createElementNS(b || d, a)
        ...
        (b.hasCssString = function (a, b) {
          ...
          } else if ((d = b.getElementsByTagName("style")))
            while (c < d.length) if (d[c++].id === a) return !0;
          return !1;
        }),
        (b.importCssString = function (c, e, f) {
          ...
          if (f.createStyleSheet)
            (g = f.createStyleSheet()),
              (g.cssText = c),
              e && (g.owningElement.id = e);
          else {
            (g = f.createElementNS
              ? f.createElementNS(d, "style")
              : f.createElement("style")),
              g.appendChild(f.createTextNode(c)),
              e && (g.id = e);
        ...
        (b.getInnerWidth = function (a) {
          return (
            parseInt(b.computedStyle(a, "paddingLeft"), 10) +
            parseInt(b.computedStyle(a, "paddingRight"), 10) +
            a.clientWidth
          );
        }),
        (b.getInnerHeight = function (a) {
          return (
            parseInt(b.computedStyle(a, "paddingTop"), 10) +
            parseInt(b.computedStyle(a, "paddingBottom"), 10) +
            a.clientHeight
          );
        }),
        ...
        (b.setInnerText = function (a, b) {
          ...
          c.body && "textContent" in c.body
            ? (a.textContent = b)
            : (a.innerText = b);
        }),
        (b.getInnerText = function (a) {
          var b = a.ownerDocument;
          return b.body && "textContent" in b.body
            ? a.textContent
  ...
  ace.define(
    ...
    function (a, b, c) {
      function g(a, b, c) {
        var f = 0;
        !e.isOpera || "KeyboardEvent" in window || !e.isMac
          ? (f =
              0 |
              (b.ctrlKey ? 1 : 0) |
              (b.altKey ? 2 : 0) |
        ...
        return (
          f & 8 && (c == 91 || c == 93) && (c = 0),
          !!f || c in d.FUNCTION_KEYS || c in d.PRINTABLE_KEYS ? a(b, f, c) : !1
        );
      }
      var d = a("./keys"),
        e = a("./useragent"),
      ...
      (b.addListener = function (a, b, c) {
        ...
        (b.getButton = function (a) {
          return a.type == "dblclick"
            ? 0
            : a.type == "contextmenu" || (a.ctrlKey && e.isMac)
            ? 2
            : a.preventDefault
            ? a.button
        ...
        document.documentElement.setCapture
          ...
          : (b.capture = function (a, b, c) {
              function d(a) {
                b && b(a),
                  c && c(a),
                  document.removeEventListener("mousemove", b, !0),
        ...
        (b.addMouseWheelListener = function (a, c) {
          var d = 8,
            e = function (a) {
              a.wheelDelta !== undefined
                ? a.wheelDeltaX !== undefined
                  ? ((a.wheelX = -a.wheelDeltaX / d),
                    (a.wheelY = -a.wheelDeltaY / d))
                  : ((a.wheelX = 0), (a.wheelY = -a.wheelDelta / d))
                : a.axis && a.axis == a.HORIZONTAL_AXIS
                ? ((a.wheelX = (a.detail || 0) * 5), (a.wheelY = 0))
                : ((a.wheelX = 0), (a.wheelY = (a.detail || 0) * 5)),
                c(a);
            };
          b.addListener(a, "DOMMouseScroll", e),
            b.addListener(a, "mousewheel", e);
        }),
        (b.addMultiMouseDownListener = function (a, c, d, f) {
          var g = 0,
            ...
            i,
            j,
            k = { 2: "dblclick", 3: "tripleclick", 4: "quadclick" };
          b.addListener(a, "mousedown", function (a) {
            if (b.getButton(a) != 0) g = 0;
            else {
              var e =
                Math.abs(a.clientX - h) > 5 || Math.abs(a.clientY - i) > 5;
              if (!j || e) g = 0;
              (g += 1),
                j && clearTimeout(j),
            ...
            e.isOldIE &&
              b.addListener(a, "dblclick", function (a) {
                (g = 2),
                  j && clearTimeout(j),
                  (j = setTimeout(function () {
                    j = null;
      ...
      if (window.postMessage && !e.isOldIE) {
        ...
        b.nextTick = function (a, c) {
          ...
          b.addListener(c, "message", function e(f) {
            f.data == d &&
              (b.stopPropagation(f), b.removeListener(c, "message", e), a());
          }),
            c.postMessage(d, "*");
        };
      } else
        b.nextTick = function (a, b) {
      ...
      var d = a("./oop"),
        e = (function () {
          ...
          for (var b in a.FUNCTION_KEYS) {
            var c = a.FUNCTION_KEYS[b].toLowerCase();
            a[c] = parseInt(b, 10);
          }
          return (
  ...
  ace.define(
    ...
    ["require", "exports", "module"],
    function (a, b, c) {
      var d = (navigator.platform.match(/mac|win|linux/i) || [
          "other",
        ])[0].toLowerCase(),
      ...
      (b.isWin = d == "win"),
        ...
        (b.isChrome = parseFloat(e.split(" Chrome/")[1]) || undefined),
        (b.isAIR = e.indexOf("AdobeAIR") >= 0),
        (b.isIPad = e.indexOf("iPad") >= 0),
        (b.isTouchPad = e.indexOf("TouchPad") >= 0),
        (b.OS = { LINUX: "LINUX", MAC: "MAC", WINDOWS: "WINDOWS" }),
        (b.getOS = function () {
    ...
    function (a, b, c) {
      ...
      var d = a("./lib/oop"),
        ...
        q = function (a, b) {
          ...
          (this.container = c),
            (this.renderer = a),
            (this.commands = new o(f.isMac ? "mac" : "win", p)),
            (this.textInput = new g(a.getTextAreaContainer(), this)),
            (this.renderer.textarea = this.textInput.getElement()),
            (this.keyBinding = new j(this)),
            (this.$mouseHandler = new h(this)),
            new i(this),
            (this.$blockScrolling = 0),
            (this.$search = new l().set({ wrap: !0 })),
        ...
        d.implement(this, n),
          ...
          (this.setSession = function (a) {
            ...
            (this.session = a),
              ...
              a.addEventListener("tokenizerUpdate", this.$onTokenizerUpdate),
              ...
              a.addEventListener("changeFold", this.$onChangeFold),
              ...
              this._emit("changeSession", { session: a, oldSession: b });
          }),
            ...
            (this.$highlightPending = !0),
              setTimeout(function () {
                ...
                if (b) {
                  ...
                  a.session.$bracketHighlight = a.session.addMarker(
                    c,
                    "ace_bracket",
                    "text"
                  );
          ...
          (this.$updateHighlightActiveLine = function () {
            ...
            if (this.$highlightActiveLine) {
              ...
              if (
                this.getSelectionStyle() != "line" ||
                !this.selection.isMultiLine()
              ) {
                var d;
                c
                  ? (d = new m(c.start.row, 0, c.end.row + 1, 0))
                  : (d = new m(b.row, 0, b.row + 1, 0)),
                  (a.$highlightLineMarker = a.addMarker(
                    d,
                    "ace_active_line",
                    "background"
                  ));
          ...
          (this.$getSelectionHighLightRegexp = function () {
            ...
            if ((c >= 0 && /^[\w\d]/.test(g)) || (d <= f && /[\w\d]$/.test(g)))
              return;
          ...
          (this.insert = function (a) {
            ...
            if (!this.selection.isEmpty())
              (d = this.session.remove(this.getSelectionRange())),
                this.clearSelection();
            ...
            e &&
              e.selection &&
              (e.selection.length == 2
                ? this.selection.setSelectionRange(
                    new m(d.row, g + e.selection[0], d.row, g + e.selection[1])
                  )
                : this.selection.setSelectionRange(
                    new m(
                      d.row + e.selection[0],
            ...
            if (b.getDocument().isNewLine(a)) {
              ...
              for (var p = d.row + 1; p <= l.row; ++p) {
                var s = o;
                j = b.getLine(p);
                for (var r = 0; r < j.length && s > 0; ++r)
                  j.charAt(r) == "	" ? (s -= n) : j.charAt(r) == " " && (s -= 1);
          ...
          (this.setSelectionStyle = function (a) {
            ...
            (this.$selectionStyle = a),
              this.onSelectionChange(),
              this._emit("changeSelectionStyle", { data: a });
          }),
          ...
          (this.setShowFoldWidgets = function (a) {
            ...
            this.renderer.$gutterLayer.setShowFoldWidgets(a),
          ...
          (this.transposeLetters = function () {
            ...
            b < c.length
              ? ((d = c.charAt(b) + c.charAt(b - 1)),
                (e = new m(a.row, b - 1, a.row, b + 1)))
              : ((d = c.charAt(b - 1) + c.charAt(b - 2)),
                (e = new m(a.row, b - 2, a.row, b))),
          ...
          (this.removeLines = function () {
            var a = this.$getSelectedRows(),
              b;
            a.first === 0 || a.last + 1 < this.session.getLength()
              ? (b = new m(a.first, 0, a.last + 1, 0))
              : (b = new m(
                  a.first - 1,
                  this.session.getLine(a.first - 1).length,
                  a.last,
                  this.session.getLine(a.last).length
                )),
          ...
          (this.$moveLines = function (a) {
            ...
            d
              ...
              : (c.setSelectionAnchor(b.last + f + 1, 0),
          ...
          (this.isRowVisible = function (a) {
            return (
              a >= this.getFirstVisibleRow() && a <= this.getLastVisibleRow()
            );
          }),
          ...
          (this.$moveByPage = function (a, b) {
            ...
            c.scrollBy(0, e * d.lineHeight),
              b != null && c.scrollCursorIntoView(null, 0.5),
          ...
          (this.jumpToMatching = function (a) {
            ...
            if (!c) {
              ...
              var d = c.start;
              d.row == b.row &&
                Math.abs(d.column - b.column) < 2 &&
                (c = this.session.getBracketRange(d));
            }
            (d = (c && c.cursor) || d),
              d &&
                (a
                  ? c && c.isEqual(this.getSelectionRange())
                    ? this.clearSelection()
          ...
          (this.gotoLine = function (a, b, c) {
            this.selection.clearSelection(),
              ...
              (this.$blockScrolling -= 1),
              this.isRowFullyVisible(a - 1) || this.scrollToLine(a - 1, !0, c);
          }),
          ...
          (this.navigateFileEnd = function () {
            ...
            this.selection.moveCursorFileEnd(),
              this.clearSelection(),
              this.renderer.animateScrolling(a);
          }),
          ...
          (this.$tryReplace = function (a, b) {
            ...
            return (
              ...
              b !== null ? ((a.end = this.session.replace(a, b)), a) : null
            );
          }),
          ...
          (this.revealRange = function (a, b) {
            ...
            this.renderer.scrollSelectionIntoView(a.start, a.end, 0.5),
              b != 0 && this.renderer.animateScrolling(c);
          }),
          (this.undo = function () {
            this.$blockScrolling++,
      ...
      var d = a("../lib/event"),
        ...
        g = function (a, b) {
          function l(a) {
            try {
              a
                ? ((c.value = g), (c.selectionStart = 0), (c.selectionEnd = 1))
                : c.select();
            } catch (b) {}
          }
          function m(a) {
            if (!i) {
              ...
              d &&
                (d.length > 1 &&
                  (d.charAt(0) == g
                    ? (d = d.substr(1))
                    : d.charAt(d.length - 1) == g && (d = d.slice(0, -1))),
                d && d != g && (j ? b.onPaste(d) : b.onTextInput(d)));
            }
            (i = !1), (j = !1), l(!0);
          }
          function v() {
          ...
          function w() {
            setTimeout(function () {
              k && ((c.style.cssText = k), (k = "")),
                m(),
                b.renderer.$keepTextAreaAtCursor == null &&
                  ((b.renderer.$keepTextAreaAtCursor = !0),
                  b.renderer.$moveTextAreaToCursor());
            }, 0);
          }
          var c = f.createElement("textarea");
          e.isTouchPad && c.setAttribute("x-palm-disable-auto-cap", !0),
          ...
          d.addListener(c, "paste", function (a) {
            (j = !0),
              a.clipboardData && a.clipboardData.getData
                ? (m(a.clipboardData.getData("text/plain")), a.preventDefault())
                : o();
          }),
            "onbeforecopy" in c && typeof clipboardData != "undefined"
              ? (d.addListener(c, "beforecopy", function (a) {
                  if (k) return;
                  var c = b.getCopyText();
                ...
                d.addListener(c, "cut", t))
              : !e.isOpera || "KeyboardEvent" in window
              ? (d.addListener(c, "copy", s), d.addListener(c, "cut", t))
              : d.addListener(a, "keydown", function (a) {
                  if ((e.isMac && !a.metaKey) || !a.ctrlKey) return;
                  if (a.keyCode == 88 || a.keyCode == 67) {
                    var d = b.getCopyText();
                    d &&
                      ((c.value = d), c.select(), a.keyCode == 88 && b.onCut());
                  }
                }),
            d.addListener(c, "compositionstart", p),
            e.isGecko && d.addListener(c, "text", q),
            e.isWebKit && d.addListener(c, "keyup", q),
            d.addListener(c, "compositionend", r),
            ...
            (this.onContextMenu = function (a) {
              k || (k = c.style.cssText),
                (c.style.cssText =
                  ...
                  (e.isIE
                    ? "background:rgba(0, 0, 0, 0.03); opacity:0.1;"
                    : "") +
                  "left:" +
                  (a.clientX - 2) +
                  "px; top:" +
                  (a.clientY - 2) +
                  "px;"),
                b.selection.isEmpty() ? (c.value = "") : l(!0);
              ...
              b.renderer.$keepTextAreaAtCursor &&
                ...
                e.isWin &&
                  ...
                  d.capture(
                    b.container,
                    function (a) {
                      (c.style.left = a.clientX - 2 + "px"),
                        (c.style.top = a.clientY - 2 + "px");
                    },
                    w
                  );
            }),
            ...
            e.isGecko ||
              d.addListener(c, "contextmenu", function (a) {
    ...
    function (a, b, c) {
      var d = a("../lib/event"),
        ...
        j = function (a) {
          ...
          d.addListener(b, "click", this.onMouseEvent.bind(this, "click")),
            d.addListener(
              b,
              "mousemove",
        ...
        (this.$scrollSpeed = 1),
          ...
          (this.captureMouse = function (a, b) {
            ...
            var f = this,
              ...
              h = function (a) {
                clearInterval(j),
                  f[f.state + "End"] && f[f.state + "End"](a),
                  (f.$clickSelection = null),
                  c.$keepTextAreaAtCursor == null &&
                    ((c.$keepTextAreaAtCursor = !0), c.$moveTextAreaToCursor());
              },
              i = function () {
                f[f.state] && f[f.state]();
              };
  ...
  ace.define(
    "ace/mouse/default_handlers",
    ["require", "exports", "module", "ace/lib/dom", "ace/lib/useragent"],
    function (a, b, c) {
      function g(a) {
      ...
      function i(a, b) {
        if (a.start.row == a.end.row)
          var c = 2 * b.column - a.start.column - a.end.column;
        else var c = 2 * b.row - a.start.row - a.end.row;
        return c < 0
          ? { cursor: a.start, anchor: a.end }
          : { cursor: a.end, anchor: a.start };
      }
      var d = a("../lib/dom"),
        e = a("../lib/useragent"),
        f = 5;
        ...
        (this.onMouseDown = function (a) {
          ...
          if (e !== 0) {
            var f = d.getSelectionRange(),
              g = f.isEmpty();
            g && (d.moveCursorToPosition(c), d.selection.clearSelection()),
              d.textInput.onContextMenu(a.domEvent);
            return;
          }
          if (b && !d.isFocused()) {
            d.focus();
          ...
          return (
            !b || this.$clickSelection || a.getShiftKey()
              ? this.startSelect(c)
              : b &&
          ...
          (this.startSelect = function (a) {
            (a =
              ...
              this.mousedownEvent.getShiftKey()
                ? this.editor.selection.selectToPosition(a)
                : this.$clickSelection ||
                  (this.editor.moveCursorToPosition(a),
          ...
          (this.extendSelectionBy = function (a) {
            ...
            if (this.$clickSelection) {
              ...
              if (f == -1 && g <= 0) {
                ...
                if (e.start.row != d.row || e.start.column != d.column)
                  d = e.end;
          ...
          (this.startDrag = function () {
            ...
            (this.dragSelectionMarker = a.session.addMarker(
              this.dragRange,
              "ace_selection",
              b
            )),
              a.clearSelection(),
              d.addCssClass(a.container, "ace_dragging"),
              this.$dragKeybinding ||
                (this.$dragKeybinding = {
          ...
          (this.focusWait = function () {
            var a = h(
              ...
              b = new Date().getTime();
            (a > f || b - this.mousedownEvent.time > this.$focusWaitTimout) &&
              this.startSelect();
          }),
          (this.dragWait = function (a) {
            ...
            b > f
              ...
              : c - this.mousedownEvent.time > d.getDragDelay() &&
                this.startDrag();
          }),
          ...
          (this.drag = function () {
            var a = this.editor;
            (this.dragCursor = a.renderer.screenToTextCoordinates(
              this.x,
              this.y
            )),
          ...
          (this.dragEnd = function (a) {
            var b = this.editor,
              c = this.dragCursor,
              e = this.dragRange;
            d.removeCssClass(b.container, "ace_dragging"),
              b.session.removeMarker(this.dragSelectionMarker),
              b.keyBinding.removeKeyboardHandler(this.$dragKeybinding);
            if (!c) return;
            b.clearSelection();
          ...
          (this.onDoubleClick = function (a) {
            ...
            if (e) {
              e.isEmpty() && (e.start.column--, e.end.column++),
                (this.$clickSelection = e),
                this.setState("select");
              return;
            }
            (this.$clickSelection = c.selection.getWordRange(b.row, b.column)),
          ...
          (this.onMouseWheel = function (a) {
            if (a.getShiftKey() || a.getAccelKey()) return;
            var b = this.editor,
              c = b.renderer.isScrollableBy(
                a.wheelX * a.speed,
                a.wheelY * a.speed
              );
  ...
  ace.define(
    "ace/mouse/default_gutter_handler",
    ["require", "exports", "module", "ace/lib/dom", "ace/lib/event"],
    function (a, b, c) {
      function f(a) {
        function j() {
          (h = d.createElement("div")),
            (h.className = "ace_gutter_tooltip"),
        ...
        function l() {
          f && (f = clearTimeout(f)),
            i &&
              ((h.style.display = "none"),
              (i = null),
              b.removeEventListener("mousewheel", l));
        }
        function m(a) {
          var c = b.renderer.$gutter.getBoundingClientRect();
          (h.style.left = a.x - c.left + 15 + "px"),
            a.y + 3 * b.renderer.lineHeight + 15 < c.bottom
              ? ((h.style.bottom = ""), (h.style.top = a.y - c.top + 15 + "px"))
              : ((h.style.top = ""),
                (h.style.bottom = c.bottom - a.y + 5 + "px"));
        }
        var b = a.editor,
        ...
        a.editor.setDefaultHandler("guttermousedown", function (d) {
          ...
          return (
            ...
            a.captureMouse(d, "selectByLines"),
            d.preventDefault()
          );
        });
        var f, g, h, i;
        ...
        e = function (a) {
          ...
          d.addListener(l, "dragenter", function (a) {
            ...
            if (!c) {
              ...
              (c = b.session.addMarker(h, "ace_selection", e)),
                b.clearSelection(),
                clearInterval(g),
                (g = setInterval(m, 20));
            }
          ...
          var m = function () {
            (j = b.renderer.screenToTextCoordinates(e, f)),
              b.moveCursorToPosition(j),
          ...
          d.addListener(l, "dragleave", function (a) {
            ...
            if (k > 0) return;
            return (
              console.log(a.type, k, a.target),
              clearInterval(g),
              b.session.removeMarker(c),
              (c = null),
              b.selection.setSelectionRange(h, i),
              d.preventDefault(a)
            );
          }),
            d.addListener(l, "drop", function (a) {
              return (
                ...
                b.session.removeMarker(c),
                (c = null),
                (h.end = b.session.insert(j, a.dataTransfer.getData("Text"))),
                (h.start = j),
                b.focus(),
                b.selection.setSelectionRange(h),
                d.preventDefault(a)
              );
            });
        };
        ...
        a.on("click", function (b) {
          ...
          a.on("gutterclick", function (b) {
            ...
            if (c == "foldWidgets") {
              ...
              e.foldWidgets &&
                e.foldWidgets[d] &&
                a.session.onFoldWidgetClick(d, b),
                b.stop();
            }
          });
      }
      ...
      (function () {
        (this.setDefaultHandler = function (a) {
          ...
          (this.addKeyboardHandler = function (a, b) {
            ...
            c != -1 && this.$handlers.splice(c, 1),
              b == undefined
                ? this.$handlers.push(a)
                : this.$handlers.splice(b, 0, a),
              c == -1 && a.attach && a.attach(this.$editor);
          }),
          ...
          (this.$callKeyboardHandlers = function (a, b, c, d) {
            ...
            return (
              f.command != "null"
                ? (h = i.exec(f.command, this.$editor, f.args, d))
                : (h = f.passEvent != 1),
              h && d && a != -1 && e.stopEvent(d),
              h
            );
          }),
          (this.onCommandKey = function (a, b, c) {
      ...
      var d = a("./config"),
        ...
        o = function (a, b) {
          (this.$modified = !0),
            ...
            typeof a == "object" && a.getLine
              ? this.setDocument(a)
              : this.setDocument(new l(a)),
        ...
        e.implement(this, h),
          ...
          (this.onChange = function (a) {
            ...
            !this.$fromUndo &&
              this.$undoManager &&
              !b.ignore &&
              (this.$deltasDoc.push(b),
              c &&
                c.length != 0 &&
                this.$deltasFold.push({ action: "removeFolds", folds: c }),
              this.$informUndoManager.schedule()),
              this.bgTokenizer.$updateOnChange(b),
              this._emit("change", a);
          }),
          ...
          (this.getTokenAt = function (a, b) {
            ...
            return (
              (d = c[f]),
              d ? ((d.index = f), (d.start = e - d.value.length), d) : null
            );
          }),
            ...
            if (a) {
              ...
              (this.$syncInformUndoManager = function () {
                b.$informUndoManager.cancel(),
                  b.$deltasFold.length &&
                    (b.$deltas.push({ group: "fold", deltas: b.$deltasFold }),
                    (b.$deltasFold = [])),
                  b.$deltasDoc.length &&
                    (b.$deltas.push({ group: "doc", deltas: b.$deltasDoc }),
                    (b.$deltasDoc = [])),
                  b.$deltas.length > 0 &&
                    a.execute({ action: "aceupdate", args: [b.$deltas, b] }),
                  (b.$deltas = []);
              }),
                (this.$informUndoManager = f.deferredCall(
          ...
          (this.getTabString = function () {
            return this.getUseSoftTabs()
              ? f.stringRepeat(" ", this.getTabSize())
              : "	";
          }),
          (this.$useSoftTabs = !0),
          ...
          (this.addMarker = function (a, b, c, d) {
            ...
            return (
              d
                ? ((this.$frontMarkers[e] = f), this._emit("changeFrontMarker"))
                : ((this.$backMarkers[e] = f), this._emit("changeBackMarker")),
              e
            );
          }),
          (this.addDynamicMarker = function (a, b) {
            ...
            return (
              ...
              (a.inFront = !!b),
              b
                ? ((this.$frontMarkers[c] = a), this._emit("changeFrontMarker"))
                : ((this.$backMarkers[c] = a), this._emit("changeBackMarker")),
              a
            );
          }),
          (this.removeMarker = function (a) {
            ...
            b &&
              (delete c[a],
              this._emit(b.inFront ? "changeFrontMarker" : "changeBackMarker"));
          }),
          ...
          (this.setAnnotations = function (a) {
            ...
            for (var b = 0; b < a.length; b++) {
              var c = a[b],
                d = c.row;
              this.$annotations[d]
                ? this.$annotations[d].push(c)
                : (this.$annotations[d] = [c]);
            }
          ...
          (this.$modes = {}),
          (this._loadMode = function (b, c) {
            function i(a) {
              if (e.$modes[b]) return c(e.$modes[b]);
              (e.$modes[b] = new a.Mode()),
                (e.$modes[b].$id = b),
                e._emit("loadmode", { name: b, mode: e.$modes[b] }),
                c(e.$modes[b]);
            }
            function k(a, b) {
            ...
            this.$modes["null"] ||
              (this.$modes["null"] = this.$modes["ace/mode/text"] = new j());
          ...
          (this.$startWorker = function () {
            if (typeof Worker != "undefined" && !a.noWorker)
              try {
          ...
          (this.$computeWidth = function (a) {
            if (this.$modified || a) {
              ...
              for (var i = 0; i < h; i++) {
                ...
                c[i] == null && (c[i] = this.$getStringScreenWidth(b[i])[0]),
                  c[i] > d && (d = c[i]);
              }
              this.screenWidth = d;
            }
            ...
            for (var d = a.length - 1; d != -1; d--) {
              ...
              e.group == "doc"
                ? (this.doc.revertDeltas(e.deltas),
                  (c = this.$getUndoSelection(e.deltas, !0, c)))
          ...
          (this.redoChanges = function (a, b) {
            ...
            for (var d = 0; d < a.length; d++) {
              ...
              e.group == "doc" &&
                ...
                (c = this.$getUndoSelection(e.deltas, !1, c)));
            }
            return (
              (this.$fromUndo = !1),
              c &&
          ...
          (this.$getUndoSelection = function (a, b, c) {
            ...
            d(e)
              ? ((f = e.range.clone()), (h = !0))
              : ((f = k.fromPoints(e.range.start, e.range.start)), (h = !1));
            for (var i = 1; i < a.length; i++)
              (e = a[i]),
                d(e)
                  ? ((g = e.range.start),
                    f.compare(g.row, g.column) == -1 &&
                      f.setStart(e.range.start),
                    (g = e.range.end),
                    f.compare(g.row, g.column) == 1 && f.setEnd(e.range.end),
                    (h = !0))
                  : ((g = e.range.start),
                    f.compare(g.row, g.column) == -1 &&
                      (f = k.fromPoints(e.range.start, e.range.start)),
                    (h = !1));
            if (c != null) {
          ...
          (this.outdentRows = function (a) {
            ...
            for (var e = b.start.row; e <= b.end.row; ++e) {
              ...
              g < d && f.charAt(g) == "	"
                ? ((c.start.column = g), (c.end.column = g + 1))
                : ((c.start.column = 0), (c.end.column = g)),
                this.remove(c);
            }
          }),
          ...
          (this.$clipPositionToDocument = function (a, b) {
            ...
            if (a < 0) (a = 0), (b = 0);
              ...
              a >= c
                ? ((a = c - 1), (b = this.doc.getLine(c - 1).length))
          ...
          (this.$clipRangeToDocument = function (a) {
            ...
            return (
              a.end.row > b
                ? ((a.end.row = b), (a.end.column = this.doc.getLine(b).length))
          ...
          (this.$updateInternalDataOnChange = function (a) {
            var b = this.$useWrapMode,
              ...
              i = null;
            d.indexOf("Lines") != -1
              ? (d == "insertLines" ? (f = e + a.data.lines.length) : (f = e),
                (c = a.data.lines ? a.data.lines.length : f - e))
              : (c = f - e);
            if (c != 0)
              if (d.indexOf("remove") != -1) {
                ...
                var k = this.getFoldLine(h.row),
                  l = 0;
                if (k) {
                  k.addRemoveChars(h.row, h.column, g.column - h.column),
                    k.shiftRow(-c);
                ...
                if (b) {
                  ...
                  (n = Array(c)),
                    n.unshift(e, 0),
                    this.$rowLengthCache.splice.apply(this.$rowLengthCache, n);
                var j = this.$foldData,
                ...
                if (k) {
                  ...
                  p == 0
                    ? ((k = k.split(g.row, g.column)),
                      k.shiftRow(c),
                      k.addRemoveChars(f, 0, h.column - g.column))
                    : p == -1 &&
                      (k.addRemoveChars(e, 0, h.column - g.column),
                      k.shiftRow(c)),
                    (l = j.indexOf(k) + 1);
                }
                for (l; l < j.length; l++) {
              ...
              (c = Math.abs(
                a.data.range.start.column - a.data.range.end.column
              )),
                d.indexOf("remove") != -1 &&
                  ((i = this.getFoldsInRange(a.data.range)),
                  this.removeFolds(i),
                  (c = -c));
            ...
            return (
              ...
              b ? this.$updateWrapData(e, f) : this.$updateRowLengthCache(e, f),
              i
            );
          }),
          ...
          (this.$updateWrapData = function (a, b) {
            ...
            while (k <= b) {
              ...
              if (!j)
                (h = this.$getDisplayTokens(f.stringTrimRight(c[k]))),
                  (e[k] = this.$computeWrapSplits(h, g, d)),
                  k++;
              else {
                (h = []),
                  j.walk(
                    ...
                    j.end.row,
                    c[j.end.row].length + 1
                  );
                while (h.length != 0 && h[h.length - 1] >= p) h.pop();
                (e[j.start.row] = this.$computeWrapSplits(h, g, d)),
                  (k = j.end.row + 1);
              }
            }
          });
          ...
          (this.screenToDocumentPosition = function (a, b) {
            ...
            while (g <= a) {
              ...
              (g += h),
                ...
                d > n &&
                  ((d = m.end.row + 1),
                  (m = this.getNextFoldLine(d, m)),
                  (n = m ? m.start.row : Infinity)),
                k && (this.$docRowCache.push(d), this.$screenRowCache.push(g));
            }
            if (m && m.start.row <= d)
              (c = this.getFoldDisplayLine(m)), (d = m.start.row);
            else {
              if (g + h <= a || d > l)
                return { row: l, column: this.getLine(l).length };
            ...
            if (this.$useWrapMode) {
              ...
              o &&
                ...
                a > g &&
                  o.length &&
                  ((e = o[a - g - 1] || o[o.length - 1]),
                  (c = c.substring(e))));
            }
            return (
              (e += this.$getStringScreenWidth(c, b)[1]),
              this.$useWrapMode && e >= f && (e = f - 1),
              m ? m.idxToPosition(e) : { row: d, column: e }
            );
          }),
          (this.documentToScreenPosition = function (a, b) {
            if (typeof b == "undefined")
              var c = this.$clipPositionToDocument(a.row, a.column);
            ...
            (f = this.getFoldAt(a, b, 1)),
              f && ((a = f.start.row), (b = f.start.column));
            var g,
              h = 0,
              i = this.$docRowCache,
              j = this.$getRowCacheIndex(i, a);
            ...
            while (h < a) {
              if (h >= m) {
                g = l.end.row + 1;
                if (g > a) break;
                (l = this.getNextFoldLine(g, l)),
                  (m = l ? l.start.row : Infinity);
              } else g = h + 1;
              (d += this.getRowLength(h)),
                (h = g),
                k && (this.$docRowCache.push(h), this.$screenRowCache.push(d));
            }
            var n = "";
            l && h >= m
              ? ((n = this.getFoldDisplayLine(l, a, b)), (e = l.start.row))
              : ((n = this.getLine(a).substring(0, b)), (e = a));
            if (this.$useWrapMode) {
      ...
      (b.get = function (a) {
        ...
        (b.moduleUrl = function (a, b) {
          ...
          var d = c[c.length - 1]
            ...
            .replace(/(^[\-_])|([\-_]$)/, "");
          return (
            !d && c.length > 1 && (d = c[c.length - 2]),
            this.get(b + "Path") + "/" + b + "-" + d + this.get("suffix")
          );
        }),
        ...
        (b.init = function () {
          f.packaged =
            a.packaged || c.packaged || (e.define && define.packaged);
          ...
          for (var j = 0; j < i.length; j++) {
            ...
            for (var n = 0, o = m.length; n < o; n++) {
              var p = m[n];
              p.name.indexOf("data-ace-") === 0 &&
                (d[g(p.name.replace(/^data-ace-/, ""))] = p.value);
            }
            var q = l.match(/^(.*)\/ace(\-\w+)?\.js(\?|$)/);
            q && (h = q[1]);
          }
          h && ((d.base = d.base || h), (d.packaged = !0)),
            (d.workerPath = d.workerPath || d.base),
            (d.modePath = d.modePath || d.base),
            (d.themePath = d.themePath || d.base),
            delete d.base;
      ...
      var d = a("./lib/oop"),
        ...
        h = function (a) {
          ...
          this.lead.on("change", function (a) {
            b._emit("changeCursor"),
              b.$isEmpty || b._emit("changeSelection"),
              !b.$keepDesiredColumnOnChange &&
                a.old.column != a.value.column &&
                (b.$desiredColumn = null);
          }),
        ...
        d.implement(this, f),
          ...
          (this.getLineRange = function (a, b) {
            var c = typeof a == "number" ? a : this.lead.row,
              d,
              e = this.session.getFoldLine(c);
            return (
              e ? ((c = e.start.row), (d = e.end.row)) : (d = c),
              b
                ? new g(c, 0, d, this.session.getLine(d).length)
                : new g(c, 0, d + 1, 0)
            );
          }),
          ...
          (this.moveCursorLineStart = function () {
            ...
            f[0].length == b
              ? this.moveCursorTo(d.row, d.column)
              : this.moveCursorTo(d.row, d.column + f[0].length);
          }),
          (this.moveCursorLineEnd = function () {
            var a = this.lead,
              b = this.session.getDocumentLastRowColumnPosition(
                a.row,
                a.column
              );
          ...
          (this.moveCursorLongWordRight = function () {
            ...
            if ((e = this.session.nonTokenRe.exec(d)))
            ...
            if ((e = this.session.tokenRe.exec(d)))
          ...
          (this.moveCursorLongWordLeft = function () {
            ...
            (this.session.nonTokenRe.lastIndex = 0),
              (this.session.tokenRe.lastIndex = 0);
            if ((g = this.session.nonTokenRe.exec(f)))
              (b -= this.session.nonTokenRe.lastIndex),
            ...
            if (b <= 0) {
              this.moveCursorTo(a, 0),
                this.moveCursorLeft(),
                a > 0 && this.moveCursorWordLeft();
              return;
            }
            if ((g = this.session.tokenRe.exec(f)))
              (b -= this.session.tokenRe.lastIndex),
                (this.session.tokenRe.lastIndex = 0);
            this.moveCursorTo(a, b);
          }),
          (this.$shortWordEndIndex = function (a) {
            ...
            f.lastIndex = 0;
            if ((b = this.session.tokenRe.exec(a)))
          ...
          (this.moveCursorShortWordLeft = function () {
            var a = this.lead.row,
              ...
              c;
            if ((c = this.session.getFoldAt(a, b, -1)))
              return this.moveCursorTo(c.start.row, c.start.column);
          ...
          (this.moveCursorTo = function (a, b, c) {
            ...
            d && ((a = d.start.row), (b = d.start.column)),
      ...
      (function () {
        (this.tokenRe = new RegExp(
          ...
          (this.createModeDelegates = function (a) {
            ...
            this.$modes = {};
            for (var b = 0; b < this.$embeds.length; b++)
              a[this.$embeds[b]] &&
                (this.$modes[this.$embeds[b]] = new a[this.$embeds[b]]());
            var c = [
              "toggleCommentLines",
              "getNextLineIndent",
              "checkOutdent",
      ...
      var d = function (a, b) {
        ...
        for (var c in this.rules) {
          ...
          for (var i = 0; i < e.length; i++) {
            e[i].regex instanceof RegExp &&
              (e[i].regex = e[i].regex.toString().slice(1, -1));
            var j =
                new RegExp("(?:(" + e[i].regex + ")|(.))").exec("a").length - 2,
              k = e[i].regex.replace(/\\([0-9]+)/g, function (a, b) {
                return "\\" + (parseInt(b, 10) + g + 1);
              });
            if (j > 1 && e[i].token.length !== j - 1)
              throw new Error(
                "For " +
                  e[i].regex +
                  " the matching groups and length of the token array don't match (rule #" +
                  i +
                  " of state " +
                  c +
                  ")"
        ...
        this.getLineTokens = function (a, b) {
          ...
          while ((g = f.exec(a))) {
            ...
            for (var n = 0; n < g.length - 2; n++) {
              ...
              (l = d[e[n].rule]),
                e[n].len > 1 && (m = g.slice(n + 2, n + 1 + e[n].len)),
                typeof l.token == "function"
                  ? (k = l.token.apply(this, m))
                  : (k = l.token);
              if (l.next) {
                (c = l.next),
                  (d = this.rules[c]),
                ...
                if (f === undefined)
                  throw new Error(
                    "You indicated a state of " +
                      l.next +
                      " to go to, but it doesn't exist!"
                  );
                f.lastIndex = i;
              }
              break;
            ...
            if (m[0]) {
              ...
              for (var n = 0; n < m.length; n++) {
                if (!m[n]) continue;
                (!l || l.merge || k[n] === "text") && j.type === k[n]
                  ? (j.value += m[n])
                  : (j.type && h.push(j), (j = { type: k[n], value: m[n] }));
              }
            }
            if (i == a.length) break;
            i = f.lastIndex;
        ...
        (this.addRules = function (a, b) {
          ...
          (this.embedRules = function (a, b, c, e) {
            ...
            for (var g = 0; g < e.length; g++)
              Array.prototype.unshift.apply(this.$rules[e[g]], d.deepCopy(c));
        ...
        (this.add = function (a, b, c) {
          ...
          (this.getBehaviours = function (a) {
            ...
            for (var c = 0; c < a.length; c++)
              this.$behaviours[a[c]] && (b[a[c]] = this.$behaviours[a[c]]);
            return b;
          });
      }).call(d.prototype),
        (b.Behaviour = d);
          ...
          this.$worker = function () {
            ...
            while (c.currentLine < f) {
              ...
              if (e % 5 == 0 && new Date() - a > 20) {
                c.fireUpdateEvent(b, c.currentLine - 1),
      ...
      (function () {
        d.implement(this, e),
          ...
          (this.$updateOnChange = function (a) {
            ...
            else if (a.action == "removeText" || a.action == "removeLines")
              this.lines.splice(c, d + 1, null),
                this.states.splice(c, d + 1, null);
            else {
              var e = Array(d + 1);
              e.unshift(c, 1),
          ...
          (this.getState = function (a) {
            return (
              this.currentLine == a && this.$tokenizeRow(a),
              this.states[a] || "start"
            );
          }),
          (this.$tokenizeRow = function (a) {
            ...
            return (
              d && (e.tokens.push(d), (e.state = "start")),
              this.states[a] !== e.state
                ? ((this.states[a] = e.state),
                  (this.lines[a + 1] = null),
                  this.currentLine > a + 1 && (this.currentLine = a + 1))
                : this.currentLine == a && (this.currentLine = a + 1),
              (this.lines[a] = e.tokens)
            );
          });
      }).call(g.prototype),
        (b.BackgroundTokenizer = g);
    }
  ),
  ace.define(
    "ace/search_highlight",
        ...
        (this.getFoldAt = function (a, b, c) {
          ...
          (this.getAllFolds = function () {
            ...
            for (var d = 0; d < b.length; d++)
              for (var e = 0; e < b[d].folds.length; e++) c(b[d].folds[e]);
            return a;
          }),
          (this.getFoldStringAt = function (a, b, c, d) {
            ...
            for (var h = 0; h < d.folds.length; h++) {
              ...
              if (i == -1) {
                f = this.getLine(g.start.row).substring(
                  e.end.column,
                  g.start.column
                );
                break;
            ...
            return (
              f || (f = this.getLine(g.start.row).substring(e.end.column)),
              c == -1
                ? f.substring(0, b - e.end.column)
                : c == 1
                ? f.substring(b - e.end.column)
                : f
            );
          }),
          ...
          (this.addFold = function (a, b) {
            var c = this.$foldData,
              d = !1,
              g;
            a instanceof f ? (g = a) : (g = new f(b, a)),
              this.$clipRangeToDocument(g.range);
            var h = g.start.row,
              i = g.start.column,
              j = g.end.row,
              k = g.end.column;
            if (g.placeholder.length < 2)
            ...
            if ((l && !l.range.isStart(h, i)) || (m && !m.range.isEnd(j, k)))
              throw (
          ...
          (this.unfold = function (a, b) {
            ...
            if (b) this.removeFolds(e);
              ...
              while (e.length)
                this.expandFolds(e), (e = this.getFoldsInRange(c));
          }),
          ...
          (this.getFoldDisplayLine = function (a, b, c, d, e) {
            d == null && ((d = a.start.row), (e = 0)),
              b == null && ((b = a.end.row), (c = this.getLine(b).length));
            var f = this.doc,
              g = "";
            return (
              a.walk(
          ...
          (this.getDisplayLine = function (a, b, c, d) {
            ...
            if (!e) {
              var f;
              return (
                (f = this.doc.getLine(a)), f.substring(d || 0, b || f.length)
              );
            }
          ...
          (this.toggleFold = function (a) {
            ...
            if (c.isEmpty()) {
              ...
              (e = this.findMatchingBracket(f))
                ? c.comparePoint(e) == 1
                  ? (c.end = e)
                  : ((c.start = e), c.start.column++, c.end.column--)
                : (e = this.findMatchingBracket({
                    row: f.row,
                    column: f.column + 1,
                  }))
                ? (c.comparePoint(e) == 1 ? (c.end = e) : (c.start = e),
                  c.start.column++)
          ...
          (this.getCommentFoldRange = function (a, b) {
            ...
            if (e && /^comment|string/.test(e.type)) {
              ...
              c.stepForward(),
                (f.start.row = c.getCurrentTokenRow()),
                (f.start.column = c.getCurrentTokenColumn() + 2),
                (c = new g(this, a, b));
              do e = c.stepForward();
              while (e && h.test(e.type));
              return (
                (e = c.stepBackward()),
                (f.end.row = c.getCurrentTokenRow()),
                (f.end.column = c.getCurrentTokenColumn() + e.value.length),
                f
              );
            }
          }),
          ...
          (this.onFoldWidgetClick = function (a, b) {
            var c = this.getFoldWidget(a),
              ...
              g;
            c == "end"
              ? (g = this.getFoldAt(a, 0, -1))
              : (g = this.getFoldAt(a, d.length, 1));
            if (g) {
            ...
            if (h) {
              ...
              e || this.addFold("...", h),
                f && this.foldAll(h.start.row + 1, h.end.row);
            } else
              f && this.foldAll(a + 1, this.getLength()),
                ((b.target || b.srcElement).className += " invalid");
          }),
          (this.updateFoldWidgets = function (a) {
            ...
            else if (b.action == "removeText" || b.action == "removeLines")
              this.foldWidgets.splice(d, e + 1, null);
            else {
              var f = Array(e + 1);
              f.unshift(d, 1),
                this.foldWidgets.splice.apply(this.foldWidgets, f);
            }
          });
      }
      var d = a("../range").Range,
      ...
      (function () {
        (this.shiftRow = function (a) {
          ...
          (this.addFold = function (a) {
            if (a.sameRow) {
              ...
              this.folds.push(a),
                ...
                this.range.compareEnd(a.start.row, a.start.column) > 0
                  ? ((this.end.row = a.end.row),
                    (this.end.column = a.end.column))
                  : this.range.compareStart(a.end.row, a.end.column) < 0 &&
                    ((this.start.row = a.start.row),
                    (this.start.column = a.start.column));
          ...
          (this.split = function (a, b) {
            ...
            var g = d.indexOf(c),
              h = d[g - 1];
            (this.end.row = h.end.row),
              (this.end.column = h.end.column),
              (d = d.splice(g, d.length - g));
            var i = new e(f, d);
          ...
          (this.idxToPosition = function (a) {
            ...
            for (var d = 0; d < this.folds.length; d++) {
              ...
              a -= c.start.column - b;
              if (a < 0)
                return { row: c.start.row, column: c.start.column + a };
    ...
    function (a, b, c) {
      function f() {
        (this.findMatchingBracket = function (a) {
          ...
          return c
            ? c[1]
              ? this.$findClosingBracket(c[1], a)
              : this.$findOpeningBracket(c[2], a)
            : null;
        }),
          (this.getBracketRange = function (a) {
            var b = this.getLine(a.row),
              c = !0,
              d,
              f = b.charAt(a.column - 1),
              g = f && f.match(/([\(\[\{])|([\)\]\}])/);
            g ||
              ((f = b.charAt(a.column)),
              (a = { row: a.row, column: a.column + 1 }),
              (g = f && f.match(/([\(\[\{])|([\)\]\}])/)),
              (c = !1));
            if (!g) return null;
            if (g[1]) {
              ...
              if (!h) return null;
              (d = e.fromPoints(a, h)),
                c || (d.end.column++, d.start.column--),
                (d.cursor = d.end);
            } else {
              var h = this.$findOpeningBracket(g[2], a);
              if (!h) return null;
              (d = e.fromPoints(h, a)),
                c || (d.start.column++, d.end.column--),
                (d.cursor = d.start);
            }
            return d;
          }),
          ...
          (this.$findOpeningBracket = function (a, b, c) {
            ...
            c ||
              (c = new RegExp(
                "(\\.?" +
                  h.type.replace(".", "\\.").replace("rparen", ".paren") +
                  ")+"
              ));
          ...
          (this.$findClosingBracket = function (a, b, c) {
            ...
            c ||
              (c = new RegExp(
                "(\\.?" +
                  h.type.replace(".", "\\.").replace("lparen", ".paren") +
                  ")+"
              ));
      ...
      (function () {
        (this.set = function (a) {
          ...
          (this.findAll = function (a) {
            ...
            if (c) {
              ...
              while (
                q < l &&
                g[q].start.column < t &&
                g[q].start.row == c.start.row
              )
                q++;
              while (q < l && g[l].end.column > u && g[l].end.row == c.end.row)
                l--;
              ...
              var i = c.length,
                j = function (b, d, e) {
                  ...
                  var k = b.match(c[i - 1])[0].length,
                    l = new f(d, h, d + i - 1, k);
                  c.offset == 1
                    ? (l.start.row--, (l.start.column = Number.MAX_VALUE))
                    : e && (l.start.column += e);
                  if (g(l)) return !0;
                };
            else if (h)
          ...
          (this.$assembleRegExp = function (a) {
            ...
            a.regExp || (b = d.escapeRegExp(b)),
              a.wholeWord && (b = "\\b" + b + "\\b");
            var c = a.caseSensitive ? "g" : "gi";
            a.$isMultiLine = /[\n\r]/.test(b);
            if (a.$isMultiLine)
              return (a.re = this.$assembleMultilineRegExp(b, c));
            try {
          ...
          (this.$lineIterator = function (a, b) {
            var c = b.backwards == 1,
              ...
              e = b.range,
              f = b.start;
            f || (f = e ? e[c ? "end" : "start"] : a.selection.getRange()),
              f.start && (f = f[d != c ? "end" : "start"]);
        ...
        (this.addCommand = function (a) {
          ...
          (this.parseKeys = function (a) {
            ...
            for (var g = b.length; g--; ) {
              ...
              if (h == null) throw "invalid modifier " + b[g] + " in " + a;
              f |= h;
            }
  ...
  ace.define(
    ...
    function (a, b, c) {
      ...
      var r = function (a, b) {
        var c = this;
        (this.container = a),
          (this.$keepTextAreaAtCursor = !g.isIE),
          ...
          this.setHighlightGutterLine(!0),
          (this.$gutterLayer = new j(this.$gutter)),
          this.$gutterLayer.on(
            "changeGutterWidth",
            this.onResize.bind(this, !0)
          ),
        ...
        (this.canvas = d.element),
          ...
          (this.characterWidth = d.getCharacterWidth()),
          (this.lineHeight = d.getLineHeight()),
          (this.$cursorLayer = new m(this.content)),
          (this.$cursorPadding = 8),
          (this.$horizScroll = !1),
          (this.$horizScrollAlwaysVisible = !1),
          (this.$animatedScroll = !1),
          (this.scrollBar = new n(a)),
          this.scrollBar.addEventListener("scroll", function (a) {
            c.$inScrollAnimation || c.session.setScrollTop(a.data);
          }),
          (this.scrollTop = 0),
          (this.scrollLeft = 0),
          f.addListener(this.scroller, "scroll", function () {
            var a = c.scroller.scrollLeft;
            (c.scrollLeft = a), c.session.setScrollLeft(a);
          }),
          (this.cursorPos = { row: 0, column: 0 }),
          this.$textLayer.addEventListener("changeCharacterSize", function () {
            (c.characterWidth = d.getCharacterWidth()),
              (c.lineHeight = d.getLineHeight()),
              c.$updatePrintMargin(),
              c.onResize(!0),
              c.$loop.schedule(c.CHANGE_FULL);
          }),
          (this.$size = {
            width: 0,
            height: 0,
      ...
      (function () {
        (this.showGutter = !0),
          ...
          (this.onResize = function (a, b, c, d) {
            ...
            if (a || g.height != d)
              (g.height = d),
                ...
                (g.scrollerHeight = this.scroller.clientHeight),
                this.scrollBar.setHeight(g.scrollerHeight),
                this.session &&
            ...
            if (a || this.resizing > 1 || g.width != c) {
              ...
              (this.scroller.style.left = b + "px"),
                (g.scrollerWidth = Math.max(
                  0,
                  c - b - this.scrollBar.getWidth()
                )),
            ...
            a ? this.$renderChanges(f, !0) : this.$loop.schedule(f),
          ...
          (this.setFadeFoldWidgets = function (a) {
            a
              ? e.addCssClass(this.$gutter, "ace_fade-fold-widgets")
              : e.removeCssClass(this.$gutter, "ace_fade-fold-widgets");
          }),
          (this.$highlightGutterLine = !1),
          (this.setHighlightGutterLine = function (a) {
            if (this.$highlightGutterLine == a) return;
            this.$highlightGutterLine = a;
          ...
          (this.$updateGutterLineHighlight = function () {
            (this.$gutterLineHighlight.style.top =
              this.$cursorLayer.$pixelPos.top - this.layerConfig.offset + "px"),
              (this.$gutterLineHighlight.style.height =
                this.layerConfig.lineHeight + "px");
          }),
          (this.$updatePrintMargin = function () {
            ...
            this.$printMarginEl ||
              ...
              (a.className = "ace_print_margin_layer"),
              (this.$printMarginEl = e.createElement("div")),
              (this.$printMarginEl.className = "ace_print_margin"),
              a.appendChild(this.$printMarginEl),
              this.content.insertBefore(a, this.$textLayer.element));
          ...
          (this.$moveTextAreaToCursor = function () {
            ...
            this.$composition && (c += this.textarea.scrollWidth),
              (b -= this.scrollLeft),
              b > this.$size.scrollerWidth - c &&
                (b = this.$size.scrollerWidth - c),
              this.showGutter && (b += this.$gutterLayer.gutterWidth),
          ...
          (this.setHScrollBarAlwaysVisible = function (a) {
            this.$horizScrollAlwaysVisible != a &&
              ((this.$horizScrollAlwaysVisible = a),
              (!this.$horizScrollAlwaysVisible || !this.$horizScroll) &&
          ...
          (this.$renderChanges = function (a, b) {
            ...
            a & this.CHANGE_TEXT
              ...
              : a & this.CHANGE_LINES
              ? (this.$updateLines() ||
                  (a & this.CHANGE_GUTTER && this.showGutter)) &&
                this.$gutterLayer.update(this.layerConfig)
              : (a & this.CHANGE_TEXT || a & this.CHANGE_GUTTER) &&
                this.showGutter &&
                this.$gutterLayer.update(this.layerConfig),
          ...
          (this.$computeLayerConfig = function () {
            var a = this.session,
              ...
              e =
                ...
                this.$size.scrollerWidth - d < 0,
              f = this.$horizScroll !== e;
            (this.$horizScroll = e),
              f &&
                ((this.scroller.style.overflowX = e ? "scroll" : "hidden"),
                e || this.session.setScrollLeft(0));
            var g = this.session.getScreenLength() * this.lineHeight;
            this.session.setScrollTop(
              Math.max(
                0,
                Math.min(this.scrollTop, g - this.$size.scrollerHeight)
              )
            );
            var h = Math.ceil(c / this.lineHeight) - 1,
              i = Math.max(
                0,
                Math.round((this.scrollTop - b) / this.lineHeight)
              ),
              j = i + h,
              k,
              l,
            ...
            n && (i = n.start.row),
              (k = a.documentToScreenRow(i, 0)),
              (l = a.getRowLength(i) * m),
              (j = Math.min(a.screenToDocumentRow(j, 0), a.getLength() - 1)),
              (c = this.$size.scrollerHeight + a.getRowLength(j) * m + l),
              (b = this.scrollTop - k * m),
              (this.layerConfig = {
                width: d,
          ...
          (this.scrollCursorIntoView = function (a, b) {
            ...
            var c = this.$cursorLayer.getPixelPosition(a),
              ...
              e = c.top;
            this.scrollTop > e
              ? (b && (e -= b * this.$size.scrollerHeight),
                this.session.setScrollTop(e))
              : this.scrollTop + this.$size.scrollerHeight <
                  e + this.lineHeight &&
                (b && (e += b * this.$size.scrollerHeight),
                this.session.setScrollTop(
                  e + this.lineHeight - this.$size.scrollerHeight
                ));
            var f = this.scrollLeft;
            f > d
              ? (d < this.$padding + 2 * this.layerConfig.characterWidth &&
                  (d = 0),
                this.session.setScrollLeft(d))
              : f + this.$size.scrollerWidth < d + this.characterWidth &&
                this.session.setScrollLeft(
                  Math.round(d + this.characterWidth - this.$size.scrollerWidth)
                );
          }),
          (this.getScrollTop = function () {
          ...
          (this.scrollToLine = function (a, b, c, d) {
            var e = this.$cursorLayer.getPixelPosition({ row: a, column: 0 }),
              f = e.top;
            b && (f -= this.$size.scrollerHeight / 2);
            var g = this.scrollTop;
            this.session.setScrollTop(f),
              c !== !1 && this.animateScrolling(g, d);
          }),
          ...
          (this.scrollToY = function (a) {
            this.scrollTop !== a &&
              (this.$loop.schedule(this.CHANGE_SCROLL), (this.scrollTop = a));
          }),
          ...
          (this.setTheme = function (b) {
            function h(a) {
              e.importCssString(
                ...
                a && a.isDark
                  ? e.addCssClass(c.container, "ace_dark")
                  : e.removeCssClass(c.container, "ace_dark"),
        ...
        e.implement(this, f),
            ...
            for (var b in a)
              if (a.hasOwnProperty(b)) {
                ...
                for (var e = 0; e < c.length; e++) {
                  ...
                  var h = f.type;
                  h == "error"
                    ? (d.className = " ace_error")
                    : h == "warning" && d.className != " ace_error"
                    ? (d.className = " ace_warning")
                    : h == "info" &&
                      !d.className &&
                      (d.className = " ace_info");
                }
              }
          }),
          (this.update = function (a) {
            ...
            for (;;) {
              e > h &&
                ((e = g.end.row + 1),
                (g = this.session.getNextFoldLine(e, g)),
                (h = g ? g.start.row : Infinity));
              if (e > f) break;
              ...
              c.push(
                ...
                m.className,
                "' style='height:",
                this.session.getRowLength(e) * a.lineHeight,
                "px;'>",
                (l = e + 1)
              );
              if (i) {
                var n = i[e];
                n == null && (n = i[e] = this.session.getFoldWidget(e)),
                  n &&
                    c.push(
                      "<span class='ace_fold-widget ",
                      n,
                      n == "start" && e == h && e < g.end.row
                        ? " closed"
                        : " open",
                      "' style='height:",
                      a.lineHeight,
            ...
            (this.element = d.setInnerHtml(this.element, c.join(""))),
              (this.element.style.height = a.minHeight + "px"),
              this.session.$useWrapMode && (l = this.session.getLength());
            ...
            (o += p.left + p.right),
              o !== this.gutterWidth &&
                ...
                this._emit("changeGutterWidth", o));
          }),
          (this.$showFoldWidgets = !0),
          (this.setShowFoldWidgets = function (a) {
            a
              ? d.addCssClass(this.element, "ace_folding-enabled")
              : d.removeCssClass(this.element, "ace_folding-enabled"),
              (this.$showFoldWidgets = a),
              (this.$padding = null);
          }),
          (this.getShowFoldWidgets = function () {
          ...
          (this.$computePadding = function () {
            ...
            return (
              (this.$padding = {}),
              (this.$padding.left = parseInt(a.paddingLeft) + 1),
              (this.$padding.right = parseInt(a.paddingRight)),
              this.$padding
            );
          }),
        ...
        (this.$padding = 0),
            ...
            for (var c in this.markers) {
              ...
              if (d.renderer) {
                var g = this.$getTop(f.start.row, a),
                  h = Math.round(
                    this.$padding + f.start.column * a.characterWidth
                  );
                d.renderer(b, f, h, g, a);
              } else
                f.isMultiLine()
                  ? d.type == "text"
                    ? this.drawTextMarker(b, f, d.clazz, a)
                    : this.drawMultiLineMarker(b, f, d.clazz, a, d.type)
          ...
          (this.drawTextMarker = function (a, b, c, e) {
            var f = b.start.row,
              g = new d(
                ...
                b.start.column,
                f,
                this.session.getScreenLastRowColumn(f)
              );
            this.drawSingleLineMarker(a, g, c + " start", e, 1, "text"),
              (f = b.end.row),
              (g = new d(f, 0, f, b.end.column)),
              this.drawSingleLineMarker(a, g, c, e, 0, "text");
            for (f = b.start.row + 1; f < b.end.row; f++)
              (g.start.row = f),
                (g.end.row = f),
                (g.end.column = this.session.getScreenLastRowColumn(f)),
                this.drawSingleLineMarker(a, g, c, e, 1, "text");
          }),
          ...
          (this.drawSingleLineMarker = function (a, b, c, d, e, f) {
            ...
            if (f === "background") var i = d.width;
              ...
              i = Math.round(
                (b.end.column + (e || 0) - b.start.column) * d.characterWidth
              );
        ...
        d.implement(this, h),
            ...
            g.isIE || g.isOldGecko
              ? function () {
                  ...
                  if (!this.$measureNode) {
                    ...
                    if (this.element.ownerDocument.body)
                      this.element.ownerDocument.body.appendChild(b);
                    else {
              ...
              : function () {
                  if (!this.$measureNode) {
                    ...
                    while (c && !e.hasCssClass(c, "ace_editor"))
                      c = c.parentNode;
          ...
          (this.setDisplayIndentGuides = function (a) {
            return this.displayIndentGuides == a
              ? !1
              : ((this.displayIndentGuides = a), this.$computeTabString(), !0);
          }),
          (this.$tabStrings = []),
            ...
            function () {
              ...
              if (this.displayIndentGuides) {
                ...
                var d = "ace_indent-guide",
                  ...
                  f = e;
                this.showInvisibles &&
                  ((d += " ace_invisible"), (f = this.TAB_CHAR + e.substr(6))),
                  (this.$tabStrings[" "] =
                    "<span class='" + d + "'>" + e + "</span>"),
                  (this.$tabStrings["	"] =
                    "<span class='" + d + "'>" + f + "</span>");
          ...
          (this.updateLines = function (a, b, c) {
            ...
            for (;;) {
              i > k &&
                ((i = j.end.row + 1),
                (j = this.session.getNextFoldLine(i, j)),
                (k = j ? j.start.row : Infinity));
              if (i > f) break;
              var l = g[h++];
              if (l) {
                var m = [];
                this.$renderLine(m, i, !this.$useLineGroups(), i == k ? j : !1),
                  e.setInnerHtml(l, m.join(""));
              }
              i++;
            }
          }),
          (this.scrollLines = function (a) {
            ...
            if (b.firstRow < a.firstRow)
              for (
                var d = this.session.getFoldedRowCount(
                  b.firstRow,
                  a.firstRow - 1
                );
                d > 0;
          ...
          (this.$renderLinesFragment = function (a, b, c) {
            ...
            for (;;) {
              ...
              var i = e.createElement("div"),
                j = [];
              this.$renderLine(j, f, !1, f == h ? g : !1),
                (i.innerHTML = j.join(""));
              if (this.$useLineGroups())
                (i.className = "ace_line_group"), d.appendChild(i);
              else {
                var k = i.childNodes;
          ...
          (this.$renderToken = function (a, b, c, d) {
            ...
            if (!this.$textToken[c.type]) {
              ...
              c.type == "fold" &&
                (j =
                  " style='width:" +
                  c.value.length * this.config.characterWidth +
                  "px;' "),
                a.push("<span class='", i, "'", j, ">", h, "</span>");
            } else a.push(h);
            return b + d.length;
          }),
          (this.renderIndentGuide = function (a, b) {
            ...
            return c <= 0
              ...
              : b[0] == " "
              ? ((c -= c % this.tabSize),
                a.push(Array(c / this.tabSize + 1).join(this.$tabStrings[" "])),
                b.substr(c))
              : b[0] == "	"
              ? (a.push(Array(c + 1).join(this.$tabStrings["	"])), b.substr(c))
              : b;
          }),
          (this.$renderWrappedLine = function (a, b, c, d) {
            ...
            for (var i = 0; i < b.length; i++) {
              ...
              if (e + k.length < g)
                (h = this.$renderToken(a, h, j, k)), (e += k.length);
              else {
                while (e + k.length >= g)
                  (h = this.$renderToken(a, h, j, k.substring(0, g - e))),
                    (k = k.substring(g - e)),
                    (e = g),
                    d ||
                      a.push(
                    ...
                    f++,
                    (h = 0),
                    (g = c[f] || Number.MAX_VALUE);
                k.length != 0 &&
                  ((e += k.length), (h = this.$renderToken(a, h, j, k)));
              }
            }
          }),
          (this.$renderSimpleLine = function (a, b) {
            ...
            for (var f = 1; f < b.length; f++)
              (d = b[f]), (e = d.value), (c = this.$renderToken(a, c, d, e));
          }),
          (this.$renderLine = function (a, b, c, d) {
            ...
            if (e.length) {
              ...
              f && f.length
                ? this.$renderWrappedLine(a, e, f, c)
          ...
          (this.$getFoldLineTokens = function (a, b) {
            function e(a, b, c) {
              ...
              if (f != b) {
                ...
                g.length > c - b && (g = g.substring(0, c - b)),
                  d.push({ type: a[e].type, value: g }),
                  (f = b + g.length),
                  (e += 1);
              }
              while (f < c && e < a.length) {
                var g = a[e].value;
                g.length + f > c
                  ? d.push({ type: a[e].type, value: g.substring(0, c - f) })
                  : d.push(a[e]),
                  (f += g.length),
                  (e += 1);
              }
      ...
      (function () {
        (this.$padding = 0),
          ...
          (this.setBlinking = function (a) {
            (this.isBlinking = a), a && this.restartTimer();
          }),
          (this.addCursor = function () {
            var a = d.createElement("div"),
              b = "ace_cursor";
            return (
              this.isVisible || (b += " ace_hidden"),
              this.overwrite && (b += " ace_overwrite"),
              (a.className = b),
          ...
          (this.hideCursor = function () {
            this.isVisible = !1;
            for (var a = this.cursors.length; a--; )
              d.addCssClass(this.cursors[a], "ace_hidden");
            clearInterval(this.blinkId);
          }),
          (this.showCursor = function () {
            this.isVisible = !0;
            for (var a = this.cursors.length; a--; )
              d.removeCssClass(this.cursors[a], "ace_hidden");
          ...
          (this.getPixelPosition = function (a, b) {
            ...
            var c = this.session.documentToScreenPosition(a),
              d = Math.round(
                this.$padding + c.column * this.config.characterWidth
              ),
              e =
          ...
          (this.update = function (a) {
            ...
            if (this.session.selectionMarkerCount > 0) {
              ...
              for (var c = b.length; c--; ) {
                ...
                if ((f.top > a.height + a.offset || f.top < -a.offset) && c > 1)
                  continue;
                var g = (this.cursors[e++] || this.addCursor()).style;
                (g.left = f.left + "px"),
                  (g.top = f.top + "px"),
                  (g.width = a.characterWidth + "px"),
                  (g.height = a.lineHeight + "px");
              }
            ...
            h != this.overwrite && this.$setOverite(h),
              (this.$pixelPos = f),
              this.restartTimer();
          }),
          (this.$setOverite = function (a) {
            this.overwrite = a;
            for (var b = this.cursors.length; b--; )
              a
                ? d.addCssClass(this.cursors[b], "ace_overwrite")
                : d.removeCssClass(this.cursors[b], "ace_overwrite");
          }),
          (this.destroy = function () {
            clearInterval(this.blinkId);
          });
      ...
      var d = a("./lib/oop"),
        ...
        h = function (a) {
          (this.element = e.createElement("div")),
            ...
            a.appendChild(this.element),
            (this.width = e.scrollbarWidth(a.ownerDocument)),
    ...
    function (a, b, c) {
      ...
      function q(a) {
        (a.$onAddRange = a.$onAddRange.bind(a)),
          ...
          b.onSessionChange.call(a, a),
          a.on("changeSession", b.onSessionChange.bind(a)),
          a.on("mousedown", g),
      ...
      function r(a) {
        ...
        h.addListener(b, "keydown", function (a) {
          a.keyCode == 18 && !(a.ctrlKey || a.shiftKey || a.metaKey)
            ? c || ((d.style.cursor = "crosshair"), (c = !0))
            : c && (d.style.cursor = "");
        }),
          h.addListener(b, "keyup", e),
          h.addListener(b, "blur", e);
      }
          ...
          (this.ranges = null),
            ...
            (this.$onRemoveRange = function (a) {
              ...
              this._emit("removeRange", { ranges: a }),
                ...
                (b = b || this.ranges[0]),
                b && !b.isEqual(this.getRange()) && this.fromOrientedRange(b);
            }),
              ...
              if (this.rangeCount > 1) {
                ...
                if (f == g) {
                  if (d)
                    ...
                    var h = c.start,
                      i = c.end;
                  this.addRange(e.fromPoints(i, i)),
                    this.addRange(e.fromPoints(h, h));
                  return;
                }
                var j = [],
                  k = this.getLineRange(f, !0);
                (k.start.column = c.start.column), j.push(k);
                for (var l = f + 1; l < g; l++)
                  j.push(this.getLineRange(l, !0));
                (k = this.getLineRange(g, !0)),
                  (k.end.column = c.end.column),
                  j.push(k),
                  j.forEach(this.addRange, this);
              }
            }),
            (this.toggleBlockSelection = function () {
              if (this.rangeCount > 1) {
                ...
                var d = this.session.documentToScreenPosition(
                    this.selectionLead
                  ),
                  f = this.session.documentToScreenPosition(
            ...
            (this.rectangularRangeBlock = function (a, b, c) {
              ...
              for (var l = j; l <= k; l++) {
                var m = e.fromPoints(
                  this.session.screenToDocumentPosition(l, g),
                  this.session.screenToDocumentPosition(l, h)
                );
                if (m.isEmpty()) {
                  if (n && p(m.end, n)) break;
                  var n = m.end;
                }
              ...
              if (!c) {
                var o = d.length - 1;
                while (d[o].isEmpty() && o > 0) o--;
                if (o > 0) {
                  var q = 0;
                  while (d[q].isEmpty()) q++;
                }
                for (var r = o; r >= q; r--) d[r].isEmpty() && d.splice(r, 1);
              }
              return d;
            });
        }.call(f.prototype);
      ...
      (function () {
        (this.updateSelectionMarkers = function () {
          ...
          (this.removeSelectionMarker = function (a) {
            ...
            b != -1 && this.session.$selectionMarkers.splice(b, 1),
              (this.session.selectionMarkerCount =
                this.session.$selectionMarkers.length);
          }),
          ...
          (this.$onSingleSelect = function (a) {
            ...
            (this.inMultiSelectMode = !1),
              ...
              this.commands.removeEventListener(
                "exec",
          ...
          (this.$onMultiSelectExec = function (a) {
            ...
            b.multiSelectAction
              ? b.multiSelectAction == "forEach"
                ? c.forEachSelection(b, a.args)
                : b.multiSelectAction == "single"
                ? (c.exitMultiSelectMode(), b.exec(c, a.args || {}))
                : b.multiSelectAction(c, a.args || {})
              : (b.exec(c, a.args || {}),
          ...
          (this.forEachSelection = function (a, b) {
            ...
            for (var i = e.ranges.length; i--; )
              h.fromOrientedRange(e.ranges[i]),
                (this.selection = c.selection = h),
                a.exec(this, b || {}),
                h.toOrientedRange(e.ranges[i]);
            h.detach(),
              (this.selection = c.selection = d),
          ...
          (this.getCopyText = function () {
            ...
            if (this.inMultiSelectMode) {
              ...
              for (var c = 0; c < b.length; c++)
                a.push(this.session.getTextRange(b[c]));
          ...
          (this.onPaste = function (a) {
            ...
            if (b.length > c.length || b.length <= 2 || !b[1])
              return this.commands.exec("insertstring", this, a);
            for (var d = c.length; d--; ) {
              var e = c[d];
              e.isEmpty() || this.session.remove(e),
                this.session.insert(e.start, b[d]);
            }
          }),
          ...
          (this.selectMoreLines = function (a, b) {
            ...
            this.selection.$desiredColumn &&
              (f.column = this.selection.$desiredColumn);
            var g = this.session.screenToDocumentPosition(f.row + a, f.column);
            if (!c.isEmpty())
              var h = this.session.documentToScreenPosition(
                  d ? c.end : c.start
                ),
          ...
          (this.selectMore = function (a, b) {
            ...
            var f = c.getTextRange(e),
              g = m(c, f, a);
            g &&
              ((g.cursor = a == -1 ? g.start : g.end),
              this.multiSelect.addRange(g)),
          ...
          (this.alignCursors = function () {
            ...
            if (!c.length) {
              var d = this.selection.getRange(),
                f = d.start.row,
                g = d.end.row,
                h = this.session.doc.removeLines(f, g);
              (h = this.$reAlignText(h)),
                this.session.doc.insertLines(f, h),
                (d.start.column = 0),
                (d.end.column = h[h.length - 1].length),
                this.selection.setRange(d);
            } else {
              var j = -1,
                k = c.filter(function (a) {
                  if (a.cursor.row == j) return !0;
                  j = a.cursor.row;
                });
              b.$onRemoveRange(k);
              var l = 0,
              ...
              c.forEach(function (b, c) {
                var d = b.cursor,
                  ...
                  g = n[c] - m;
                f > g
                  ? a.insert(d, i.stringRepeat(" ", f - g))
                  : a.remove(new e(d.row, d.column, d.row, d.column - f + g)),
                  (b.start.column = b.end.column = l),
                ...
                return g
                  ? d == null
                    ? ((d = g[1].length),
                      ...
                      (f = g[3].length),
                      g)
                    : (d + e + f != g[1].length + g[2].length + g[3].length &&
                        (c = !1),
                      d != g[1].length && (b = !1),
                      d > g[1].length && (d = g[1].length),
                      e < g[2].length && (e = g[2].length),
                      f > g[3].length && (f = g[3].length),
                      g)
                  : [a];
              })
              .map(b ? (c ? i : h) : j);
        ...
        (b.onSessionChange = function (a) {
          ...
          c &&
            (c.multiSelect &&
              c.multiSelect.editor == this &&
              (c.multiSelect.editor = null),
            b.multiSelect.removeEventListener("addRange", this.$onAddRange),
            b.multiSelect.removeEventListener(
              "removeRange",
              this.$onRemoveRange
            ),
            b.multiSelect.removeEventListener(
        ...
        (this.comparePoints = function (a, b) {
          ...
          (this.pointIndex = function (a, b) {
            ...
            for (var d = b || 0; d < c.length; d++) {
              ...
              return f == 0
                ? d
                : ((f = this.comparePoints(a, e.start)), f >= 0 ? d : -d - 1);
            }
            return -d - 1;
          }),
          (this.add = function (a) {
          ...
          (this.merge = function () {
            ...
            for (var e = 1; e < b.length; e++) {
              ...
              this.comparePoints(d.end, c.end) < 0 &&
                ((d.end.row = c.end.row), (d.end.column = c.end.column)),
                b.splice(e, 1),
                a.push(c),
                (c = d),
                e--;
          ...
          (this.$onChange = function (a) {
            ...
            for (var j = 0, k = i.length; j < k; j++) {
              ...
              l.start.row == e &&
                ...
                ((l.start.column += h), (l.start.row += g)),
                l.end.row == e &&
                  l.end.column >= c.column &&
                  ((l.end.column += h), (l.end.row += g));
            }
            if (g != 0 && j < k)
              for (; j < k; j++) {
                var l = i[j];
      ...
      function f(a) {
        ...
        var i = a.editor,
          ...
          r = function () {
            ...
            (u = a),
              i.selection.moveCursorToPosition(b),
              i.selection.clearSelection(),
              i.renderer.scrollCursorIntoView(),
              i.removeSelectionMarkers(x),
              (x = j.rectangularRangeBlock(u, t)),
              x.forEach(i.addSelectionMarker, i),
              i.updateSelectionMarkers();
          },
          s = i.session,
        ...
        if (g && !f && !c && h == 0) {
          ...
          d.capture(
            ...
            function () {
              ...
              w && a.isEmpty() && e(w.cursor, a.cursor)
                ? j.substractPoint(a.cursor)
                : (v && (i.removeSelectionMarker(v), j.addRange(v)),
                  j.addRange(a));
            }
          );
        } else if (!f && c && h == 0) {
          a.stop(),
            k && !g ? j.toSingleRange() : !k && g && j.addRange(),
            j.moveCursorToPosition(l),
            j.clearSelection();
          var x = [],
            y = function (a) {
    ...
    function (a, b, c) {
      var d = a("../lib/oop"),
        ...
        g = function (b, c, d) {
          ...
          if (f.get("packaged"))
            this.$worker = new Worker(f.moduleUrl(c, "worker"));
          else {
            var e;
            typeof a.supports != "undefined" &&
            a.supports.indexOf("ucjs2-pinf-0") >= 0
              ? (e = a.nameToUrl("ace/worker/worker_sourcemint"))
              : (a.nameToUrl && !a.toUrl && (a.toUrl = a.nameToUrl),
                (e = this.$normalizePath(
                  a.toUrl("ace/worker/worker", null, "_")
                ))),
              (this.$worker = new Worker(e));
            var g = {};
            for (var h = 0; h < b.length; h++) {
              var i = b[h],
                j = this.$normalizePath(
                  a.toUrl(i, null, "_").replace(/.js(\?.*)?$/, "")
                );
              g[i] = j;
            }
          }
    ...
    function (a, b, c) {
      ...
      (e.prototype = {
        ...
        $buildBindingsRegex: function (a) {
          a.forEach(function (a) {
            a.key
              ...
              ? ("key" in a || (a.key = new RegExp("^" + a.regex[1] + "$")),
        ...
        $find: function (a, b, c, e, f, g) {
          var h = {};
          return (
            this.keymapping[a.state].some(function (i) {
              var j;
              if (i.key && !i.key.test(c)) return !1;
              if (i.regex && !(j = i.regex.exec(b))) return !1;
              if (i.match && !i.match(b, e, f, c, g)) return !1;
              if (i.disallowMatches)
                for (var k = 0; k < i.disallowMatches.length; k++)
                  if (!!j[i.disallowMatches[k]]) return !1;
              if (i.exec) {
                h.command = i.exec;
                if (i.params) {
                  var l;
                  (h.args = {}),
                    i.params.forEach(function (a) {
                      a.match != null && j != null
                        ? (l = j[a.match] || a.defaultValue)
                        : (l = a.defaultValue),
                        a.type === "number" && (l = parseInt(l)),
                        (h.args[a.name] = l);
                    });
                }
                a.buffer = "";
              ...
              return (
                i.then && ((a.state = i.then), (a.buffer = "")),
                h.command == null && (h.command = "null"),
                d && console.log("KeyboardStateMapper#find", i),
                !0
              );
            }),
        ...
        handleKeyboard: function (a, b, c, e, f) {
          ...
          if (b == 0 || (c != "" && c != String.fromCharCode(0))) {
            var g = this.$composeBuffer(a, b, c, f),
              ...
              j = g.keyIdentifier;
            return (
              (g = this.$find(a, h, i, b, c, j)),
              d && console.log("KeyboardStateMapper#match", h, i, g),
              g
            );
          }
          return null;
      ...
      var d = a("./range").Range,
        ...
        g = function (a, b, c, d, e, f) {
          ...
          (this.length = b),
            ...
            (this.$pos = c);
          var h = a.getUndoManager().$undoStack ||
            a.getUndoManager().$undostack || { length: -1 };
        ...
        f.implement(this, e),
          (this.setup = function () {
            ...
            (this.pos = b.createAnchor(e.row, e.column)),
              (this.markerId = c.addMarker(
                new d(e.row, e.column, e.row, e.column + this.length),
                this.mainClass,
                null,
                !1
              )),
              this.pos.on("change", function (b) {
                c.removeMarker(a.markerId),
                  (a.markerId = c.addMarker(
                    new d(
                      b.value.row,
                      b.value.column,
                      b.value.row,
                      b.value.column + a.length
                    ),
                    a.mainClass,
                    null,
                    !1
            ...
            (this.othersActive = !0),
              this.others.forEach(function (c) {
                (c.markerId = a.addMarker(
                  new d(c.row, c.column, c.row, c.column + b.length),
                  b.othersClass,
                  null,
                  !1
                )),
          ...
          (this.onUpdate = function (a) {
            ...
            if (
              c.start.column >= this.pos.column &&
              ...
              if (!this.session.$fromUndo) {
                if (b.action === "insertText")
                  for (var g = this.others.length - 1; g >= 0; g--) {
                    var h = this.others[g],
                      i = { row: h.row, column: h.column + f };
                    h.row === c.start.row &&
                      c.start.column < h.column &&
                      (i.column += e),
                      this.doc.insert(i, b.text);
                  }
                  ...
                  for (var g = this.others.length - 1; g >= 0; g--) {
                    ...
                    h.row === c.start.row &&
                      ...
                      (i.column += e),
                      this.doc.remove(
                        new d(i.row, i.column, i.row, i.column - e)
                      );
                  }
                c.start.column === this.pos.column && b.action === "insertText"
                  ? setTimeout(
                      function () {
                        this.pos.setPosition(this.pos.row, this.pos.column - e);
                        for (var a = 0; a < this.others.length; a++) {
                          var b = this.others[a],
                            d = { row: b.row, column: b.column - e };
                          b.row === c.start.row &&
                            c.start.column < b.column &&
                            (d.column += e),
                            b.setPosition(d.row, d.column);
                        }
                      }.bind(this),
                      0
                    )
                    ...
                    setTimeout(
                      function () {
                        for (var a = 0; a < this.others.length; a++) {
                          ...
                          b.row === c.start.row &&
                            c.start.column < b.column &&
                            b.setPosition(b.row, b.column - e);
                        }
                      }.bind(this),
                      0
                    );
              ...
              for (var g = 0; g < this.others.length; g++)
                this.others[g]._emit("change", { value: this.others[g] });
            }
            this.$updating = !1;
          }),
          (this.onCursorChange = function (a) {
            ...
            b.row === this.pos.row &&
            b.column >= this.pos.column &&
            b.column <= this.pos.column + this.length
              ? (this.showOtherMarkers(), this._emit("cursorEnter", a))
              : (this.hideOtherMarkers(), this._emit("cursorLeave", a));
          }),
          (this.detach = function () {
  ...
  ace.define(
    ...
    [
      ...
      "exports",
      "module",
      "text!ace/theme/textmate.css",
      "ace/lib/dom",
    ],
    function (a, b, c) {
      (b.isDark = !1),
        (b.cssClass = "ace-tm"),
        (b.cssText = a("text!./textmate.css"));
      var d = a("../lib/dom");
