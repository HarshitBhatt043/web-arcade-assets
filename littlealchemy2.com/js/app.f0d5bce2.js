(function (t) {
  function e(e) {
    for (
      var i, n, o = e[0], c = e[1], l = e[2], h = 0, d = [];
      h < o.length;
      h++
    )
      (n = o[h]),
  ...
  function o(t) {
    return (
      ...
      ({
        ...
        "firebase-app-firebase-auth-firebase-database-firebase-messaging":
          "firebase-app-firebase-auth-firebase-database-firebase-messaging",
        ...
        e.push(
          (n[t] = new Promise(function (e, s) {
            for (
              ...
              if ("stylesheet" === l.rel && (h === i || h === a)) return e();
            }
  ...
  "152b": function (t, e, s) {
    ...
    const n = ["EMAIL", "TEXT", "PASSWORD", "FILE"],
      a = (t) => {
        ...
        let r = !0;
        (("INPUT" === s && n.includes(a)) || "TEXTAREA" === s) &&
  ...
  1663: function (t, e, s) {
    ...
    class p {
      ...
      initInitialEvents(t) {
        this.once("LIBRARY_RENDERED", () =>
          window.setTimeout(() => this.emit(o["a"]), 150)
        ),
          this.once("LIBRARY_EMPTY", () =>
            window.setTimeout(() => this.emit(o["a"]), 150)
          ),
          this.once("LOGGED_IN", () => this.emit(o["a"])),
          this.once("NOT_LOGGED_IN", () =>
            window.setTimeout(() => this.emit(o["a"]), 250)
          ),
          this.once(o["a"], () => {
            Object(r["a"])(o["a"]), t.commit("GAME_READY");
          }),
  ...
  "22a7": function (t, e, s) {
    "use strict";
    s("2532"), s("e260"), s("ddb0");
    var i = s("c2e2"),
      n = s("ded8");
    s("13d5");
    const a = (t) => t.reduce((t, e) => ((t[e] = !0), t), {});
    class r {
      analyze(t, e) {
        const { totalProgress: s, timestamps: i } = this.analyzeHistory(t, e),
          ...
          c = a(r),
          l = s.filter(
            (t) => !c.hasOwnProperty(t) && !n.includes(t) && !o.includes(t)
          );
        return {
          progress: a(l),
          base: n,
      ...
      analyzeHistory(t, e) {
        const s = {},
          a = [];
        return (
          e.forEach(({ mother: e, father: r, timestamp: o }) => {
  ...
  2540: function (t, e, s) {
    ...
    class h {
      ...
      hide() {
        this.$store.getters.isPopupActive &&
      ...
      onHidePromise() {
        return this.$store.getters.isPopupOverlayActive
          ? new Promise((t) => {
              const e = this.$store.watch(
                (t, e) => e.isPopupOverlayActive,
                (s) => {
                  s || (e(), t());
                }
              );
  ...
  2929: function (t, e, s) {
    ...
    window.addEventListener("unhandledrejection", (t) => {
      ...
      e.test(t.reason) &&
        !s &&
        ((window.location.hash = "retry"), window.location.reload(!0));
    });
  },
  "2ae7": function (t, e, s) {
    "use strict";
      ...
      c = {
        ...
        prepare: (t) => {
          ...
          const e = document.querySelectorAll(
              `#${r["g"]} [data-id][data-normal]`
            ),
            s = [];
          return (
            Array.from(e).forEach(({ dataset: { id: e } }) => {
              e !== t.getters.draggableHelperId &&
                s.push(t.getters.droppableById(e));
            }),
            s
          );
        },
    ...
    class f {
      ...
      initSaveTriggers() {
        E.forEach((t) => a["a"].on(t, this.save)),
          Object.values(this.entries).forEach(({ watch: t }) =>
  ...
  "54cb": function (t, e, s) {
    ...
    class i {
      ...
      checkConditions(t) {
        ...
        const e = t.condition;
        return "elements" === e.type
          ? this.checkElements(e.elements, e.min)
          : "progress" !== e.type || this.checkProgress(e.total);
      }
      checkElements(t, e = 0) {
        const s = t.reduce(
          (t, e) => (this.$store.getters.hasInProgress(e) ? t + 1 : t),
          0
        );
        return s >= e;
      }
      ...
      get lockedIds() {
        ...
        return t.filter((t) => {
          ...
          return (
            !!e &&
            (e.parents.length
              ? !this.$store.getters.hasInProgress(t)
              : !this.$store.getters.hasUnlockedBase(t))
          );
        });
      }
    }
  ...
  "5c57": function (t, e, s) {
      ...
      m = {
        ...
        actions: {
          ...
          async mixOccured({ dispatch: t, getters: e }) {
            await Object(a["c"])(10),
              e.mixStatus !== d["a"] &&
                (e.mixStatus !== d["b"]
                  ? e.mixStatus === d["c"] &&
                    (o(), t("animationChange", l["c"]))
                  : h["a"].emit("ANIMATION_MIXED_START"));
          },
          ...
          animationNewCheck({ dispatch: t, getters: e }) {
            e.mixHasNewChildren &&
              (t("animationChange", l["f"]), h["a"].emit("ANIMATION_NEW_POP"));
          },
          ...
          animationEndCheck({ dispatch: t, getters: e }) {
            e.hasAllElements &&
              (t("animationChange", l["e"]), h["a"].emit("GAME_ENDED"));
          },
          async workspaceClear({ dispatch: t }) {
            await Object(a["c"])(1e3), t("animationCompletionCheck");
          },
          workspaceFinalRemove({ dispatch: t }) {
            t("animationCompletionCheck");
          },
          async workspaceExhaustedRemove({ dispatch: t }) {
            await Object(a["c"])(10), t("animationCompletionCheck");
          },
          animationCompletionCheck({ getters: t, dispatch: e }) {
            t.hasAllCleared &&
              t.needsGameCompletionAnimation &&
              (e("animationChange", l["d"]), h["a"].emit("GAME_COMPLETED"));
          },
    ...
    const E = {
      ...
      f = {
        ...
        getters: {
          ...
          baseElementsIds: (t, e) =>
            e.elementsList.filter(({ base: t }) => t).map(({ id: t }) => t),
          elementsCount: (t, e) => e.elementsIds.length,
          connectionsCount: (t, e) =>
            e.elementsList.reduce((t, e) => t + e.parents.length, 0),
        },
        actions: {
          init({ dispatch: t }) {
            t("baseLoad");
          ...
          baseElementAdd({ commit: t, getters: e }, s) {
            e.elements.hasOwnProperty(s.id) ||
              (g["a"].elementAdd(s.id, s), t("ELEMENTS_ADD"));
          },
          ...
          baseElementRemove({ commit: t, getters: e }, s) {
            e.elements.hasOwnProperty(s) &&
              (g["a"].elementRemove(s), t("ELEMENTS_REMOVE"));
          },
        },
        mutations: {
          ELEMENTS_SET(t) {
    ...
    const _ = "#",
      ...
      k = {
        state: N,
        getters: {
          elementIsExhausted: (t) => (e) =>
            t.exhausted.hasOwnProperty(e) ? t.exhausted[e] : null,
        ...
        actions: {
          ...
          resetProgress({ commit: t, getters: e }) {
            const s = e.elementsIds
              .filter((t) => e.elementIsExhausted(t))
              .map((t) => ({
                id: t,
                exhausted: !1,
              }));
    ...
    const z = {
      ...
      V = {
        ...
        getters: {
          ...
          draggedElement: (t, e) =>
            (t.dragging && e.droppables.find((e) => e.id === t.dragging)) ||
            null,
          ...
          draggableHelperElement: (t, e) =>
            t.draggableHelper ? e.droppableById(t.draggableHelper) : null,
          droppables: (t, e) => e.workspaceElements,
          droppablesActive: (t, e) =>
            e.droppables.filter((e) => e.id !== t.draggableHelper),
          droppablesListening: (t, e) =>
            e.droppables.filter((e) => t.listening.includes(e.id)),
          droppablesStatic: (t) => t.static,
          droppableStaticById: (t) => (e) => t.static[e],
          droppablesToListen: (t, e) => (t) =>
            e.droppables
              .filter(({ id: s }) => s !== t && s !== e.draggableHelperId)
              .map(({ id: t }) => t),
          droppableById: (t, e) => (s) => {
        ...
        actions: {
          ...
          dragEnd(
            { commit: t, dispatch: e, getters: s },
            { position: i, simulated: n }
          ) {
            t(
              "DRAG_POSITION",
              Object(j["a"])(
              ...
              t("DRAG_END"),
              H()(() => {
                e("draggableHelperAdd", !0), K.onDragEnd();
              });
          },
        ...
        mutations: {
          ...
          STATIC_DROPPABLE_UPDATE(
            t,
            { id: e, width: s, height: i, x: n, y: a }
          ) {
            const r = t.static[e];
    ...
    const nt = {
      ...
      at = {
        ...
        getters: {
          ...
          historyBefore: (t, e) => (t) =>
            e.history.filter(({ timestamp: e }) => e < t),
          historyLastTimestamp: (t, e) =>
            e.history.length ? e.history[e.history.length - 1].timestamp : 0,
        ...
        actions: {
          ...
          historyIntegrity({ getters: t, dispatch: e }) {
            const s = (e) =>
                (t.hasElement(e) && t.hasInProgress(e)) || Object(it["a"])(e),
          ...
          mixNew({ commit: t, getters: e }, { parents: s }) {
            e.hasMixed(s) ||
              (t("HISTORY_NEW_PARENTS", s), h["a"].emit("HISTORY_UPDATE"));
          },
        ...
        mutations: {
          HISTORY_SET(t, e) {
            st.set(e), (t.historyTimestamp = Date.now());
          },
          HISTORY_ADD(t, e) {
            st.addEntry(e), (t.historyTimestamp = Date.now());
          },
          HISTORY_NEW_PARENTS(t, e) {
            st.addNewParents(e), (t.historyTimestamp = Date.now());
          },
          HISTORY_REMOVE_BEFORE(t, e) {
            st.removeBeforeTimestamp(e), (t.historyTimestamp = Date.now());
          },
          RESET_PROGRESS(t) {
            st.reset(),
      ...
      bt = {
        ...
        actions: {
          libraryReload({ commit: t, getters: e }) {
            let s,
              i = [...e.prime, ...e.progress, ...e.base];
            (i = e.isArtModeEnabled
              ? i.concat(e.final)
              : i.filter((t) => {
                  const s =
                    e.mixStatus &&
                    (e.mixFather.elementId === t ||
                      e.mixMother.elementId === t);
                  return (
                    !!s ||
                    !(e.elementIsExhausted(t) && !e.isExhaustedVisible(t))
                  );
                })),
              (s =
                "timestamp" === e.librarySortBy
                  ? Object(Et["b"])(e.total, i)
                  : Object(Et["a"])(e.elements, i)),
              t("LIBRARY_RELOAD", s);
          },
      ...
      At = {
        ...
        getters: {
          ...
          hasInProgress: (t) => (e) => {
            const s = `${e}`;
            return (
              t.progress.hasOwnProperty(s) ||
              t.final.hasOwnProperty(s) ||
              t.base.includes(s) ||
              t.prime.includes(s)
            );
          },
          ...
          progressSince: (t) => (e) =>
            t.total.filter(({ timestamp: t }) => t > e).map(({ id: t }) => t),
          ...
          hasAllElements: (t, e) =>
            e.elementsCount > 0 && e.totalProgress >= e.elementsCount,
          hasAllExhausted: (t, e) =>
            e.elementsCount > 0 &&
            e.elementsIds.every((t) => {
              const s = e.elements[t];
              return !!s.final || !!e.elementIsExhausted(t);
            }),
          hasEmptyLibrary: (t, e) =>
            !e.hasExhaustedVisible && e.hasAllExhausted,
          hasAllCleared: (t, e) => e.hasEmptyLibrary && !e.workspaceHasInactive,
          isArtModeEnabled: (t, e) =>
            e.hasAllCleared && !e.needsGameCompletionAnimation,
        },
        actions: {
          ...
          mixNew({ commit: t, getters: e }, { parents: s, children: i }) {
            i.forEach((s) => {
              ...
              i &&
                (i.final
                  ? t("PROGRESS_FINAL", s)
                  : e.hasInProgress(s) || t("PROGRESS_NEW", s));
            }),
              window.setTimeout(
                () =>
                  h["a"].emit("ENCYCLOPEDIA_MIX_NEW", {
                    parents: s,
                    children: i,
                    timestamp: Date.now(),
                  }),
        ...
        mutations: {
          PROGRESS_ANALYZED(
            t,
            { progress: e, base: s, final: i, primes: n, timestamps: r }
          ) {
            (t.progress = e),
              (t.base = s),
              (t.prime = n),
    ...
    const Mt = Object(j["a"])(
      ...
      jt = {
        ...
        getters: {
          ...
          tutorialTextCurrent: (t, e) =>
            kt["a"].getById(e.tutorialTextCurrentId),
          tutorialTextPosition: (t) => t.currentTextPosition,
          tutorialTextShown: (t) => t.shownText,
          wasTutorialTextShown: (t, e) => (t) =>
            e.tutorialTextShown.includes(t),
        },
        actions: {
          ...
          resetProgress({ commit: t }) {
            t("TUTORIALS_TEXT_CLEAR"), kt["a"].onReset();
          },
        },
        mutations: {
          TUTORIAL_SHOW(t, e) {
    ...
    const Ft = {
      ...
      Gt = {
        ...
        getters: {
          ...
          isPopupClosable: (t, e) =>
            null === e.popupData ||
            !e.popupData.hasOwnProperty("closable") ||
            e.popupData.closable,
        },
        actions: {
          popupToggle({ dispatch: t, getters: e }, s) {
            e.popup !== s
              ? (null !== e.popup && t("popupHide", void 0),
                H()(() => t("popupShow", s)))
              : t("popupHide", void 0);
          },
          ...
          popupHide({ commit: t, getters: e }, { hideOverlay: s = !0 } = {}) {
            null !== e.popup &&
              (Bt["a"].onHide(e.popup), t("UI_POPUP_HIDE", s));
          },
        },
        mutations: {
          UI_POPUP_SHOW(t, e) {
          ...
          UI_POPUP_HIDE(t, e) {
            (t.popupName = null),
              e && ((t.isOverlayActive = !1), (t.popupData = null));
          },
        },
      };
    var Ut = Gt,
    ...
    const Kt = {
      ...
      zt = {
        ...
        getters: {
          ...
          workspaceRevertable: (t, e) =>
            !!t.elementsPrevious.length || !!e.workspaceInactivePrevious.length,
          workspaceElementsExhausted: (t, e) =>
            e.workspaceElements.filter(({ elementId: t }) =>
              e.elementIsExhausted(t)
            ),
        },
        actions: {
          workspaceClearRevertStart({ dispatch: t, getters: e }) {
            e.workspaceRevertable
              ? t("workspaceRevertStart")
              : t("workspaceClearStart");
          },
          workspaceClearStart({ dispatch: t, getters: e }) {
            (e.workspaceElements.length || e.workspaceExhausted.length) &&
              (t("animationChange", l["a"]),
              h["a"].emit("WORKSPACE_CLEAR_START"),
              o(),
              h["a"].once("ANIMATION_WORKSPACE_MIDDLE", () =>
                t("workspaceClear")
              ));
          },
          workspaceRevertStart({ dispatch: t, getters: e }) {
            (e.workspacePrevious.length ||
              e.workspaceInactivePrevious.length) &&
              (t("animationChange", l["g"]),
              o(),
              h["a"].once("ANIMATION_WORKSPACE_MIDDLE", () =>
                t("workspaceRevert")
              ));
          ...
          workspaceClear({ commit: t, getters: e }) {
            e.droppablesActive.length &&
              (t("WORKSPACE_CLEAR", e.draggableHelperElement),
              h["a"].emit("WORKSPACE_CLEAR"));
          },
          workspaceRevert({ commit: t, getters: e }) {
            e.workspacePrevious.length &&
              (t("WORKSPACE_REVERT"), h["a"].emit("WORKSPACE_REVERT"));
          },
          workspaceRemoveUnderLibrary({ commit: t, getters: e }) {
            const {
                position: { x: s },
              } = e.droppableStaticById(F["e"]),
          ...
          workspaceRemoveExhausted({ commit: t, getters: e }) {
            e.workspaceElementsExhausted.forEach(({ id: e }) =>
          ...
          workspaceElementClone({ dispatch: t, commit: e, getters: s }, i) {
            ...
            const a = Object(j["a"])({}, n),
              r = Yt["a"].getCloneDirections(
                n.position,
                s.workspaceBoxDimensions
              );
          ...
          historyIntegrity({ commit: t, getters: e }) {
            e.workspaceElements.forEach(({ id: s, elementId: i }) => {
              e.draggableHelperId !== s &&
                (e.hasInProgress(i) || t("WORKSPACE_ELEMENT_REMOVE", s));
            });
          },
          resetProgress({ commit: t, getters: e }) {
        ...
        mutations: {
          ...
          DRAGGABLE_HELPER_PREPARE(
            t,
            { helper: e, elementId: s, position: i }
          ) {
    ...
    const qt = Xt,
      Qt = {
        ...
        getters: {
          ...
          workspaceInactivePrevious: (t) =>
            t.workspaceExhaustedPrevious.concat(t.workspaceFinalPrevious),
          workspaceHasInactive: (t, e) =>
            !!e.workspaceFinal.length || !!e.workspaceExhausted.length,
        ...
        mutations: {
          WORKSPACE_FINAL_CLEAR(t) {
            (t.workspaceFinal.length || t.workspaceExhausted.length) &&
          ...
          DRAG_START(t) {
            t.workspaceExhaustedPrevious.length &&
              (t.workspaceExhaustedPrevious = []),
              t.workspaceFinalPrevious.length &&
                (t.workspaceFinalPrevious = []);
          },
  ...
  6953: function (t, e, s) {
      ...
      l = [
        {
          ...
          getPosition: (t) => {
            ...
            const e = Object(r["b"])(
              t.getters.workspaceFinal[0].position,
              t.getters.workspaceBoxDimensions
            );
            return Object(o["a"])(e);
          },
        },
        {
          ...
          getPosition: (t) => {
            const e =
              t.getters.workspaceElements.find(({ elementId: e }) => {
        ...
        },
        {
          ...
          after: (t) =>
            t.mixHasNewChildren
              ? a["a"].then("ANIMATION_NEW_END")
              : Promise.resolve(),
          delay: 1e3,
          getPosition: (t) => {
            if (!t.getters.workspaceExhausted.length) return c;
            const e = Object(r["b"])(
              t.getters.workspaceExhausted[0].position,
              t.getters.workspaceBoxDimensions
            );
            return Object(o["a"])(e);
          },
    ...
    class h {
      ...
      canShow() {
        return null === this.$store.getters.tutorialTextCurrentId
          ? Promise.resolve()
          : new Promise((t) => {
              const e = this.$store.watch(
                (t, e) => null === e.tutorialTextCurrentId,
                (s) => {
                  s && (t(), e());
                }
              );
  ...
  "6eebf": function (t, e, s) {
    ...
    class u {
      ...
      load() {
        return Promise.all([
          ...
          s.e("firebase-messaging"),
        ]).then(s.bind(null, "741f"));
      }
      onLoaded() {
      ...
      async sendToken(t) {
        "function" === typeof this._saveToken &&
          (await this._saveToken(t), Object(o["b"])(l, JSON.stringify(1)));
      }
      notifySuccess() {
      ...
      shouldLoad(t) {
        return (
          this.shouldRequestPermission(t) ||
    ...
    class f {
      ...
      async login({ mail: t, password: e }) {
        try {
          const { user: s, additionalUserInfo: i } = await this.firebase
            .auth()
            .signInWithEmailAndPassword(t, e);
          this.notify(s, i);
        } catch (s) {
          this.handleError(s);
        }
      ...
      async signup({ mail: t, password: e }) {
        try {
          const { user: s, additionalUserInfo: i } = await this.firebase
            .auth()
            .createUserWithEmailAndPassword(t, e);
          this.notify(s, i);
        } catch (s) {
          this.handleError(s);
        }
    ...
    class y {
      constructor() {
        (this.unsubscribe = null),
          (this.onAuthStateChanged = (t, e) => {
            if ((this.log("onAuthStateChanged", t), !t))
      ...
      async loginWithProvider(t) {
        try {
          ...
          return (
            this.log(t.providerId, "login success", e),
            this.onAuthStateChanged(e.user, e.additionalUserInfo),
            e
          );
        } catch (e) {
          throw (
            (this.log(t.providerId, "login error", e), new Error(e.message))
          );
        }
      }
      async logout() {
    ...
    class w {
      ...
      loadDatabase() {
        ...
        ]).then(s.bind(null, "66ce"));
      }
      async loadHandler() {
        const t = await s
          .e("firebase-database-handler")
          .then(s.bind(null, "65f2"));
        return t.default;
      }
      destroy() {
      ...
      async init(t) {
        (this.$store = t),
          ...
          this.notifications.init(this.firebase, this.$store, async (t) => {
            if ((await this.initDatabase(), !this.database))
    ...
    const i = (t, e) =>
      ...
      a = (t, e, s, i, n = "half") => {
        const a = t.x,
          ...
          p = m + h;
        return "touch" === n
          ? ((m >= r && m <= c) || (p >= r && p <= c) || (m < r && p > c)) &&
              ((d >= a && d <= o) || (u >= a && u <= o) || (d < a && u > o))
          : a < d + l / 2 && u - l / 2 < o && r < m + h / 2 && p - h / 2 < c;
      };
  },
  7897: function (t, e, s) {
    "use strict";
    ...
    class c {
      ...
      get parents() {
        return this.father && this.mother
          ? Object(a["c"])([this.father.elementId, this.mother.elementId])
          : [o["a"], o["a"]];
      }
      get father() {
      ...
      get canMix() {
        return (
          !this.$store.getters.isMixingDisabled &&
          this.$store.getters.isOver &&
          this.$store.getters.isDragging &&
          !this.$store.getters.isOverStatic
        );
      }
    }
    e["a"] = new c();
  ...
  b10a: function (t, e, s) {
    ...
    class u {
      init(t) {
        (this.$store = t), l["a"].on("ELEMENT_CLONE", (t) => this.onCloned(t));
      }
      onCloned(t) {
      ...
      getCloneDirections(t, e) {
        let s = 1,
          i = -1;
        return (
          t.x + e.width + d >= this.workspacePositionRight && (s *= -1),
          t.y <= d && (i *= -1),
          {
            x: s,
            y: i,
  ...
  c2e2: function (t, e, s) {
    ...
    s("e260"), s("ddb0"), s("2532");
    var i = s("da98");
    const n = (t, [e, s], n) => {
        const a = t[n];
        if (!Object(i["a"])(t, n) || !Object(i["b"])(a)) return [];
      ...
      c = ([t, e], s, i) => {
        const n = (i) => {
          ...
          a = [],
          r = Math.floor(i / 2);
        for (let o = -r; o <= r; o++) (0 !== o || i % 2) && a.push(n(o));
        return a;
      };
  },
  c55c: function (t, e, s) {
  ...
  c97d: function (t, e, s) {
    ...
    class o {
      ...
      offScroll() {
        this._callback &&
          (this.element.removeEventListener("scroll", this._callback),
          (this._callback = null));
      }
      scrollTo(t, e = 350) {
    ...
    class m {
      ...
      initMouseOutHandling() {
        document.addEventListener(
          ...
          (t) => {
            ...
            (e && "HTML" !== e.nodeName) ||
              Object(d["c"])(this.iscroll.wrapper);
          },
          !1
        );
      }
      ...
      onScroll(t) {
        (this._callback = h()(() => {
          ...
          e + this.iscroll.wrapperHeight > this.iscroll.scrollerHeight ||
            t({
              y: e,
            });
        }, u)),
    ...
    class g {
      ...
      onInit() {
        return this.initiated
          ? Promise.resolve()
          : new Promise((t) => n["a"].once("SCROLL_INITIATED", t));
      }
      hasNativeSupport() {
  ...
  cd49: function (t, e, s) {
    ...
    class D {
      constructor() {
        (this._promise = null),
          (this.initContent = async () => {
            if (
              (this.fetch().then(this.fillCache),
          ...
          (this.fillCache = (t = []) => {
            ...
            t.forEach((t) => {
              s.includes(t.id) ||
                ...
                ("boolean" === typeof t.clear && t.clear && (e = !0),
                this.cached.push(t));
            }),
              (this.cached = e
                ? []
                : this.cached.filter(({ id: t }) => !this.shown.includes(t))),
              this.save();
          }),
      ...
      load() {
        const t = async () => (await Object(o["c"])(R), this.cached);
        return Promise.race([this.fetch(), t()]);
      }
      prepare(t) {
        return t
          ? t
              .map((t) => Object(E["a"])(Object(E["a"])({}, I), t))
              .filter(({ id: t, offline: e, conditions: s }) => {
      ...
      show(t) {
        b()(() =>
          this.$store.dispatch("popupShowWithData", {
            name: v["NEWS"],
            data: t,
          })
        ),
      ...
      checkConditions(t) {
        ...
        return t.every(
          ({ type: t, value: s }) => !e.hasOwnProperty(t) || e[t](s)
        );
      }
      save() {
        Object(y["b"])(P, {
      ...
      fetch() {
        return null !== this._promise
          ? this._promise
          : ((this._promise = Object(o["d"])(x)), this._promise);
      }
      get storage() {
        return Object(y["a"])(P) || {};
      }
    ...
    const G = (t, e, s) =>
      ...
      U = [
        G("ENCYCLOPEDIA_ELEMENTS", "elements", {
          prepare: () => ({
        ...
        G("PROGRESS_RESET", "reset", {}),
        G("ENCYCLOPEDIA_MIX_BASE", "mixBase", {
          prepare: (t, e) => ({
            elements: e,
          }),
        }),
        ...
        G("ENCYCLOPEDIA_PROGRESS_ANALYZED", "progress", {
          prepare: (t) => {
            const e = t.getters.totalProgressElements.filter((e) =>
              t.getters.elementIsExhausted(e)
            );
            return {
    ...
    class Y {
      ...
      post(t, e = {}) {
        if (!this.loaded)
          return this.log("post save", t, e), void this.saved.push([t, e]);
    ...
    const Z = 0.6,
      ...
      et = [
        ...
        },
        {
          name: J["a"].Mix,
          check: () =>
            !r["a"].getters.hasProgress &&
            1 === r["a"].getters.droppablesActive.length,
          next: J["a"].Guide,
          hide() {
            return new Promise((t) => {
              const e = () => {
                tt().length < 2 ||
                  (g["a"].off("ELEMENT_DROP", e),
                  g["a"].off("MIX_NEW", e),
                  t());
              };
    ...
    const ht = (t) =>
        ...
        t.target.parentElement.classList.contains("element"),
      dt = 2,
      ut = 600,
      mt = 30;
    let pt = 0,
    ...
    const vt = () => {
        ...
        t.initEvent("doubletap", !0, !0), Et.dispatchEvent(t);
      },
      wt = () => {
        clearTimeout(gt),
          (gt = null),
      ...
      At = (t) => {
        ...
        if ("mouseup" === t.type && t.button !== ct) return;
        if (null !== ft && ft !== t.type) return;
        if (null !== Et && Et !== t.target) return;
        if (!ht(t)) return;
        if (!yt) return void wt();
    ...
    const Rt = () => {
      ...
      Dt = () => {
        if (!Ot) return void Rt();
        const t = document.createEvent("Event");
        t.initEvent("longpress", !0, !0), Ot.dispatchEvent(t), Rt();
      },
      Nt = () => {
        if (!Ct || !Pt) return 0;
    ...
    class Bt {
      ...
      onDragStart(t) {
        null !== t &&
          (Ht["a"].handler.disable(), this.$store.dispatch("dragStart", t));
      }
      onDragEnd(t, e = !1) {
        Ht["a"].handler.enable(),
      ...
      async onLibraryDistanceDragged(t, e, s, i, n) {
        ...
        (c && this.getWorkspaceBoxElement(r)) ||
      ...
      simulateStartDrag({
        ...
        if (!a) throw new Error("DragManager.simulateStartDrag - empty helper");
        const r = a.__vue__;
        r && (r.updateDraggablePosition(), r.draggable.dragStart(n, n));
      }
    ...
    class Kt {
      ...
      isOnline() {
        ...
        return t
          ? this.testConnection().then((t) => this.notify(t))
          : (this.notify(!1), Promise.reject());
      }
      notify(t) {
    ...
    class ge {
      ...
      initWatchers() {
        this.$store.watch(
          (t, e) => e.playMusic,
          (t) => this[t ? "unmute" : "mute"](ee)
        ),
          this.$store.watch(
            (t, e) => e.playSfx,
            (t) => this[t ? "unmute" : "mute"](te)
          );
      }
      mute(t) {
        const e = t === ee ? pe : de;
      ...
      canPlay(t) {
        return t === ee
          ? this.$store.getters.playMusic
          : this.$store.getters.playSfx;
      }
      setVolume(t, e) {
    ...
    class ve {
      constructor(t) {
        (this.sounds = {}),
          (this.decode = (t) =>
            new Promise((e, s) => this.context.decodeAudioData(t, e, s))),
          (this.context = t);
      }
      add(t, e) {
      ...
      load(t) {
        ...
        return this.sounds.hasOwnProperty(e) && s
          ? t.hasOwnProperty("promise")
            ? t.promise
            : ((t.promise = this.fetch(s)
                .then(this.decode)
                .then((e) => ((t.buffer = e), !0))
                .catch((t) => {
                  throw (
                    (console.error("Error while loading and decoding sound", t),
                    new Error(t.message))
                  );
                })),
              t.promise)
    ...
    const xe = 6e4,
      ...
      Re = () => {
        ...
        const i = Date.now();
        return (
          r["a"].getters.history.forEach(({ timestamp: n }) => {
            const a = i - n;
    ...
    class je {
      constructor(t, e) {
        (this.history = []),
          ...
          (Oe[Me].lazy = !1),
          g["a"].once("PLAY", () => {
            this.play(Me), this.addToHistory(Me);
          });
      }
      onTrackFinished() {
        Object(o["q"])("music", "trackFinished", this.current),
          this.current && this.current.silenceAfter
            ? window.setTimeout(this.playNext, 1e3 * this.current.silenceAfter)
            : this.playNext();
      }
      getNext() {
      ...
      randomConnector() {
        const t = this.names.filter(
          (t) =>
            this.getSound(t).type === se &&
            !this.prevents.includes(t) &&
            t !== this.latest
        );
        return this.random(t);
      }
      ...
      addToHistory(t) {
        this.history.unshift(t), this.history.length > ke && this.history.pop();
      }
      getSound(t) {
    ...
    class Be {
        ...
        (this.timer = null),
          ...
          (this.durationReached = () => {
            ...
            e < this.currentDuration ||
              (this.currentSound && this.currentSound.fadeOut
                ? this.volume
                    .fadeOutMusic(this.currentSound.fadeOut)
                    .then(() => this.stop(!0))
                : this.stop(!0));
          }),
          (this.base = t),
      ...
      play(t) {
        ...
        this.isValid(e) &&
          (this.$store.dispatch("musicPlay", t),
          Object(o["q"])("music", "play track", e),
          this.current !== ie
            ? (this.playSource(e),
              0 !== this.currentDuration &&
                (this.clearTimer(),
                (this.timer = window.setTimeout(
                  this.durationReached,
                  1e3 * (this.currentDuration - this.pausedAt)
                ))),
              e.fadeIn
                ? this.volume.fadeInMusic(e.fadeIn, e.volume)
                : this.volume.unmute(ee, e.volume))
            : window.setTimeout(() => {
      ...
      isValid(t) {
        return (
          ...
          !this.isPlaying &&
          !this.isHidden &&
          (this.volume.canPlay(ee) && this.$store.getters.isGameActive
            ? !!t.buffer ||
              (this.base.sounds
                .load(t)
                .then(() => this.play(t.name))
                .catch(() => null),
              !1)
            : (this.$store.dispatch("musicSet", t.name), !1))
        );
      }
      playSource(t) {
        if (!t.buffer) return;
      ...
      async onShow() {
        this.currentSound &&
          ...
          this.currentSound &&
            ...
            this.volume.fadeInMusic(He, this.currentSound.volume));
      }
      async onHide() {
        this.isPlaying &&
          (Object(o["q"])("music", "stop on hide", this.current),
      ...
      constructor() {
        (this.playMusic = (t) => {
          ...
          (this.playSFX = (t) => {
            ...
            if (!e) return;
            if (!e.buffer) return;
            if (!this.volume.canPlay(te)) return;
    ...
    const Ye = {
      ...
      Qe = [
        Xe("ANALYTICS_INIT", ({ send: t }) =>
          t("metrics", "game_ready", null, null, null, !0)
        ),
        Xe("PLAY", ({ send: t }) => t("metrics", "play_clicked")),
        Xe("MIX_NEW", async ({ send: t, $store: e }) => {
          await Object(o["c"])(500);
          const s = e.getters.totalProgress,
            i = Ve(s);
          i && t("metrics", "total_progress", i, +i);
        }),
        Xe("TUTORIALS_FINISHED", ({ send: t }) =>
          t("metrics", "tutorials_finished")
        ),
        Xe("HINTS_CLICKED", ({ send: t, $store: e }) => {
          t("metrics", "hints_clicked"),
            t(
              "user",
              "opens hints - fails streak",
              e.getters.sessionFailStreak
            );
        }),
        Xe("UNLOAD", ({ send: t, $store: e }) =>
          t("user", "leaves - fails streak", e.getters.sessionFailStreak)
        ),
      ];
    var Je = Qe;
    const Ze = [
        Xe("ANALYTICS_INIT", ({ set: t, $store: e }) => {
          t("game_ready_timing", Math.round(window.performance.now())),
            ...
            e.getters.totalProgress === e.getters.prime.length &&
              t("engagement", "game_ready");
        }),
        Xe("PLAY", ({ set: t, $store: e }) => {
          const s = e.getters.totalProgress,
            i = e.getters.prime.length;
          s === i
            ? t("engagement", "play_clicked")
            : s === i + 1
            ? t("engagement", "tutorials_finished")
            : s >= i + 2 && t("engagement", "own_element");
          const n = Ve(s);
          n && t("progress", n);
        }),
        ...
        Xe("LOGGED_IN", ({ set: t }) => t("logged_in", !0)),
        Xe("NOT_LOGGED_IN", ({ set: t }) => t("logged_in", !1)),
        Xe("TUTORIALS_FINISHED", ({ set: t }) =>
          t("engagement", "tutorials_finished")
        ),
        Xe("TUTORIALS_PROGRESS", ({ set: t }, { type: e, name: s }) =>
          t("engagement", `tutorial_${e}_${s}`)
        ),
        Xe("ANIMATION_NEW_POP", ({ set: t, $store: e }) => {
          e.getters.totalProgress > 5 ||
            t("engagement", "first_new_animation_pop");
        }),
        Xe("ANIMATION_NEW_END", ({ set: t, $store: e }) => {
          e.getters.totalProgress > 5 ||
            t("engagement", "first_new_animation_end");
        }),
        Xe("HINTS_CLICKED", ({ set: t }) => t("engagement", "hints_clicked")),
        Xe("GAME_ENDED", ({ set: t }) => t("engagement", "game_ended")),
        Xe("GAME_COMPLETED", ({ set: t }) => t("engagement", "game_completed")),
      ],
      ts = [
        qe(
          (t) => t.playMusic,
          ({ set: t }, e) => t("music_active", e)
        ),
        qe(
          (t) => t.playSfx,
          ({ set: t }, e) => t("sfx_active", e)
        ),
      ],
      es = [...Ze, ...ts];
    var ss = es;
    const is = [
      Xe("GAME_READY", ({ timing: t }) =>
    ...
    class ls {
        ...
        (this.setup = () => {
          ...
          (this.send = (t, e, s = null, i = null, n = null, a = !1) => {
            ...
            a && (r.nonInteraction = !0),
              null === n
                ? window.ga("send", "event", t, e, s, i, r)
                : window.ga("send", "event", t, e, n, r),
              this.logger("[EVENT]", t, e, s, i, n, r);
          }),
          (this.set = (t, e) => {
            window.ga &&
              (window.ga("set", cs[t], e), this.logger("[SET]", t, e));
          }),
          (this.sendTiming = (t, e) => {
            window.ga &&
              (window.ga("send", "timing", "Game", t, e),
              this.logger("[TIMING]", t, e));
          });
      }
      async init(t) {
        (this.$store = t),
          document.addEventListener(ot["c"], () =>
            this.send(
              "metrics",
              "not_ready_play_click",
              "timing",
      ...
      initHandlers() {
        ...
        rs.forEach((e) => {
          ...
          os(e)
            ? g["a"].on(e.trigger, s)
            : this.$store.watch((t, s) => e.watcher(s), s);
        });
      }
      handleErrors(t) {
        window.ga &&
      ...
      bs = function () {
        ...
        return i(
          ...
          [
            ...
            t.areTutorialsVisible ? i("Tutorials") : t._e(),
            i("TextTutorials"),
          ],
          1
        );
      ...
      vs = function () {
        ...
        return s(
          ...
          [
            ...
            s("BoxSizing"),
            t._l(t.workspaceFinalWithoutAnimated, function (t) {
              return s("FinalBox", {
                key: t.id,
                attrs: {
                  data: t,
      ...
      ks = fs["a"].extend({
        ...
        computed: {
          ...
          classes() {
            return {
              "js-final":
                !this.isFinalAnimationActive &&
                !this.isExhaustedAnimationActive,
    ...
    class Ys {
      ...
      _create(t) {
        this.isWorkspace &&
          (this.position = t.position ? t.position : this._getPosition()),
        ...
        this.handles.forEach((t) => {
          t.addEventListener("mousedown", this, !1),
            ...
            window.navigator.pointerEnabled &&
              (t.addEventListener("pointerdown", this, !1),
      ...
      dragStart(t, e) {
        Ft.isDragging ||
          ...
          this.isWorkspace
            ? this.startAnimatedDrag()
            : this.hasOwnProperty("onLibraryDragStart") &&
              "function" === typeof this.onLibraryDragStart &&
              this.onLibraryDragStart());
      }
      startAnimatedDrag() {
        (this.helper = this.element),
          this.setLeftTop(),
          this.hasOwnProperty("onDragStart") &&
            "function" === typeof this.onDragStart &&
      ...
      dragMove(t, e) {
        ...
        if (this.isWorkspace || !this.options.dragDistance)
          ...
          t > this.options.dragDistance &&
            (this.dragEnd(),
            this.hasOwnProperty("onDistanceDragged") &&
              "function" === typeof this.onDistanceDragged &&
              this.onDistanceDragged(
                this.startPoint,
                this.dragPoint,
                this.startPosition,
                this.startEventType
        ...
        (this.isDragging = !1),
          ...
          this.isWorkspace &&
            (this.helper &&
              ...
              Gs &&
              ((this.helper.style[Gs] = ""), this.setLeftTop()),
            this.hasOwnProperty("onDragEnd") &&
      ...
      transform() {
        this.helper.style[
          Gs
        ] = `translate(${this.dragPoint.x}px,${this.dragPoint.y}px)`;
      }
      setLeftTop() {
      ...
      zs = fs["a"].extend({
          ...
          {},
          {
            ...
            classes() {
              return {
                ...
                "js-to-remove":
                  !!this.element && this.isExhausted && !this.isArtModeEnabled,
              };
            },
          }
        ),
        ...
        methods: {
          ...
          onDoubleTap() {
            this.$store.dispatch("workspaceElementClone", this.id),
              this.$nextTick(async () => {
                (this.cloned = !0),
                  this.$refs.element
                    ? await Object(o["t"])(this.$refs.element)
                    : await Object(o["c"])(50),
                  (this.cloned = !1);
              });
          },
          ...
          updateDraggablePosition() {
            this.draggable &&
              this.draggable.setPosition(Object(E["a"])({}, this.position));
          },
        },
      }),
      Vs = zs,
      ...
      Zs = fs["a"].extend({
        ...
        methods: {
          updateSize(t = !1) {
            ...
            e && s
              ? ((this.obtainSize = !1), this.notify(e, s))
              : this.retry(t);
          },
          retry(t) {
            t
              ? this.notify(0, 0)
              : window.setTimeout(() => this.updateSize(!0), 100);
          },
          getSize() {
    ...
    var ni = fs["a"].extend({
        ...
        computed: Object(E["a"])(
          ...
          {},
          {
            ...
            ifAnimateClear() {
              return (
                this.isAnimationActive(As["a"]) || this.workspaceRevertable
              );
            },
            ifAnimateRevert() {
            ...
            workspaceFinalWithoutAnimated() {
              return this.workspaceFinal.filter(
                ({ elementId: t }) => !this.animationFinalFinished.includes(t)
              );
            },
        ...
        methods: {
          ...
          onTransitionEnd({ target: t, propertyName: e }) {
            ...
            s || i
              ? this.onWorkspaceAnimationMiddle()
              : this.onWorkspaceAnimationEnd();
          },
      ...
      li = [],
      hi = (s("498a"), s("4d63"), s("25f0"), s("b047")),
      di = s.n(hi),
      ui = s("623d");
    const mi = (t) => {
        const e = 200,
    ...
    var gi = function () {
      ...
      yi = fs["a"].extend({
        ...
        computed: Object(E["a"])(
          Object(E["a"])(
            {},
            Object(r["b"])(["elementIsExhausted", "isExhaustedForIdActive"])
          ),
          {},
          {
            iconUrl() {
            ...
            ifAnimateExhausted() {
              return (
                this.isExhausted && this.isExhaustedForIdActive(this.element.id)
              );
            },
            classes() {
              return {
            ...
            startIndex() {
              ...
              return (
                t + this.KEEP > this.elementsCount &&
                  (t = this.elementsCount - this.KEEP),
                Math.max(t, 0)
              );
            },
            KEEP() {
        ...
        watch: {
          searchQuery(t, e) {
            t !== e &&
              ...
              t.length &&
              this.$nextTick(() => {
                this.setStarting(0), this.$nextTick(() => Ht["a"].scrollTop(0));
              });
          },
          isSearchActive(t) {
            t ||
    ...
    var ji = fs["a"].extend({
        ...
        computed: Object(E["a"])(
          ...
          {
            elements() {
              return this.libraryElementsIds
                .map((t) => this.elementById(t))
                .filter(M);
            },
            filteredByQuery() {
              ...
              return this.elements.filter(({ name: t }) =>
        ...
        mounted() {
          (this.checkUnderLibrary = di()(
            this.checkUnderLibrary.bind(this),
            w["a"]
          )),
        ...
        methods: {
          ...
          updateHeights() {
            const t = this.$refs.scroller.$children;
            if (Ht["a"].isNative || !this.$refs.element.firstChild) return !1;
            if (t.length < 2) return !1;
            const e = t[1].$el,
              s = e.offsetHeight,
              i = (Object(o["e"])(e) - s) / 2;
            return (
              (this.elementOuterHeight = s + i),
          ...
          refreshScroll() {
            ...
            e < t * this.elementHeight && (e = t * this.elementHeight + 20),
              Ht["a"].handler &&
                Ht["a"].handler.refresh &&
                Ht["a"].handler.refresh(e);
          },
          libraryRendered() {
            return new Promise((t) => {
              const e = this.$watch(
        ...
        methods: {
          initListener() {
            g["a"].on("KEY_DOWN", (t) => {
              ...
              (e && e !== document.body && "INPUT" !== e.tagName) ||
                t.keyCode < Ui["a"] ||
                t.keyCode > Ui["f"] ||
                t.ctrlKey ||
                t.metaKey ||
          ...
          onKeyUp(t) {
            ...
            if (this.isActive && t.keyCode === Ui["d"])
              return t.preventDefault(), void this.hide();
          ...
          show(t = !1) {
            const e =
              this.isTutorialFinished && !this.isCompletionAnimationActive;
            e &&
              ...
              Object(o["p"])() &&
                Object(o["n"])() &&
                document.addEventListener("touchstart", this.blurHackForIOS));
          },
          emitSound() {
          ...
          onHide() {
            this.$refs.input.blur(),
              ...
              Object(o["p"])() &&
                Object(o["n"])() &&
                document.removeEventListener("touchstart", this.blurHackForIOS);
          },
          blurHackForIOS(t) {
            t.target &&
              (Object(o["m"])(this.$refs.container, t.target) ||
                (this.isArtModeEnabled
                  ? window.setTimeout(() => this.$refs.input.blur(), 100)
                  : this.$refs.input.blur()));
          },
        },
      }),
    ...
    var rn = fs["a"].extend({
        ...
        mounted() {
          g["a"].on("ANIMATION_FINAL_SINGLE_END", () =>
            this.onElementAnimationEnd()
          );
        },
        methods: {
          ...
          classes() {
            ...
            return {
              ...
              secondary:
                !this.active &&
                this.hasSecondary &&
                (!this.alwaysAnimate || !this.animating),
      ...
      On = fs["a"].extend({
        ...
        computed: Object(E["a"])(
          Object(E["a"])(
            {},
            Object(r["b"])([
              "isPopupWithNameActive",
              "encyclopediaTimestamp",
              "workspaceRevertable",
              "progressSince",
            ])
          ),
        ...
        methods: {
          ...
          toggleSettings() {
            this.isPopupWithNameActive(v["SETTINGS"])
              ? g["a"].emit("SETTINGS_HIDE")
              : g["a"].emit("SETTINGS_SHOW"),
          ...
          toggleHints() {
            this.isPopupWithNameActive(v["SYNC"]) ||
              (window.open(w["f"], "_blank"), this.onHintsClick());
          },
          onHintsClick() {
          ...
          toggle(t) {
            this.isPopupWithNameActive(v["SYNC"]) ||
              this.$store.dispatch("popupToggle", t);
          },
        },
      }),
      xn = On,
    ...
    var jn = fs["a"].extend({
        ...
        computed: Object(E["a"])(
          Object(E["a"])(
            {},
            Object(r["b"])(["tutorialTextCurrent", "tutorialTextPosition"])
          ),
          {},
          {
            classes() {
            ...
            containerClasses() {
              ...
              const e = [
                `horizontal-${Mn(Nn, t.horizontal)}`,
                `vertical-${Mn(kn, t.vertical)}`,
              ];
        ...
        watch: {
          tutorialTextCurrent(t) {
            if (!t) return;
            let e;
            (e = Object(Dn["b"])(t.text)
              ? t.text
              : t.text(this.$store.getters)),
              (this.textCopy = e);
          },
        },
        methods: {
      ...
      Jn = Qn,
      Zn = (s("6294"), Object(Rs["a"])(Jn, gs, Es, !1, null, null, null)),
      ta = Zn.exports;
  ...
  d0c4: function (t, e, s) {
    ...
    class o {
      ...
      onDragEnd(t = !1) {
        if (((this.currentPosition = null), !this.isOver))
          return this.isOutsideWorkspace()
            ? void this.destroyDragged()
            : void (
                this.wasCloned ||
                "longpress" === t ||
                n["a"].emit("ELEMENT_DROP")
              );
        this.shouldDestroyAfterDrop
          ? this.destroyDragged()
          : t || this.$store.dispatch("droppableDrop");
      }
      destroyDragged() {
      ...
      checkStatic() {
        ...
        return (
          !!t &&
          ((this.over && this.over.id === t.id) || this.triggerOver(t), !0)
        );
      }
      checkListening() {
      ...
      getSortedListening() {
        ...
        return (
          Array.from(s).forEach(({ dataset: { id: s } }) => {
  ...
  d257: function (t, e, s) {
    ...
    const u = ["Webkit", "Moz", "ms", "Ms", "O"],
      ...
      E = (t) => {
        ...
        return (
          t.offsetHeight +
          parseInt(e.marginTop || "0", 10) +
          parseInt(e.marginBottom || "0", 10)
        );
      };
    s("2532");
    var f = s("0347");
    ...
    const P = (t, ...e) => {},
      ...
      B = (t) => {
        ...
        return 0 === e && 0 === s && i < 2
          ...
          ? `${i} minutes ago`
          : 0 === e && 1 === s
          ? `${s} hour ${i} minutes ago`
          : 0 === e && s < 3
          ? `${s} hours ${i} minutes ago`
          : 0 === e
          ? `${s} hours ago`
          : 1 === e
          ? `${e} day ago`
  ...
  da98: function (t, e, s) {
    ...
    const r = (t, e) => t.hasOwnProperty(e),
      o = (t) =>
        t.hasOwnProperty("parents") && !!t.parents && !!t.parents.length,
      c = (t, e) => {
        const s = t.name || t.n || "",
          n = t.parents || t.p || [],
          r = t.children || t.c || [];
  ...
  ded8: function (t, e, s) {
    ...
    s("ac1f"), s("5319"), s("e260"), s("ddb0"), s("4e82"), s("26e9"), s("13d5");
    const i = /[0-9]{1,2}_/,
      n = (t, e) => {
      ...
      l = (t, e, s = !1) => {
        const i = t.reduce((t, { id: e, timestamp: s }) => ((t[e] = s), t), {});
        return c(i, e, s);
      };
  },
  e5fe: function (t, e) {},
