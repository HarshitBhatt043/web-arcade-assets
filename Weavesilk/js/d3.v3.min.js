d3 = (function () {
  ...
  function w(n) {
    ...
    return function (e, r) {
      ...
      r
        ? ((t.lastIndex = 0),
          t.test(u) || e.setAttribute("class", M(u + " " + n)))
        : e.setAttribute("class", M(u.replace(t, " ")));
    };
  }
  function S(n, t, e) {
    function r() {
  ...
  function q(n) {
    return (
      arguments.length || (n = oa.ascending),
      function (t, e) {
  ...
  function G(n, t, e) {
    ...
    return (
      ...
      (i = W(i) * Ia),
      tt(
        nt(3.2404542 * u - 1.5371385 * r - 0.4985314 * i),
        nt(-0.969266 * u + 1.8760108 * r + 0.041556 * i),
        nt(0.0556434 * u - 0.2040259 * r + 1.0572252 * i)
      )
    );
  }
  function K(n, t, e) {
  ...
  function at(n, t, e) {
    ...
    var r = Q((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / Ya),
      u = Q((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / Ua),
      i = Q((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / Ia);
  ...
  function gt() {
    ...
    var r = pt() - t;
    r > 24
      ? (isFinite(r) && (clearTimeout($a), ($a = setTimeout(gt, r))), (Ba = 0))
      : ((Ba = 1), Wa(gt));
  }
  function pt() {
    for (var n = null, t = Ka, e = 1 / 0; t; )
      t.flush
        ? (delete Ga[t.callback.id],
          (t = n ? (n.next = t.next) : (Ka = t.next)))
  ...
  function Yt(n, t) {
    ...
    for (
      ...
      (o = n[i]),
        ...
        (u = 1 - t * Math.cos(c) * f),
        (Math.abs(h - 2) < Fa && Math.abs(u - 2) < Fa) ||
          (Math.abs(u) < Fa ||
            Math.abs(h) < Fa ||
            (Math.abs(Math.abs(r - s) - La) < Fa
              ? u + h > 2 && (a += 4 * (r - s))
              : (a +=
                  Math.abs(h - 2) < Fa
                    ? 4 * (r - g)
                    : (((3 * La + r - s) % (2 * La)) - La) * (h + u))),
          (g = s),
          (s = r),
          (h = u));
    return a;
  ...
  function Ut(n, t) {
    return (
      ((n = n.point)[0] < 0 ? n[1] - La / 2 - Fa : La / 2 - n[1]) -
      ((t = t.point)[0] < 0 ? t[1] - La / 2 - Fa : La / 2 - t[1])
    );
  }
  function It(n) {
    var t,
    ...
    return {
      ...
      point: function (i, a) {
        ...
        Math.abs(c - La) < Fa
          ...
          : u !== o &&
            c >= La &&
            (Math.abs(e - u) < Fa && (e -= u * Fa),
            Math.abs(i - o) < Fa && (i -= o * Fa),
            (r = Vt(e, r, i, a)),
            n.point(u, r),
            n.lineEnd(),
            n.lineStart(),
    ...
    function r(n, t, e) {
      ...
      if (!(0 > M)) {
        ...
        if (
          ...
          N
            ? q
              ? (E + k > 0) ^ (b[1] < (Math.abs(b[0] - w) < Fa ? E : k))
              : E <= b[1] && b[1] <= k
            : (A > La) ^ (w <= b[0] && b[0] <= S))
        ) {
          var T = Ct(m, (-v + x) / y);
  ...
  function Bt(n, t, e, r) {
    ...
    function o(u, i) {
      var a = i[0] - u[0],
        o = i[1] - u[1],
        c = [0, 1];
      return Math.abs(a) < Fa && Math.abs(o) < Fa
        ? n <= u[0] && u[0] <= e && t <= u[1] && u[1] <= r
        : $t(n - u[0], a, c) &&
          $t(u[0] - e, -a, c) &&
          $t(t - u[1], o, c) &&
          $t(u[1] - r, -o, c)
        ? (c[1] < 1 && ((i[0] = u[0] + c[1] * a), (i[1] = u[1] + c[1] * o)),
          c[0] > 0 && ((u[0] += c[0] * a), (u[1] += c[0] * o)),
          !0)
        : !1;
    }
    return function (c) {
      ...
      var y,
        ...
        C = {
          ...
          polygonEnd: function () {
            (c = N),
              (y = oa.merge(y)).length
                ? (c.polygonStart(), Ft(y, i, l, h, c), c.polygonEnd())
                : f([n, t]) &&
                  (c.polygonStart(),
                  c.lineStart(),
                  h(null, null, 1, c),
    ...
    function e(t, u, i, a, o, c, l, f, s, h, g, p, d, m) {
      ...
      if (M > 4 * r && d--) {
        ...
        ((C * C) / M > r || Math.abs((v * N + y * T) / M - 0.5) > 0.3) &&
          (e(t, u, i, a, o, c, A, q, E, (x /= w), (b /= w), _, d, m),
          m.point(A, q),
  ...
  function Wt(n) {
    ...
    return (
      ...
      (t.clipAngle = function (n) {
        return arguments.length
          ? ((y = null == n ? ((x = n), xo) : Zt((x = +n) * Ha)), t)
          : x;
      }),
      (t.clipExtent = function (n) {
        return arguments.length
          ? ((b = n),
            (M = null == n ? ft : Bt(n[0][0], n[0][1], n[1][0], n[1][1])),
            t)
          : b;
      }),
      (t.scale = function (n) {
    ...
    var u = Math.cos(t),
      ...
      p = h
        ? function (n) {
            ...
            return [
              Math.atan2(u, r) * Pa,
              Math.atan2(a, Math.sqrt(r * r + u * u)) * Pa,
            ];
          }
        : function () {
            return [n * Pa, t * Pa];
  ...
  function ke(n, t) {
    ...
    return i
      ? ((e.invert = function (n, t) {
          ...
          return [
            Math.atan2(n, e) / i,
            2 * Math.atan(Math.pow(a / r, 1 / i)) - La / 2,
          ];
        }),
        e)
      : qe;
  ...
  function Ce(n) {
    function t(t) {
      ...
      for (
        var c, l = [], f = [], s = -1, h = t.length, g = lt(e), p = lt(r);
        ++s < h;
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((a = "function" == typeof n ? (i = n) : (i = Do.get(n) || je).key),
            t)
          : a;
      }),
  ...
  function Re(n, t) {
    return n.length < 3
      ? je(n)
      : n[0] +
          Ye((n.push(n[0]), n), Ue([n[n.length - 2]].concat(n, [n[1]]), t));
  }
  function Oe(n, t) {
    ...
    return (
      o[0] != c[0] || o[1] != c[1]
        ? (r.push("translate(", null, ",", null, ")"),
          u.push({ i: 1, x: hr(o[0], c[0]) }, { i: 3, x: hr(o[1], c[1]) }))
        : c[0] || c[1]
        ? r.push("translate(" + c + ")")
        : r.push(""),
      l != f
      ...
      s != h
        ? u.push({ i: r.push(r.pop() + "skewX(", null, ")") - 2, x: hr(s, h) })
  ...
  function dr(n, t) {
    var e,
      ...
      l = [],
      f = [];
    for (Ro.lastIndex = 0, r = 0; (e = Ro.exec(t)); ++r)
  ...
  function Or(n, t) {
    if (n === t) return n;
    for (
      var e = Rr(n), r = Rr(t), u = e.pop(), i = r.pop(), a = null;
      u === i;
      ...
      if (
        ...
        for (
          ...
          if (1 == p)
            for (
              c = r._pack_prev;
              c !== o._pack_prev && !_u(c, i);
              c = c._pack_prev, m++
            );
          p
            ? (m > d || (d == m && u.r < r.r) ? bu(r, (u = o)) : bu((r = c), u),
              a--)
            : (xu(r, i), (u = i), t(i));
        }
      var v = (f + s) / 2,
  ...
  function ku(n, t, e, r) {
    ...
    if (((n.x = t += r * n.x), (n.y = e += r * n.y), (n.r *= r), u))
      for (var i = -1, a = u.length; ++i < a; ) ku(u[i], t, e, r);
  }
  function Au(n, t, e) {
    var r = n.r + e.r,
      u = t.x - n.x,
  ...
  function Vu(n, t, e) {
    var r = -Math.floor(Math.log(Uu(n, t)[2]) / Math.LN10 + 0.01);
    return oa.format(
      e
        ? e.replace(ro, function (n, t, e, u, i, a, o, c, l, f) {
            return [
              t,
              e,
              u,
  ...
  function Qu(n, t) {
    ...
    return (
      ...
      (e.rangePoints = function (u, i) {
        ...
        return (
          (a = r(n.length < 2 ? (c + l) / 2 : c + (f * i) / 2, f)),
          (o = 0),
  ...
  function li(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((c = "function" == typeof n ? (o = n) : (o = Do.get(n) || je).key),
            (l = o.reverse || o),
            (f = o.closed ? "M" : "L"),
            t)
          : c;
  ...
  function _i(n, t, e) {
    if (((r = []), e && t.length > 1)) {
      for (
        ...
        for (u = e; --u > 0; ) (i = +t[o] - u * l) >= a[0] && r.push(i);
  ...
  (oa.ascending = function (n, t) {
    ...
    (oa.mean = function (t, e) {
      ...
      if (arguments.length === 1)
        ...
        for (; ++a < u; ) n((r = e.call(t, t[a], a))) && (i += (r - i) / ++o);
      return o ? i : void 0;
    }),
    ...
    (oa.median = function (t, e) {
      return (
        ...
        (t = t.filter(n)),
        t.length ? oa.quantile(t.sort(oa.ascending), 0.5) : void 0
      );
    }),
  ...
  (oa.bisectLeft = ga.left),
    ...
    (oa.zip = function () {
      ...
      for (var n = -1, e = oa.min(arguments, t), r = Array(e); ++n < e; )
  ...
  (oa.touches = function (n, t) {
    return (
      arguments.length < 2 && (t = f().touches),
      t
        ? va(t).map(function (t) {
            var e = h(n, t);
    ...
    (oa.behavior.drag = function () {
      ...
      function t() {
        function n() {
          var n = o.parentNode;
          return null != s
            ? oa.touches(n).filter(function (n) {
        ...
        function t() {
          ...
          (g |= e | r),
            (h = t),
            l(),
            c({ type: "drag", x: t[0] + a[0], y: t[1] + a[1], dx: e, dy: r });
        }
        function u() {
          c({ type: "dragend" }),
            g && (l(), oa.event.target === f && p.on("click.drag", i, !0)),
            p
              .on(null != s ? "touchmove.drag-" + s : "mousemove.drag", null)
              .on(null != s ? "touchend.drag-" + s : "mouseup.drag", null);
        }
        function i() {
        ...
        var a,
          ...
          p = oa
            .select(la)
            .on(null != s ? "touchmove.drag-" + s : "mousemove.drag", t)
            .on(null != s ? "touchend.drag-" + s : "mouseup.drag", u, !0);
        r
          ? ((a = r.apply(o, arguments)), (a = [a.x - h[0], a.y - h[1]]))
          : (a = [0, 0]),
          null == s && l(),
          c({ type: "dragstart" });
      }
    ...
    (Ea.select = function (n) {
      ...
      for (var a = -1, o = this.length; ++a < o; ) {
        ...
        for (var c = -1, l = r.length; ++c < l; )
          (u = r[c])
            ? (t.push((e = n.call(u, u.__data__, c))),
    ...
    (Ea.selectAll = function (n) {
      ...
      for (var u = -1, i = this.length; ++u < i; )
        for (var a = this[u], o = -1, c = a.length; ++o < c; )
          (e = a[o]) &&
            (r.push((t = va(n.call(e, e.__data__, o)))), (t.parentNode = e));
      return d(r);
    });
  var ka = {
  ...
  (oa.ns = {
    ...
    qualify: function (n) {
      ...
      return (
        ...
        ka.hasOwnProperty(e) ? { space: ka[e], local: n } : n
      );
    },
  }),
  ...
  (Ea.classed = function (n, t) {
    ...
    (Ea.style = function (n, t, e) {
      ...
      if (3 > r) {
        ...
        if (2 > r)
          return la.getComputedStyle(this.node(), null).getPropertyValue(n);
        e = "";
      }
    ...
    (Ea.insert = function (n, t) {
      function e(e, r) {
        return this.insertBefore(
          ca.createElementNS(this.namespaceURI, n),
          t.call(this, e, r)
        );
      }
      function r(e, r) {
        return this.insertBefore(
          ca.createElementNS(n.space, n.local),
          t.call(this, e, r)
        );
      }
      return (
    ...
    (Na.select = function (n) {
      for (var t, e, r, u, i, a = [], o = -1, c = this.length; ++o < c; ) {
        ...
        for (var l = -1, f = u.length; ++l < f; )
          (i = u[l])
            ? (t.push((r[l] = e = n.call(u.parentNode, i.__data__, l))),
  ...
  (Ta[0].parentNode = _a),
    ...
    (oa.behavior.zoom = function () {
      ...
      function h() {
        ...
        r(
          Math.pow(2, oa.event.shiftKey ? Math.ceil(i) - 1 : Math.floor(i) + 1)
        ),
          u(n, e),
          a(E.of(this, arguments));
      }
  ...
  oa.hcl = function (n, t, e) {
    return arguments.length === 1
      ? n instanceof Z
        ...
        : n instanceof J
        ? K(n.l, n.a, n.b)
        : K((n = at((n = oa.rgb(n)).r, n.g, n.b)).l, n.a, n.b)
      : X(+n, +t, +e);
  };
  ...
  (Ra.brighter = function (n) {
    return X(
      this.h,
      this.c,
      Math.min(100, this.l + Oa * (arguments.length ? n : 1))
    );
  }),
    (Ra.darker = function (n) {
      return X(
        this.h,
        this.c,
        Math.max(0, this.l - Oa * (arguments.length ? n : 1))
      );
    }),
    (Ra.rgb = function () {
  ...
  Za.forEach(function (n, t) {
    ...
    (oa.xhr = function (n, t, e) {
      ...
      var u = {},
        ...
        o = ft,
        c = new (
          la.XDomainRequest && /^(http(s)?:)?\/\//.test(n)
            ? XDomainRequest
            : XMLHttpRequest
        )();
      return (
  ...
  (oa.timer = function (n, t, e) {
    ...
    r && r.callback === n
      ? ((r.then = e), (r.delay = t))
      : (Ga[(n.id = ++Ja)] = Ka = { callback: n, then: e, delay: t, next: Ka }),
  ...
  var Wa =
      ...
      la.webkitRequestAnimationFrame ||
      la.mozRequestAnimationFrame ||
      la.oRequestAnimationFrame ||
      la.msRequestAnimationFrame ||
      function (n) {
        setTimeout(n, 17);
      },
    Qa = ".",
  ...
  var ro =
    ...
    uo = oa.map({
      ...
      r: function (n, t) {
        return (n = oa.round(n, mt(n, t))).toFixed(
  ...
  (oa.geo.bounds = _t(ft)),
    (oa.geo.centroid = function (n) {
      ...
      var t;
      return po && Math.abs((t = Math.sqrt(mo * mo + vo * vo + yo * yo))) > Fa
        ? [
            Math.atan2(vo, mo) * Pa,
            Math.asin(Math.max(-1, Math.min(1, yo / t))) * Pa,
          ]
        : void 0;
    });
  var go,
  ...
  (oa.geo.projection = Kt),
    ...
    (oa.geo.rotation = function (n) {
      ...
      return (
        (n = te((n[0] % 360) * Ha, n[1] * Ha, n.length > 2 ? n[2] * Ha : 0)),
        (t.invert = function (t) {
          return (
            (t = n.invert(t[0] * Ha, t[1] * Ha)), (t[0] *= Pa), (t[1] *= Pa), t
          );
        }),
        t
      );
    ...
    (oa.geo.graticule = function () {
      ...
      function t() {
        return oa
          ...
          .map(h)
          .concat(oa.range(Math.ceil(l / v) * v, c, v).map(g))
          .concat(
            oa
    ...
    (oa.geo.albersUsa = function () {
      ...
      return (
        ...
        (n.translate = function (t) {
          ...
          return (
            i.translate(t),
            a.translate([f - 0.4 * l, s + 0.17 * l]),
            o.translate([f - 0.19 * l, s + 0.2 * l]),
            c.translate([f + 0.58 * l, s + 0.43 * l]),
            (e = de(a, [
              [-180, 50],
              [-130, 72],
            ])),
  ...
  (oa.geo.path = function () {
    ...
    return (
      ...
      (n.projection = function (e) {
        return arguments.length
          ? ((r = (t = e) ? e.stream || Se(e) : ft), n)
          : t;
      }),
      (n.context = function (t) {
        return arguments.length
          ? ((u = (e = t) == null ? new ve() : new _e(t)), n)
          : e;
      }),
      (n.pointRadius = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : +t), n)
          : i;
      }),
    ...
    function t(n) {
      ...
      for (i = 0; v > i; ++i)
        i !== b &&
          ((c = t[i][1] - t[b][1]),
          (o = t[i][0] - t[b][0]),
          M.push({ angle: Math.atan2(c, o), index: i }));
      for (
        M.sort(function (n, t) {
        ...
        (a = M[i].index),
          g == M[i].angle
            ? ((o = t[h][0] - t[b][0]),
              ...
              o * o + c * c >= l * l + f * f
                ? (M[i].index = -1)
                : ((M[s].index = -1), (g = M[i].angle), (s = i), (h = a)))
            : ((g = M[i].angle), (s = i), (h = a));
        ...
        (n.clip = function (t) {
          for (
            ...
            for (
              ...
              (o = e[r]),
                nr(o, f, i)
                  ? (nr(a, f, i) || t.push(tr(a, o, f, i)), t.push(o))
                  : nr(a, f, i) && t.push(tr(a, o, f, i)),
                (a = o);
            f = i;
          }
          return t;
  ...
  (oa.geom.quadtree = function (n, t, e, r, u) {
    ...
    return (a = arguments.length)
      ? ((o = rr), (c = ur), 3 === a && ((u = e), (r = t), (e = t = 0)), i(n))
      : ((i.x = function (n) {
  ...
  (oa.interpolate = mr),
    (oa.interpolators = [
      ...
      function (n, t) {
        return (
          ("string" == typeof n || "string" == typeof t) && dr(n + "", t + "")
        );
      },
      function (n, t) {
        return (
          ("string" == typeof t
            ? Za.has(t) || /^(#|rgb\(|hsl\()/.test(t)
            : t instanceof L) && or(n, t)
        );
      },
      function (n, t) {
    ...
    (oa.layout.force = function () {
      ...
      return (
        (o.tick = function () {
          ...
          if (g)
            for (Xr((t = oa.geom.quadtree(m)), r, a), e = -1; ++e < b; )
          ...
          return (
            e ||
              (e = oa.behavior
                .drag()
                .origin(ft)
                .on("dragstart.force", Yr)
                .on("drag.force", t)
                .on("dragend.force", Ur)),
            arguments.length
              ? (this.on("mouseover.force", Ir)
                  .on("mouseout.force", Vr)
                  .call(e),
                void 0)
              : e
          );
    ...
    (oa.layout.pie = function () {
      function n(i) {
        var a = i.map(function (e, r) {
          ...
          c =
            (("function" == typeof u ? u.apply(this, arguments) : u) - o) /
            oa.sum(a),
          l = oa.range(i.length);
        null != e &&
          l.sort(
  ...
  oa.layout.stack = function () {
    ...
    return (
      ...
      (n.order = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : Zo.get(t) || nu), n)
          : e;
      }),
      (n.offset = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : Bo.get(t) || tu), n)
          : r;
      }),
      (n.x = function (t) {
      ...
      if (g > 0)
        for (i = -1; ++i < h; )
          (o = l[i]),
            o >= f[0] &&
              o <= f[1] &&
              ((a = c[oa.bisect(s, o, 1, g) - 1]), (a.y += p), a.push(n[i]));
      return c;
    }
    var t = !0,
      e = Number,
      ...
      return (
        ...
        (i.padding = function (n) {
          function t(t) {
            ...
            return null == e
              ? zu(t)
              : Du(t, "number" == typeof e ? [e, e, e, e] : e);
          }
          function e(t) {
            return Du(t, n);
          }
  ...
  var ec,
    ...
    ic = [],
    ac = 0,
    oc = { ease: Sr, delay: 0, duration: 250 };
  (ic.call = Ea.call),
    (ic.empty = Ea.empty),
    (ic.node = Ea.node),
      ...
      return (
        ...
        this.tween("style." + n, function (r, u) {
          var i = t.call(
            ...
            r,
            u,
            la.getComputedStyle(this, null).getPropertyValue(n)
          );
          return (
            i &&
            function (t) {
    ...
    (ic.transition = function () {
      for (
        var n, t, e, r, u = this.id, i = ++ac, a = [], o = 0, c = this.length;
        c > o;
        o++
      ) {
        a.push((n = []));
    ...
    (oa.svg.axis = function () {
      ...
      return (
        ...
        (n.tickSize = function (t, e) {
          ...
          return (
            (u = +t), (i = r > 1 ? +e : u), (a = r > 0 ? +arguments[r] : u), n
          );
        }),
  ...
  var cc = "bottom",
    lc = { top: 1, right: 1, bottom: 1, left: 1 };
  oa.svg.brush = function () {
    function n(i) {
      i.each(function () {
        ...
        a
          ...
          h.exit().remove(),
          o &&
            ((i = Lu(o)), l.attr("x", i[0]).attr("width", i[1] - i[0]), e(a)),
          c &&
            ((i = Lu(c)), l.attr("y", i[0]).attr("height", i[1] - i[0]), r(a)),
          t(a);
      });
    }
    function t(n) {
      n.selectAll(".resize").attr("transform", function (n) {
        return (
          "translate(" + h[+/e$/.test(n)][0] + "," + h[+/^s/.test(n)][1] + ")"
        );
      });
    }
    function e(n) {
    ...
    function u() {
      ...
      function f() {
        oa.event.keyCode == 32 &&
          (E || ((m = null), (k[0] -= h[1][0]), (k[1] -= h[1][1]), (E = 2)),
          l());
      }
      function s() {
        oa.event.keyCode == 32 &&
          2 == E &&
          ((k[0] += h[1][0]), (k[1] += h[1][1]), (E = 0), l());
      }
      function g() {
        var n = u(),
          i = !1;
        v && ((n[0] += v[0]), (n[1] += v[1])),
          E ||
            (oa.event.altKey
              ? (m || (m = [(h[0][0] + h[1][0]) / 2, (h[0][1] + h[1][1]) / 2]),
                (k[0] = h[+(n[0] < m[0])][0]),
                (k[1] = h[+(n[1] < m[1])][1]))
              : (m = null)),
          w && p(n, o, 0) && (e(b), (i = !0)),
          S && p(n, c, 1) && (r(b), (i = !0)),
          i && (t(b), x({ type: "brush", mode: E ? "move" : "resize" }));
      }
      function p(n, t, e) {
        var r,
          u,
        ...
        return (
          ...
          E
            ? (u = (r += l) + f)
            : (m && (l = Math.max(o, Math.min(c, 2 * m[e] - r))),
              r > l ? ((u = r), (r = l)) : (u = l)),
          h[0][e] !== r || h[1][e] !== u
            ? ((i = null), (h[0][e] = r), (h[1][e] = u), !0)
            : void 0
        );
      }
      function d() {
      ...
      var m,
        ...
        A = oa
          ...
          .on("keydown.brush", f)
          .on("keyup.brush", s);
      if (E) (k[0] = h[0][0] - k[0]), (k[1] = h[0][1] - k[1]);
      else if (_) {
        var q = +/w$/.test(_),
          N = +/^n/.test(_);
  ...
  (oa.time.year = Si(
    ...
    (oa.time.dayOfYear = function (n) {
      ...
      return Math.floor(
        (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * 6e4) / 864e5
      );
    }),
    gc.forEach(function (n, t) {
      ...
      var e = (oa.time[n] = Si(
        function (n) {
          return (
            (n = oa.time.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)),
            n
          );
        },
        function (n, t) {
        ...
        function (n) {
          ...
          return (
            Math.floor((oa.time.dayOfYear(n) + ((e + t) % 7)) / 7) - (e !== t)
          );
        }
      ));
      (oa.time[n + "s"] = e.range),
    ...
    (oa.time.format = function (n) {
      function t(t) {
        for (var r, u, i, a = [], o = -1, c = 0; ++o < e; )
          n.charCodeAt(o) === 37 &&
            ...
            (u = qc[(r = n.charAt(++o))]) != null && (r = n.charAt(++o)),
            (i = Nc[r]) && (r = i(t, null == u ? ("e" === r ? " " : "0") : u)),
            a.push(r),
            (c = o + 1));
      ...
      return (
        (t.parse = function (t) {
          ...
          var u = new hc();
          return (
            u.setFullYear(e.y, e.m, e.d), u.setHours(e.H, e.M, e.S, e.L), u
          );
        }),
        (t.toString = function () {
          return n;
