...
(function () {
  ...
  CanvasUtil = (function () {
    function CanvasUtil(canvas, fullscreen) {
      ...
      this.resizeToWindowAndPreserveContents = __bind(
        this.resizeToWindowAndPreserveContents,
        this
      );
      if (this.fullscreen) {
        this.resizeToWindow();
        $(window).resize(
          _.debounce(this.resizeToWindowAndPreserveContents, 300)
        );
      } else {
    ...
    CanvasUtil.prototype.resizeToWindowAndPreserveContents = function () {
      ...
      return ctx.putImageData(
        image,
        (this.canvas.width - prevWidth) / 2,
        (this.canvas.height - prevHeight) / 2
      );
    };
  ...
  Silk = (function () {
    function Silk(ctx, scaleInfo, state) {
      ...
      this.offsetX =
        (this.scaleInfo.logicalWidth - this.originalLogicalWidth) / 2;
      this.offsetY =
        (this.scaleInfo.logicalHeight - this.originalLogicalHeight) / 2;
      if (this.curve == null) {
        this.curve = [];
      }
      this.initColors();
    ...
    Silk.prototype.initColors = function () {
      ...
      switch (this.highlightMode) {
        case "time":
          this.colorScale = d3.scale
            .linear()
            .domain([
              this.timeColorScaleDomainLow,
              this.timeColorScaleDomainHigh,
            ])
        ...
        case "velocity":
          this.colorScale = d3.scale
            ...
            .domain([
              this.velocityColorScaleDomainLow,
              this.velocityColorScaleDomainHigh,
            ])
      ...
      return (this.isEraser =
        this.color === (_ref1 = this.highlightColor) &&
        _ref1 === this.eraserColor);
    };
    ...
    Silk.prototype.frame = function () {
      ...
      _results = [];
      for (
        i = _i = 1, _ref1 = this.drawsPerFrame;
    ...
    Silk.prototype.step = function (drawThisStep) {
      ...
      for (i = _i = 0, _len = curve.length; _i < _len; i = ++_i) {
        ...
        if (this.noiseForceScale) {
          noiseValue = noise(
            this.noiseOffset + p.x * this.noiseSpaceScale + 1000000,
            this.noiseOffset + p.y * this.noiseSpaceScale + 1000000,
            this.noiseOffset + this.noiseTimeScale * this.time,
            this.noiseOctaves,
            this.noiseFallout
          );
          noiseAngle =
            this.noiseAngleOffset + this.noiseAngleScale * noiseValue;
          if (this.rotateAnglesAroundSymmetryAxis) {
    ...
    Silk.prototype.generateDrawInstructions = function () {
      ...
      _results = [];
      for (
        rotationIndex = _i = 0, _ref1 = this.symNumRotations;
        _i < _ref1;
        rotationIndex = _i += 1
      ) {
        ...
        _results.push(
          function () {
            ...
            _results1 = [];
            for (
              spiralIndex = _j = 0, _ref2 = this.spiralCopies;
              _j < _ref2;
              spiralIndex = _j += 1
            ) {
    ...
    Silk.prototype.isFinishedDrawing = function () {
      return (
        this.completed &&
        (this.curve.length === 0 || this.stopDrawingOnceCompleted)
      );
    };
    ...
    Silk.prototype.setColor = function () {
      ...
      return (this.ctx.strokeStyle = this.colorScale(
        function () {
          switch (this.highlightMode) {
            case "time":
  ...
  PointPreviewSilk = (function (_super) {
    ...
    PointPreviewSilk.prototype.drawCurve = function (instr) {
      ...
      if (
        typeof this.previewEmphasisFn === "function"
          ? this.previewEmphasisFn(instr)
          : void 0
      ) {
      ...
      this.ctx.arc(
        p.x,
        p.y,
        instr.scale * this.previewRadius,
        0,
        2 * Math.PI,
        false
      );
  ...
  this.Silks = (function () {
    ...
    Silks.prototype.frame = function (dt) {
      ...
      for (id in _ref2) {
        silk = _ref2[id];
        if (
          !(this.drawInputPreview === false && id === this.inputPreviewSilkId)
        ) {
          silk.frame();
        }
        if (silk.isFinishedDrawing()) {
    ...
    Silks.prototype.add = function (id, state) {
      ...
      if (state != null) {
        ...
        silk = new Silk(
          this.silkCtx,
          scaleInfo,
          this.inputPreviewSilk.serialize()
        );
      } else {
      ...
      if (typeof Hue !== "undefined" && Hue !== null) {
        ...
        d(
          Hue.setHueSat(
            3,
            parseInt(65536 * (color.h / 360)),
            parseInt(255 * color.s)
          )
        );
      }
    ...
    Silks.prototype.addPreviewSilk = function (state) {
      ...
      this.previewSilks[id] = new PointPreviewSilk(
        this.sparksCtx,
        this.scaleInfo(),
        startState
      );
    ...
    Silks.prototype.swapSilkCanvii = function () {
      ...
      this.silkCtx = this.silkCanvas.getContext("2d");
      $(this.silkCanvas)
        .removeClass("buffer onepacity")
        .addClass("active zeropacity")
    ...
    Silks.prototype.takeSnapshot = function () {
      ...
      canvas
        .getContext("2d")
        .drawImage(this.silkCanvas, 0, 0, canvas.width, canvas.height);
      all = {};
      _ref1 = this.all;
      for (id in _ref1) {
        silk = _ref1[id];
    ...
    Silks.prototype.loadSnapshot = function (data) {
      ...
      this.fillSilkCanvas();
      this.silkCtx.drawImage(
        data.canvas,
        (this.silkCanvas._util.widthOnScreen - data.sizeOnScreen.width) / 2,
        (this.silkCanvas._util.heightOnScreen - data.sizeOnScreen.height) / 2,
        data.sizeOnScreen.width,
        data.sizeOnScreen.height
      );
      this.all = {};
      scaleInfo = this.scaleInfo();
      _ref1 = data.all;
      ...
      if (this.pinputX != null) {
        if (this.inputIsActive) {
          this.addPoint(
            ...
            this.inputX,
            this.inputY,
            this.inputX - this.pinputX,
            this.inputY - this.pinputY
          );
        } else {
      ...
      previewActive = (function (_this) {
        return function () {
          ...
          return (fadeTimer = setTimeout(function () {
            var _ref2;
            return (_ref2 = _this.inputPreviewSilk) != null
              ? _ref2.fadeOut()
              : void 0;
          }, 3000));
        };
    ...
    Silks.prototype.getCenterCoordinates = function () {
      return [
        this.silkCanvas._util.halfWidthOnScreen,
        this.silkCanvas._util.halfHeightOnScreen,
      ];
    };
      ...
      if (this.playing) {
        if (!this.recordOnly && this.time in this.tape) {
          ...
          for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
            ...
            (_ref2 = this.target[name]).call.apply(
              _ref2,
              [this.target].concat(__slice.call(args))
            );
          }
        }
        return (this.time += 1);
  ...
  this.initSound = function () {
    ...
    SoundController = (function () {
      ...
      SoundController.prototype.fadeTo = function (gain, duration) {
        ...
        return this.source.gain.linearRampToValueAtTime(
          this.gain,
          now + duration
        );
      };
    ...
    if (this.audioContext != null) {
      ...
      modulateDrawSound = function (level) {
        ...
        level = _.constrain(level, 0.15, 0.6);
    ...
    controls = {
      ...
      start: function () {
        ...
        return (check = setInterval(function () {
          ...
          introBuffered =
            bgIntro.buffered.length > 0 && bgIntro.buffered.end(0) > 2;
      ...
      playClearSound: function () {
        if (!muteEffects()) {
          return typeof playClearSound === "function"
            ? playClearSound()
            : void 0;
        }
      },
      playDrawSound: function () {
        ...
        try {
          if (!muteEffects()) {
            return typeof playDrawSound === "function"
              ? playDrawSound()
              : void 0;
          }
        } catch (_error) {
      ...
      stopDrawSound: function () {
        ...
        try {
          if (!muteEffects()) {
            return typeof stopDrawSound === "function"
              ? stopDrawSound()
              : void 0;
          }
        } catch (_error) {
      ...
      modulateDrawSound: function (level) {
        var ex;
        try {
          return typeof modulateDrawSound === "function"
            ? modulateDrawSound(level)
            : void 0;
        } catch (_error) {
          ex = _error;
      ...
      bloop: function (multiplier) {
        ...
        try {
          if (!muteEffects()) {
            return bloopEffect != null
              ? bloopEffect.trigger(multiplier)
              : void 0;
          }
        } catch (_error) {
          ex = _error;
  ...
  initUI = function (silks) {
    var initColorPicker,
      ...
      mirror,
      mouseDownOnSlider,
      mouseOverPreviewableControls,
      preview,
      settingObservable,
      showColorPicker,
      showSymmetryControls,
      spiral,
      symSlider,
      toggleMirror,
      toggleSpiral,
          ...
          (function (_this) {
            return function () {
              ...
              return (addPointTimer = setInterval(function () {
                ...
                (_ref1 = silks.getCenterCoordinates()),
                  (cx = _ref1[0]),
                  (cy = _ref1[1]);
    ...
    settingObservable = function (setting) {
      var obs;
      silks.silkSettingsState[setting] = _.load(
        setting,
        silks.silkSettingsState[setting]
      );
      ...
      swatch = function (
        ...
        calcPoints = function (
          ...
          for (
            ...
            if (
              mouseDistance > R &&
              Math.abs(angleDifference(angle, mouseAngle)) < threshold &&
              mouseDistance > dist(cx, cy, mouseSvgX, mouseSvgY)
            ) {
              _results.push(
                (points[i] = {
                  x: mouseSvgX + r * ccos,
        ...
        updateGradientAngle = function (targetAngle, anim) {
          if (anim) {
            return trans(gradient)
              .duration(1000)
              .tween("gradient", function () {
        ...
        update = function (mousePageX, mousePageY, mouseDown) {
          ...
          mouseAngle =
            mousePageX !== 0 && mousePageY !== 0
              ? Math.atan2(mouseSvgY - y, mouseSvgX - x)
              : 0;
      ...
      for (i = _i = 0, _len = _ref1.length; _i < _len; i = ++_i) {
        ...
        swatches.push(
          swatch.apply(
            null,
            [
              centerX + 65 * Math.cos(angleStep * i),
              centerY + 65 * Math.sin(angleStep * i),
            ].concat(__slice.call(color))
          )
        );
      }
      swatches.push(
        swatch.apply(null, [centerX, centerY].concat(__slice.call(colors[6])))
      );
      _fn = function (s) {
        return $(s.path.node())
      ...
      return $(window)
        ...
        .on("mouseup", function (e) {
          ...
          if (draggedSwatch != null) {
            ...
            silks.silkSettingsState.highlightColor =
              mouseoverSwatch != null && mouseoverSwatch !== draggedSwatch
                ? mouseoverSwatch.trueColor()
                : draggedSwatch.trueHighlightColor();
    ...
    initSlider = function (sel, vals, handleMoved) {
      ...
      sliderBgOffsetLeft =
        sliderBg.left + parseInt($sliderBg.css("margin-left"));
      ...
      bringHandlesTo = function (pos, onlyGhost) {
        ...
        if (useX) {
          ...
          $ghostHandle.css(
            "left",
            x + sliderBgOffsetLeft - halfHandleSize + "px"
          );
          if (!onlyGhost) {
        ...
        if (useY) {
          ...
          $ghostHandle.css(
            "top",
            y + sliderBgOffsetTop - halfHandleSize + "px"
          );
          if (!onlyGhost) {
    ...
    initColorPicker();
    preview = initPreview();
    (_ref1 = makeToggle("symMirror", true, false)),
      (mirror = _ref1[0]),
      (toggleMirror = _ref1[1]);
    (_ref2 = makeToggle("spiralCopies", 4, 1)),
      (spiral = _ref2[0]),
      (toggleSpiral = _ref2[1]);
    ...
    symSlider = initSlider(
      "#sym-num-rotations",
      {
        x: _.unlerp(
          1,
          6,
          _.load("symNumRotations", silks.silkSettingsState.symNumRotations)
        ),
      },
      function (vals, ghost) {
        var silkState, state;
        ...
        if (state.symNumRotations > 1) {
          $("#sym-num-rotations-label").html(
            "" + state.symNumRotations + "-fold rotational symmetry"
          );
        } else {
      ...
      return function () {
        ...
        if ((_ref1 = window.Hue) != null) {
          _ref1.setColor = function (color) {
            ...
            return typeof Hue !== "undefined" && Hue !== null
              ? Hue.setHueSat(num, h, s)
              : void 0;
          };
        }
        frameCount = 0;
          ...
          shareButtonClick: function () {
             ...
             */
              return $.ajax({
                ...
                error: function (data) {
                  alert(
                    "There was an error uploading your picture. Maybe try again?"
                  );
        ...
        b.shareUrlEmail = ko.computed(function () {
          ...
          return (
            "mailto:?subject=" +
            escape("Silk -- Interactive generative art") +
            "&body=" +
            escape("I just drew this on weavesilk.com: " + url)
          );
        });
        b.pristine = ko.observable(false || !b.showColorPicker());
        b.muted =
          (_ref2 = sound != null ? sound.muteSound : void 0) != null
            ? _ref2
            : ko.observable(true);
        ...
        b.showBigAnnouncementDefault = ko.computed(function () {
          return (
            b.showAnyAnnouncement() &&
            (b.introSilkShowing() ||
              (b.justCleared() && b.notPristine()) ||
              b.isReplay() ||
              b.isOnMobile())
          );
        });
        ...
        b.shareUrlFacebook = ko.computed(function () {
          ...
          return (
            "https://www.facebook.com/dialog/feed?app_id=408271179236250&link=" +
            escape(url) +
            "&picture=" +
            encodeURI(b.shareUrlThumbnail()) +
            "&name=" +
            "Silk – Interactive Generative Art" +
            "&caption=" +
            escape("weavesilk.com") +
            "&description=" +
            encodeURI("Create beautiful flowing art with Silk.") +
            "&redirect_uri=" +
            encodeURI(url)
          );
        });
        b.shareUrlTwitter = ko.computed(function () {
          ...
          return (
            ...
            escape(url) +
            "&text=" +
            escape("Look what I drew with #weavesilk!")
          );
        });
        ...
        if (urlParams.id != null && urlParams.v != null) {
          ...
          $.ajax({
            url:
              "http://weavesilk.s3.amazonaws.com/v" +
              urlParams.v +
              "/uploads/replay/" +
              urlParams.id +
              ".json",
            ...
            success: function (data) {
              ...
              b.showShareOptions(false);
              b.shareUrlDirect(url);
              return b.shareUrlThumbnail(
                "http://weavesilk.s3.amazonaws.com/v4/uploads/thumb/" +
                  urlParams.id +
                  ".png"
              );
            },
